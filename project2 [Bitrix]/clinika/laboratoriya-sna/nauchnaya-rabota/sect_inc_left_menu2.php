...
<a href="/clinika/laboratoriya-sna/index.php" alt="">
...
color:#656565; font-size:10pt;"><strong>Лаборатория сна</strong></span>
...
<!--menu-->
 <?$APPLICATION->IncludeComponent("bitrix:menu", "left", array(
	"ROOT_MENU_TYPE" => "klinikalaboratoriyasna",
	"MENU_CACHE_TYPE" => "A",
	...
	"MAX_LEVEL" => "1",
	"CHILD_MENU_TYPE" => "klinikalaboratoriyasna",
	"USE_EXT" => "Y",
	"DELAY" => "N",

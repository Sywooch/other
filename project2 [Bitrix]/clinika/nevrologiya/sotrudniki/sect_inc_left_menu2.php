...
<a href="/clinika/nevrologiya/index.php" alt="">
...
color:#656565; font-size:11pt;"><strong>Неврология</strong></span>
...
<!--menu-->
 <?$APPLICATION->IncludeComponent("bitrix:menu", "left", array(
	"ROOT_MENU_TYPE" => "klinikanevrologiya",
	"MENU_CACHE_TYPE" => "A",
	...
	"MAX_LEVEL" => "1",
	"CHILD_MENU_TYPE" => "klinikanevrologiya",
	"USE_EXT" => "Y",
	"DELAY" => "N",

...
$html=$html.'  
<div class="poster_img tmp90" style="height: calc(208px);">
...
$html=$html.'  
<div class="poster_img tmp91" style="height: calc(208px);">
<div class="black_shadow_1">
...
$j3(".black_shadow_1").mouseover(function (){  
$j3(this).css("display","none"); 
 });
 
 
$j3(".poster_img2").mouseout(function (){

 $j3(".black_shadow_1").css("display","block");
 }); 

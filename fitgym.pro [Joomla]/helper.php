...
class modJak2filterHelper
{
	...
	public function __construct($module) {
		...
		$this->disable_option_empty &= $this->display_counter;
	}
...
function jaK2GetOrderFields() {
	...
	//Extra Fields
	$db = JFactory::getDbo();
	$aXFSupported = array('select', 'multipleSelect', 'radio', 'labels');
	$query = "SELECT f.`id`, f.name, g.name AS group_name

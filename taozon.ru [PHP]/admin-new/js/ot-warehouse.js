    ...
    initialize: function(){
        ...
        $("#jstree")
            ...
            .bind("create.jstree", function (e, node) {
                ...
                $.post(
                    "index.php?cmd=Warehouse&do=createCategory",
                    {
                        "parentId" : parentId,
            ...
            .bind("remove.jstree", function (e, node) {
                    $.post(
                        "index.php?cmd=Warehouse&do=removeCategory",
            ...
            .bind("rename.jstree", function (e, node) {
                ...
                $.post(
                    "index.php?cmd=Warehouse&do=renameCategory",
            ...
            .bind("move_node.jstree", function (e, node) {
                node.rslt.o.each(function (i) {
                    $.ajax({
                        ...
                        type: 'POST',
                        dataType: 'json',
                        url: "index.php?cmd=Warehouse&do=moveCategory",
                        data : {

...
class Promo extends GeneralUtil
{
     ...
     * @param RequestWrapper $request
     */
    private function onVkLinkSave($request)
    {
        if(!$request)
            return;
        $this->checkHideField($request,"hide_vk_link");
    }

    /**
     * @param RequestWrapper $request
     */
    private function onFbLinkSave($request)
    {
        if(!$request)
            return;
        $this->checkHideField($request,"hide_fb_link");
    }

    /**
     * @param RequestWrapper $request
     */
    private function onTwLinkSave($request)
    {
        if(!$request)
            return;
        $this->checkHideField($request,"hide_tw_link");
    }

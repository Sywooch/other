...
class VendorNew extends GenerateBlock {
    ...
    protected function setVars() {
        ...
        */
        ...
        $baseUrl->Set("http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]");
        $this->tpl->assign('baseUrl', $baseUrl);
    }

    private function getAndAssignPerPageItemCount(){
        $default_perpage = General::getConfigValue('default_perpage') ? General::getConfigValue('default_perpage') : 16;

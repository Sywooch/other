...
class Robokassa {
    ...
    public function __construct() {
        $server = defined('CFG_PAYMENT_SERVER') ? CFG_PAYMENT_SERVER : 'http://paymentsystemconnector.payments.demo.services.opentao.net/';
    ...
    public function success(){
        header('Location: http://'.$_SERVER['HTTP_HOST'].'/index.php?p=robo_success');
        die();
    }
    
    public  function fail(){
        header('Location: http://'.$_SERVER['HTTP_HOST'].'/index.php?p=robo_fail');
        die();
    }

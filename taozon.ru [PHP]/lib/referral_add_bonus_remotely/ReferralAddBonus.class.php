...
class ReferralAddBonus {
    ...
    public function runAction(){
        ...
        if ($addAmount == 0) {
            // если добавляемая сумма ноль - просто логируем
            $this->log->Add('add_amount_is_zero', 'order: '.$orderId.'; userId: '.$userId.'; amount: '.$amount.';');
            return false;
        } else {
            // если добавляемая сумма не ноль - зачисляем бонус, уведомляем реферера о бонусе

...
?>
        <div class="spoiler-wrap">
            ...
            <input type="button" value="<?=LangAdmin::get('change')?>" id="ItemPropertyName<?= $pid ?>" onclick="update_search_filter('<?= $pid ?>', 'ItemPropertyName', '<?= $pid ?>');" />
            ...
            <div class="spoiler-body">
                ...
                <input type="button" value="<?=LangAdmin::get('change')?>" id="ItemPropertyValueName<?= $value['id'] ?>" onclick="update_search_filter('<?= $value['id'] ?>', 'ItemPropertyValueName', '<?= $pid ?>');" /><br />
                <? } ?>
            </div>
        </div>
<?

...
<h1 id="head">
    ...
    <span style="float: right; margin-left: 15px;"><a href="http://<?=$_SERVER['SERVER_NAME']?>/admin-new/" style="color: white;" target="_blank"><?=@LangAdmin::get('admin_new')?></a></span>
    Opentao Admin &nbsp;&nbsp;&nbsp;&nbsp;
<?

...
$IsHasntShowcaseItemSellAllowed = (string)$data->Settings->IsHasntShowcaseItemSellAllowed;
    ...
    <div class="col700">
        ...
        <div class="tuning">
            ...
            <form action="<?=BASE_DIR;?>index.php?sid=<?=$GLOBALS['ssid'];?>&amp;do=savecase&amp;cmd=Control" method="post">
                ...
                <br clear="all"/>
                <label for="IsHasntShowcaseItemSellAllowed">
                    <input type="checkbox" name="IsHasntShowcaseItemSellAllowed" value="true" <? if($IsHasntShowcaseItemSellAllowed=='true'){?> checked <?} ?> />
                    <?=LangAdmin::get('IsHasntShowcaseItemSellAllowed')?>
                </label>
                <br clear="all"/>

...
class Randomset extends GeneralUtil {
    ...
    function savestatAction() {
        setcookie("HiddenS1", @$_GET['stats1'], time()+3600*24*30);
        setcookie("HiddenS2", @$_GET['stats2'], time()+3600*24*30);
        setcookie("HiddenS3", @$_GET['stats3'], time()+3600*24*30);
        setcookie("HiddenS4", @$_GET['stats4'], time()+3600*24*30);
    }

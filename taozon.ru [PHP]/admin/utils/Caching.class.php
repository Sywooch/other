...
class Caching extends GeneralUtil { 
    ...
    public function saveSettingsAction()
    {
		...
		if(!$site_conf['caching_lvl1'] && !$site_conf['caching_lvl2'] && $site_conf['caching_lvl3'])
			...
			$cron_config =  "{$site_conf['caching_time_minutes']} {$site_conf['caching_time_hours']} * * * ".BASE_PATH."admin/cron/cacheme.php";
			//$cron_config =  "{$site_conf['caching_time_minutes']} {$site_conf['caching_time_hours']} * * * ".BASE_PATH."admin/index.php?cmd=doCaching";

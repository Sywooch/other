...
ALTER table `site_user_visits` change `user_ip` `user_ip` varchar(20) not null default '';
ALTER table `site_user_purchases` change `user_ip` `user_ip` varchar(20) not null default '';

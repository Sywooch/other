...
class Curl {
	...
	public function setPost($postFields, $as_json = true)
	{
		if (is_array($postFields)){
			if($as_json) $postFields = array('data' => json_encode($postFields)); 
	...
	public function init()
	{
        ...
        curl_setopt($this->_resource, CURLOPT_CONNECTTIMEOUT, 3);
        ...
        if(version_compare(PHP_VERSION, '5.3.0') >= 0 || (!ini_get('safe_mode') && !ini_get('open_basedir'))){

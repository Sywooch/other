    ...
    <div class="col700">
        ...
        <div class="tuning">
					 ...
					 if($currency_settings['currenciesdisplayingorder'])  {
					 	foreach ($currency_settings['currenciesdisplayingorder'] as $currency) {
								...
								foreach ($currency_settings['currencyratelist'] as $rate) {	
										...
										if (($rate['firstcode']==$currency['code']) and ($rate['secondcode']==$currency_settings['internalcurrencycode'])) {
            ...
            <form action="<?=BASE_DIR;?>index.php?sid=<?=$GLOBALS['ssid'];?>&amp;do=savecase&amp;cmd=Control" method="post">
                ...
                <br clear="all"/>
                <div class="fbut clrfix">	
                    <input type="submit" class="ui-button ui-widget ui-state-default ui-corner-all" value="<?=LangAdmin::get('save_ban_on_the_sale')?>"/>
                </div>
                ...
                <input type="checkbox" name="usediscount" value="true" <?=$usediscount;?>/>

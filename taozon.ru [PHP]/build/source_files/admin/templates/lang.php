            ...
            <div class="tuning">
                ...
                <table>
                    ...
                    <? if($translations) foreach($translations as $trans) { ?>
                        ...
                        <a href="?cmd=langTranslations&do=del&id=<?=$trans['id']?>"><?=LangAdmin::get('remove')?></a>&nbsp;&nbsp;&nbsp;
                        &nbsp;
                        </td>
                        </tr>
                    <? } ?>
                </table>
                <input type="submit" class="ui-button ui-widget ui-state-default ui-corner-all" value="<?=LangAdmin::get('add_a_translation')?>" onclick="location.href='?cmd=lang&do=addTranslation'"/>
                <p>
                </p>
            </div>
        </div>

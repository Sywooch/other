        ...
        <table>
            ...
            <tbody>
                ...
                <tr id="group<?=$group['id']?>" style="border: 1px dotted #D3D3D3;">
                    ...
                    <td>
                        <button class="edit_group" value="<?=$group['id']?>"><?=LangAdmin::get('edit')?></button>
                        <button class="delete_group" value="<?=$group['id']?>"><?=LangAdmin::get('remove')?></button>
                    </td>
                </tr>
                <? } ?>
            </tbody>

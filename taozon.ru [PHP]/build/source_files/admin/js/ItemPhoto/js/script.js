...
$(document).ready(function(){
	...
	var template = '<a href="../files/ItemCam/{src}" target="_blank" rel="cam" '+'style="background-image:url(../files/ItemCam/thumbs/{src})" ></a>';
	...
	function loadPics(){
		...
		$.getJSON('js/ItemPhoto/browse.php?nme='+OrederID+'-'+ItemID,{},function(r){
			...
			if(r.nextStart){
				...
				photos.append(loadMore.html('Загрузить еще'));
			}

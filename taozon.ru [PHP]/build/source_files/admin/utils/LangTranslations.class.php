...
class LangTranslations {
    ...
    public function delAction(){
        ...
        header('Location: index.php?cmd=lang');
        die;
    }
    ...
    public function exportAction(){
        ...
        foreach($langs as $l){
            ...
            foreach($translations as $t){
                $el = $xml->addChild('key', htmlspecialchars($t['translation']));
                $el->addAttribute('name', htmlspecialchars($t['key']));
            }

            $xml->asXML('../langs/'.$l['lang_code'].'.xml');
        }
    }

...
class Discount extends GeneralUtil
{
    ...
    public function defaultAction()
    {
        ...
        try{
            ...
            $discount_users = $otapilib->GetUsersOfDiscountGroup($sid, $_GET['d_group'], $from, $to);
            $this->tpl->assign('discount_users', $discount_users);
			$this->tpl->assign('perpage', $perpage);
			$this->tpl->assign('currency_settings', $currency_settings);
...
//=======================================  Работа со юзерами ============================================	
	...
	function GetUserAction()
    {
		...
		try{			
			...
			$users = $otapilib->FindBaseUserInfoListFrame($sid, $filters,0, 5);    		
			$usrs="<ul id=\"scr\" >";
        	foreach ($users['content'] as $item) {

...
var Pristroy = new function () {
    ...
    this.items = {};
    this.currentItem = {};
    this.blankImage = 'http://www.placehold.it/100x100/EFEFEF/AAAAAA';
    ...
    this.fillForm = function(product)
    {
        ...
        if ('undefined' !== typeof (product.pristroy)) {
            ...
            var images = product.pristroy.images;
    ...
    this.initDialogs = function()
    {
        ...
        var buttons = {};
        buttons[trans.get('Sell_out')] = function() {
            if (! self.validate()) {
                return;
            }
            var that = this;
...
$(document).ready(function(){
    ...
    tinyMCE.init({
        mode : "exact",
        elements: 'pristroy_desc',
        theme : "advanced",
        plugins : "inlinepopups",
// Theme options
        theme_advanced_buttons1 : "bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,styleselect,formatselect,|,removeformat,code",

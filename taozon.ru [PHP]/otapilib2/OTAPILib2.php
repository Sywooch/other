...
class OTAPILib2 extends AbstractOTAPILib2 {
    ...
    /**
     *  Регистрация покупателя<br/><a href="/docs/IOtapiService.html#M:RegisterUser">Документация</a> 
     *
     ...
     */
    public static function RegisterUser($userParameters, &$request) {
        $params = array(
            'userParameters' => $userParameters,
        );
        self::registerRequest('RegisterUser', $params, 'OtapiEmailConfirmationInfoAnswer', $request);
    }
    ...
    /**
     *  Получить список счетов<br/><a href="/docs/IOtapiService.html#M:SearchBills">Документация</a> 
     *
     * @param string $sessionId    
     ...
     */
    public static function SearchBills($sessionId, $xmlSearchParameters, $framePosition, $frameSize, &$request) {
        $params = array(
            'sessionId' => $sessionId,
    ...
    /**
     *  Обновление настроек заказа<br/><a href="/docs/IOtapiService.html#M:UpdateOrderSettings">Документация</a> 
     *
     * @param string $sessionId    
     * @param string $xmlUpdateData    
     * @param $request Переменная, куда будет записан ответ от сервисов
     ...
     */
    public static function UpdateOrderSettings($sessionId, $xmlUpdateData, &$request) {
        $params = array(
            'sessionId' => $sessionId,
            'xmlUpdateData' => $xmlUpdateData,
        );
     ...
     */
    public static function AddItemToBasket($sessionId, $itemId, $configurationId, $price, $quantity, $currencyName, $fieldParameters, &$request) {
        $params = array(
            'sessionId' => $sessionId,
            'itemId' => $itemId,
     ...
     */
    public static function AddItemToNote($sessionId, $itemId, $configurationId, $price, $quantity, $currencyName, $fieldParameters, &$request) {
        $params = array(
            'sessionId' => $sessionId,
            'itemId' => $itemId,
            'configurationId' => $configurationId,
     ...
     *
     * @param string $xmlSearchSettings    
     * @param $request Переменная, куда будет записан ответ от сервисов
     * @return OtapiCallArchiveAnswer

     */
    public static function GetCallArchives($xmlSearchSettings, &$request) {
        $params = array(
            'xmlSearchSettings' => $xmlSearchSettings,
        );
    ...
    /**
     *  Получить настройки инстанса<br/><a href="/docs/IOtapiService.html#M:GetInstanceOptionsInfo">Документация</a> 
     *
     * @param string $sessionId    
     * @param $request Переменная, куда будет записан ответ от сервисов
     ...
     */
    public static function GetInstanceOptionsInfo($sessionId, &$request) {
        $params = array(
            'sessionId' => $sessionId,
        );
    ...
    /**
     *  Получение курса валют для витрины<br/><a href="/docs/IOtapiService.html#M:GetShowcaseCurrencyRates">Документация</a> 
     *
     * @param $request Переменная, куда будет записан ответ от сервисов
     * @return OtapiShowcaseCurrencyRatesAnswer

     */
    public static function GetShowcaseCurrencyRates(&$request) {
        $params = array(
        );
        self::registerRequest('GetShowcaseCurrencyRates', $params, 'OtapiShowcaseCurrencyRatesAnswer', $request);
    }
    ...
    /**
     *  Получить историю смены тарифа инстанса<br/><a href="/docs/IOtapiService.html#M:GetTariffChangeHistory">Документация</a> 
     *
     * @param string $sessionId    
     * @param $request Переменная, куда будет записан ответ от сервисов
     ...
     */
    public static function GetTariffChangeHistory($sessionId, &$request) {
        $params = array(
            'sessionId' => $sessionId,
        );
    ...
    /**
     *  Получение информации о  статусе пользователя<br/><a href="/docs/IOtapiService.html#M:GetUserStatusInfo">Документация</a> 
     *
     * @param string $sessionId    
     * @param $request Переменная, куда будет записан ответ от сервисов
     ...
     */
    public static function GetUserStatusInfo($sessionId, &$request) {
        $params = array(
            'sessionId' => $sessionId,
        );
    ...
    /**
     *  Получение настроек фичи WebUI<br/><a href="/docs/IOtapiService.html#M:GetWebUISettings">Документация</a> 
     *
     * @param string $sessionId    
     * @param $request Переменная, куда будет записан ответ от сервисов
     ...
     */
    public static function GetWebUISettings($sessionId, &$request) {
        $params = array(
            'sessionId' => $sessionId,
        );

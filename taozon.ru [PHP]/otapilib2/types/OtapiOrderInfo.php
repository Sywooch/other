...
class OtapiOrderInfo extends BaseOtapiType{
     ...
     * @return decimal
     */
    public function GetTotalAmountOriginalInExternalCurrency(){
        $value = isset($this->xmlData->TotalAmountOriginalInExternalCurrency) ? (string)$this->xmlData->TotalAmountOriginalInExternalCurrency : false;
        $propertyType = 'decimal';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
    /**
     * @return OtapiArrayOfPackagePriceInfo
     */
    public function GetPackagePrices(){
        $value = isset($this->xmlData->PackagePrices) ? $this->xmlData->PackagePrices : false;
        return new OtapiArrayOfPackagePriceInfo($value);
    }
    /**
    ...
    /**
     * @return OtapiArrayOfOrderTotalCostPerCurrency
     */
    public function GetTotalOriginalCostList(){
        $value = isset($this->xmlData->TotalOriginalCostList) ? $this->xmlData->TotalOriginalCostList : false;
        return new OtapiArrayOfOrderTotalCostPerCurrency($value);
    }
    /**
     * @return OtapiArrayOfPackageTotalCostPerCurrency
     */
    public function GetPackageTotalCostPerCurrencyList(){
        $value = isset($this->xmlData->PackageTotalCostPerCurrencyList) ? $this->xmlData->PackageTotalCostPerCurrencyList : false;
        return new OtapiArrayOfPackageTotalCostPerCurrency($value);
    }
    /**
     * @return decimal
     */
    public function GetInternalDeliveryOriginalInInternalCurrency(){
        $value = isset($this->xmlData->InternalDeliveryOriginalInInternalCurrency) ? (string)$this->xmlData->InternalDeliveryOriginalInInternalCurrency : false;
        $propertyType = 'decimal';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
    /**
    ...
    public function GetProfit(){
        $value = isset($this->xmlData->Profit) ? (string)$this->xmlData->Profit : false;
        $propertyType = 'decimal';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
    /**
    ...
    public function GetRateList(){
        $value = isset($this->xmlData->RateList) ? $this->xmlData->RateList : false;

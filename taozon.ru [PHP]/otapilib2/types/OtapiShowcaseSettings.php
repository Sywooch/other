...
class OtapiShowcaseSettings extends BaseOtapiType{
     ...
     * @return boolean
     */
    public function IsHasntShowcaseItemSellAllowed(){
        $value = isset($this->xmlData->IsHasntShowcaseItemSellAllowed) ? (string)$this->xmlData->IsHasntShowcaseItemSellAllowed : false;
        $propertyType = 'boolean';
        return $propertyType == 'boolean' ? $value == 'true' : $value;
    }
    /**

...
<div class="ot_sub_sub_nav">
    <ul class="nav nav-pills">
        ...
        <li class="active"><a href="cat/restrictions/categories">Категории</a></li>
...
<div class="row-fluid">
            ...
            <div class="well inset-bottom0">
                <form class="form-horizontal ot_form" action="">
                    ...
                    <div class="control-group">
                        <label class="control-label bold">По ссылке <i class="icon-question-sign ot_inline_help" data-toggle="popover" data-placement="right" data-content="Добавление ограничения происходит по ссылке на категорию товаров на сайте."></i>
                        </label>
                        <div class="controls">
                            <input class="span9" type="text" placeholder="Вставьте ссылку на категорию товаров">
                            <span type="button" data-toggle="button" class="btn" title="Указать раздел каталога"><i class="icon-list-alt font-14"></i></span>
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="controls">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="/subcategory/pogremushki-otc-798" title="На страницу категории">Погремушки</a></td>
            <td>234</td>
        </tr>

        <tr class="selected_item">
            <td><input type="checkbox" checked="checked"/></td>
            <td><a href="/subcategory/aksessuary-otc-284?virt&root" title="На страницу категории">Аксессуары</a></td>
            <td>259</td>
        </tr>

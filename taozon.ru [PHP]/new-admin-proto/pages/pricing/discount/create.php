...
<ul class="breadcrumb">
    ...
    <li class="active">Добавление новой скидки</li>
</ul>

<? include('inc/sub_nav_pricing.php'); ?>


<h1>Добавление новой скидки</h1>
...
<div class="well">
    ...
    <form method="post" action="pricing/discount" class="form-horizontal ot_form">
        ...
        <div class="control-group control-group-medium">
            ...
            <div class="controls">
                <a href="pricing/discount" class="btn btn-primary btn_preloader" data-loading-text="Сохраняется">Сохранить</a>
                <a href="pricing/discount" class="btn offset-left1 btn_preloader" data-loading-text="Отменяется">Отменить</a>
            </div>

...
<ul class="breadcrumb">
    ...
    <li><a href="promo/referals/category">«Средний уровень»</a> <span class="divider">›</span></li>
...
<h1>Редактирование категории «Средний уровень»</h1>
...
<div class="well">
    ...
    <form method="post" action="pricing/discount" class="form-horizontal ot_form">
        ...
        <div class="control-group control-group-medium">
            ...
            <div class="controls">
                <a href="promo/referals/category" class="btn btn-primary btn_preloader" data-loading-text="Сохранить">Сохранить</a>
                <a href="promo/referals/category" class="btn offset-left1 btn_preloader" data-loading-text="Отменить">Отменить</a>
            </div>

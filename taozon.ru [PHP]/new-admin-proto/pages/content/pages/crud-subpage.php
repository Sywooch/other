...
<ul class="breadcrumb">
    ...
    <li class="active">Добавление подраздела для страницы «О магазине»</li>
...
<h1>Добавление подраздела для страницы «О магазине»</h1>
        ...
        <div class="box box-blinked box-closed offset-top0 offset-bottom1_2">
            ...
            <div class="box-body inset-horizontal-none">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="input-xlarge" type="text" title="Заголовок страницы">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="input-xxlarge" type="text" title="Заголовок страницы">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea cols="20" rows="3" class="input-xxlarge"></textarea>
                    </div>
                </div>

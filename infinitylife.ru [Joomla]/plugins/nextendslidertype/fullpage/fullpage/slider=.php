...
$database->setQuery("SELECT * FROM #__k2_items WHERE catid=16");
$list = $database->loadObjectList();
       ...
       <?php
             ...
             foreach($list as $it) { ?> 
			    ...
			    <div class="<?php echo $tmp1; ?> smart-slider-bg-colored tmp3" style="<?php echo $tmp2; ?>"<?php echo $tmp3; ?>>
                <?php $hash = md5('Image'.$it->id);  ?>
                	<img src="<?php echo'/media/k2/items/src/'.$hash.'.jpg'; ?>" class="nextend-slide-bg"/>
                    <!--<?php //if (!$this->_backend && !$flux[0] && $slide['bg']['desktop']): ?>
                        <img<?php //echo $this->makeImg($slide['bg'], $i); ?> class="nextend-slide-bg"/>
                    <?php //endif; ?>
                    <?php //if ($this->_backend && strpos($slide['classes'], 'smart-slider-slide-active') !== false): ?>

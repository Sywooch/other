...
if(!defined('PE_FANCYBOX_LOADED')){
		...
		/*
			...
			*/
				...
				afterLoad : function() {
		         ...
		         $(".gallery_bar").css({"height" : height_new});
		         ...
		         $(".gallery_bar").css({"top" : "10px"});
				  ...
				  // $(".gallery_bar").css({"top" : sum});
				   ...
				   var width_2=width_1/7;  $(".gallery_bar img").width(100);  width_2=width_2-2; $(".gallery_bar .blue_border").width(width_2); var left_2=(width_2/2)+2; 
  ...
  var MyIntervalID=setInterval(function() { 
				...
				var temp_height2=temp_height-2;
					$("img.img"+img_num+"").css({"height" : temp_height2+"px"});

...
class SimpleImageGalleryProHelper
{
	...
	//		echo"<div class='votes'>".$votes1."</div>";
				...
				$gallery[$key]->downloadLink = self::replaceHtml('<br /><a class="sigProDownloadLink tmp2" href="'.$downloadFile.'?file='.$srcimgfolder.'/'.self::replaceWhiteSpace($filename).'" download>'.JText::_('JW_SIGP_LABELS_05').'</a>  <a class="sigProShareLink"></a>  <a class="sigProCommLink">Комментарии</a>    
				
				
				<div class="rating_author2">
			...
			{//'.($siteUrl.$srcimgfolder.'/'.self::replaceWhiteSpace($filename)).'

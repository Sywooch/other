...
$jYtc(document).ready(function($) {
	   $('#yt_megasslider_nav<?php echo $module->id;?>').cycle({
            ...
            leftScroll:<?php echo floor(($width_module_mega + 18)/$num_item_per_page);?>,                        
            <?php endif;?>
            <?php if($nav_style_mega != 'nav_style02'):?>                                    
            leftScroll:<?php echo floor(($width_module_mega - 15)/$num_item_per_page);?>,
            <?php endif;?>                   
...
<div class="yt_megasslider" style="width: <?php echo $width_module_mega + 30;?>px;">
    <?php ob_start();?>
    	<div class="yt-contentmegaslider-nav" style="width: <?php echo $width_module_mega + 30?>px; height:<?php echo $thumb_height+65?>px;">
                            ...
                            <div class="content-main">
                                <div class="content-box-main">
                                    <div class="hidden-main-content">
                                        <?php if($showmaintitle == 1):?><div class="item_title_main_theme3"><a href="<?php echo $item['link'];?>" class="<?php if($target=='pop-up'):?>modal<?php endif;?>" title="<?php echo $item['title'];?>" target = "<?php echo $target;?>" style="color:<?php echo $maintitlecolor;?>; font-weight:bold"><?php echo $item['sub_main_title'];?></a></div><?php endif;?>                                          
                                      
                                        <?php if($showmaindesc == 1):?><div class="item_content_main_theme3" style="color:<?php echo $maindesccolor;?>;"><p style="color:<?php echo $maindesccolor;?>;text-align: left;"><?php echo $item['sub_main_content']?></p></div><?php endif;?>
            ...
            <div style="width:<?php echo ($num_item_per_page * 45)?>px; <?php if($position_image_display == "left"){echo "left:".$left_number_button;}else{echo 'right:'.$left_number_button;}?>px;" class="buttons_number_<?php echo $theme;?>">
                <div class="cover_buttons_number_<?php echo $module->id;?> cover_buttons_number" style="width:<?php echo ($total*45)?>px;">
        ...
        <div class="content-box-normal-<?php echo $theme;?> content-box-normal-<?php echo $module->id;?>" style="width:<?php echo $width_module_mega + 30;?>px; height:<?php echo ($small_thumb_height + 25)?>px;">
            ...
            <div class="content-box-middle-<?php echo $theme;?>" style="width:<?php echo $width_module_mega - 15;?>px;height:<?php echo ($small_thumb_height + 25)?>px;">
                <div class="content_box_<?php echo $theme.$module->id;?> content_box_<?php echo $theme;?>" style="width:100%;height:<?php echo ($small_thumb_height + 25)?>px !important;" >	
                    <div class="cover_buttons_<?php echo $module->id;?> cover_item_box" style="width:<?php echo floor((($width_module_mega - 15)/$num_item_per_page) * $total);?>px; display:<?php echo ($prenext_show)?'block':'none'?>">
            			<div class="<?php echo $theme;?>">		
    						<div class="buttons_<?php echo $theme;?> content_box_item">					
    							<ul class="image_button_<?php echo $module->id;?>" style="list-style: none;">
    								<?php foreach($items as $key=>$item) {?>
    									<li id="li_height_item_<?php echo $module->id;?>" class="<?php echo ($key==$start)?"button_img_selected_theme5_{$module->id}":"button_img_theme5_{$module->id}";?>" value="<?php echo $key;?>" style="width:<?php echo floor(($width_module_mega - 15)/$num_item_per_page);?>px">
                                         <center>   
                                            <div class="yt_post_item_<?php echo $theme;?> yt_post_item_<?php echo $module->id;?>" style="display:<?php echo $show_normal_image?"block":"none";?>;height:<?php echo $small_thumb_height;?>px; width:<?php echo $small_thumb_width?>px;">
    ...
    <?php ob_start();?>
        ...
        <div class="content-box-normal-<?php echo $theme;?> content-box-normal-<?php echo $module->id;?>" style="width:<?php echo $width_module_mega + 30;?>px; height:<?php echo ($small_thumb_height + 25)?>px;">
            <div class="content-box-middle-<?php echo $theme;?>" style="width:<?php echo $width_module_mega + 18;?>px;height:<?php echo ($small_thumb_height + 25)?>px;">
                <div class="content_box_<?php echo $theme.$module->id;?> content_box_<?php echo $theme;?>" style="width:<?php echo ($width_module_mega + 18);?>px; height:<?php echo ($small_thumb_height + 25)?>px !important;overflow:hidden;" >	
                    <div class="cover_buttons_<?php echo $module->id;?> cover_item_box" style="width:<?php echo floor((($width_module_mega + 18)/$num_item_per_page) * $total);?>px; display:<?php echo ($prenext_show)?'block':'none'?>">
            			<div class="<?php echo $theme;?>">		
    						<div class="buttons_<?php echo $theme;?> content_box_item">					
    							<ul class="image_button_<?php echo $module->id;?>">
    								<?php foreach($items as $key=>$item) {?>
    									<li id="li_height_item_<?php echo $module->id;?>" class="<?php echo ($key==$start)?"button_img_selected_theme5_{$module->id}":"button_img_theme5_{$module->id}";?>" value="<?php echo $key;?>" style="width: <?php echo floor(($width_module_mega + 18)/$num_item_per_page);?>px">
                                          <center> 
...
<div class="footer_text" style="text-align:left; margin-top: 10px; width: <?php echo $width_module;?>px;">

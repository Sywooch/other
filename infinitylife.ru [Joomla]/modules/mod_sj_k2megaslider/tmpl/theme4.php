...
<div id="yt_megasslider_<?php echo $module->id;?>" class="yt_megasslider" style="width: <?php echo $width_module_mega;?>px;">
    <?php ob_start();?>
    				...
    				<div class="megaslider-content-article" style="width:<?php echo $width_module_mega;?>px">
                        ...
                        <div class="<?php if($position_image_display == "left"){echo 'content-mega-main-'.$theme;}else{echo 'content-mega-main-right-'.$theme;}?>" style="width:<?php echo $width_module_mega - ($thumb_width + 45);?>px;height:<?php echo $thumb_height;?>px;">
                            <div class="hidden-main-content-<?php echo $theme;?>">
                                <?php if($showmaintitle == 1):?><div class="item_title_main_theme1"><a href="<?php echo $item['link'];?>" class="<?php if($target=='pop-up'):?>modal<?php endif;?>" title="<?php echo $item['title'];?>" target = "<?php echo $target;?>" style="color:<?php echo $maintitlecolor;?>"><?php echo $item['sub_main_title'];?></a></div><?php endif;?>
                               
                                <?php if($showmaindesc == 1):?><div class="item_content_main_theme1" style="color:<?php echo $maindesccolor;?>;"><p style="color:<?php echo $maindesccolor;?>;"><?php echo $item['sub_main_content']?></p></div><?php endif;?>
                            </div>
    ...
    <?php ob_start();?>
        ...
        <div class="content-box-normal-<?php echo $theme;?> content-box-normal-<?php echo $module->id;?>" style="width:<?php echo $width_module_mega;?>px; height:<?php echo ($small_thumb_height + 25)?>px;">
            ...
            <div class="content-box-middle-<?php echo $theme;?>" style="width:<?php echo $width_module_mega - (25+25);?>px;height:<?php echo ($small_thumb_height + 25)?>px;">
                <div class="content_box_<?php echo $theme.$module->id;?> content_box_<?php echo $theme;?>" style="width:<?php echo ($width_module_mega - (25+25)) * $num_item_per_page?>px;height:<?php echo ($small_thumb_height + 25)?>px !important;" >	
            			...
            			<div class="<?php echo $theme;?>">		
    						<div class="buttons_<?php echo $theme;?> content_box_item">					
    							<ul class="image_button_<?php echo $module->id;?>" style="list-style: none;">
    								<?php foreach($items as $key=>$item) {?>
    									<li id="li_height_item_<?php echo $module->id;?>" class="<?php echo ($key==$start)?"button_img_selected_theme5_{$module->id}":"button_img_theme5_{$module->id}";?>" value="<?php echo $key;?>" style="width:<?php echo floor(($width_module_mega - 25-25)/$num_item_per_page);?>px">
                                          <center>  
    ...
    <?php ob_start();?>
        ...
        <div class="content-box-normal-<?php echo $theme;?> content-box-normal-<?php echo $module->id;?>" style="width:<?php echo $width_module_mega;?>px; height:<?php echo ($small_thumb_height + 25)?>px;">
            <div class="content-box-middle-<?php echo $theme;?>" style="width:<?php echo $width_module_mega - 10;?>px;height:<?php echo ($small_thumb_height + 25)?>px;">
                <div class="content_box_<?php echo $theme.$module->id;?> content_box_<?php echo $theme;?>" style="width:<?php echo ((($width_module_mega - 10)/$num_item_per_page) * $num_item_per_page);?>px;height:<?php echo ($small_thumb_height + 25)?>px !important;overflow:hidden;" >	
            			...
            			<div class="<?php echo $theme;?>">		
    						<div class="buttons_<?php echo $theme;?> content_box_item">					
    							<ul class="image_button_<?php echo $module->id;?>">
    								<?php foreach($items as $key=>$item) {?>
    									<li id="li_height_item_<?php echo $module->id;?>" class="<?php echo ($key==$start)?"button_img_selected_theme5_{$module->id}":"button_img_theme5_{$module->id}";?>" value="<?php echo $key;?>" style="width:<?php echo floor(($width_module_mega - 10)/$num_item_per_page);?>px">
                                           <center> 

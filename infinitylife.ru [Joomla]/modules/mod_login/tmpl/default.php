...
<form action="<?php echo JRoute::_(JUri::getInstance()->toString(), true, $params->get('usesecure')); ?>" method="post" id="login-form" class="form-inline btl-formlogin">
<!--
...
<h3>АВТОРИЗАЦИЯ</h3>
				...
				<div class="left1">
				<span class="head1">Быстрая</span>
				<span class="text1">[В разработке]</span>
	...
	<span class="head1">СТАНДАРТНАЯ</span>
				<span class="text1">Если Вы уже есть на нашем сайте, введите логин и пароль:</span>
	
	
	
	<a class="link_responses_pass" href="/component/users/?view=reset" >Забыли пароль?</a>
	
	
	
	<div id="register-link1">
						Пройдите регистрацию, если Вас ещё нет на сайте: <span onclick="reg_modal2();" style="cursor:pointer; text-decoration:underline;"> Регистрация </span>
...
var $j2 = jQuery.noConflict();
    ...
    function reg_modal2(){
       ...
       //$j2('#simplemodal-overlay').css({'display' : 'block'});
        //$j2('#simplemodal-container').css({'display' : 'block'});

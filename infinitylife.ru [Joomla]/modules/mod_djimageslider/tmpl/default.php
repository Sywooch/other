...
<div id="djslider-loader<?php echo $mid; ?>" class="djslider-loader">
    <div id="djslider<?php echo $mid; ?>" class="djslider">
        ...
        <div class="fix_left" style=" height:100%; position:absolute; top:0px;  width:100px; z-index:999999999;"></div>
        <div class="fix_right" style=" height:100%; position:absolute; top:0px;  width:100px; z-index:999999999;"></div>
        
        <div class="border_slider">
 	       <div class="slide-title"></div>
           <div class="slide-text"></div>
           <?php //if($params->get('show_readmore') && $slide->link) { ?>
								<a href="<?php echo  $slide->link; ?>" target="<?php echo $slide->target; ?>" class="readmore tmp1"><?php echo ($params->get('readmore_text',0) ? $params->get('readmore_text') : JText::_('MOD_DJIMAGESLIDER_READMORE')); ?></a>
							<?php //} ?>
...
$j(".fix_left").css({'left' : '-'+width+'px'});
$j(".fix_left").css({'width' : ''+width+'px'});

$j(".fix_right").css({'right' : '-'+width+'px'});
$j(".fix_right").css({'width' : ''+width+'px'});
		...
		?>
        	<ul id="slider<?php echo $mid; ?>">
          		<?php foreach ($slides as $slide) { ?>
          			<li id="num<?php echo $num_sl; $num_sl++; ?>">
          				<?php if($slide->image) { 

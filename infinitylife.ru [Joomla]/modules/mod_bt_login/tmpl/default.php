...
<div id="btl">
	...
	<div id="btl-content">
		...
		<div id="btl-content-login" class="btl-content-block">
			...
			<form name="btl-formlogin" class="btl-formlogin" action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post">
				...
				<span class="head">СТАНДАРТНАЯ</span>
				<span class="text">Если Вы уже есть на нашем сайте, введите логин и пароль:</span>
				...
				<div class="btl-field">
					...
					<div class="btl-input">
						<input id="btl-input-username" type="text" name="username"	placeholder="Логин"/>
					</div>
				</div>
				<div class="btl-field">
					<div class="btl-label"><?php echo JText::_('MOD_BT_LOGIN_PASSWORD') ?></div>
							
					<div class="btl-input" style="height:60px;position:relative;">
					    <a href="/component/users/?view=reset" style="position: absolute;
  top: 0px;
  height: 5px;
  right: 0px;
  display: block;
  ...
  ">Забыли пароль?</a>
						...
						<input id="btl-input-password" type="password" name="password" alt="password"	placeholder="Пароль" style="margin-top:16px;"/>
					</div>
				</div>

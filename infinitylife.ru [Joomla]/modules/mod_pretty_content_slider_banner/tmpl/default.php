...
<div id="pretty-content-slider-style">
	<div class="pretty-content-rotator">
				...
				<div style="display:none;">
					...
					<div class="info_description">
					 <?php echo $DesLong[$loop]; ?>
						<a href="<?php echo $LinkDetail[$loop]; ?>" class="more">Read more</a>
					</div>
				</div>
			</li>
		<?php } ?>
		...
		<div id="rot1">
			<img src="" width="<?php echo $moduleWidth; ?>" height="<?php echo $moduleHeight; ?>" class="bg" alt=""/>
			<div class="heading">
				<h1></h1>
			</div>

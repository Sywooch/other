...
$database->setQuery("SELECT * FROM #__k2_items WHERE catid=16 AND trash=0 AND published=1");
                ...
                <div class="<?php echo $slide['classes']; ?> smart-slider-bg-colored" style="<?php echo $slide['style']; ?> "<?php echo $slide['link']; ?> >
				  ...
				  $mydesc = $mydesc2."...";
                    ...
                    $link_mas=explode(" ",$it->extra_fields_search);
 					...
 					$link_mas[1]=str_replace("afishi/afishi","afishi/vse",$link_mas[1]);

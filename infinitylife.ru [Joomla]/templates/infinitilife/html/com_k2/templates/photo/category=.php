...
<?php
  ...
  //echo JModuleHelper::renderModule( $module[0], $attribs );
    ...
    if(JRequest::getInt('month') && JRequest::getInt('year') && JRequest::getInt('day')){ $date =  (JRequest::getInt('day') < 10 ? "0". JRequest::getInt('day') : JRequest::getInt('day')).".".(JRequest::getInt('month') < 10 ? "0". JRequest::getInt('month') : JRequest::getInt('month')).".". JRequest::getInt('year'); } else { $date = "Выбрать дату"; }
            ...
            if($_GET['localion']=="17"){
		                                ...
		                                foreach($list as $it){
		                                  ...
		                                  <a href="/<?php echo "fotoootchety.html?localion=17&location_name=blagoveshchensk"; ?>"  <?php
		                                  
		                                  if($url=="/fotoootchety.html?localion=17&location_name=blagoveshchensk"){ echo ' class="active" ';  }
		                                  ...
		                                  <a href="/<?php echo $it->path; ?>?localion=17&location_name=blagoveshchensk" <?php
    ...
    <?php
       $database = JFactory::getDbo(); 
		                                ...
		                                foreach($list as $it){
		                                  ...
		                                  <li style="padding:0px; margin:0px; padding-right:15px;"><a href="/<?php echo "fotoootchety.html?localion=17&location_name=blagoveshchensk"; ?>"  <?php
    ...
    <?php
                ...
                <a href="/fotoootchety/?localion=<?php  echo $_GET['localion'];  ?>"  
                
                 <?php
		                                  
		                                  if($url=="/fotoootchety/?localion=".$_GET['localion'].""){ echo ' class="active" ';  }
    ...
    <span class="date datepick" style="position:absolute; z-index:99; left:41px"><a><?php echo $date; ?></a><input type="hidden" class="datepickhidden" value=""></span>

    <span class="date datepick2" style="position:absolute; z-index:99; left:210px"><a><?php
   // echo $_GET['localion']; 
  ...
  left: 19px; display:none;">
						...
						$database2->setQuery("SELECT * FROM #__k2_categories WHERE parent='25'");
						 ...
						 $list2 = $database2->loadObjectList();
		                    ...
		                    ?>                
		                    <li style="padding:0px; margin:0px;"><a href="/fotoootchety.html?localion=<?php  echo $it2->id;   ?>&location_name=<?php echo $it2->alias; ?>" style="padding:0px; margin:0px; width:140px; 

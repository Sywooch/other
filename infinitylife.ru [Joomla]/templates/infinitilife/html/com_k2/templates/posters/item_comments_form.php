...
<form action="<?php echo JURI::root(true); ?>/index.php" method="post" id="comment-form" class="form-validate">
	...
	<img class="form_avatar" src="/media/k2/users/<?php echo $url_avatar; ?>" title="" alt=""/>
	...
	<textarea rows="20" cols="10" class="inputbox" onblur="if(this.value=='') this.value='<?php echo "Ваш комментарий"; ?>';" 
	onfocus="if(this.value=='<?php echo JText::_('K2_ENTER_YOUR_MESSAGE_HERE'); ?>') this.value='';" name="commentText" id="commentText"><?php echo "Ваш комментарий"; ?></textarea>
	...
	<input type="submit" class="button" id="submitCommentButton" value="<?php echo "Отправить"; ?> />

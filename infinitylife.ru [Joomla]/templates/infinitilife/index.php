...
pic6.src = "/templates/infinitilife/images/load_social6.png";
 ...
 $j2('.hidescreen').click(function(){ //для тех кому невтерпеж
  $j2('.hidescreen,.load_page').fadeOut(300); 
  $j2('.pace').fadeOut(300); 
 });
 $j2('.close').click(function(){ //для тех кому невтерпеж
  $j2('.hidescreen,.load_page').fadeOut(300); 
   $j2('.pace').fadeOut(300); 
 });
});
...
<div class='load_page'>
 <span style="display:block; width:100%; margin-top:5px; font-size:13px;">cтраница загружается...</span>
  <br>
 <!--<img src="/images/ajax-loader.gif" /> <!--картинка индикатора загрузки-->
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>
									...
									?><span><img src="/media/k2/users/<?php echo $url_avatar; ?>" alt=""></span></div>
								</td>
...
<!--<span style="position:absolute; z-index:999999; background-color:yellow;"><?php echo  $it2->publish_up;echo" - "; echo $it2->catid; echo"<br>"; echo  $it2->publish_down;   ?></span>
-->
</a>

...
//echo "-=".$it->publish_down."=".$today."=-";
	
if(($it->publish_down)>=$today){	
...
$j(window).resize(function(){
	...
	//alert(height_window); 
	$j('.jspContainer').height(height_window); 
	var width_window=$j(window).width();
	$j('.jspPane').width(width_window);
	var jspTrack_height=height_window-105;
	$j('.jspTrack').height(jspTrack_height);
	
	var width_img=$j('.poster_items .poster_img').width();
	$j('.poster_items .poster_img').height(width_img);
	
	var slider_thimb=$j('#nextend-smart-slider-1-thumbnail').width();
	var slider_width=$j('#nextend-smart-slider-1').width();
	
	var slider_image=slider_width-slider_thimb;
	
	$j('div#nextend-smart-slider-1 .smart-slider-border1').width(slider_image);
...
$j(window).bind('load', function() {
 ...
 var height_1=$j('#nextend-smart-slider-1').height();
 height_1=height_1-75;
 $j('#nextend-smart-slider-1 .smart-slider-border1 img').height(height_1);
 
 //var width_1=$j('#nextend-smart-slider-1').width();
 //var width_thimb=$j('#nextend-smart-slider-1-thumbnail').width();
 //var width_image=width_1-width_thimb;
 //$j('#nextend-smart-slider-1 .smart-slider-border1 img').width(width_image);
 
 var width_1=$j('#nextend-smart-slider-1').width();
 var width_image=$j('#nextend-smart-slider-1 .smart-slider-border1 img').width();
 $j('div#nextend-smart-slider-1 .smart-slider-border1').width(width_image);
//alert(width_image);


 var width_thimb=width_1-width_image;
// alert(width_thimb);
 $j('#nextend-smart-slider-1-thumbnail').width(width_thimb);
 
 $j('.nextend-widget.nextend-arrow-next.nextend-transition.nextend-transition-next.nextend-transition-next-my-test').css({"right" : ""+width_thimb+"px"});

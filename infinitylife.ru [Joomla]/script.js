...
*/
    ...
    $('.datepick').click(function(){
        ...
        var class1=$(".pickmeup.pmu-view-days").hasClass("display_none");
    
	
        $(".pickmeup.pmu-view-days:first").css("display", "none");
	
    
    if(class1==true){
        $(".pickmeup.pmu-view-days").removeClass("display_none");
        $(".pickmeup.pmu-view-days").css("display", "none");
        $(".pickmeup.pmu-view-days:first").css("display", "none");
        
    }else{
        $(".pickmeup.pmu-view-days").addClass("display_none");
        $(".pickmeup.pmu-view-days").css("display", "block");        
        $(".pickmeup.pmu-view-days:first").css("display", "none");
    }

		...
		/*
			...
			*/
				...
				afterLoad : function() {
				    ...
				    var t2=0;
				   var MyIntervalID3=setInterval( function() { var  width_1= $(".fancybox-skin").width(); $(".gallery_bar").width(width_1); var left_1=$(".fancybox-wrap").css("left");
				   
				   
				   $(".gallery_bar").css({"left" : left_1}); var height_1=$(".fancybox-skin").height(); var top_1=$(".fancybox-wrap").css("top");  var sum=parseInt(height_1)+parseInt(top_1);   $(".gallery_bar").css({"top" : sum}); var width_2=width_1/7;  $(".gallery_bar img").width(width_2);  width_2=width_2-2; $(".gallery_bar .blue_border").width(width_2); var left_2=(width_2/2)+2;  $(".gallery_bar .blue_border").css({"margin-left" : "-"+left_2+"px"}); 
  ...
  var MyIntervalID=setInterval(function() { 
			...
			//	alert((parseInt(img_num)+2)+"  "+num_el);
				...
				//alert("===");
				    ...
				    var sdvig1=(img_num-3)*width_img;
                ...
                var left_1=$(".fancybox-wrap").css("left");
				   ...
				   $(".gallery_bar").css({"left" : left_1});
		            ...
		            $(".list_comments2").css({"display" : "block"});

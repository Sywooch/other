						...
						<td>
							...
							<div class="simpleTabs" id="k2Tabs">
								<ul class="simpleTabsNavigation">
									...
									<li id="tabImageGallery"><a href="#k2Tab3"><?php 
									$catid_tmp="";
									//".$id_tmp1."
									if(!isset($this->row->id)){
									$id_tmp1=0; 
									echo JText::_('K2_IMAGE_GALLERY');        
									}else{
									$id_tmp1=$this->row->id; 
									
									}
									$database = JFactory::getDbo();
									$database->setQuery("SELECT * FROM #__k2_items WHERE id=".$id_tmp1."");
									$list = $database->loadObjectList();
									foreach($list as $it) { 
										if(($it->catid)=="5"){
										$catid_tmp="5";	
										echo JText::_('K2_IMAGE_GALLERY_AF');
										}else{
										echo JText::_('K2_IMAGE_GALLERY');	
										}
									}
									...
									<li id="tabVideo"><a href="#k2Tab4"><?php 
										if(($catid_tmp)=="5"){
										echo JText::_('K2_MEDIA_AF');
										}else{
										echo JText::_('K2_MEDIA');	
										}
                                    ...
                                    <li id="tabPlugins"><a href="#k2Tab71"><?php echo JText::_('K2_AF_INFO'); ?></a></li>
                                    <li id="tabPlugins"><a href="#k2Tab72"><?php echo JText::_('K2_AF_ACTORS'); ?></a></li>
                                    <li id="tabPlugins"><a href="#k2Tab73"><?php echo JText::_('K2_AF_SEANS'); ?></a></li>
								...
								<div class="simpleTabsContent" id="k2Tab71">
								    ...
								    <div id="extraFieldsContainer">
										...
										<table class="admintable table" id="extraFields">
											<?php //foreach($this->extraFields as $extraField): ?>
											<tr>
												<?php if($this->extraFields[0]->type == 'header'): ?>
												<td colspan="2" ><h4 class="k2ExtraFieldHeader"><?php echo $this->extraFields[0]->name; ?></h4></td>
												<?php else: ?>
												<td align="right" class="key">
													<label for="K2ExtraField_<?php echo $this->extraFields[0]->id; ?>"><?php echo $this->extraFields[0]->name; ?></label>
												</td>
												<td>
													<?php echo $this->extraFields[0]->element; ?>
												</td>
												<?php endif; ?>
											</tr>
											<?php //endforeach; ?>
								...
								<div class="simpleTabsContent" id="k2Tab72">
								    ...
								    <div id="extraFieldsContainer">
										...
										<table class="admintable table" id="extraFields">
											<?php //foreach($this->extraFields as $extraField): ?>
											<tr>
												<?php if($this->extraFields[1]->type == 'header'): ?>
												<td colspan="2" ><h4 class="k2ExtraFieldHeader"><?php echo $this->extraFields[1]->name; ?></h4></td>
												<?php else: ?>
												<td align="right" class="key">
													<label for="K2ExtraField_<?php echo $this->extraFields[1]->id; ?>"><?php echo $this->extraFields[1]->name; ?></label>
												</td>
												<td>
													<?php echo $this->extraFields[1]->element; ?>
												</td>
												<?php endif; ?>
											</tr>
											<?php //endforeach; ?>
								...
								<div class="simpleTabsContent" id="k2Tab73">
								    ...
								    <div id="extraFieldsContainer">
										...
										<table class="admintable table" id="extraFields">
											<?php //foreach($this->extraFields as $extraField): ?>
											<tr>
												<?php if($this->extraFields[4]->type == 'header'): ?>
												<td colspan="2" ><h4 class="k2ExtraFieldHeader"><?php echo $this->extraFields[4]->name; ?></h4></td>
												<?php else: ?>
												<td align="right" class="key">
													<label for="K2ExtraField_<?php echo $this->extraFields[4]->id; ?>"><?php echo $this->extraFields[4]->name; ?></label>
												</td>
												<td>
													<?php echo $this->extraFields[4]->element; ?>
												</td>
												<?php endif; ?>
											</tr>
											<?php //endforeach; ?>

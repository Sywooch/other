...
$APPLICATION->SetPageProperty("title", "Anna Bronze. Уникальная фурнитура для тех, кто создает украшения");
...
$APPLICATION->SetPageProperty("description", "Anna Bronze. Авторская фурнитура для украшений");
$APPLICATION->SetTitle("Anna Bronze");
?>
	...
	<div class="b-main-about">
		<div class="b-title js-content-title _no-marg _no-bg">
			<div class="b-title__row _title">
				<div class="b-title__title">О нас</div>
			</div>
		</div>
...
<? $APPLICATION->IncludeComponent("bitrix:main.include","",Array("AREA_FILE_SHOW" => "file",
	"PATH" => "/include_areas/main_social_buttons.php","EDIT_TEMPLATE" => ""));?>

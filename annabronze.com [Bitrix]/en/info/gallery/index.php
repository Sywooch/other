...
?> 
<div> 
<!--<div>English В этом разделе Вы можете посмотреть работы мастеров, работающих с нашей фурнитурой. В описании работы можно посмотреть фурнитуру, которая использовалась при сборке. Кликнув на артикул в списке, Вы перейдете на его страницу с подробным описанием.</div>
...
<div>Если Вам понравилась работа и Вы хотели бы приобрести её, нужно связаться непосредственно с автором.
 ...
  <?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"LIST_PROPERTY_CODE" => array(0=>"ASSOCIATED",1=>"TITLE_ASSOCIATED",2=>"MORE_PHOTO",3=>"",),
		...
		"DETAIL_PROPERTY_CODE" => array(0=>"ASSOCIATED",1=>"TITLE_ASSOCIATED",2=>"USED_INTO",3=>"MORE_PHOTO",4=>"",),

...
if (CModule::IncludeModule('sale')	&& CModule::IncludeModule('iblock') && CModule::IncludeModule('catalog') && CModule::IncludeModule('currency')) 
{
	...
	$res = CSaleBasket::GetList(array('SORT' => 'DESC'),array('FUSER_ID' => CSaleBasket::GetBasketUserID(), 'ORDER_ID' => 'NULL', 'DELAY' => 'N'));
	...
	else
	{
		...
		//поправим количество на случай, если товар уже был в корзине

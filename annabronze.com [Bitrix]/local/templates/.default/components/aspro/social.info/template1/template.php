...
<?endif;?>
<?if(!empty($arParams["PINT"])):?>
	<a href="<?=$arParams["PINT"]?>" target="_blank">
		<img border="0" src="/bitrix/components/aspro/social.info/images/pinterest.png" alt="pinterest" title="pinterest" /> 
	</a>
<?endif;?>

...
if (StrLen($arResult["ERROR_MESSAGE"])<=0)
{
	...
	function ShowBasketItems(val)
	{
		if(val == 2)//отложенные
		{
			...
			$("a.link_2").parents(".js-basket-table__states-item").addClass("_current");
			$("a.link_1").parents(".js-basket-table__states-item").removeClass("_current");
		...
		else if(val == 3)
		{
			...
			$("a.link_2").parents(".js-basket-table__states-item").removeClass("_current");
			$("a.link_3").parents(".js-basket-table__states-item").addClass("_current");
		...
		else
		{
			...
			$("a.link_1").parents(".js-basket-table__states-item").addClass("_current");
			$("a.link_2").parents(".js-basket-table__states-item").removeClass("_current");
...
<input type="hidden" class="js-basket-table__is-basket-page" value=""/>

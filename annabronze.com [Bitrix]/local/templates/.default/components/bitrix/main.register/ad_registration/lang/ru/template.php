...
$MESS["MAIN_REGISTER_AUTH"] = "Вы зарегистрированы<br> на сайте и успешно<br> авторизованы.";
...
$MESS['REGISTER_EMAIL_ERROR']='Некорректно указан E-mail';
$MESS['REGISTER_EMAIL_EXIST_ERROR']='Пользователь с таким email уже зарегистрирован';
$MESS['REGISTER_PASSWORD_LENGTH']='не менее 6 символов';
$MESS['REGISTER_PASSWORD_ERROR']='Неверный пароль';
$MESS['REGISTER_LOGIN_ERROR']='Логин должен быть не короче 2 символов';
$MESS['REGISTER_BTN']='Регистрация';
$MESS['REGISTER_REQUIRED_FIELDS']='Обязательные поля';
$MESS['REGISTER_SUBSCRIBE']='Подписаться';
$MESS['REGISTER_LOGIN'] = 'логином';
$MESS['REG_SUCCESS']='Вы успешно зарегистрированы';
?>
...
<!--
	<textarea class="lha-textarea" rows="25" id="comment"
			  style="font-family: Helvetica, Verdana, Arial, sans-serif; font-size: 16px; height: 170px; width: 288px;">

	</textarea>
-->
<!--
	<textarea class="b-form__textarea review-text" placeholder="<?=GetMessage("COMMENT");?>"
		  name="REVIEW_TEXT" id="comment"></textarea>--><!--name="REVIEW_TEXT"-->

...
else
{
	...
	function addField()
	{
		...
		add_block.innerHTML = 
			"<b>" + user_count + ".</b>" +
			"<input type=\"text\" name=\"add_friend[]\" class=\"b-form__input\" value=\"\" size='40'>" +
			"<br />";
	...
	<br><?=GetMessage("B_B_US_AD_NEW_FR_BY")?><br><br>
	<form name="add_friends" action="<?=POST_FORM_ACTION_URI?>" method="post">
	<?=bitrix_sessid_post()?>
		<div class="blogtext">
			<div id="add_friend_1">
				<b>1.</b><input type="text" class="b-form__input" name="add_friend[]" size="40" value="">
				<br />
			</div>
			<div id="add_friend_2">
				<b>2.</b>&nbsp;

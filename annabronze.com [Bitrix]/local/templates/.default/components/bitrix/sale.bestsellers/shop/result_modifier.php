...
$rsProducts = CIBlockElement::GetList(array("PRICE"=>"ASC"), array('IBLOCK_ID' => CATALOG_IBLOCK_ID, "PROPERTY_HOME_VALUE" => "yes"), false, Array("nPageSize"=>8), Array());//, Array("nPageSize"=>8)

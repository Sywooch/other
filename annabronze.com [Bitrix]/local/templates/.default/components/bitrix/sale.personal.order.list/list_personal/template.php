                ...
                <div class="row">
                    <div class="col-md-12 sale-order-list-inner-container">
						<span class="sale-order-list-inner-title-line">
							<span
                                class="sale-order-list-inner-title-line-item"><?= Loc::getMessage('SPOL_TPL_PAYMENT') ?></span>
                        ...
                        foreach ($order['PAYMENT'] as $payment) {
                            ...
                            <div class="row sale-order-list-inner-row">
                                ...
                                <div class="sale-order-list-inner-row-body grid-container">
                                    <div class=" grid-row col-md-9 col-sm-8 col-xs-12 sale-order-list-payment">
                                        <div class="sale-order-list-payment-title">
                                            ...
                                            ?>
                                            <span
                                                class="sale-order-list-payment-title-element"><?= $payment['PAY_SYSTEM_NAME'] ?></span>
                                            <?
                                            if ($payment['PAID'] === 'Y') {
                                                ?>
                                                <span
                                                    class="sale-order-list-status-success"><?= Loc::getMessage('SPOL_TPL_PAID') ?></span>
                                                <?
                                            } else {
                                                ?>
                                                <span
                                                    class="sale-order-list-status-alert"><?= Loc::getMessage('SPOL_TPL_NOTPAID') ?></span>
                                                <?
                                            }
                                            ?>
                                        </div>
                                        <div class="sale-order-list-payment-price">
                                            <span
                                                class="sale-order-list-payment-element"><b><?= Loc::getMessage('SPOL_TPL_SUM_TO_PAID') ?>
                                                    :</b></span>

                                            <span
                                                class="sale-order-list-payment-number"><?= $payment['FORMATED_SUM'] ?></span>
                                        </div>

                                        <div class="sale-order-list-payment-price">
                                            <span
                                                class="sale-order-list-payment-element"><b><?= Loc::getMessage('SPOL_TPL_PAY_TYPE') ?>
                                                    :</b></span>

                                            <span
                                                class="sale-order-list-payment-number"><?= $payment['PAY_SYSTEM_NAME'] ?></span>
                                        </div>


                                        <?/*
										if($payment["PAY_SYSTEM_ID"] == "5" && $payment["PAID"] == "N") {
											?>
											<!-----квитанция-------->
											<br>
											<a href="#" class="js-sale-order-list-payment-table"
												data-show-text="<?=Loc::getMessage('SPOL_TPL_PAY_SHOW_RECEIPT')?>"
											   	data-hide-text="<?=Loc::getMessage('SPOL_TPL_PAY_HIDE_RECEIPT')?>">
												<?=Loc::getMessage('SPOL_TPL_PAY_SHOW_RECEIPT')?>
											</a>

											<div class="spoiler" style="display: none;">
												<div class="sale-order-list-payment-table">
                                    ...
                                    if ($payment['PAID'] === 'N' && $payment['IS_CASH'] !== 'Y'
                                        && $payment['PAY_SYSTEM_ID'] != "22" && $payment['PAY_SYSTEM_ID'] != "21"
                                    ) {//не перевод на карту и не наложенный платеж

                                        //	&& $payment['PAY_SYSTEM_ID'] == "19")
                                        //{
                                        ...
                                        ?>
                                        <div
                                            class="grid-row col-md-3 col-sm-4 col-xs-12 sale-order-list-button-container">
                                            <a class=" btn _medium-size" target="_blank"
                                        ...
                                        else
                                        {
                                            ...
                                            <div class="col-md-3 col-sm-4 col-xs-12 sale-order-list-button-container">
                                                <a class="sale-order-list-button btn _medium-size ajax_reload" href="<?=htmlspecialcharsbx($payment['PSA_ACTION_FILE'])?>">
                                                    <?=Loc::getMessage('SPOL_TPL_PAY')?>
                                                </a>
                                            </div>
                                            <?
                        ...
                        if (!empty($order['SHIPMENT'])) {
                            ...
                            <div class="sale-order-list-inner-title-line">
                                <span
                                    class="sale-order-list-inner-title-line-item"><?= Loc::getMessage('SPOL_TPL_DELIVERY') ?></span>
                                <span class="sale-order-list-inner-title-line-border"></span>
                            </div>
                            <?
                        }
                        ...
                        foreach ($order['SHIPMENT'] as $shipment) {
                            ...
                            ?>
                            <div class="row sale-order-list-inner-row grid-container">
                                <?
                                if ($showDelimeter) {
                                    ?>
                                    <div class="sale-order-list-top-border"></div>
                                ...
                                ?>
                                <div class="grid-row col-md-9 col-sm-8 col-xs-12 sale-order-list-shipment">
                                    <? /* ?>
                                    ...
                                    if (!empty($shipment['TRACKING_NUMBER'])) {
                                        ...
                                        <div class="sale-order-list-shipment-item">
                                            <span
                                                class="sale-order-list-shipment-id-name"><?= Loc::getMessage('SPOL_TPL_POSTID') ?>
                                                :</span>
                                            <span
                                                class="sale-order-list-shipment-id"><?= htmlspecialcharsbx($shipment['TRACKING_NUMBER']) ?></span>
                                ...
                                if (strlen($shipment['TRACKING_URL']) > 0) {
                                    ?>
                                    <div
                                        class="col-md-2 col-md-offset-1 col-sm-12 sale-order-list-shipment-button-container">
                        ...
                        <div class="row sale-order-list-inner-row">
                            <div class=" grid-container">
                                ...
                                <div class="grid-row col-md-8  col-sm-12 sale-order-list-about-container">
                                ...
                                <div class="grid-row col-md-2 col-sm-12 sale-order-list-repeat-container">
                                ...
                                <div class=" grid-row col-md-2 col-sm-12 sale-order-list-cancel-container">
            ...
            <div class="col-md-12 col-sm-12 sale-order-list-container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 sale-order-list-accomplished-title-container">
                        <div class="row">
                            <div class="col-md-8 col-sm-12 sale-order-list-title-container">
                                <h2>
                                    <?= Loc::getMessage('SPOL_TPL_ORDER') ?>
                            ...
                            <div class="col-md-4 col-sm-12 sale-order-list-accomplished-date-container">
                                ...
                                ?>
                                <span
                                    class="sale-order-list-accomplished-date-number"><?= $order['ORDER']['DATE_STATUS_FORMATED'] ?></span>
                            </div>
                        </div>
                    </div>
                </div>

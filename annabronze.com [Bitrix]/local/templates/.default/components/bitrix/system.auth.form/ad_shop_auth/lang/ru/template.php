...
$MESS["socserv_as_user_form_1"] = "Войти с";
$MESS["socserv_as_user_form_2"]= "помощью";
...
$MESS['AUTH_FIRST_TIME_VISITOR']='Первый раз на сайте?';
$MESS['AUTH_FILL_THE_REGISTRATION_FORM']='Заполните, пожалуйста, форму регистрации';
$MESS['AUTH_EMAIL_ERROR']='Некорректно указан E-mail';
$MESS['AUTH_PASSWORD_ERROR']='Пароль должен быть не менее 6 символов';
$MESS['AUTH_EMAIL']='E-mail';
$MESS['AUTH_SUCCESS']='Вы успешно авторизованы';
?>
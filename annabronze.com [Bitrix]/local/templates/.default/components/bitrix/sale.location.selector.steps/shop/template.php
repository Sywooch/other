...
<?else:?>
	<?CJSCore::Init(array("fx","bx","jquery"));?>
	...
	<!--<input type="hidden" name="ORDER_PROP_6" value="<?=$arResult['VALUE']?>" class="bx-ui-slst-target">-->
	<div id="sls" class="bx-slst<?if($arResult['ADMIN_MODE']):?> bx-admin-mode<?endif?>"> <!---<?=$arResult['RANDOM_TAG']?>-->
	...
	<span class="b-selector__notice"><?=Loc::getMessage('SALE_SLS_CITY_NOTICE')?></span>
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$("label").on("click", function(){
				...
				loc = jQuery('input[name="<?=$arParams['INPUT_NAME']?>"]').val();

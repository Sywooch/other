...
<?if($available):?>
	<a href="#" onclick="return false;" class="ilike b-blog-list__counts-item _likes <?=($arResult['VOTE_AVAILABLE'] == 'Y'? '': 'bx-ilike-button-disable')?>">
<?else:?>
	<span onclick="return false;" class="ilike b-blog-list__counts-item _likes <?=($arResult['VOTE_AVAILABLE'] == 'Y'? '': 'bx-ilike-button-disable')?>">
<?endif?>

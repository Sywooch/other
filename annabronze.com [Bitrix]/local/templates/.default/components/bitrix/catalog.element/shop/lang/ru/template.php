...
$MESS["CATALOG_NOT_AVAILABLE"] = "Нет в наличии (Предзаказ)";
...
$MESS['CT_IS_AVAILABLE'] = "Товар доступен по адресам";
...
$MESS["POPUP_CONTINUE_SHOPPING"] = "ПРОДОЛЖИТЬ ПОКУПКИ";
$MESS["POPUP_IN_STOCK"] = "В наличии";
$MESS["POPUP_ADD_TO_CART"] = "добавить в корзину";
$MESS["POPUP_ADDED_TO_CART"] = "в корзине";
$MESS["POPUP_DISCOUNT_1"] = "Ваша скидка";
$MESS["POPUP_DISCOUNT_2"] = "до скидки в";
$MESS["POPUP_DISCOUNT_3"] = "осталось";
$MESS["POPUP_SELECT_COLOR"] = "Выберите цвет";
$MESS["POPUP_TEXT_1"] = "В нашем магазине Вы можете получить следующие скидки";
$MESS["POPUP_TEXT_FROM"] = "От";

$MESS["TERMS"] = "условия доставки и гарантии";
$MESS["THIS_ELEMENT_USED_HERE"] = "Этот элемент используется в:";
$MESS["SOCIAL_SHARE"] = "Поделиться вдохновением:";
$MESS["YOU_MAY_ALSO"] = "Вам может также понравиться";

...
<?
$fullAddress = "";
if(!empty($GLOBALS["SALE_INPUT_PARAMS"]["PROPERTY"]["LOCATION_COUNTRY"])){
	$fullAddress = $fullAddress . $GLOBALS["SALE_INPUT_PARAMS"]["PROPERTY"]["LOCATION_COUNTRY"].", ";
}

if(!empty($GLOBALS["SALE_INPUT_PARAMS"]["PROPERTY"]["LOCATION_REGION"])) {
	$fullAddress = $fullAddress . $GLOBALS["SALE_INPUT_PARAMS"]["PROPERTY"]["LOCATION_REGION"] . ", ";
}

if(!empty($GLOBALS["SALE_INPUT_PARAMS"]["PROPERTY"]["LOCATION_CITY"])) {
	$fullAddress = $fullAddress . $GLOBALS["SALE_INPUT_PARAMS"]["PROPERTY"]["LOCATION_CITY"] . ", ";
}

if(!empty($GLOBALS["SALE_INPUT_PARAMS"]["PROPERTY"]["ADDRESS"])) {
	$fullAddress = $fullAddress . $GLOBALS["SALE_INPUT_PARAMS"]["PROPERTY"]["ADDRESS"];
}

$params["SELLER_COMPANY_BANK_BIC"] = str_replace("БИК","",$params["SELLER_COMPANY_BANK_BIC"]);
...
<tr valign="top">
	...
	<? echo $GLOBALS["SALE_INPUT_PARAMS"]["ORDER"]["ACCOUNT_NUMBER"];  //=$params["PAYMENT_ID"]?>
	...
	<?=$params["PAYMENT_DATE_INSERT"]?></td>
		...
		<table border="0" cellspacing="0" cellpadding="0" style="width:122mm; margin-top:3pt;">
			<tr>
				...
				<td width="100%" style="border-bottom:1pt solid #000000;"><?=$GLOBALS["SALE_INPUT_PARAMS"]["PROPERTY"]["FIO"]; //=$params["BUYER_PERSON_FIO"]?></td>
			</tr>
		</table>
		<table border="0" cellspacing="0" cellpadding="0" style="width:122mm; margin-top:3pt;">
			<tr>

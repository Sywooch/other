...
HTML;
	...
	if( $user_group[$member_id['user_group']]['allow_main'] ) $main_input = "<input type=\"checkbox\" name=\"allow_main\" value=\"1\">&nbsp;{$lang['addnews_main']}"; else $main_input = "&nbsp;";
    ...
    <tr>
		...
		<table>
			...
			<tr>
				<td>{$main_input}</td>
				<td><input type="checkbox" name="allow_comm" value="1">&nbsp;{$lang['addnews_comm']}</td>
				<td>{$disable_index}</td>
			</tr>
			<tr>
				<td><input type="checkbox" name="allow_rating" value="1">&nbsp;{$lang['addnews_allow_rate']}</td>
				<td>{$fix_input}</td>
				<td>&nbsp;</td>
			</tr>
		</table><br />{$fix_br}</td>

<?php
$EMAIL = 'support@moedelo.org.ru'; //  Ваш e-mail на который будут приходить заявки
$FROM = 'info@moedelo.org.ru';  //  e-mail отправителя (иногда требуется указать разрешенный настройками e-mail)
$REPLY = 'support@moedelo.org.ru';   //  e-mail для ответа 

...
<div class="poping_links" style="display:none;"> <?php echo $params->get('pretext'); ?>
	<?php $usersConfig = &JComponentHelper::getParams( 'com_users' ); if ($usersConfig->get('allowUserRegistration')) : ?>
	
	<a  href="index.php?option=com_virtuemart&view=user&layout=editaddress"  id="openReg"><?php echo JText::_('CREATE_AN_ACCOUNT') ?></a><a href="javascript:;" onclick="showThem('login_pop');return false;" id="openLogin"><?php echo JText::_('LOGIN') ?></a>
	<?php endif; ?>
</div>
<!-- login -->

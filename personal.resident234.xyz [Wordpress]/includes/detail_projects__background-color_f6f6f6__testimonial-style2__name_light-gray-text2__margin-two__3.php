<section id="testimonial" class=" " style=" background-color:#f6f6f6; ">
    <div class="container">
        <div class="row">
            ...
            foreach ($posts as $post) {
                ...
                <div class="vc-column-innner-wrapper">
                    <div class="testimonial-style2"><img
                                src=""
                                class="js-img" alt=""
                                data-image="<?php echo $fileNew; ?>" width="300" height="300"/>
                        <p class="center-col width-90"><?php
                        ...
                        <span class="name light-gray-text2"
                              style="color:#000000;"><?php echo $post->post_title; ?></span></div>
                </div>
            </div>
            <?php
            if($i == 2) break;

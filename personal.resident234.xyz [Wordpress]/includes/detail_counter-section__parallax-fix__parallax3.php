...
<section class="  parallax-fix parallax3"
         style=" background-image: url(http://wpdemos.themezaa.com/h-code/wp-content/uploads/2015/08/parallax-pattern3.jpg); ">
            ...
            <div
                ...
                <div class="vc-column-innner-wrapper">
                    <div class="counter-section"><i class="icon-heart medium-icon"></i><span
                                ...
                                class="counter-number white-text"><?php echo $countPosts;?></span><span class="counter-title"
                                                                                                        style="color: #7f7f7f"><?php
            ...
            <div
                ...
                <div class="vc-column-innner-wrapper">
                    <div class="counter-section"><i class="icon-happy medium-icon"></i><span
                                ...
                                class="counter-number white-text"><?php echo $countSertificates;?></span><span class="counter-title"
                                                                                                               style="color: #7f7f7f"><?php
                            echo numberof($countPosts, '',
            ...
            <div
                ...
                <div class="vc-column-innner-wrapper">
                    <div class="counter-section"><i class="icon-anchor medium-icon"></i><span
                                ...
                                class="counter-number white-text"><?php echo $countFilesInRepo; ?></span><span class="counter-title"
                                                                                                               style="color: #7f7f7f">Файлов с кодом в репозитории</span>
                    </div>
                </div>
            </div>
            <div

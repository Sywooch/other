...
<ul id="menu-main-menu" class="mega-menu-ul nav navbar-nav navbar-right panel-group">
    ...
    <li id="menu-item-275"
        ...
        <a href="#collapse11" data-redirect-url="#" data-default-url="#collapse11"
           class="dropdown-toggle collapsed " data-hover="dropdown"
           data-toggle="collapse">Портфолио</a><a
                href="#collapse11" class="dropdown-toggle collapsed megamenu-right-icon aaa"
...
">
        <a href="#collapse28" data-redirect-url="/skills/" data-default-url="#collapse28"
           class="dropdown-toggle collapsed " data-hover="dropdown"
...
<?php if( strpos($_SERVER["REQUEST_URI"], "/info/") !== false ){ ?>current-menu-item<?php } ?>">
        <a href="#collapse33" data-redirect-url="#" data-default-url="#collapse33"
           class="dropdown-toggle collapsed " data-hover="dropdown"
        ...
        <ul id="collapse33" class="dropdown-menu mega-menu panel-collapse collapse">
            ...
            <li id="menu-item-418"
                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-417 dropdown-toggle collapsed">
                <a href="/info/personal/">Персональная страница</a>
...
<?php } ?>
">
        <a href="#collapse40" data-redirect-url="/services/" data-default-url="#collapse40"
           class="dropdown-toggle collapsed " data-hover="dropdown"
...
">
        <a href="#collapse40" data-redirect-url="/links/" data-default-url="#collapse40"
           class="dropdown-toggle collapsed " data-hover="dropdown"

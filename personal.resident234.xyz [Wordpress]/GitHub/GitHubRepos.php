...
require_once(__DIR__ . '/GitHubFullRepo.php');
require_once(__DIR__ . '/GitHubContributor.php');
require_once(__DIR__ . '/GitHubTeam.php');
require_once(__DIR__ . '/GitHubTag.php');
require_once(__DIR__ . '/GitHubBranches.php');
require_once(__DIR__ . '/GitHubBranch.php');

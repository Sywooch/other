...
<body class="page-template-default page page-id-77 wpb-js-composer js-comp-ver-5.1 vc_responsive">
<nav
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center animated fadeInUp">
                ...
                <span class="white-text">Список сертификатов</span>
            </div>
        </div>
    </div>
</section>
...
<section class="parent-section no-padding post-77 page type-page status-publish hentry">
    <div class="container">
                        ...
                        <div class="row">
                            <div class="wpb_column hcode-column-container  col-xs-mobile-fullwidth">
                                <div class="vc-column-innner-wrapper">
                                    ...
                                    <div class="work-2col gutter work-with-title">
                                                        ...
                                                        ?>">
                                                            <figure>
                                                                <div class="gallery-img"><a
                                                                        href="http://docs.google.com/viewer?url=<?php echo $linkToPdf;?>"
                                                                        class="" target="_blank"><img alt=""

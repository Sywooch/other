...
<body class="page-template-default page page-id-67 wpb-js-composer js-comp-ver-5.1 vc_responsive">
<nav
...
<section class="parent-section no-padding post-67 page type-page status-publish hentry">
                        ...
                        <div class="row">
                            <div class="wpb_column hcode-column-container  col-xs-mobile-fullwidth">
                                <div class="vc-column-innner-wrapper">
                                    <div id="hcode-owl-slider15"
                                         class="owl-carousel owl-theme  round-pagination light-pagination light-navigation white-cursor  hcode-owl-slider15 ">
                                                ...
                                                <div class="slider-typography">
                                                    <div class="slider-text-middle-main">
                                                        <div class="slider-text-middle"><p><span
                                                                ...
                                                                class="btn-small-white btn margin-five-top no-margin-bottom inner-link margin-lr-10px"
                                                                href="#animated-tab" target="_self">Специализации</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <script type="text/javascript">/*<![CDATA[*/
                                        jQuery(document).ready(function () {
                                            jQuery("#hcode-owl-slider15").owlCarousel({
                                                navigation: true,
                                                pagination: true,

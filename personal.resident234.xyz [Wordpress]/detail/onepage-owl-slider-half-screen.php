...
<body class="page-template-default page page-id-68 wpb-js-composer js-comp-ver-5.1 vc_responsive">
<nav
...
<section class="parent-section no-padding post-68 page type-page status-publish hentry">
                                            ...
                                            <div class="container position-relative">
                                                <div class="slider-typography text-left">
                                                    <div class="slider-text-middle-main">
                                                        <div
                                                            class="slider-text-middle padding-left-right-px animated fadeInUp">
                                                            <p><span class="owl-subtitle black-text">
                                                                <?php if($i == 1)  echo $arProject["post_title"];
                                                                else displayRandomElement($arPostTagsNames); ?>

                                                                </span>
                                                            </p> <span class="owl-title black-text">

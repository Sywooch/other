...
<section class="page-title parallax6 parallax-fix page-title-large">
    <img class="parallax-background-img js-img"
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center animated fadeInUp">
                ...
                <span class="text-uppercase gray-text">
...
<section
    class="no-padding post-9811 portfolio type-portfolio status-publish format-image
    hentry portfolio-category-portfolio-related">
                                ...
                                <div
                                    ...
                                    <div class="vc-column-innner-wrapper">
                                        <div class="text-large ">
                                            <h6 class="no-margin-top  wow fadeIn">
                                                <?php echo implode(" + ", $arPostTagsNames); ?>
                                            </h6>

        ...
        <div class="row">
            <div class="blog-details-text portfolio-single-content">
                <div class="entry-content">
                    <section class="  no-padding fix-background full-screen
                    js-background scroll-to-down scrollToDownSection"
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div
                                    ...
                                    <div class="vc-column-innner-wrapper">
                                        <div class="project-highlight">
                                            <span class="black-text">Год</span><?php echo $YEAR; ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="wpb_column hcode-column-container  col-xs-mobile-fullwidth">
                                    <div class="vc-column-innner-wrapper">
                                        <div id="hcode-owl-slider19"
                                             class="owl-carousel owl-theme  round-pagination dark-pagination
                                             dark-navigation cursor-black  hcode-owl-slider19 ">
                    ...
                    <section>
                        <div class="container">
                            <div class="row">
                                ...
                                <div
                                        class="wpb_column hcode-column-container  col-md-12 col-xs-mobile-fullwidth col-sm-12 text-center margin-seven-top wow fadeInUp">
                                    <div class="vc-column-innner-wrapper"><h5
                                                class="section-title  black-text no-padding"
                                                style="font-size:11px !important;font-weight:600 !important;;">Посмотреть другие проекты</h5><a href="/projects/" target="_self"
                                                                                                                                                class="inner-link highlight-button-dark btn-small
                                                                margin-two-top button btn">Проекты</a></div>
                                </div>
                            </div>
                        </div>
                    </section>
                    <section class="  no-padding-bottom" style=" background-color:#f6f6f6; ">
                        <div class="container">
                            <div class="row">
                                <div
                                    ...
                                    <div class="vc-column-innner-wrapper"><h3
                                                class="section-title  margin-five-bottom black-text no-padding">
                                            Описание</h3></div>
                                </div>
                                <div
                                        class="wpb_column hcode-column-container  col-md-7 col-xs-mobile-fullwidth col-sm-10 text-center center-col wow fadeInUp">
                                    <div class="vc-column-innner-wrapper">
                                        <div class="text-extra-large">
                                            <p class="no-margin-bottom wow fadeInUp">
                                ...
                                <div
                                    ...
                                    col-xs-mobile-fullwidth col-sm-10 text-center center-col">
                                    <div class="vc-column-innner-wrapper"><img
                                                src="" data-image="<?php displayRandomElement($arProjectMockups); ?>"
                                                width="800" class="js-img no-padding margin-ten-top" alt=""></div>
                                </div>
                            </div>
                        </div>
                    </section>

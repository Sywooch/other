...
<body class="page-template-default page page-id-25 wpb-js-composer js-comp-ver-5.1 vc_responsive">
<nav
...
<section class="parent-section no-padding post-25 page type-page status-publish hentry">
    <div class="container-fluid">
        <div class="row">
            <div class="entry-content">
                <section class="  parallax-fix parallax2 full-screen scroll-to-down
                                    ...
                                    <div class=" position-relative full-screen">
                                        <div class="slider-typography">
                                            <div class="slider-text-middle-main">
                                                <div
                                                    class="slider-text-middle text-left slider-text-middle1 animated fadeInUp">
                                                    <span class="slider-subtitle1
                                                    alt-font white-text bg-black width-auto
max-width__400px">
                                                       <?php echo $arProject["post_title"];?>
                                                    </span>
                                                    <div class="slider-title-big1
                                                    black-text"><?php echo get_post_meta($arProject["ID"], 'YEAR')[0]; ?>
                                                    </div>

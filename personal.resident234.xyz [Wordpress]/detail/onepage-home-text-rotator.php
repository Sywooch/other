...
<body class="page-template-default page page-id-62 wpb-js-composer js-comp-ver-5.1 vc_responsive">
<nav
...
<section class="parent-section no-padding post-62 page type-page status-publish hentry">
    <div class="container-fluid">
        <div class="row">
            <div class="entry-content">
                <section id="slider"
                         class="  parallax-fix parallax1 full-screen scroll-to-down-white
                         scrollToDownSection no-padding js-background"
                         style=" background-image: url(); "
                         data-image="<?php displayRandomElement($arProjectAllImages); ?>"
                         data-section-id="#features">
                    <div class="selection-overlay" style=" opacity:0.6; background-color:rgba(27,22,28,0.9);"></div>
                    <div class="container">
                        <div class="row">
                                        ...
                                        <div class="slider-typography">
                                            <div class="slider-text-middle-main">
                                                <div class="slider-text-middle slider-text-middle2">
                                                    <div class="separator-line xs-margin-bottom-five"
                                                         style="background-color:#e6af2a;"></div>
                                                    <span class="cd-headline slide animation2 text-uppercase"
                                                          style="color:#ffffff;border-color:#ffffff"><span
                                                            class="cd-words-wrapper text-center ">
                                                            <b class="is-visible"><?php echo $arProject["post_title"];?></b>
                                                            <b><?php echo get_post_meta($arProject["ID"], 'YEAR')[0]; ?></b>
                                                            <b><?php if($ProjectURL){ ?><?php echo $ProjectURL; ?><?php } ?></b>
                                                        </span></span><br><a
                                                        class="btn-small-white btn margin-lr-10px margin-five-top no-margin-bottom inner-link"
                                                        href="#features">Далее</a><a
                                                        class="btn-small-white btn margin-lr-10px margin-five-top no-margin-bottom inner-link"
                                                        href="#features">Детали</a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>

...
<body class="page-template-default page page-id-23 wpb-js-composer js-comp-ver-5.1 vc_responsive">
<nav
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="entry-content">
                <section
                    class=" full-width-image owl-half-slider parallax-fix parallax2 scroll-to-down-white
                                        ...
                                        <div class="slider-typography text-center">
                                            <div class="slider-text-middle-main">
                                                <div class="slider-text-bottom padding-left-right-px animated fadeInUp">
                                                    <span class="owl-subtitle"
                                                          style="color:#ffffff;border-color:#ffffff">
                                                        <?php echo get_post_meta($arProject["ID"], 'YEAR')[0]; ?>
                                                    </span>
                                                    <div class="separator-line-thick margin-three"
                                                         style="background-color:#e6af2a;"></div>
                                                    <p>
                                                        <span
                                                            class="owl-title center-col margin-ten no-margin-top
                                                            white-text">

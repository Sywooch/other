...
<body class="page-template-default page page-id-55 wpb-js-composer js-comp-ver-5.1 vc_responsive">
<nav
...
<section class="parent-section no-padding post-55 page type-page status-publish hentry">
    <div class="container-fluid">
        <div class="row">
            <div class="entry-content">
                <section id="slider" class="  parallax-fix parallax1 full-screen no-padding
js-background"
                         style=" background-image: url(); "
                         data-image="<?php displayRandomElement($arProjectAllImages); ?>"
                >
                    <div class="selection-overlay" style=" opacity:0.7; background-color:rgba(126,47,10,0.7);"></div>
                    <div class="container">
                        <div class="row">
                                        ...
                                        <div class="slider-typography">
                                            <div class="slider-text-middle-main">
                                                <div class="slider-text-middle slider-text-middle2">
                                                    <div class="separator-line bg-white"
                                                         style="background-color:#ffffff;"></div>
                                                    <div class="slider-subtitle2 white-text alt-font">

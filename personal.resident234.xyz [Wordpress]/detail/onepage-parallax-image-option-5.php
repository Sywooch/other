...
<body class="page-template-default page page-id-58 wpb-js-composer js-comp-ver-5.1 vc_responsive">
<nav
...
<section class="parent-section no-padding post-58 page type-page status-publish hentry">
    <div class="container-fluid">
        <div class="row">
            <div class="entry-content">
                <section id="slider"
                         class=" js-background parallax-fix parallax2 full-screen scroll-to-down-white scrollToDownSection no-padding"
                         style=" background-image: url(); "
                         data-image="<?php displayRandomElement($arProjectAllImages); ?>"data-section-id="#features">
                    <div class="container">
                        <div class="row">

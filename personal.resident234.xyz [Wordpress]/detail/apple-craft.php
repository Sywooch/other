...
<body
    class="portfolio-template-default single single-portfolio postid-15438 single-format-standard wpb-js-composer js-comp-ver-5.1 vc_responsive">
<nav
...
<section class="content-top-margin page-title-section page-title border-bottom-light border-top-light bg-white">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-7 col-sm-12 slideInUp wow fadeInUp" data-wow-duration="300ms">
                <h1
...
<section
    class=" post-15438 portfolio type-portfolio status-publish format-standard has-post-thumbnail hentry portfolio-category-masonry3">
            ...
            <div class="col-md-8 col-sm-8 col-xs-12">
                        ...
                        <section class="  no-padding">
                            <div
                                ...
                                <div class="vc-column-innner-wrapper">
                                    <p class="text-large"><?php echo $arProject["post_title"]; ?></p>
                                    <p><?php
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 text-center no-padding">
                                    <div class="blog-date no-padding-top"><?php
                ...
                <section class="no-padding">
                    <div class="container">
                        <div class="row">
                            <div
                                class="text-center padding-four-top padding-four-bottom col-md-12 col-sm-12
                                col-xs-12 no-padding-lr">

...
<body
    class="portfolio-template-default single single-portfolio postid-14266 single-format-standard wpb-js-composer js-comp-ver-5.1 vc_responsive">
<nav
...
<section
    class=" post-14266 portfolio type-portfolio status-publish format-standard has-post-thumbnail hentry portfolio-category-sample portfolio-tags-portfolio portfolio-tags-sidebar">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="gallery-img margin-bottom-30px"><img
                                    ...
                                    width="1240" class="js-img" alt=""></div>
                        </div>
                    </div>
                </section>

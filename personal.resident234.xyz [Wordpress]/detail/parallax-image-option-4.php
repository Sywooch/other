...
<body class="page-template-default page page-id-28 wpb-js-composer js-comp-ver-5.1 vc_responsive">
<nav
...
<section class="parent-section no-padding post-28 page type-page status-publish hentry">
    <div class="container-fluid">
        <div class="row">
            <div class="entry-content">
                <section class="  parallax-fix parallax2 full-screen scroll-to-down scrollToDownSection no-padding js-background"

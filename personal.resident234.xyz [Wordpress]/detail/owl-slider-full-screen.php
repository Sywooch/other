...
<body class="page-template-default page page-id-34 wpb-js-composer js-comp-ver-5.1 vc_responsive">
<nav
...
<section class="parent-section no-padding post-34 page type-page status-publish hentry">
                        ...
                        <div class="row">
                            <div class="wpb_column hcode-column-container  col-xs-mobile-fullwidth">
                                <div class="vc-column-innner-wrapper">
                                    <div id="hcode-owl-slider8"
                                         class="owl-carousel owl-theme  round-pagination light-pagination light-navigation white-cursor  hcode-owl-slider8 ">
                                                ...
                                                <div class="slider-typography">
                                                    <div class="slider-text-middle-main">
                                                        <div class="slider-text-middle animated fadeInUp">
                                                            <p><span
                                                                    class="owl-subtitle white-text
                                                                    xs-margin-bottom-four">
                                                                    <?php echo get_post_meta($arProject["ID"], 'YEAR')[0]; ?>
                                                                </span>
                                                            </p> <span class="owl-title-big white-text">
                                                                <?php if($i == 1)  echo $arProject["post_title"];
                                                                else displayRandomElement($arPostTagsNames); ?></span><br><a
                                                                class="btn-small-white btn margin-five-top no-margin-bottom inner-link margin-lr-10px"
                                                                href="#features" target="_self">Далее</a><a
                                                                class="btn-small-white btn margin-five-top no-margin-bottom inner-link margin-lr-10px"
                                                                href="#features" target="_self">Детали</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <script type="text/javascript">/*<![CDATA[*/
                                        jQuery(document).ready(function () {
                                            jQuery("#hcode-owl-slider8").owlCarousel({
                                                navigation: true,
                                                pagination: true,

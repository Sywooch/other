...
<body class="page-template-default page page-id-16510 wpb-js-composer js-comp-ver-5.1 vc_responsive">
<section class="parent-section no-padding post-16510 page type-page status-publish hentry">
    <div class="container-fluid">
        <div class="row">
            <div class="entry-content">
                <section class="  cover-background full-screen no-transition no-padding"
                         style=" background-image: url(http://wpdemos.themezaa.com/h-code/wp-content/uploads/2017/04/coming-soon-animation-1.jpg); ">
                    <div class="selection-overlay" style=" opacity:0.7; background-color:#252525; z-index:1;"></div>
                    <div class="wpb_column hcode-column-container  col-xs-mobile-fullwidth col-sm-12 no-padding"
                         style=" z-index:2;">
                            ...
                            <div class="slider-typography xs-position-inherit">
                                <div class="slider-text-middle-main">
                                    <div class="slider-text-top slider-text-middle2">
                                        <div class="coming-soon-logo"><img class="logo-style-2" style="max-width:108px"
                                                                           src="<?php echo PERSONAL_WP_HCODE_URL; ?>/h-code/wp-content/uploads/2015/10/logo-light-big.png"
                                                                           width="420" height="78" alt=""/></div>
                                        <span
                                            class="coming-soon-title text-uppercase  margin-ten no-margin-lr no-margin-bottom"
                                            style="color:#7f7f7f !important;">
                                            <?php echo $arProject["post_title"];?>
                                        </span>
                                        <?php /* ?>
                                        <span
                                                class="coming-soon-title  margin-ten no-margin-lr no-margin-bottom"
                                                style="color:#7f7f7f !important;">
                                            Работаю web-разработчиком
                                        </span>
                                        <div id="counter-underconstruction" data-days-text="Дней"
                                             data-hours-text="Часов"
                                             data-minutes-text="Минут" data-seconds-text="Секунд"
                                             class="hcode-date-style2 margin-two no-margin-lr no-margin-bottom"
                                             style="color:#ffffff !important;"></div>
                                        <span
                                            class="hide counter-underconstruction-date counter-hidden">15/12/2019</span>
                                        <?php */ ?>
                                    </div>
                                </div>
                            </div>
                            <div class="notify-me-main" style="background:#ffffff">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 text-center"><span
                                                ...
                                                <?php echo $arProject["post_content"]; ?>
                                            </span>
                                        </div>
                                    </div>
                                    <?php /* ?>
                                    ...
                                    <div class="row coming-soon-footer">
                                        <div class="col-md-12 text-center margin-five no-margin-bottom "><a
                                                href="https://www.facebook.com/" target="_blank"
                                                class="btn social-icon button"><i class="fa fa-facebook"></i></a><a
                                                href="https://twitter.com/" target="_blank"
                                                class="btn social-icon button"><i class="fa fa-twitter"></i></a><a
                                                href="#" target="_blank" class="btn social-icon button"><i
                                                    class="fa fa-google-plus"></i></a><a href="#" target="_blank"
                                                                                         class="btn social-icon button"><i
                                                    class="fa fa-dribbble"></i></a><a href="#" target="_blank"
                                                                                      class="btn social-icon button"><i
                                                    class="fa fa-youtube"></i></a><a href="#" target="_blank"
                                                                                     class="btn social-icon button"><i

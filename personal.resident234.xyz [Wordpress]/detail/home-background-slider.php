...
<body class="page-template-default page page-id-17 wpb-js-composer js-comp-ver-5.1 vc_responsive">
<nav
...
<section class="parent-section no-padding post-17 page type-page status-publish hentry">
                            ...
                            <div class="wpb_column hcode-column-container  col-xs-mobile-fullwidth">
                                <div class="vc-column-innner-wrapper">
                                                ...
                                                <div class="slider-text-middle-main">
                                                    <div
                                                        ...
                                                        <span
                                                            ...
                                                            class="slider-subtitle5 black-text"><?php echo get_post_meta($arProject["ID"], 'YEAR')[0]; ?></span><br>
                                                        <div
                                                            class="separator-line bg-black no-margin-lr no-margin-top sm-margin-bottom-eleven
                                                            xs-margin-bottom-thirteen"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="hcode-owl-slider7"
                                        ...
                                        <?php foreach($currentBackgroundImage as $itemBackgroundImage){ ?>
                                            <div class="item owl-bg-img full-screen js-background"
                                                 data-image="<?php echo $itemBackgroundImage; ?>"

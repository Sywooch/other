...
<body class="page-template-default page page-id-57 wpb-js-composer js-comp-ver-5.1 vc_responsive">
<nav
...
<section class="parent-section no-padding post-57 page type-page status-publish hentry">
    <div class="container-fluid">
        <div class="row">
            <div class="entry-content">
                <section id="slider"
                         class="  parallax-fix parallax2 full-screen scroll-to-down
                         js-background scrollToDownSection no-padding"

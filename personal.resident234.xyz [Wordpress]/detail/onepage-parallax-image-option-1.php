...
<body class="page-template-default page page-id-54 wpb-js-composer js-comp-ver-5.1 vc_responsive">
<nav
...
<section class="parent-section no-padding post-54 page type-page status-publish hentry">
    <div class="container-fluid">
        <div class="row">
            <div class="entry-content">
                <section id="slider"
                         class=" js-background parallax-fix parallax2 full-screen scroll-to-down scrollToDownSection no-padding"
                                        ...
                                        <div class="slider-typography">
                                            <div class="slider-text-middle-main">
                                                <div
                                                    ...
                                                    <span class="slider-subtitle1 alt-font white-text
                                                     bg-black width-auto">
                                                        <?php echo $arProject["post_title"]; ?>
                                                    </span>
                                                    <div class="slider-title-big1 black-text">

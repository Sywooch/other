...
<body class="page-template-default page page-id-20 wpb-js-composer js-comp-ver-5.1 vc_responsive">
<nav
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="entry-content">
                <section
                    class="  parallax-fix parallax1 full-screen scroll-to-down-white scrollToDownSection
                    no-padding js-background"
                                                ...
                                                <div class="slider-text-middle slider-text-middle2">
                                                    ...
                                                    <span class="cd-headline slide animation2 text-uppercase"
                                                          style="color:#ffffff;border-color:#ffffff"><span
                                                            ...
                                                            <b><?php echo implode("  ", $arPostTagsNames); ?></b>
                                                        ...
                                                        href="/projects/">Проекты</a><a
                                                        class="btn-small-white btn margin-lr-10px margin-five-top
                                                        no-margin-bottom inner-link"
                                                        href="/sertificates/">Сертификаты</a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>

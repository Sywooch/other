...
<body class="page-template-default page page-id-81 wpb-js-composer js-comp-ver-5.1 vc_responsive">
<nav
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center animated fadeInUp">
                ...
                <span class="white-text">Список лучших проектов</span>
            </div>
        </div>
    </div>
</section>

...
<body class="page-template-default page page-id-88 wpb-js-composer js-comp-ver-5.1 vc_responsive">
<nav
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2 pull-left"><a class="logo-light" href="<?php echo PERSONAL_WP_HCODE_URL; ?>/h-code"> <img
                            alt="H-Code" src="<?php echo PERSONAL_WP_HCODE_URL; ?>/h-code/wp-content/uploads/2015/08/logo-white.png"
                            class="logo"/> <img alt="H-Code"
                                                src="<?php echo PERSONAL_WP_HCODE_URL; ?>/h-code/wp-content/uploads/2015/08/logo-white.png"
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center animated fadeInUp">
                ...
                <span class="white-text">Список проектов, в которых я принимал эпизодическое участие</span>
            </div>
        </div>
    </div>
</section>
...
<section class="parent-section no-padding post-81 page type-page status-publish hentry">
                        ...
                        <div class="row">
                            <div class="wpb_column hcode-column-container  col-xs-mobile-fullwidth">
                                <div class="vc-column-innner-wrapper">
                                    ...
                                    <div class="work-5col gutter wide">
                                        <div class="col-md-12  no-padding grid-gallery overflow-hidden  content-section">
...
//PORTFOLIO_WP_BEST_PROJECTS_LABEL_ID
                                                        }
                                                        ?>">
                                                            <figure>
                                                                <div class="gallery-img"><a
                                                                            ...
                                                                            class="" target=""><img alt=""
                                                                                                    ...
                                                                                                    width="800"
                                                                                                    height="500" class="js-img"/></a></div>
                                                                <figcaption><h3><a
                                                                                href="/detail/<?php echo $arDetailTemplates[wp_rand(0, count($arDetailTemplates) - 1)]; ?>?ID=<?php echo $post->ID; ?>"
                                                                                class="" target=""><?php echo $post->post_title; ?></a>
                                                                    </h3>
                                                                    <p></p></figcaption>
                                                            </figure>
                                                        </li>

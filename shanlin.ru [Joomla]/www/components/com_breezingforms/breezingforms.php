			...
			if ($task == 'submit'){
				...
				if(trim($form->template_code_processed) == ''){
					echo "</div>\n";
                                ...
                                if(trim($form->template_code_processed) == 'QuickMode') echo '<br/><br/><div align="center"><a href="http://crosstec.de/" target="_blank">Joomla!&reg; Forms Download</a></div>';
						...
						if($options['downloadableFile']){
							...
							$db->setQuery("
									...
									Where 
										id = '".$recordId."'
									And
										paypal_tx_id = ".$db->Quote('Sofort??berweisung: ' . JRequest::getVar('tx',''))."
									");
						...
						if($txid[0]->paypal_tx_id == ''){
							...
							$db->setQuery("
										Update 
											#__facileforms_records 
										Set 
											paypal_tx_id = ".$db->Quote('Sofort??berweisung: ' . JRequest::getVar('transaction','')).", 

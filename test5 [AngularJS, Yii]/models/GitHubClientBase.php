...
class GitHubClientBase extends Model
{
	...
	public $uploadUrl = 'https://uploads.github.com';
	...
	public $timeout = 240;
	public $rateLimit = 0;
	public $rateLimitRemaining = 0;
	public $rateLimitReset = 0;
	
	public $authType = self::GITHUB_AUTH_TYPE_BASIC;
	public $oauthKey = null;
	...
	public $lastReturnType = null;
	public $lastReturnIsArray = null;
	public $lastExpectedHttpCode = null;
	...
	public function requestLast(array $data)
	{

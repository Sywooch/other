...
(function ($, window, document, undefined) {
    var Carousel = {
        init: function (options, el) {
            ...
            $(".item").css("width", parseInt(base.itemWidth) - 1);
            $(".item .box").css("width", parseInt(base.itemWidth) - 1);
            $(".item a img").css("width", parseInt(base.itemWidth) - 1);
            $(".item a img").css("max-width", parseInt(base.itemWidth) - 1);

            initGalleryImagesPosition($('#owl2 .box'));
            initGalleryImagesPosition($('#owl2_1 .box'));



            /*$('#owl2 .box').each(function(){


                var circPaddingBottom = $(this).find(".circ").css("paddingBottom");

                circPaddingBottom = circPaddingBottom.replace("px","");
                var circHeight = Math.abs(parseInt(circPaddingBottom)) + Math.abs(parseInt($(this).find(".circ").height()));

                //alert(circHeight);

                //var heightImage = $(this).find("img").height();
                //var heightImage = $(this).find("img").attr("src");
                //var widthImage = $(this).width();
                //alert(widthImage);
                var heightImage = $(this).find("img").height();

                //alert(heightImage);
                //var heightImage = $(this).find("img").css("height");
                //alert("=" + heightImage);

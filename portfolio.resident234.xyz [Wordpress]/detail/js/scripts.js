...
jQuery('a.zoom').hover(function(){jQuery(this).addClass('active');jQuery(this).find('span.zoom-bg').stop(true,true).animate({opacity:0.7},200);jQuery(this).find('span.zoom-icon').stop(true,true).animate({top:'50%'},200);},function(){jQuery(this).removeClass('active');jQuery(this).find('span.zoom-bg').stop(true,true).animate({opacity:0},200);jQuery(this).find('span.zoom-icon').stop(true,true).animate({top:'-50%'},200);});jQuery("#back-top").hide();jQuery(function(){jQuery(window).scroll(function(){if(jQuery(this).scrollTop()>100){jQuery('#back-top').fadeIn();}else{jQuery('#back-top').fadeOut();}});jQuery('#back-top a').click(function(){jQuery('body,html').animate({scrollTop:0},400);return false;});});jQuery('div.pagination ul li:not([class])').addClass('num');jQuery(function(){var viewportmeta=document.querySelector&&document.querySelector('meta[name="viewport"]'),ua=navigator.userAgent,gestureStart=function(){viewportmeta.content="width=device-width, minimum-scale=0.25, maximum-scale=1.6";},scaleFix=function(){if(viewportmeta&&/iPhone|iPad/.test(ua)&&!/Opera Mini/.test(ua)){viewportmeta.content="width=device-width, minimum-scale=1.0, maximum-scale=1.0";document.addEventListener("gesturestart",gestureStart,false);}};scaleFix();});jQuery('.body__splash .menu_button').toggle(function(){jQuery('.sf-menu').slideDown()},function(){jQuery('.sf-menu').slideUp()})
jQuery('.sf-menu>li').each(function(n){jQuery(this).children('a,span').wrapInner('<em></em>')
jQuery(this).children('a,span').prepend('<i>0'+(n+1)+'.</i>')})
jQuery(window).load(function(){elHeight=0;m=0;jQuery('.maxheight').each(function(){if(jQuery(this).outerHeight()>elHeight)elHeight=jQuery(this).outerHeight();m++;})
if(m>1){jQuery('.maxheight').css({minHeight:elHeight})
jQuery(window).resize(function(){jQuery('.maxheight').css({minHeight:0})
if(jQuery(window).width()>769){elHeight=0;jQuery('.maxheight').each(function(){if(jQuery(this).outerHeight()>elHeight)elHeight=jQuery(this).outerHeight();})
jQuery('.maxheight').css({minHeight:elHeight})}})
jQuery(window).scroll(function(){if(jQuery(window).width()>769){jQuery('.maxheight').css({minHeight:0})
if(jQuery(window).width()>769){elHeight=0;jQuery('.maxheight').each(function(){if(jQuery(this).outerHeight()>elHeight)elHeight=jQuery(this).outerHeight();})
jQuery('.maxheight').css({minHeight:elHeight})}}})}})
if(!jQuery('#content-row').text().replace(/\s+/g,'')){jQuery('#content-row').remove();}});

...
require_once RPATH_SITE.DS.'modules'.DS.'mod_bt_contentslider'.DS.'helpers'.DS.'helper.php';
//Get list content
$list = modBtContentSliderHelper::getList( $params, $module );
//var_dump($list);

// ROW * COL
$elementsPerRow = (int)$params->get( 'elements_per_rows', 3 );
$elementsPerCol = (int)$params->get( 'elements_per_cols', 1 );
$moduleclass_sfx = $params->get('moduleclass_sfx');
$imgClass = $params->get('hovereffect',1)? 'class= "hovereffect"':'';

//Num of element display
$maxPages = $elementsPerRow*$elementsPerCol;
...
$elementWidth = floor(100/$elementsPerRow -0.1);

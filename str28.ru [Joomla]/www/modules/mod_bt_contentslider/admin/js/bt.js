...
window.addEvent("domready",function(){
	$$("#rinputform_params_asset-lbl").getParent().destroy();
...
window.addEvent("domready",function(){
	BtParamsChoose();
	jQuery("#rinputform_params_source").change(function(){
		BtParamsChoose();
...
function BtParamsChoose(){
	jQuery("#rinputform_params_article_ids").parent().hide();	
	jQuery("#rinputform_params_category").parent().hide();	
	jQuery("#rinputform_params_k2_article_ids").parent().hide();	
	jQuery("#rinputform_params_k2_category").parent().hide();	
	jQuery("#rinputform_params_btportfolio_article_ids").parent().hide();	
	jQuery("#rinputform_params_btportfolio_category").parent().hide();
	jQuery("#rinputform_params_"+jQuery("#rinputform_params_source").val()).parent().show();
	if(jQuery("#rinputform_params_source").val().indexOf("k2")>=0){
		if(jQuery("#rinputform_params_k2_category option").length==0){
			alert("K2 component is not installed or configured on your site!");
		}
	}
	if(jQuery("#rinputform_params_source").val().indexOf("btportfolio")>=0){
		if(jQuery("#rinputform_params_btportfolio_category option").length==0){

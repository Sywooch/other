...
{
	/**
	 * Color picker form field type compatible with retina 1.6. Displays an Adobe type color picker panel, and returns a six-digit hex value, eg #cc99ff
	 */
	...
	protected function getInput()
	{
		...
		$module = str_replace( RPATH_SITE.DS.'modules'.DS,'',dirname(__FILE__) );
		...
		if($scriptname == 'self')
		{
           $filedir = str_replace(RPATH_SITE . '/','',dirname(__FILE__));

 ...
 * admin/components/com_admin/sql/updates/<database>.
 ...
 * @since       2.5
 */
abstract class JSchemaChangeelement extends JObject
{
	/**
	...
	*/
	...
	/**
	* Array with values for use in a RText::sprintf statment indicating what was checked
	*
	...
	*/
	...
	/**
	 *
	 * Returns an instance of the correct schemachangeelement for the $db
	 *
	 * @param   JDatabase $db
	 * @param   string    $file   full path name of the sql file
	 * @param   string    $query  text of the sql query (one line of the file)
	 *
	 * @return  JSchemaChangeelement for the $db driver
	 *
	 * @since   2.5
	 */
	public static function getInstance($db, $file, $query)
	{
		...
		$path = dirname(__FILE__).'/' . 'changeelement' . $dbname . '.php'  ;
		$class = 'JSchemaChangeelement' . $dbname;

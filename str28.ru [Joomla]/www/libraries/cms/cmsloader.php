...
{
	/**
	 * Method to setup the autoloaders for the retina CMS. Since the SPL autoloaders are
	...
	/**
	 * Autoload a retina library class based on name.
	 *
	...
	private static function _autoload($class)
	{
		...
		if ($class[0] == 'J') {
			...
			$path = RPATH_PLATFORM . '/cms/' . implode('/', array_map('strtolower', $parts)) . '.php';

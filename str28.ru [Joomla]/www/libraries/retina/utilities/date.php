...
class JDate extends DateTime
{
	 ...
	 * options from Retina CMS 1.5 and below.
	 *
	 * @deprecated    12.1
	 *
	 * @var    array
	...
	public function dayToString($day, $abbr = false)
	{
		...
		{
			case 0:
				return $abbr ? RText::_('SUN') : RText::_('SUNDAY');
			case 1:
				return $abbr ? RText::_('MON') : RText::_('MONDAY');
			case 2:
				return $abbr ? RText::_('TUE') : RText::_('TUESDAY');
			case 3:
				return $abbr ? RText::_('WED') : RText::_('WEDNESDAY');
			case 4:
				return $abbr ? RText::_('THU') : RText::_('THURSDAY');
			case 5:
				return $abbr ? RText::_('FRI') : RText::_('FRIDAY');
			case 6:
				return $abbr ? RText::_('SAT') : RText::_('SATURDAY');
		}
	}
	...
	public function monthToString($month, $abbr = false)
	{
		...
		{
			case 1:
				return $abbr ? RText::_('JANUARY_SHORT') : RText::_('JANUARY');
			case 2:
				return $abbr ? RText::_('FEBRUARY_SHORT') : RText::_('FEBRUARY');
			case 3:
				return $abbr ? RText::_('MARCH_SHORT') : RText::_('MARCH');
			case 4:
				return $abbr ? RText::_('APRIL_SHORT') : RText::_('APRIL');
			case 5:
				return $abbr ? RText::_('MAY_SHORT') : RText::_('MAY');
			case 6:
				return $abbr ? RText::_('JUNE_SHORT') : RText::_('JUNE');
			case 7:
				return $abbr ? RText::_('JULY_SHORT') : RText::_('JULY');
			case 8:
				return $abbr ? RText::_('AUGUST_SHORT') : RText::_('AUGUST');
			case 9:
				return $abbr ? RText::_('SEPTEMBER_SHORT') : RText::_('SEPTEMBER');
			case 10:
				return $abbr ? RText::_('OCTOBER_SHORT') : RText::_('OCTOBER');
			case 11:
				return $abbr ? RText::_('NOVEMBER_SHORT') : RText::_('NOVEMBER');
			case 12:
				return $abbr ? RText::_('DECEMBER_SHORT') : RText::_('DECEMBER');
		}
	}

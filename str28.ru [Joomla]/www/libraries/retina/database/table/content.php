...
class JTableContent extends JTable
{
	...
	public function bind($array, $ignore = '')
	{
		...
		{
			$pattern = '#<hr\s+id=("|\')main-readmore("|\')\s*\/*>#i';
	...
	public function check()
	{
		if (trim($this->title) == '')
		{
			$this->setError(RText::_('COM_CONTENT_WARNING_PROVIDE_VALID_NAME'));
			return false;
		}
		...
		{
			$this->setError(RText::_('RGLOBAL_ARTICLE_MUST_HAVE_TEXT'));
			return false;
		}
	...
	public function store($updateNulls = false)
	{
		...
		{
			$this->setError(RText::_('RLIB_DATABASE_ERROR_ARTICLE_UNIQUE_ALIAS'));
			return false;
		}
	...
	public function publish($pks = null, $state = 1, $userId = 0)
	{
		...
		if (empty($pks))
		{
			...
			{
				$this->setError(RText::_('RLIB_DATABASE_ERROR_NO_ROWS_SELECTED'));
				return false;
			}
		}

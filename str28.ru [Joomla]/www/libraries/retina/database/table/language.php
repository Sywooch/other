...
class JTableLanguage extends JTable
{
	...
	public function check()
	{
		if (trim($this->title) == '')
		{
			$this->setError(RText::_('RLIB_DATABASE_ERROR_LANGUAGE_NO_TITLE'));
			return false;
		}
	...
	public function store($updateNulls = false)
	{
		...
		{
			$this->setError(RText::_('RLIB_DATABASE_ERROR_LANGUAGE_UNIQUE_SEF'));
			return false;
		}
		...
		{
			$this->setError(RText::_('RLIB_DATABASE_ERROR_LANGUAGE_UNIQUE_IMAGE'));
			return false;
		}
		...
		{
			$this->setError(RText::_('RLIB_DATABASE_ERROR_LANGUAGE_UNIQUE_LANG_CODE'));
			return false;
		}

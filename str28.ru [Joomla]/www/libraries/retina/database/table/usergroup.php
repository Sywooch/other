...
class JTableUsergroup extends JTable
{
	...
	public function check()
	{
		...
		if ((trim($this->title)) == '')
		{
			$this->setError(RText::_('RLIB_DATABASE_ERROR_USERGROUP_TITLE'));
			return false;
		}
		...
		if ($db->loadResult() > 0)
		{
			$this->setError(RText::_('RLIB_DATABASE_ERROR_USERGROUP_TITLE_EXISTS'));
			return false;
		}
	...
	public function delete($oid = null)
	{
		...
		if ($this->id == 0)
		{
			return new JException(RText::_('RGLOBAL_CATEGORY_NOT_FOUND'));
		}
		if ($this->parent_id == 0)
		{
			return new JException(RText::_('RLIB_DATABASE_ERROR_DELETE_ROOT_CATEGORIES'));
		}
		if ($this->lft == 0 or $this->rgt == 0)
		{
			return new JException(RText::_('RLIB_DATABASE_ERROR_DELETE_CATEGORY'));
		}

...
class JDatabaseSQLSrv extends JDatabase
{
	...
	protected function __construct($options)
	{
		...
		if (!function_exists('sqlsrv_connect'))
		{
			...
			{
				$this->errorNum = 1;
				$this->errorMsg = RText::_('RLIB_DATABASE_ERROR_ADAPTER_SQLSRV');
				return;
			}
			else
			{
				throw new JDatabaseException(RText::_('RLIB_DATABASE_ERROR_ADAPTER_SQLSRV'));
			}
		}
		...
		if (!($this->connection = @ sqlsrv_connect($options['host'], $config)))
		{
			...
			{
				$this->errorNum = 2;
				$this->errorMsg = RText::_('RLIB_DATABASE_ERROR_CONNECT_SQLSRV');
				return;
			}
			else
			{
				throw new JDatabaseException(RText::_('RLIB_DATABASE_ERROR_CONNECT_SQLSRV'));
			}
		}
	...
	public function getExporter()
	{
		...
		{
			throw new JDatabaseException(RText::_('RLIB_DATABASE_ERROR_MISSING_EXPORTER'));
		}
	...
	public function getImporter()
	{
		...
		{
			throw new JDatabaseException(RText::_('RLIB_DATABASE_ERROR_MISSING_IMPORTER'));
		}
	...
	public function getQuery($new = false)
	{
		if ($new)
		{
			...
			{
				throw new JDatabaseException(RText::_('RLIB_DATABASE_ERROR_MISSING_QUERY'));
			}
	...
	*/
	...
	public function loadResult()
	{
		...
		// Free up main resources and return.
	...
	public function query()
	{
		if (!is_resource($this->connection))
		{
			...
			{
				JLog::add(RText::sprintf('RLIB_DATABASE_QUERY_FAILED', $this->errorNum, $this->errorMsg), JLog::ERROR, 'database');
		...
		if (!$this->cursor)
		{
			...
			{
				JLog::add(RText::sprintf('RLIB_DATABASE_QUERY_FAILED', $this->errorNum, $this->errorMsg), JLog::ERROR, 'databasequery');
				throw new JDatabaseException($this->errorMsg, $this->errorNum);
			}
		}
	...
	public function select($database)
	{
		...
		if (!sqlsrv_query($this->connection, 'USE ' . $database, null, array('scrollable' => SQLSRV_CURSOR_STATIC)))
		{
			...
			{
				$this->errorNum = 3;
				$this->errorMsg = RText::_('RLIB_DATABASE_ERROR_DATABASE_CONNECT');
				return false;
			}
			else
			{
				throw new JDatabaseException(RText::_('RLIB_DATABASE_ERROR_DATABASE_CONNECT'));
			}
		}

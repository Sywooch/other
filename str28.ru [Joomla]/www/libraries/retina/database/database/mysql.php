...
class JDatabaseMySQL extends JDatabase
{
	...
	protected function __construct($options)
	{
		...
		if (!function_exists('mysql_connect'))
		{
			...
			{
				$this->errorNum = 1;
				$this->errorMsg = RText::_('RLIB_DATABASE_ERROR_ADAPTER_MYSQL');
				return;
			}
			else
			{
				throw new JDatabaseException(RText::_('RLIB_DATABASE_ERROR_ADAPTER_MYSQL'));
			}
		}
		...
		if (!($this->connection = @ mysql_connect($options['host'], $options['user'], $options['password'], true)))
		{
			...
			{
				$this->errorNum = 2;
				$this->errorMsg = RText::_('RLIB_DATABASE_ERROR_CONNECT_MYSQL');
				return;
			}
			else
			{
				throw new JDatabaseException(RText::_('RLIB_DATABASE_ERROR_CONNECT_MYSQL'));
			}
		}

 ...
 * Provides a storage for filemain's paths where JForm's entities reside and methods for creating those entities.
...
class JFormHelper
{
	...
	protected static function addPath($entity, $new = null)
	{
		...
		if (empty($paths))
		{
			...
			// an inflector class to "libraries/retina/utilities" and use it here (or somebody can use a real inflector in his subclass).

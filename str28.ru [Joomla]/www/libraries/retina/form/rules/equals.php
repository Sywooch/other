...
class JFormRuleEquals extends JFormRule
{
	...
	public function test(&$element, $value, $group = null, &$input = null, &$form = null)
	{
		...
		if (!$field)
		{
			return new JException(RText::sprintf('RLIB_FORM_INVALID_FORM_RULE', get_class($this)));
		}

		// Check that a valid JForm object is given for retrieving the validation field value.
		if (!($form instanceof JForm))
		{
			return new JException(RText::sprintf('RLIB_FORM_INVALID_FORM_OBJECT', get_class($this)));
		}

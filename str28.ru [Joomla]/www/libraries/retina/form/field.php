...
/**
 * Abstract Form Field class for the retina Platform.
 *
 */
abstract class JFormField
{
	...
	protected function getTitle()
	{
		...
		$title = $this->translateLabel ? RText::_($title) : $title;
	...
	protected function getLabel()
	{
		...
		$text = $this->translateLabel ? RText::_($text) : $text;
		...
		if (!empty($this->description))
		{
			$label .= ' title="'
				. htmlspecialchars(
				trim($text, ':') . '::' . ($this->translateDescription ? RText::_($this->description) : $this->description),
				ENT_COMPAT, 'UTF-8'
			) . '"';
		}

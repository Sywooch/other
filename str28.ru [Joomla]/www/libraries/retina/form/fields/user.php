...
class JFormFieldUser extends JFormField
{
	...
	protected function getInput()
	{
		...
		{
			$table->username = RText::_('RLIB_FORM_SELECT_USER');
		}
		...
		{
			$html[] = '		<a class="modal_' . $this->id . '" title="' . RText::_('RLIB_FORM_CHANGE_USER') . '"' . ' href="' . $link . '"'
				. ' rel="{handler: \'iframe\', size: {x: 800, y: 500}}">';
			$html[] = '			' . RText::_('RLIB_FORM_CHANGE_USER') . '</a>';
		}
		$html[] = '  </div>';
		$html[] = '</div>';

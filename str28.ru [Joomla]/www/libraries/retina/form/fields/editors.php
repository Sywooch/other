...
class JFormFieldEditors extends JFormFieldList
{
	...
	protected function getOptions()
	{
		...
		{
			$lang->load('plg_editors_' . $option->value, RPATH_admin, null, false, false)
				|| $lang->load('plg_editors_' . $option->value, RPATH_PLUGINS . '/editors/' . $option->value, null, false, false)
				|| $lang->load('plg_editors_' . $option->value, RPATH_admin, $lang->getDefault(), false, false)
				|| $lang->load('plg_editors_' . $option->value, RPATH_PLUGINS . '/editors/' . $option->value, $lang->getDefault(), false, false);
			$options[$i]->text = RText::_($option->text);
		}

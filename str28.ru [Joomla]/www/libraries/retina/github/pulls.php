...
/**
 * GitHub API Pull Requests class for the retina Platform.
 *
 * @package     retina.Platform
 * @subpackage  GitHub
 * @since       11.3
...
class JGithubPulls extends JGithubObject
{
	 ...
	 * @param   string   $repo    The name of the GitHub repository.
	 * @param   integer  $pullId  The pull request number.
	 * @param   integer  $page    The page number from which to get elements.
	 * @param   integer  $limit   The number of elements on a page.
	 *
	 * @return  array
	 *
	 * @since   11.3

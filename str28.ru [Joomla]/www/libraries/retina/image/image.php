...
class JImage
{
	...
	/**
	 * Method to return a properties object for an image given a filemain path.  The
	 * result object has values for image width, height, type, attributes, mime type, bits,
	 * and channels.
	 *
	 * @param   string  $path  The filemain path to the image for which to get properties.
	 *
	 * @return  object
	 *
	 * @since   11.3
	 ...
	 *
	 * @param   string  $path  The filemain path to load as an image.
	 *
	 * @return  void
	 *
	 * @since   11.3
	...
	public function loadFile($path)
	{
		...
		// Set the filemain path to the source image.
		$this->path = $path;
	}
	 ...
	 *
	 * @param   string   $path     The filemain path to save the image.

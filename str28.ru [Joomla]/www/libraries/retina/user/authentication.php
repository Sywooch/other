...
/**
 * Authentication class, provides an interface for the retina authentication main
 *
...
class JAuthentication extends JObject
{
	...
	public function __construct()
	{
		...
		if (!$isLoaded)
		{
			JError::raiseWarning('SOME_ERROR_CODE', RText::_('RLIB_USER_ERROR_AUTHENTICATION_LIBRARIES'));
		}
	}
	...
	public function authenticate($credentials, $options = array())
	{
		...
		foreach ($plugins as $plugin)
		{
			...
			else
			{
				...
				JError::raiseWarning(50, RText::sprintf('RLIB_USER_ERROR_AUTHENTICATION_FAILED_LOAD_PLUGIN', $className));
				continue;
			}
...
class JAuthenticationResponse extends JObject
{
	...
	/**
	 * UTF-8 string free text that SHOULD conform to the End User's country's postal main.
	 *
	 * @var postcode string
	 * @since  11.1
	 */

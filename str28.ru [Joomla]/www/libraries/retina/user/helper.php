 ...
 * to the retina user and authorisation classes
 *
...
abstract class JUserHelper
{
	...
	public static function addUserToGroup($userId, $groupId)
	{
		...
		if (!in_array($groupId, $user->groups))
		{
			...
			if (!$title)
			{
				return new Exception(RText::_('RLIB_USER_EXCEPTION_ACCESS_USERGROUP_INVALID'));
			}
	...
	public static function activateUser($activation)
	{
		...
		{
			JError::raiseWarning("SOME_ERROR_CODE", RText::_('RLIB_USER_ERROR_UNABLE_TO_FIND_USER'));
			return false;
		}
	 ...
	 *                                  Defaults to md5-hex.
	 * @param   boolean  $show_encrypt  Some password mains prepend the kind of
	...
	{
		// Получение соли для использования.
	...
	/**
	 * Возвращает соль для соответствующего вида шифрования паролей.
	 * Optionally takes a seed and a plaintext password, to extract the seed
	 * of an existing password, or for encryption types that use the plaintext
	 * in the generation of the salt.
	 *
	 * @param   string  $encryption  Используемый вид хеширования.
	 *                               По умолчанию - md5-hex.
	...
	{//получение соли.
		// Хеширование пароля.
		switch ($encryption)//выбор метода хеширования.
		{
			case 'crypt':
			case 'crypt-des':
				if ($seed)
	 ...
	 *
	 * @param   integer  $length  Длина генерируемого пароля
	 *

 ...
 * for the retina Platform to access and manipulate a URI.  Second it obtains the URI of
...
class JURI extends JObject
{
	...
	/**
	 * Removes an element from the query string variables if it exists.
	 *

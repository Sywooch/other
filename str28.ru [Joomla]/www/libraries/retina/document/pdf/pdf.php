...
/*		// Installation path
		define("K_PATH_MAIN", RPATH_rs_LIBRARIES.DS."tcpdf");

		// URL path
		define("K_PATH_URL", RPATH_BASE);

		// Fonts path
		define("K_PATH_FONTS", K_PATH_MAIN.DS.'fonts'.DS);
		//define("K_PATH_FONTS", RPATH_admin.DS.'components'.DS.'com_phocapdf'.DS.'fonts'.DS)
...
/*		// Cell height ratio
		...
		if(!class_exists('TCPDF')) require(RPATH_ROOT.DS.'libraries'.DS.'tcpdf'.DS.'tcpdf.php');

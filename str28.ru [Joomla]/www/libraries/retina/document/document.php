...
jimport('retina.filter.filteroutput');
...
class JDocument extends JObject
{
	 ...
	 * @var    string
	 */
	public $_generator = 'Retina - Open Source Content Management';
	...
	public static function getInstance($type = 'html', $attributes = array())
	{
		...
		if (empty(self::$instances[$signature]))
		{
			...
			if (!class_exists($class))
			{
				...
				{
					JError::raiseError(500, RText::_('RLIB_DOCUMENT_ERROR_UNABLE_LOAD_DOC_CLASS'));
				}
			}
	...
	public function loadRenderer($type)
	{
		...
		if (!class_exists($class))
		{
			...
			{
				JError::raiseError(500, RText::_('Unable to load renderer class'));
			}
		}

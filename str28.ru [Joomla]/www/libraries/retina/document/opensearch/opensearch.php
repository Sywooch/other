...
class JDocumentOpensearch extends JDocument
{
	...
	public function __construct($options = array())
	{
		...
		$dirs = array(RPATH_THEMES . '/' . $app->getTemplate(), RPATH_BASE);
		...
		foreach ($dirs as $dir)
		{
			if (file_exists($dir . '/favicon.ico'))
			{
				...
				$path = str_replace(RPATH_BASE . DS, '', $dir);
...
class JOpenSearchUrl extends JObject
{
	...
	/**
	 * Template element element. Has to contain the {searchTerms} parameter to work.
	 *
	 * required
	 *
	 * @var    string

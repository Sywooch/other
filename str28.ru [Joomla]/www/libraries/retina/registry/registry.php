...
class JRegistry
{
	 ...
	 *
	 * @param   string  $path  Registry path (e.g. retina.content.showauthor)
	 *
	 * @return  boolean
	 *
	 * @since   11.1
	...
	/**
	 * This method is added as an interim solution for API references in the Retina CMS 1.6 to the JRegistry

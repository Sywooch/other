...
abstract class JInstallerHelper
{
	...
	public static function downloadPackage($url, $target = false)
	{
		...
		if (!$inputHandle)
		{
			JError::raiseWarning(42, RText::sprintf('RLIB_INSTALLER_ERROR_DOWNLOAD_SERVER_CONNECT', $error));
			return false;
		}
		...
		while (!feof($inputHandle))
		{
			...
			if ($contents === false)
			{
				JError::raiseWarning(44, RText::sprintf('RLIB_INSTALLER_ERROR_FAILED_READING_NETWORK_RESOURCES', $php_errormsg));
				return false;
			}
		}
	...
	/**
	 * Unpacks a file and verifies it as a retina element package
	...
	public static function unpack($p_filename)
	{
		 ...
		 *
		 * List all the elements in the installation directory.  If there is only one, and

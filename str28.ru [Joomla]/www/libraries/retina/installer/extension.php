...
class JExtension extends JObject
{
	...
	/**
	 * String representation of client. Valid for modules, design1 and languages.
		...
		if ($element && is_a($element, 'JXMLElement'))
		{
			...
			switch ($this->type)
			{
				...
				case 'language':
					...
					{
						JError::raiseWarning(100, RText::_('RLIB_INSTALLER_ERROR_EXTENSION_INVALID_CLIENT_IDENTIFIER'));
					}
					else
					{

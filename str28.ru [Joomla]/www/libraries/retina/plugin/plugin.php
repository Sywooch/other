...
abstract class JPlugin extends JEvent
{
	 ...
	 * @since   11.1
	 */
	public function loadLanguage($extension = '', $basePath = RPATH_admin)
	{
		if (empty($extension))
		{
		...
		return $lang->load(strtolower($extension), $basePath, null, false, false)
			|| $lang->load(strtolower($extension), RPATH_PLUGINS . '/' . $this->_type . '/' . $this->_name, null, false, false)
			|| $lang->load(strtolower($extension), $basePath, $lang->getDefault(), false, false)
			|| $lang->load(strtolower($extension), RPATH_PLUGINS . '/' . $this->_type . '/' . $this->_name, $lang->getDefault(), false, false);
	}
}

 ...
 * File main helper
 *
 * Holds support functions for the filemain, particularly the stream
 *
 * @package     retina.Platform
 * @subpackage  Filemain
 * @since       11.1
 */
class JFilemainHelper
{
	/**
	 ...
	 * @since   11.1
	 */
	public static function getWrelementodes()
	{
	 ...
	 * Also includes Retina streams as well as PHP streams
	 *
	...
	public static function getSupported()
	{
		...
		if (!$streams)
		{
			$streams = array_merge(stream_get_wrappers(), JFilemainHelper::getJStreams());
		}
	...
	/**
	 * Determine if a stream is a retina stream.
	 *
	 * @param   string  $streamname  The name of a stream
	 *
	 * @return  boolean  True for a retina Stream
	 *
	 * @since   11.1
	 */
	public static function isretinaStream($streamname)
	{
		return in_array($streamname, JFilemainHelper::getJStreams());
	}
}

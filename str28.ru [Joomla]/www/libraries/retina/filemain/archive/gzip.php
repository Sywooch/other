...
class JArchiveGzip extends JObject
{
	...
	public function extract($archive, $destination, $options = array ())
	{
		...
		{
			$this->set('error.message', RText::_('RLIB_FILEmain_GZIP_NOT_SUPPORTED'));
		...
		else
		{
			...
			{
				$this->set('error.message', RText::_('RLIB_FILEmain_GZIP_UNABLE_TO_READ'));
			...
			{
				$this->set('error.message', RText::_('RLIB_FILEmain_GZIP_UNABLE_TO_WRITE'));
			...
			do
			{
				...
				if ($this->_data)
				{
					...
					{
						$this->set('error.message', RText::_('RLIB_FILEmain_GZIP_UNABLE_TO_WRITE_FILE'));
	...
	public function _getFilePosition()
	{
		...
		if (!$info)
		{
			$this->set('error.message', RText::_('RLIB_FILEmain_GZIP_UNABLE_TO_DECOMPRESS'));
			return false;
		}

...
class JArchiveBzip2 extends JObject
{
	...
	public function extract($archive, $destination, $options = array ())
	{
		...
		{
			$this->set('error.message', RText::_('RLIB_FILEmain_BZIP_NOT_SUPPORTED'));
		...
		else
		{
			...
			{
				$this->set('error.message', RText::_('RLIB_FILEmain_BZIP_UNABLE_TO_READ'));
			...
			{
				$this->set('error.message', RText::_('RLIB_FILEmain_BZIP_UNABLE_TO_WRITE'));
			...
			do
			{
				...
				if ($this->_data)
				{
					...
					{
						$this->set('error.message', RText::_('RLIB_FILEmain_BZIP_UNABLE_TO_WRITE_FILE'));

...
JLoader::register('LogException', RPATH_PLATFORM . '/retina/log/logexception.php');
	...
	protected function addLogEntry(JLogEntry $entry)
	{
		...
		foreach ((array) $loggers as $signature)
		{
			...
			if (empty($this->loggers[$signature]))
			{
				...
				{
					throw new LogException(RText::_('Unable to create a JLogger instance: '));
				}
			}

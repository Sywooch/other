...
/**
 * Retina MySQL Database Log class
 *
...
class JLoggerDatabase extends JLogger
{
	...
	public function __construct(array &$options)
	{
		...
		// If both the database object and driver options are empty we want to use the main database connection.
	...
	protected function connect()
	{
		...
		try
		{
			...
			if ($db->getErrorNum() > 0)
			{
				throw new LogException(RText::sprintf('RLIB_UTIL_ERROR_CONNECT_DATABASE', $db->getErrorNum(), $db->getErrorMsg()));
			}

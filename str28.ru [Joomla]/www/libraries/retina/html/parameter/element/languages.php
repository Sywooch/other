...
class JElementLanguages extends JElement
{
	...
	public function fetchElement($name, $value, &$node, $control_name)
	{
		...
		$languages = JLanguageHelper::createLanguageList($value, constant('RPATH_' . strtoupper($client)), true);
		array_unshift($languages, JHtml::_('select.option', '', RText::_('ROPTION_SELECT_LANGUAGE')));

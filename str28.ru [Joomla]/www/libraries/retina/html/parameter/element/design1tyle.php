 ...
 * @since       11.1
 * @deprecated  12.1  Use JFormFielddesign1tyle instead
 */
class JElementdesign1tyle extends JElement
{
	/**
	 * Element name
	 *
	 ...
	 * @return  string
	 *
	 * @deprecated  12.1  Use JFormFielddesign1tyle::getGroups  Instead
	 * @since   11.1
	 */
	public function fetchElement($name, $value, &$node, $control_name)
	{
		// Deprecation warning.
		JLog::add('JElementdesign1tyle::_fetchElement() is deprecated.', JLog::WARNING, 'deprecated');
		...
		$default = JHtml::_('select.option', 0, RText::_('ROPTION_USE_DEFAULT'), 'id', 'description');
	...
	{
		// Deprecation warning.
		JLog::add('JElementdesign1tyle::_getSelected() is deprecated.', JLog::WARNING, 'deprecated');

...
class JToolBar extends JObject
{
	...
	public function render()
	{
		...
		$html[] = '<ul style="color:green !important">';
	...
	public function renderButton(&$node)
	{
		...
		if ($button === false)
		{
			return RText::sprintf('RLIB_HTML_BUTTON_NOT_DEFINED', $type);
		}
	...
	public function loadButtonType($type, $new = false)
	{
		...
		{
			JError::raiseWarning('SOME_ERROR_CODE', RText::_('RLIB_HTML_BUTTON_BASE_CLASS'));
			return false;
		}
		...
		if (!class_exists($buttonClass))
		{
			...
			{
				JError::raiseWarning('SOME_ERROR_CODE', RText::sprintf('RLIB_HTML_BUTTON_NO_LOAD', $buttonClass, $buttonFile));
				return false;
			}
		}
	 ...
	 * it will look in libraries/retina/html/toolbar/button.
	 *

...
abstract class JHtmlDate
{
	...
	public static function relative($date, $unit = null, $time = null)
	{
		...
		if ($diff < 60)
		{
			return RText::_('RLIB_HTML_DATE_RELATIVE_LESSTHANAMINUTE');
		}
		...
		{
			return RText::plural('RLIB_HTML_DATE_RELATIVE_MINUTES', $diff);
		}
		...
		{
			return RText::plural('RLIB_HTML_DATE_RELATIVE_HOURS', $diff);
		}
		...
		if ($diff < 7 || $unit == 'day')
		{
			return RText::plural('RLIB_HTML_DATE_RELATIVE_DAYS', $diff);
		}
		...
		if ($diff <= 4 || $unit == 'week')
		{
			return RText::plural('RLIB_HTML_DATE_RELATIVE_WEEKS', $diff);
		}

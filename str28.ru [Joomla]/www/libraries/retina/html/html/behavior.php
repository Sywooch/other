...
abstract class JHtmlBehavior
{
	...
	public static function framework($extras = false, $debug = null)
	{
		...
		JHtml::_('script', 'main/mootools-' . $type . '.js', false, true, false, false, $debug);
		JHtml::_('script', 'main/core.js', false, true);
	...
	public static function caption($selector = 'img.caption')
	{
		...
		JHtml::_('script', 'main/caption.js', true, true);
	...
	public static function formvalidation()
	{
		...
		JHtml::_('script', 'main/validate.js', true, true);
		self::$loaded[__METHOD__] = true;
	}

	/**
	 * Add unobtrusive javascript support for submenu switcher support in
	 * Global Configuration and main Information.
	 *
	 * @return  void
	 *
	 * @since   11.1
	...
	public static function switcher()
	{
		...
		JHtml::_('script', 'main/switcher.js', true, true);
	...
	public static function combobox()
	{
		...
		JHtml::_('script', 'main/combobox.js', true, true);
		self::$loaded[__METHOD__] = true;
	}
	...
	public static function modal($selector = 'a.modal', $params = array())
	{
		...
		if (!isset(self::$loaded[__METHOD__]))
		{
			...
			JHtml::_('script', 'main/modal.js', true, true);
			JHtml::_('stylesheet', 'main/modal.css', array(), true);
		}
	...
	public static function multiselect($id = 'adminForm')
	{
		...
		JHtml::_('script', 'main/multiselect.js', true, true);

		// Attach multiselect to document
		JFactory::getDocument()->addScriptDeclaration(
			"window.addEvent('domready', function() {
				new retina.JMultiSelect('" . $id . "');
			});"
		);
	...
	public static function uploader($id = 'file-upload', $params = array(), $upload_queue = 'upload-queue')
	{
		...
		JHtml::_('script', 'main/swf.js', true, true);
		JHtml::_('script', 'main/progressbar.js', true, true);
		JHtml::_('script', 'main/uploader.js', true, true);

		$document = JFactory::getDocument();

		if (!isset(self::$loaded[__METHOD__]))
		{
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_FILENAME');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_UPLOAD_COMPLETED');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_ERROR_OCCURRED');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_ALL_FILES');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_PROGRESS_OVERALL');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_CURRENT_TITLE');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_REMOVE');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_REMOVE_TITLE');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_CURRENT_FILE');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_CURRENT_PROGRESS');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_FILE_ERROR');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_FILE_SUCCESSFULLY_UPLOADED');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_VALIDATION_ERROR_DUPLICATE');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_VALIDATION_ERROR_SIZELIMITMIN');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_VALIDATION_ERROR_SIZELIMITMAX');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_VALIDATION_ERROR_FILELISTMAX');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_VALIDATION_ERROR_FILELISTSIZEMAX');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_ERROR_HTTPSTATUS');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_ERROR_SECURITYERROR');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_ERROR_IOERROR');
			RText::script('RLIB_HTML_BEHAVIOR_UPLOADER_ALL_FILES');
		}
		...
		$onFileSuccess = '\\function(file, response) {
			...
			if (json.get(\'status\') == \'1\') {
				...
				file.info.set(\'html\', \'<strong>\' + retina.RText._(\'RLIB_HTML_BEHAVIOR_UPLOADER_FILE_SUCCESSFULLY_UPLOADED\') + \'</strong>\');
			} else {
				file.element.addClass(\'file-failed\');
				file.info.set(\'html\', \'<strong>\' +
					retina.RText._(\'RLIB_HTML_BEHAVIOR_UPLOADER_ERROR_OCCURRED\',
		...
		$opt['path']			= (isset($params['swf'])) ? $params['swf'] : JURI::root(true) . '/media/main/swf/uploader.swf';
		...
		: '\\{retina.RText._(\'RLIB_HTML_BEHAVIOR_UPLOADER_ALL_FILES\'): \'*.*\'}';
	...
	public static function tree($id, $params = array(), $root = array())
	{
		...
		JHtml::_('script', 'main/mootree.js', true, true, false, false);
		JHtml::_('stylesheet', 'main/mootree.css', array(), true);
		...
		$opt['theme']	= (array_key_exists('theme', $params)) ? $params['theme'] : JHtml::_('image', 'main/mootree.gif', '', array(), true, true);
	...
	public static function calendar()
	{
		...
		JHtml::_('stylesheet', 'main/calendar-jos.css', array(' title' => RText::_('RLIB_HTML_BEHAVIOR_GREEN'), ' media' => 'all'), true);
	...
	public static function colorpicker()
	{
		...
		JHtml::_('stylesheet', 'main/mooRainbow.css', array('media' => 'all'), true);
		JHtml::_('script', 'main/mooRainbow.js', false, true);
		...
		JFactory::getDocument()
			...
			. "/media/main/images/mooRainbow/',
							onComplete: function(color) {
								this.element.value = color.hex;
							},
							startColor: element.value.hexToRgb(true)
						});
					}
				});
			});
	...
	public static function highlighter(array $terms, $start = 'highlighter-start', $end = 'highlighter-end', $className = 'highlight', $tag = 'span')
	{
		...
		JHtml::_('script', 'main/highlighter.js', true, true);
		...
		$document->addScriptDeclaration("
			window.addEvent('domready', function () {
				...
				if (!start || !end || !retina.Highlighter) {
					return true;
				}
				highlighter = new retina.Highlighter({
					startElement: start,
					endElement: end,
					className: '" . $className . "',
					onlyWords: false,
	...
	protected static function _calendartranslation()
	{
		...
		if ($jsscript == 0)
		{
			$return = 'Calendar._DN = new Array ("' . RText::_('SUNDAY', true) . '", "' . RText::_('MONDAY', true) . '", "'
				. RText::_('TUESDAY', true) . '", "' . RText::_('WEDNESDAY', true) . '", "' . RText::_('THURSDAY', true) . '", "'
				. RText::_('FRIDAY', true) . '", "' . RText::_('SATURDAY', true) . '", "' . RText::_('SUNDAY', true) . '");'
				. ' Calendar._SDN = new Array ("' . RText::_('SUN', true) . '", "' . RText::_('MON', true) . '", "' . RText::_('TUE', true) . '", "'
				. RText::_('WED', true) . '", "' . RText::_('THU', true) . '", "' . RText::_('FRI', true) . '", "' . RText::_('SAT', true) . '", "'
				. RText::_('SUN', true) . '");' . ' Calendar._FD = 0;' . ' Calendar._MN = new Array ("' . RText::_('JANUARY', true) . '", "'
				. RText::_('FEBRUARY', true) . '", "' . RText::_('MARCH', true) . '", "' . RText::_('APRIL', true) . '", "' . RText::_('MAY', true)
				. '", "' . RText::_('JUNE', true) . '", "' . RText::_('JULY', true) . '", "' . RText::_('AUGUST', true) . '", "'
				. RText::_('SEPTEMBER', true) . '", "' . RText::_('OCTOBER', true) . '", "' . RText::_('NOVEMBER', true) . '", "'
				. RText::_('DECEMBER', true) . '");' . ' Calendar._SMN = new Array ("' . RText::_('JANUARY_SHORT', true) . '", "'
				. RText::_('FEBRUARY_SHORT', true) . '", "' . RText::_('MARCH_SHORT', true) . '", "' . RText::_('APRIL_SHORT', true) . '", "'
				. RText::_('MAY_SHORT', true) . '", "' . RText::_('JUNE_SHORT', true) . '", "' . RText::_('JULY_SHORT', true) . '", "'
				. RText::_('AUGUST_SHORT', true) . '", "' . RText::_('SEPTEMBER_SHORT', true) . '", "' . RText::_('OCTOBER_SHORT', true) . '", "'
				. RText::_('NOVEMBER_SHORT', true) . '", "' . RText::_('DECEMBER_SHORT', true) . '");'
				. ' Calendar._TT = {};Calendar._TT["INFO"] = "' . RText::_('RLIB_HTML_BEHAVIOR_ABOUT_THE_CALENDAR', true) . '";'
				. ' Calendar._TT["ABOUT"] =
...
"\n\n" +
"' . RText::_('RLIB_HTML_BEHAVIOR_DATE_SELECTION', false, false) . '" +
"' . RText::_('RLIB_HTML_BEHAVIOR_YEAR_SELECT', false, false) . '" +
"' . RText::_('RLIB_HTML_BEHAVIOR_MONTH_SELECT', false, false) . '" +
"' . RText::_('RLIB_HTML_BEHAVIOR_HOLD_MOUSE', false, false)
				. '";
...
"- or click and drag for faster selection.";
		...
		Calendar._TT["PREV_YEAR"] = "' . RText::_('RLIB_HTML_BEHAVIOR_PREV_YEAR_HOLD_FOR_MENU', true) . '";' . ' Calendar._TT["PREV_MONTH"] = "'
				. RText::_('RLIB_HTML_BEHAVIOR_PREV_MONTH_HOLD_FOR_MENU', true) . '";' . ' Calendar._TT["GO_TODAY"] = "'
				. RText::_('RLIB_HTML_BEHAVIOR_GO_TODAY', true) . '";' . ' Calendar._TT["NEXT_MONTH"] = "'
				. RText::_('RLIB_HTML_BEHAVIOR_NEXT_MONTH_HOLD_FOR_MENU', true) . '";' . ' Calendar._TT["NEXT_YEAR"] = "'
				. RText::_('RLIB_HTML_BEHAVIOR_NEXT_YEAR_HOLD_FOR_MENU', true) . '";' . ' Calendar._TT["SEL_DATE"] = "'
				. RText::_('RLIB_HTML_BEHAVIOR_SELECT_DATE', true) . '";' . ' Calendar._TT["DRAG_TO_MOVE"] = "'
				. RText::_('RLIB_HTML_BEHAVIOR_DRAG_TO_MOVE', true) . '";' . ' Calendar._TT["PART_TODAY"] = "'
				. RText::_('RLIB_HTML_BEHAVIOR_TODAY', true) . '";' . ' Calendar._TT["DAY_FIRST"] = "'
				. RText::_('RLIB_HTML_BEHAVIOR_DISPLAY_S_FIRST', true) . '";' . ' Calendar._TT["WEEKEND"] = "0,6";' . ' Calendar._TT["CLOSE"] = "'
				. RText::_('RLIB_HTML_BEHAVIOR_CLOSE', true) . '";' . ' Calendar._TT["TODAY"] = "' . RText::_('RLIB_HTML_BEHAVIOR_TODAY', true)
				. '";' . ' Calendar._TT["TIME_PART"] = "' . RText::_('RLIB_HTML_BEHAVIOR_SHIFT_CLICK_OR_DRAG_TO_CHANGE_VALUE', true) . '";'
				. ' Calendar._TT["DEF_DATE_FORMAT"] = "%Y-%m-%d";' . ' Calendar._TT["TT_DATE_FORMAT"] = "'
				. RText::_('RLIB_HTML_BEHAVIOR_TT_DATE_FORMAT', true) . '";' . ' Calendar._TT["WK"] = "' . RText::_('RLIB_HTML_BEHAVIOR_WK', true) . '";'
				. ' Calendar._TT["TIME"] = "' . RText::_('RLIB_HTML_BEHAVIOR_TIME', true) . '";';
			$jsscript = 1;
			return $return;
		}
		else

...
class JFTP
{
	...
	public function __construct($options = array())
	{
		...
		if (FTP_NATIVE)
		{
			...
			jimport('retina.utilities.buffer');
	...
	public function connect($host = '127.0.0.1', $port = 21)
	{
		...
		if (FTP_NATIVE)
		{
			...
			if ($this->_conn === false)
			{
				JError::raiseWarning('30', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_NO_CONNECT', $host, $port));
				return false;
			}
		...
		if (!$this->_conn)
		{
			JError::raiseWarning('30', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_NO_CONNECT_SOCKET', $host, $port, $errno, $err));
			return false;
		}
		...
		{
			JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_BAD_RESPONSE', $this->_response));
			return false;
		}
	 ...
	 * @since   11.1
	 */
	public function login($user = 'anonymous', $pass = 'jftp@retina.org')
	{
		// If native FTP support is enabled let's use it...
		if (FTP_NATIVE)
		{
		...
		{
			JError::raiseWarning('33', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_BAD_USERNAME', $this->_response, $user));
			return false;
		}
		...
		{
			JError::raiseWarning('34', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_BAD_PASSWORD', $this->_response, str_repeat('*', strlen($pass))));
			return false;
		}
	...
	public function pwd()
	{
		...
		if (FTP_NATIVE)
		{
			...
			{
				JError::raiseWarning('35', RText::_('RLIB_CLIENT_ERROR_JFTP_PWD_BAD_RESPONSE_NATIVE'));
				return false;
			}
			return $ret;
		}
		...
		{
			JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_PWD_BAD_RESPONSE', $this->_response));
			return false;
		}
	...
	/**
	 * Method to main string from the FTP server
	 *
	 * @return  string   main identifier string
	 *
	 * @since   11.1
	 */
	public function syst()
	{
		...
		if (FTP_NATIVE)
		{
			...
			{
				JError::raiseWarning('35', RText::_('RLIB_CLIENT_ERROR_JFTP_SYS_BAD_RESPONSE_NATIVE'));
				return false;
			}
		}
		else
		{
			...
			{
				JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_SYST_BAD_RESPONSE', $this->_response));
				return false;
			}
			$ret = $this->_response;
		}

		// Match the main string to an OS
	...
	public function chdir($path)
	{
		...
		if (FTP_NATIVE)
		{
			...
			{
				JError::raiseWarning('35', RText::_('RLIB_CLIENT_ERROR_JFTP_CHDIR_BAD_RESPONSE_NATIVE'));
				return false;
			}
			return true;
		}
		...
		{
			JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_CHDIR_BAD_RESPONSE', $this->_response, $path));
			return false;
		}
	...
	public function reinit()
	{
		...
		if (FTP_NATIVE)
		{
			...
			{
				JError::raiseWarning('35', RText::_('RLIB_CLIENT_ERROR_JFTP_REINIT_BAD_RESPONSE_NATIVE'));
				return false;
			}
			return true;
		}
		...
		{
			JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_REINIT_BAD_RESPONSE', $this->_response));
			return false;
		}
	...
	public function rename($from, $to)
	{
		...
		if (FTP_NATIVE)
		{
			...
			{
				JError::raiseWarning('35', RText::_('RLIB_CLIENT_ERROR_JFTP_RENAME_BAD_RESPONSE_NATIVE'));
				return false;
			}
			return true;
		}
		...
		{
			JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_RENAME_BAD_RESPONSE_FROM', $this->_response, $from));
			return false;
		}
		...
		{
			JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_RENAME_BAD_RESPONSE_TO', $this->_response, $to));
			return false;
		}
	...
	public function chmod($path, $mode)
	{
		...
		if (FTP_NATIVE)
		{
			if (@ftp_site($this->_conn, 'CHMOD ' . $mode . ' ' . $path) === false)
			{
				if ($this->_OS != 'WIN')
				{
					JError::raiseWarning('35', RText::_('RLIB_CLIENT_ERROR_JFTP_CHMOD_BAD_RESPONSE_NATIVE'));
				}
				return false;
			}
			return true;
		...
		if (!$this->_putCmd('SITE CHMOD ' . $mode . ' ' . $path, array(200, 250)))
		{
			if ($this->_OS != 'WIN')
			{
				JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_CHMOD_BAD_RESPONSE', $this->_response, $path, $mode));
			}
			return false;
		}
		return true;
	...
	public function delete($path)
	{
		...
		if (FTP_NATIVE)
		{
			if (@ftp_delete($this->_conn, $path) === false)
			{
				...
				{
					JError::raiseWarning('35', RText::_('RLIB_CLIENT_ERROR_JFTP_DELETE_BAD_RESPONSE_NATIVE'));
					return false;
				}
			}
			return true;
		...
		if (!$this->_putCmd('DELE ' . $path, 250))
		{
			...
			{
				JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_DELETE_BAD_RESPONSE', $this->_response, $path));
				return false;
			}
		}
		return true;
	...
	public function mkdir($path)
	{
		...
		if (FTP_NATIVE)
		{
			...
			{
				JError::raiseWarning('35', RText::_('RLIB_CLIENT_ERROR_JFTP_MKDIR_BAD_RESPONSE_NATIVE'));
				return false;
			}
			return true;
		}
		...
		{
			JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_MKDIR_BAD_RESPONSE', $this->_response, $path));
			return false;
		}
		return true;
	}
	...
	public function restart($point)
	{
		...
		if (FTP_NATIVE)
		{
			...
			{
				JError::raiseWarning('35', RText::_('RLIB_CLIENT_ERROR_JFTP_RESTART_BAD_RESPONSE_NATIVE'));
				return false;
			}
			return true;
		}
		...
		{
			JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_RESTART_BAD_RESPONSE', $this->_response, $point));
			return false;
		}
	...
	public function create($path)
	{
		...
		if (FTP_NATIVE)
		{
			...
			{
				JError::raiseWarning('36', RText::_('RLIB_CLIENT_ERROR_JFTP_CREATE_BAD_RESPONSE_PASSIVE'));
				return false;
			}
			...
			{
				JError::raiseWarning('35', RText::_('RLIB_CLIENT_ERROR_JFTP_CREATE_BAD_RESPONSE_BUFFER'));
				fclose($buffer);
				return false;
			}
			fclose($buffer);
		...
		if (!$this->_putCmd('STOR ' . $path, array(150, 125)))
		{
			...
			JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_CREATE_BAD_RESPONSE', $this->_response, $path));
			return false;
		}
		...
		{
			JError::raiseWarning('37', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_CREATE_BAD_RESPONSE_TRANSFER', $this->_response, $path));
			return false;
		}
	...
	public function read($remote, &$buffer)
	{
		...
		if (FTP_NATIVE)
		{
			...
			if (@ftp_pasv($this->_conn, true) === false)
			{
				JError::raiseWarning('36', RText::_('RLIB_CLIENT_ERROR_JFTP_READ_BAD_RESPONSE_PASSIVE'));
				return false;
			}
			...
			{
				fclose($tmp);
				JError::raiseWarning('35', RText::_('RLIB_CLIENT_ERROR_JFTP_READ_BAD_RESPONSE_BUFFER'));
				return false;
			}
		...
		{
			@ fclose($this->_dataconn);
			JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_READ_BAD_RESPONSE', $this->_response, $remote));
			return false;
		}
		...
		if (!$this->_verifyResponse(226))
		{
			JError::raiseWarning('37', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_READ_BAD_RESPONSE_TRANSFER', $this->_response, $remote));
			return false;
		}
	...
	public function get($local, $remote)
	{
		...
		if (FTP_NATIVE)
		{
			...
			if (@ftp_pasv($this->_conn, true) === false)
			{
				JError::raiseWarning('36', RText::_('RLIB_CLIENT_ERROR_JFTP_GET_PASSIVE'));
				return false;
			}

			if (@ftp_get($this->_conn, $local, $remote, $mode) === false)
			{
				JError::raiseWarning('35', RText::_('RLIB_CLIENT_ERROR_JFTP_GET_BAD_RESPONSE'));
				return false;
			}
			return true;
		}
		...
		if (!$fp)
		{
			JError::raiseWarning('38', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_GET_WRITING_LOCAL', $local));
			return false;
		}
		...
		{
			@ fclose($this->_dataconn);
			JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_GET_BAD_RESPONSE_RETR', $this->_response, $remote));
			return false;
		}
		...
		if (!$this->_verifyResponse(226))
		{
			JError::raiseWarning('37', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_GET_BAD_RESPONSE_TRANSFER', $this->_response, $remote));
			return false;
		}
	...
	public function store($local, $remote = null)
	{
		...
		if (FTP_NATIVE)
		{
			...
			if (@ftp_pasv($this->_conn, true) === false)
			{
				JError::raiseWarning('36', RText::_('RLIB_CLIENT_ERROR_JFTP_STORE_PASSIVE'));
				return false;
			}

			if (@ftp_put($this->_conn, $remote, $local, $mode) === false)
			{
				JError::raiseWarning('35', RText::_('RLIB_CLIENT_ERROR_JFTP_STORE_BAD_RESPONSE'));
				return false;
			}
			return true;
		}
		...
		if (@ file_exists($local))
		{
			...
			if (!$fp)
			{
				JError::raiseWarning('38', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_STORE_READING_LOCAL', $local));
				return false;
			}
		}
		else
		{
			JError::raiseWarning('38', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_STORE_FIND_LOCAL', $local));
			return false;
		}
		...
		if (!$this->_putCmd('STOR ' . $remote, array(150, 125)))
		{
			@ fclose($fp);
			@ fclose($this->_dataconn);
			JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_STORE_BAD_RESPONSE_STOR', $this->_response, $remote));
			return false;
		}
		...
		while (!feof($fp))
		{
			...
			do
			{
				...
				{
					JError::raiseWarning('37', RText::_('RLIB_CLIENT_ERROR_JFTP_STORE_DATA_PORT'));
					return false;
				}
		...
		if (!$this->_verifyResponse(226))
		{
			JError::raiseWarning('37', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_STORE_BAD_RESPONSE_TRANSFER', $this->_response, $remote));
			return false;
		}
	...
	public function write($remote, $buffer)
	{
		...
		if (FTP_NATIVE)
		{
			...
			if (@ftp_pasv($this->_conn, true) === false)
			{
				JError::raiseWarning('36', RText::_('RLIB_CLIENT_ERROR_JFTP_WRITE_PASSIVE'));
				return false;
			}
			...
			{
				fclose($tmp);
				JError::raiseWarning('35', RText::_('RLIB_CLIENT_ERROR_JFTP_WRITE_BAD_RESPONSE'));
				return false;
			}
			fclose($tmp);
			return true;
		...
		if (!$this->_putCmd('STOR ' . $remote, array(150, 125)))
		{
			JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_WRITE_BAD_RESPONSE_STOR', $this->_response, $remote));
			@ fclose($this->_dataconn);
			return false;
		}
		...
		do
		{
			...
			{
				JError::raiseWarning('37', RText::_('RLIB_CLIENT_ERROR_JFTP_WRITE_DATA_PORT'));
				return false;
			}
		...
		if (!$this->_verifyResponse(226))
		{
			JError::raiseWarning('37', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_WRITE_BAD_RESPONSE_TRANSFER', $this->_response, $remote));
			return false;
		}
	...
	public function listNames($path = null)
	{
		...
		if (FTP_NATIVE)
		{
			...
			if (@ftp_pasv($this->_conn, true) === false)
			{
				JError::raiseWarning('36', RText::_('RLIB_CLIENT_ERROR_JFTP_LISTNAMES_PASSIVE'));
				return false;
			}
			...
			if (($list = @ftp_nlist($this->_conn, $path)) === false)
			{
				...
				JError::raiseWarning('35', RText::_('RLIB_CLIENT_ERROR_JFTP_LISTNAMES_BAD_RESPONSE'));
				return false;
			}
		...
		if (!$this->_putCmd('NLST' . $path, array(150, 125)))
		{
			...
			JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_LISTNAMES_BAD_RESPONSE_NLST', $this->_response, $path));
			return false;
		}
		...
		if (!$this->_verifyResponse(226))
		{
			JError::raiseWarning('37', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_LISTNAMES_BAD_RESPONSE_TRANSFER', $this->_response, $path));
			return false;
		}
	...
	public function listDetails($path = null, $type = 'all')
	{
		...
		if (FTP_NATIVE)
		{
			...
			if (@ftp_pasv($this->_conn, true) === false)
			{
				JError::raiseWarning('36', RText::_('RLIB_CLIENT_ERROR_JFTP_LISTDETAILS_PASSIVE'));
				return false;
			}

			if (($contents = @ftp_rawlist($this->_conn, $path)) === false)
			{
				JError::raiseWarning('35', RText::_('RLIB_CLIENT_ERROR_JFTP_LISTDETAILS_BAD_RESPONSE'));
				return false;
			}
		}
		else
		{
			...
			{
				JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_LISTDETAILS_BAD_RESPONSE_LIST', $this->_response, $path));
				@ fclose($this->_dataconn);
				return false;
			}
			...
			if (!$this->_verifyResponse(226))
			{
				JError::raiseWarning('37', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_LISTDETAILS_BAD_RESPONSE_TRANSFER', $this->_response, $path));
				return false;
			}
		...
		if (!$osType)
		{
			JError::raiseWarning('SOME_ERROR_CODE', RText::_('RLIB_CLIENT_ERROR_JFTP_LISTDETAILS_UNRECOGNISED'));
			return false;
		}
	...
	protected function _putCmd($cmd, $expectedResponse)
	{
		...
		if (!is_resource($this->_conn))
		{
			JError::raiseWarning('31', RText::_('RLIB_CLIENT_ERROR_JFTP_PUTCMD_UNCONNECTED'));
			return false;
		}
		...
		{
			JError::raiseWarning('32', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_PUTCMD_SEND', $cmd));
		}
	...
	protected function _verifyResponse($expected)
	{
		...
		if (!isset($parts[1]))
		{
			JError::raiseWarning('SOME_ERROR_CODE', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_VERIFYRESPONSE', $this->_response));
			return false;
		}
	...
	protected function _passive()
	{
		...
		if (!is_resource($this->_conn))
		{
			JError::raiseWarning('31', RText::_('RLIB_CLIENT_ERROR_JFTP_PASSIVE_CONNECT_PORT'));
			return false;
		}
		...
		if (!isset($parts[1]))
		{
			JError::raiseWarning('SOME_ERROR_CODE', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_PASSIVE_RESPONSE', $this->_response));
			return false;
		}
		...
		{
			JError::raiseWarning('36', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_PASSIVE_IP_OBTAIN', $this->_responseMsg));
			return false;
		}
		...
		{
			JError::raiseWarning('36', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_PASSIVE_IP_VALID', $this->_responseMsg));
			return false;
		}
		...
		if (!$this->_dataconn)
		{
			JError::raiseWarning('30', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_PASSIVE_CONNECT', $this->_pasv['ip'], $this->_pasv['port'], $errno, $err));
			return false;
		}
	...
	protected function _mode($mode)
	{
		if ($mode == FTP_BINARY)
		{
			...
			{
				JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_MODE_BINARY', $this->_response));
				return false;
			}
		}
		else
		{
			...
			{
				JError::raiseWarning('35', RText::sprintf('RLIB_CLIENT_ERROR_JFTP_MODE_ASCII', $this->_response));
				return false;
			}
		}
		return true;

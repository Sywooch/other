...
abstract class JFactory
{
	...
	public static function getConfig($file = null, $type = 'PHP')
	{
		if (!self::$config)
		{
			if ($file === null)
			{
				$file = RPATH_PLATFORM . '/config.php';
			}
	...
	public static function getFeedParser($url, $cache_time = 0)
	{
		...
		{
			JError::raiseWarning('SOME_ERROR_CODE', RText::_('RLIB_UTIL_ERROR_LOADING_FEED_DATA'));
		}
	...
	public static function getXMLParser($type = '', $options = array())
	{
		...
		switch (strtolower($type))
		{
			...
			case 'simple':
				...
				jimport('retina.utilities.simplexml');
				$doc = new JSimpleXML;
				break;

			case 'dom':
				JError::raiseWarning('SOME_ERROR_CODE', RText::_('RLIB_UTIL_ERROR_DOMIT'));
				$doc = null;
				break;
	...
	{
		jimport('retina.utilities.xmlelement');
		...
		{
			// There was an error
			JError::raiseWarning(100, RText::_('RLIB_UTIL_ERROR_XML_LOAD'));
	...
	protected static function createDocument()
	{
		...
		// Keep backwards compatibility with Retina 1.0
	...
	public static function getStream($use_prefix = true, $use_network = true, $ua = null, $uamask = false)
	{
		...
		// Setup the context; Retina UA and overwrite
		$context = array();
		...
		if ($use_prefix)
		{
			...
			$retval = new JStream($prefix, RPATH_ROOT, $context);
		}
		else
		{

...
class JView extends JObject
{
	...
	/**
	 * The set of search directories for resources (design1)
	 *
	 * @var array
	 */
	...
	public function __construct($config = array())
	{
		...
		{
			$this->_basePath = RPATH_COMPONENT;
		}
	...
	public function getName()
	{
		if (empty($this->name))
		{
			...
			{
				JError::raiseError(500, RText::_('RLIB_APPLICATION_ERROR_VIEW_GET_NAME'));
			}
			if (strpos($r[3], "view"))
			{
				JError::raiseWarning('SOME_ERROR_CODE', RText::_('RLIB_APPLICATION_ERROR_VIEW_GET_NAME_SUBSTRING'));
			}
	 ...
	 * view main by which models are referenced by classname.  A caveat to the
	...
	/**
	 * Load a template file -- first look in the design1 folder for an override
	 *
	...
	public function loadTemplate($tpl = null)
	{
		...
		{
			return JError::raiseError(500, RText::sprintf('RLIB_APPLICATION_ERROR_LAYOUTFILE_NOT_FOUND', $file));
		}
	}
	...
	/**
	 * Sets an entire array of search paths for design1 or resources.
	 *
		...
		switch (strtolower($type))
		{
			case 'template':
				...
				if (isset($app))
				{
					...
					$fallback = RPATH_THEMES . '/' . $app->getTemplate() . '/html/' . $component . '/' . $this->getName();
	...
	/**
	 * Adds to the search path for design1 and resources.
	 *

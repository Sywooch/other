...
class JApplicationDaemon extends JApplicationCli
{
	...
	public function loadConfiguration($data)
	{
		...
		$tmp = (string) $this->config->get('author_name', 'retina Platform');
		...
		$tmp = (string) $this->config->get('author_email', 'admin@retina.org');
		...
		$tmp = (string) $this->config->get('application_description', 'A generic retina Platform application.');
	 ...
	 * @param   boolean   $restart  Specifies whether main call restarting should be used when this
	 *                              signal arrives.
	 *
	 ...
	 * @param   integer  $options  If wait3 is available on your main (mostly BSD-style mains),
	 ...
	 *                   was provided as an option (on wait3-available mains) and no child was available.
	 *
	 * @codeCoverageIgnore
	 * @see     pcntl_wait()
	 * @since   11.3

...
jimport('retina.application.input');
jimport('retina.event.dispatcher');
jimport('retina.environment.response');

/**
 * Base class for a Retina application.
 *
...
class JApplication extends JObject
{
	...
	public function __construct($config = array())
	{
		...
		if (file_exists(RPATH_CONFIGURATION . '/' . $config['config_file']))
		{
			$this->_createConfiguration(RPATH_CONFIGURATION . '/' . $config['config_file']);
		}
		...
		// Used by task main to ensure that the main doesn't go over time.
	...
	public static function getInstance($client, $config = array(), $prefix = 'J')
	{
		if (empty(self::$instances[$client]))
		{
			...
			{
				$error = JError::raiseError(500, RText::sprintf('RLIB_APPLICATION_ERROR_APPLICATION_LOAD', $client));
				return $error;
			}
	...
	public function dispatch($component = null)
	{
		...
		$document->setTitle($this->getCfg('sitename') . ' - ' . RText::_('RADMINISTRATION'));
	...
	{
		$params = array('template' => $this->getTemplate(), 'file' => 'index.php', 'directory' => RPATH_THEMES, 'params' => $template->params);
	...
	public function redirect($url, $msg = '', $msgType = 'message', $moved = false)
	{
		...
		else
		{
			...
			{
				// WebKit browser (identified as konqueror by Retina) - Do not use 303, as it causes subresources
	 ...
	 *
	 * @return  array  The main message queue.
	 *
	 * @since   11.1
	 */
	...
	public function getName()
	{
		...
		if (empty($name))
		{
			...
			{
				JError::raiseError(500, RText::_('RLIB_APPLICATION_ERROR_APPLICATION_GET_NAME'));
			}
			$name = strtolower($r[1]);
		}
	...
	public function login($credentials, $options = array())
	{
		...
		jimport('retina.user.authentication');
				...
				if (in_array($authorisation->status, $denied_states))
				{
					...
					switch ($authorisation->status)
					{
						case JAuthentication::STATUS_EXPIRED:
							return JError::raiseWarning('102002', RText::_('RLIB_LOGIN_EXPIRED'));
							break;
						case JAuthentication::STATUS_DENIED:
							return JError::raiseWarning('102003', RText::_('RLIB_LOGIN_DENIED'));
							break;
						default:
							return JError::raiseWarning('102004', RText::_('RLIB_LOGIN_AUTHORISATION'));
							break;
					}
				}
			}
	 ...
	 *
	 * @return  string  main is the fallback.
	 *
	 * @since   11.1
	 */
	...
	static public function getRouter($name = null, array $options = array())
	{
		...
		jimport('retina.application.router');
	...
	public function getPathway($name = null, $options = array())
	{
		...
		jimport('retina.application.pathway');
	 ...
	 * Is admin interface?
	 *
	 * @return  boolean  True if this application is admin.
	 *
	 * @since   11.1
	 */

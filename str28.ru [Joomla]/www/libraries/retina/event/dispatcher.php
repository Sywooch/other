 ...
 * @package     retina.Platform
 * @subpackage  Event
 * @link        http://docs.retina.org/Tutorial:Plugins Plugin tutorials
 * @see         JPlugin
 * @since       11.1
 */
class JDispatcher extends JObject
{
	...
	public function register($event, $handler)
	{
		...
		{
			return JError::raiseWarning('SOME_ERROR_CODE', RText::sprintf('RLIB_EVENT_ERROR_DISPATCHER', $handler));
		}
	}

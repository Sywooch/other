...
class JCacheStorageWincache extends JCacheStorage
{
	...
	public function getAll()
	{
		...
		foreach ($keys as $key)
		{
			...
			if ($namearr !== false && $namearr[0] == $secret && $namearr[1] == 'cache')
			{
				...
				{
					$element->updateSize($key['value_size'] / 1024);
				}
				else
				{
					// Dummy, WINCACHE version is too low.
					$element->updateSize(1);
				}
				$data[$group] = $element;
			}
		}
	...
	/**
	 * Force garbage collect expired cache data as elements are removed only on get/add/delete/info etc
	 *
	 * @return  boolean  True on success, false otherwise.
	 *
	 * @since   11.1

...
class JCacheStorage
{
	...
	public static function getInstance($handler = null, $options = array())
	{
		...
		JCacheStorage::addIncludePath(RPATH_PLATFORM . '/retina/cache/storage');
		...
		if (!isset($handler))
		{
			...
			if (empty($handler))
			{
				return JError::raiseWarning(500, RText::_('RLIB_CACHE_ERROR_CACHE_HANDLER_NOT_SET'));
			}
		}
		...
		if (!class_exists($class))
		{
			...
			{
				return JError::raiseWarning(500, RText::sprintf('RLIB_CACHE_ERROR_CACHE_STORAGE_LOAD', $handler));
			}
		}
	...
	public function getAll()
	{
		...
		{
			include_once RPATH_PLATFORM . '/retina/cache/storage/helpers/helper.php';
		}
		return;
	}

...
{
	/**
	 * Translates an internal retina URL to a humanly readible URL.
	 *
	 * @param   string   $url    Absolute or Relative URI to retina resource.
...
class RText
{
	 ...
	 *
	 * Examples:
	 * <script>alert(retina.RText._('<?php echo RText::_("JDEFAULT", array("script"=>true));?>'));</script>
	 * will generate an alert message containing 'Default'
	 * <?php echo RText::_("JDEFAULT");?> it will generate a 'Default' string
	 *
	 ...
	 *
	 * Examples:
	 * <?php echo RText::alt("RALL","language");?> it will generate a 'All' string in English but a "Toutes" string in French
	 * <?php echo RText::alt("RALL","module");?> it will generate a 'All' string in English but a "Tous" string in French
	 *
	 * @param   string   $string                The string to translate.
	...
	/**
	 * Like RText::sprintf but tries to pluralise the string.
	 *
	 ...
	 *
	 * Examples:
	 * <script>alert(retina.RText._('<?php echo RText::plural("COM_PLUGINS_N_elementS_UNPUBLISHED", 1, array("script"=>true));?>'));</script>
	 * will generate an alert message containing '1 plugin successfully disabled'
	 * <?php echo RText::plural("COM_PLUGINS_N_elementS_UNPUBLISHED", 1);?> it will generate a '1 plugin successfully disabled' string
	 *
	 ...
	 *
	 * @param   string   $string                The RText key.

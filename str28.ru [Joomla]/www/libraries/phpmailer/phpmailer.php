 ...
 */
  ...
  */
  ...
  /**
   * Adds an attachment from a path on the filemain.
  ...
  */
  ...
  /**
   * Adds a string or binary attachment (non-filemain) to the list.
  ...
  /**
   * Clears all previously set filemain, string, and binary

...
var MooTreeControl = new Class({
	...
	*/
	...
	Note:
		...
		><ul id="mytree">
		>  <li><a href="test.html">element One</a></li>
		>  <li><a href="test.html">element Two</a>
		>    <ul>
		>      <li><a href="test.html">element Two Point One</a></li>
		>      <li><a href="test.html">element Two Point Two</a></li>
		>    </ul>
		>  </li>
		>  <li><a href="test.html"><!-- icon:_doc; color:#ff0000 -->element Three</a></li>
		></ul>
	...
	update: function(recursive, invalidated) {
		...
		if (invalidated) {
			if (!this.invalidated) {
				...
				this.invalidated = false; // we're drawing this element now
			}
		}

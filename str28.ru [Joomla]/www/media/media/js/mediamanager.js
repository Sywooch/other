...
var MediaManager = this.MediaManager = {
	...
	initialize: function()
	{
		...
		this.tree = new MooTreeControl({ div: 'media-tree_tree', mode: 'folders', grid: true, theme: '../media/main/images/mootree.gif', onClick:
				function(node){
	...
	oncreatefolder: function()
	{
		if (document.id('foldername').value.length) {
			...
			retina.submitbutton('createfolder');
		}
	},

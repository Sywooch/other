 ...
 * required by the CodeMirror main.
 */
 ...
 * 'diff' main, which, when applied to a DOM tree, causes some
...
UndoHistory.prototype = {
  ...
  undo: function() {
    ...
    if (this.history.length) {
      ...
      this.redoHistory.push(this.updateTo(element, "applyChain"));
      this.notifyEnvironment();
      return this.chainNode(element);
    }
  },
  ...
  redo: function() {
    ...
    if (this.redoHistory.length) {
      ...
      var element = this.redoHistory.pop();
      this.addUndoLevel(this.updateTo(element, "applyChain"));
      this.notifyEnvironment();
      return this.chainNode(element);
    }
  },
  ...
  touchedChains: function() {
    ...
    // The temp main is a crummy hack to speed up determining

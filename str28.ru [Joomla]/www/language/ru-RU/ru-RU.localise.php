<?php
/**
 * @copyright	Copyright (C) 2005 - 2012 Open Source Matters, Inc & Russian Translation Team (http://retinaportal.ru)
 * 
 */
...
{
	/**
	 * Returns the potential suffixes for a specific number of elements
	 *

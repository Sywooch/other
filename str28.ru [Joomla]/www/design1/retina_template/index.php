        ...
        DG.autoload(function() { 
            ...
            var myBalloon = new DG.Balloons.Common({
                // Местоположение на которое указывает балун: 
                 ...
                 contentHtml: '<div style="height:300px; width:280px; text-align:center;"><img style="margin-top:10px;" src="<?php echo $this->baseurl ?>/images/logo.png"/></br></br>Спецтранс, компания по перевозке спецтехники и негабаритных грузов</br></br>г. Благовещенск, ул. Тенистая, 127,<br>оф. 504, 5 этаж<br></br>+7-(4162)-770-870<br></br><a href="mailto://770870@str28.ru">770870@str28.ru</a><br></br>ПН-ПТ: 9.00-17.00;  СБ-ВС: Выходной</br> </div>'
            });
            // Создаем маркер:
...
float:left; width:240px; height:67px; padding:0px;
display:block; 
margin-left:-245px;
margin-right:0px; 
...
margin-left:-328px; margin-top:-295px;
border: solid black 0px; padding: 0px; background-color: transparent; 
text-align: justify; font-size: 12px; width:657px; height:591px; z-index:999999000000000000099990000000000000999;
}
.st2{

width:657px; height:591px; background-color:transparent; border:0px black solid;
position:absolute;
...
<!--moving slider-->
 <!--<script src="<?php //echo $this->baseurl ?>/jquery-1.3.2.min.js" type="text/javascript" charset="utf-8"></script>-->
       <script src="<?php echo $this->baseurl ?>/loopedslider.js" type="text/javascript" charset="utf-8"></script>
        <style type="text/css" media="screen">
        .container {width:927px; height:358px; overflow:hidden; position:relative;}

.slides {position:absolute; top:0; left:0;}

.slides div {position:absolute; top:0; width:637px; display:none;}
...
#loopedSlider {margin:0 auto; width:927px; position:relative; clear:both;  background-color:transparent;}
#newsSlider {margin:0 auto; width:927px; position:relative; clear:both;  background-color:transparent;}
...
<!-------------------------->
 <!--[if IE 7]>
 <style type="text/css">
 .large_image_holder{width:926px;height:400px; float:left; display:inline;  
 z-index:5; border:3px #298ab4 solid; overflow:hidden;}
 </style>
<![endif]-->
...
(function (d, w, c) {
    (w[c] = w[c] || []).push(function() {
        try {
            w.yaCounter22079785 = new Ya.Metrika({id:22079785,
                    webvisor:true,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="//mc.yandex.ru/watch/22079785" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
...
<div id="f" name="f" style="width:657px; height:591px;  border-style:solid; border-width:0px; 
		...
		<div align="center" style="width:657px;  background-color:transparent;
		 padding-top:20px;" class="st3">
		...
		<div align="center" style="width:657px; height:400px; background-color:transparent;">
			 ...
			 style="border:0px !important;">
						...
						<table border="0" cellpadding="0" cellspacing="0">
                            <tr style="border:0px !important; background-color:transparent;">
							<td style="background-color:transparent !important; border:0px !important;
							height:24px; width: 130px;"></td>
							<td style="background-color:transparent !important; border:0px !important;
							height:24px; width: 360px;"></td>
							</tr>
								 <!--[if IE 9]>
						 	<tr style="border:0px !important; background-color:transparent;">
							<td style="background-color:transparent !important; border:0px !important;
							height:20px; width: 130px;"></td>
							<td style="background-color:transparent !important; border:0px !important;
							height:20px; width: 360px;"></td>
							</tr>
								<![endif]-->
							...
							height:20px; width: 360px;"></td>
								...
								<![endif]-->
							<tr style="background-color:transparent !important; border:0px black solid !important; 
							"><!--тема-->
                                <td style="height: 25px; width: 130px;border-style:solid; border-width:0px; border-color:white;
								padding-top:10px; background-color:transparent; border:0px black solid;">
								
								<span style="margin-left:40px;  color:black; font-weight:normal; font-size:10pt !important;
								margin-top:0px;">Тема:</span>
								</td> 
								
                                <td style="height: 30px; width:360px;border-style:solid; border-width:0px; border-color:white; 
								background-color:transparent !important; padding-top:5px; border:0px black solid;">
								
								 <input type="text" name="theme" maxlength="150" 
								 style="width: 300px; height:38px; background-color:transparent;margin-left:3px; 
								 border:0px !important; padding-left:5px; font-size:12pt;  border-width:0; margin-top:0px;"/>
								</td>
                            </tr><!--тема -->
							
							<tr style="border:0px !important;" >
							<td class="td1" style="background-color:transparent !important; border:0px !important;
							width: 130;"></td>
							<td class="td1" style="background-color:transparent !important; border:0px !important;
							width: 360;"></td>
							</tr>
						  ...
						  <tr style="background-color:transparent !important; border:0px !important;"><!--mail-->
							...
							<tr style="border:0px !important;">
							<td class="td2" style="background-color:transparent !important; border:0px !important;
							width: 130px;"></td>
							<td class="td2" style="background-color:transparent !important; border:0px !important;
							width: 360px;"></td>
							</tr>
                           ...
                           <tr style="background-color:transparent !important; border:0px !important;"><!--текст-->
							...
							<tr style="border:0px !important;">
							<td class="td3" style="background-color:transparent !important; border:0px !important;
							width: 130px;"></td>
							<td class="td3" style="background-color:transparent !important; border:0px !important;
							width: 360px;"></td>
							</tr>
   ...
   <?php
         ...
         ?>                    
					...
					<div align="left" class="st4" style="width:500px; height:40px; background-color:transparent; ">   
...
<!------------------------------------------------------------------------------------------------------------->	
	...
	background-image:url('<?php echo $this->baseurl ?>/images/feedback.png'); ">
		...
		<div align="center" style="width:180px; height:27px; background-color:transparent; float:left;
		padding-top:22px; padding-bottom:18px;">
		
		<span><a href="#" onmouseover='this.style.cursor="pointer" '
		...
		<span style="color:white; font-size:11pt;"><strong>Связаться с нами</strong></span></a></span>
	<!--window.scrollBy(0,20);-->
		</div>
		<div style="width:50px; height:67px; float:left; background-color:transparent;">
		
		<a href="#" onmouseover='this.style.cursor="pointer" '
...
<div style="width:100%; height:660px; position:absolute; background-color:transparent; 
 ...
 background-image:url('<?php echo $this->baseurl ?>/images/fon2_right.jpg');
 z-index:-11111; border:0px black solid;">
<div style="width:50%; height:660px; float:left; background-image:url('<?php echo $this->baseurl ?>/images/fon2_left.jpg');
background-repeat:repeat-x; border:0px !important; padding:0px !important; margin:0px !important;"></div>
...
<div align="center" style="height:130px; width:100%; position:absolute; background-color:transparent"><!--название и телефон-->


<div style="width:1200px; height:130px; background-color:transparent">
...
<div  id="all" style="background-color:transparent !important; ">
	...
	<div style="height:480px; width:1000px;float:left; background-color:transparent; border:0px black solid; margin:0 !important; 
	padding:0 !important;">
	...
	<a href="index.php/kontakty"><div style="height:103px; width:119px; border:0px black solid; margin-left:24px; float:left;
	 "></div></a>
	<div style="height:103px; width:140px;  float:left; margin-left:20px;"></div>
	
	<a href="index.php/gallery"><div style="height:103px; width:121px; border:0px black solid; margin-left:25px; float:left;
	 "></div></a>
	<div style="height:103px; width:140px; float:left; margin-left:20px;"></div>
 </div>
		...
		<jdoc:include type="modules" name="search"/>
				   ...
				   border:0px black solid !important; height:0px !important; height:10px;">
               ...
               <?php endif; ?>
					...
					<?php if($fpage=="1"){ echo"width:926px !important;"; };  ?>
												...
												<?php if($log_news==1){ echo"width:925px !important;"; };  ?>
										...
										id="<?php echo $showRightColumn ? 'wrapper' : 'wrapper2'; ?>" <?php if (isset($showno)){echo 'class="shownocolumns"';}?>>
                                               ...
                                               <div id="main" style="background-color:white !important; border:0px #f8f8f8 solid;
  ...
  <div id="loopedSlider" style="margin-top:0px" >
            <div class="container" style="margin-top:0px;">
								
                <div class="slides" style="border:0px blue solid; margin-top:0px;">
				

                    <div style="border:0px blue solid; margin-left:145px;"><img src="moving_slider/images/content/1.jpg" alt="" /></div>
                    <div style="border:0px blue solid; margin-left:145px;"><img src="moving_slider/images/content/2.jpg"  alt="" /></div>
                    <div style="border:0px blue solid; margin-left:145px;"><img src="moving_slider/images/content/3.jpg" alt="" /></div>
                    <div style="border:0px blue solid; margin-left:145px;"><img src="moving_slider/images/content/4.jpg"  alt="" /></div>
					<div style="border:0px blue solid; margin-left:145px;"><img src="moving_slider/images/content/5.jpg"  alt="" /></div>
					<div style="border:0px blue solid; margin-left:145px;"><img src="moving_slider/images/content/6.jpg"  alt="" /></div>
					<div style="border:0px blue solid; margin-left:145px;"><img src="moving_slider/images/content/7.jpg"  alt="" /></div>
					<div style="border:0px blue solid; margin-left:145px;"><img src="moving_slider/images/content/8.jpg"  alt="" /></div>
                </div>
				
				<div style=" width:145px; height:359px; background-color:black; opacity: 0.6;  filter: alpha(Opacity=70);
				position: absolute;	top: 0;	left: 0; bottom: 0;">
				<a href="#" class="previous"><img src="moving_slider/images/leftarrow.png" 
				style="margin:0 !important; width:145px; height:360px;position: absolute;left:0;
				top: 0px;  cursor: pointer;   z-index:999999999999 !important;"/></a>
				</div>
				
				<div style=" width:145px; height:359px; background-color:black; opacity: 0.6;  filter: alpha(Opacity=70);
				position: absolute;	top: 0;	 bottom: 0; " class="right_button_slider">
				<a href="#" class="next"><img src="moving_slider/images/rightarrow.png" 
				style="margin:0 !important; width:145px; height:360px; position: absolute;left:0;
				top: 0px;  cursor: pointer;   z-index:999999999999 !important;" /></a>
				</div>
...
<!--[if IE 7]>
<div style="width:860px; height:2px; background-color:transparent;">
</div>
<![endif]-->
...
<div style="overflow:hidden; background-image:url('.$this->baseurl.'/images/not_image.jpg); 
float:left; margin-right:10px; margin-bottom:10px; width:150px; height:112px; border:0px; padding:0px;">';
if($row['image']!=""){
echo'<img src="'.$this->baseurl.'/'.$row['image'].'" alt="" style="float:left; margin:0px; margin-top:0px; 
 border:0 !important;"  class="image_news"/>';
};
echo'
<!--image-->
</div>
...
if(($_GET['str']==$count_str)&&($count_str>1)){//если мы на последней странице
echo'
...
//новости
												...
												echo'		<div id="wrapper" style="padding:0px !important; width:926px !important; " >



  <div id="viewer" class="viewer_ie"  >
 ...
 <div class="large_image_wrap" >
   ...
   <a href="javascript:void(0);" class="next"><img src="/gallery/images/next2.png" alt="foreward" /></a> 
    ...
    <!--end thumbs-->
														...
														echo'<div class="doc_ie1" align="left" style="height:300px;  background-color:transparent;
														overflow:auto;
														...
														<a href="/add.doc"><img src="'.$this->baseurl.'/images/documentation/file.png" border="0"
														alt="" title="" style="cursor:pointer"/>
														</a>
														</div>
														<div align="center" style="width:290px; height:30px;">
														<a href="/add.doc" class="designed_by_retina">
														<span style="font-size:14pt; color:#333;"
														class="designed_by_retina">Заказ</span></a>
														</div>
														
														</div>
														
														<div align="center"  style="float:left; width:320px; height:300px; 
														margin-left:1px; background-color:transparent">
														<div align="center" style="width:320px; height:150px; 
														background-color:transparent; margin-top:30px;">
														<a href="/dog.docx"><img src="'.$this->baseurl.'/images/documentation/feature.png" border="0"
														alt="" title="" style="cursor:pointer"/>
														</a>
														</div>
														<div align="center" style="width:320px; height:30px;">
														<a href="/dog.docx" class="designed_by_retina">
														<span style="font-size:14pt; color:#333;" 
														class="designed_by_retina">Договор типовой</span></a>
														</div>
														...
														<div align="center" style="width:290px; height:150px; 
														background-color:transparent; margin-top:30px;">
														<a href="/act.doc"><img src="'.$this->baseurl.'/images/documentation/events.png"  border="0"
														alt="" title="" style="cursor:pointer"/>
														</a>
														</div>
														<div align="center" style="width:290px; height:30px;">
														<a href="/act.doc" class="designed_by_retina">
														<span style="font-size:14pt; color:#333;" 
														class="designed_by_retina">Акт приёма/передачи</span></a>
														</div>
...
<!---->
								...
								<div align="right" style="width:200px; height:40px; margin-top:95px;
								 margin-left:30px;">
								 <a href="http://www.retina-studio.ru" class="designed_by_retina">
								 <span style="color:#d4b5b3; font-size:8pt;font-weight:bold;" 
								 class="designed_by_retina">designed by retina</span>
								 </a>
								 </div>
								</div>
								</div>

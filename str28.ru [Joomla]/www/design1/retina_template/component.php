...
/**
 * @package                Retina.Site
 * @subpackage	design1.retina_template
 * @copyright        
 * @license                
 */
...
<head>
	...
	<link rel="stylesheet" href="<?php echo $this->baseurl ?>/design1/<?php echo $this->template; ?>/css/retina2.css" type="text/css" />
	...
	<link rel="stylesheet" href="<?php echo $this->baseurl ?>/design1/<?php echo $this->template; ?>/css/<?php echo $color; ?>.css" type="text/css" />
<?php

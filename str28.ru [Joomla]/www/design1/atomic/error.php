		...
		<div id="errorboxoutline">
			...
			<p><strong><?php echo RText::_('RERROR_LAYOUT_PLEASE_TRY_ONE_OF_THE_FOLLOWING_PAGES'); ?></strong></p>
				...
				<ul>
					...
					<li><a href="<?php echo $this->baseurl; ?>/index.php?option=com_search" title="<?php echo RText::_('RERROR_LAYOUT_SEARCH_PAGE'); ?>"><?php echo RText::_('RERROR_LAYOUT_SEARCH_PAGE'); ?></a></li>

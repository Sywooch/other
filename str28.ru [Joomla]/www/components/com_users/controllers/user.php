...
class UsersControllerUser extends UsersController
{
	...
	{
		JRequest::checkToken('post') or jexit(RText::_('JInvalid_Token'));
	...
	{
		JRequest::checkToken('default') or jexit(RText::_('JInvalid_Token'));
	...
	public function register()
	{
		...
		if ($return === false) {
			...
			// Redirect back to the registration form.
			$message = RText::sprintf('COM_USERS_REGISTRATION_SAVE_FAILED', $model->getError());
	...
	public function remind()
	{
		...
		if ($return instanceof Exception) {
			...
			if ($app->getCfg('error_reporting')) {
				...
				$message = RText::_('COM_USERS_REMIND_REQUEST_ERROR');
			}

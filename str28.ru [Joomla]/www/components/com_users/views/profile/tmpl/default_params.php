...
JLoader::register('JHtmlUsers', RPATH_COMPONENT . '/helpers/html/users.php');
JHtml::register('users.spacer', array('JHtmlUsers', 'spacer'));
JHtml::register('users.helpsite', array('JHtmlUsers', 'helpsite'));
JHtml::register('users.design1tyle', array('JHtmlUsers', 'design1tyle'));
...
<fieldset id="users-profile-custom">
	<legend><?php echo RText::_('COM_USERS_SETTINGS_FIELDSET_LABEL'); ?></legend>
	<dl>

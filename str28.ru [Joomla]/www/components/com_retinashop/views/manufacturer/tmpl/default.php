...
<div class="manufacturer-view-default">
	...
	foreach ( $this->manufacturers as $manufacturer ) {
		...
		$manufacturerURL = JRoute::_('index.php?option=com_retinashop&view=manufacturer&retinashop_manufacturer_id=' . $manufacturer->retinashop_manufacturer_id);
		$manufacturerIncludedProductsURL = JRoute::_('index.php?option=com_retinashop&view=category&retinashop_manufacturer_id=' . $manufacturer->retinashop_manufacturer_id);

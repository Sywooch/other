		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="html-email">
				...
				<td>
				    ...
				    <?php echo RText::sprintf('COM_RETINASHOP_WELCOME_VENDOR', $this->vendor->vendor_store_name); ?>
				    <br />
				</td>
			    </tr>
			</table>
			...
			<table class="html-email" cellspacing="0" cellpadding="0" border="0" width="100%">  <tr>
				<th width="100%">
				    <?php echo RText::_('COM_RETINASHOP_VENDOR_REGISTRATION_DATA') ?>
				</th>
			    </tr>
			    <tr>
				<td valign="top" width="100%">
				    <?php
				    echo RText::_('COM_RETINASHOP_LOGINAME') . ' : ' . $this->user->username . $li;
				    echo RText::_('COM_RETINASHOP_DISPLAYED_NAME') . ' : ' . $this->user->name . $li . $li;

				    echo RText::_('COM_RETINASHOP_ENTERED_ADDRESS') . $li;

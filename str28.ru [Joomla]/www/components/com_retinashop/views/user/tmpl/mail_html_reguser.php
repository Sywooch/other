		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="html-email">
				...
				<td >
				    ...
				    <?php echo RText::sprintf('COM_RETINASHOP_WELCOME_USER', $this->user->name); ?>
				    <br />
				    <?php
				    if (!empty($this->activationLink)) {
					$activationLink = '<a class="default" href="' . JURI::root() . $this->activationLink . '">' . RText::_('COM_RETINASHOP_LINK_ACTIVATE_ACCOUNT') . '</a>';
					echo $li;
			...
			<table class="html-email" cellspacing="0" cellpadding="0" border="0" width="100%">
			    <tr>
				<th width="100%">
				    <?php echo RText::_('COM_RETINASHOP_SHOPPER_REGISTRATION_DATA') ?>
				</th>
				...
				<td valign="top" width="100%">
				    <?php
				    echo RText::_('COM_RETINASHOP_YOUR_LOGINAME')   . $this->user->username . $li;
				    echo RText::_('COM_RETINASHOP_YOUR_DISPLAYED_NAME')   . $this->user->name . $li;
				    echo RText::_('COM_RETINASHOP_YOUR_PASSWORD')  . $this->user->password_clear . $li. $li;
				    echo RText::_('COM_RETINASHOP_YOUR_ADDRESS')  . $li;

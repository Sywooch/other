...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="html-email">
  ...
  <tr>
    <td width="30%">
		<?php echo RText::_('COM_RETINASHOP_MAIL_SHOPPER_YOUR_ORDER'); ?><br />
		<b><?php echo $this->orderDetails['details']['BT']->order_number ?></b>

	</td>
    <td width="30%">
		<?php echo RText::_('COM_RETINASHOP_MAIL_SHOPPER_YOUR_PASSWORD'); ?><br />
		<b><?php echo $this->orderDetails['details']['BT']->order_pass ?></b>
	</td>
    <td width="40%">
    	<p>
			<a class="default" title="<?php echo $this->vendor->vendor_store_name ?>" href="<?php echo JURI::root().'index.php?option=com_retinashop&view=orders&layout=details&order_number='.$this->orderDetails['details']['BT']->order_number.'&order_pass='.$this->orderDetails['details']['BT']->order_pass; ?>">
			<?php echo RText::_('COM_RETINASHOP_MAIL_SHOPPER_YOUR_ORDER_LINK'); ?></a>
		</p>
	</td>
  </tr>
  <tr>
    <td colspan="3"><p>
				<?php echo RText::sprintf('COM_RETINASHOP_MAIL_SHOPPER_TOTAL_ORDER',$this->currency->priceDisplay($this->orderDetails['details']['BT']->order_total) ); ?></p></td>
  </tr>
  <td colspan="3"><p>
				<?php echo RText::sprintf('COM_RETINASHOP_MAIL_ORDER_STATUS',$this->orderDetails['details']['BT']->order_status_name) ; ?></p></td>
  </tr>
  ...
  <tr>
    <td colspan="3">
		<?php echo RText::sprintf('COM_RETINASHOP_MAIL_SHOPPER_QUESTION',$this->orderDetails['details']['BT']->customer_note) ?>

	...
	<div style="background-color: #e6e6e6;" width="100%">
		...
		<tr>
			...
			<table class="html-email" cellspacing="0" cellpadding="0" border="0" width="100%">  <tr >
				<th width="100%">
				    <?php echo RText::_('COM_RETINASHOP_QUESTION_ABOUT').' '.$this->product->product_name ?>
				</th>
			    </tr>
			    <tr>
				<td valign="top" width="100%">
				    <?php
				    echo RText::sprintf('COM_RETINASHOP_QUESTION_MAIL_FROM', $this->user['name'], $this->user['email']) . "<br />";

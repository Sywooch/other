...
<table width="100%" cellspacing="2" cellpadding="4" border="0">
	<tr align="left" class="sectiontableheader">
		<th align="left" ><?php echo RText::_('COM_RETINASHOP_DATE') ?></th>
		<th align="left" ><?php echo RText::_('COM_RETINASHOP_ORDER_PRINT_PO_STATUS') ?></th>
		<th align="left" ><?php echo RText::_('COM_RETINASHOP_ORDER_COMMENT') ?></th>
	</tr>
<?php

...
class ContentControllerArticle extends JControllerForm
{
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($user->authorise('core.edit.own', $asset)) {
			...
			if (empty($ownerId) && $recordId) {
				...
				$record		= $this->getModel()->getelement($recordId);
	 ...
	 * @since	1.6
	 */
	protected function getRedirectToelementAppend($recordId = null, $urlVar = 'a_id')
	{
...
//		}
	...
	public function save($key = null, $urlVar = 'a_id')
	{
		...
		require_once RPATH_admin.'/components/com_content/helpers/content.php';
	...
	function vote()
	{
		...
		if ( $user_rating > -1 ) {
			...
			if ($model->storeVote($id, $user_rating)) {
				$this->setRedirect($url, RText::_('COM_CONTENT_ARTICLE_VOTE_SUCCESS'));
			} else {
				$this->setRedirect($url, RText::_('COM_CONTENT_ARTICLE_VOTE_FAILURE'));
			}
		}
	}
}

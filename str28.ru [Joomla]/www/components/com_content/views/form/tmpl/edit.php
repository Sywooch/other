...
<div class="edit element-page<?php echo $this->pageclass_sfx; ?>">
...
<form action="<?php echo JRoute::_('index.php?option=com_content&a_id='.(int) $this->element->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
	<fieldset>
		<legend><?php echo RText::_('JEDITOR'); ?></legend>
		...
		<?php if (is_null($this->element->id)):?>
			<div class="formelm">
		...
		<?php endif; ?>
			...
			<button type="button" onclick="retina.submitbutton('article.save')">
				<?php echo RText::_('JSAVE') ?>
			</button>
			<button type="button" onclick="retina.submitbutton('article.cancel')">
	...
	<fieldset>
		<legend><?php echo RText::_('COM_CONTENT_IMAGES_AND_URLS'); ?></legend>
			<div class="formelm">
	...
	<fieldset>
		<legend><?php echo RText::_('COM_CONTENT_PUBLISHING'); ?></legend>
		<div class="formelm">
		...
		<?php else : ?>
		<?php echo $this->form->getInput('catid', null, $this->element->catid); ?>
		<?php endif;?>
		</div>
		<div class="formelm">
	...
	<?php if ($this->element->params->get('access-change')): ?>
		<div class="formelm">
	...
	<?php endif; ?>
		...
		<?php if (is_null($this->element->id)):?>
			<div class="form-note">
			<p><?php echo RText::_('COM_CONTENT_ORDERING'); ?></p>
			</div>
		<?php endif; ?>
	</fieldset>

	<fieldset>
		<legend><?php echo RText::_('JFIELD_LANGUAGE_LABEL'); ?></legend>
	...
	<fieldset>
		<legend><?php echo RText::_('COM_CONTENT_METADATA'); ?></legend>
		<div class="formelm-area">
		...
		<?php if($this->params->get('enable_category', 0) == 1) :?>
		<input type="hidden" name="rinputform[catid]" value="<?php echo $this->params->get('catid', 1);?>"/>
		<?php endif;?>

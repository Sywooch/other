 ...
 * @since 1.5
 */
class ContentModelArticle extends JModelelement
{
	/**
	 ...
	 *
	 * @return	mixed	Menu element data object on success, false on failure.
	 */
		...
		if (!isset($this->_element[$pk])) {
			...
			try {
				...
				$query->select($this->getState(
					'element.select', 'a.id, a.asset_id, a.title, a.alias, a.title_alias, a.introtext, a.fulltext, ' .
				...
				if (empty($data)) {
					return JError::raiseError(404, RText::_('COM_CONTENT_ERROR_ARTICLE_NOT_FOUND'));
				}
    ...
    public function storeVote($pk = 0, $rate = 0)
    {
        ...
        JError::raiseWarning( 'SOME_ERROR_CODE', RText::sprintf('COM_CONTENT_INVALID_RATING', $rate), "JModelArticle::storeVote($rate)");
        return false;
    }
}

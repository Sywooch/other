...
<?php foreach($this->elements[$this->parent->id] as $id => $element) : ?>
	...
	<li<?php echo $class; ?>>
	<?php $class = ''; ?>
		<span class="element-title"><a href="<?php echo JRoute::_(ContactHelperRoute::getCategoryRoute($element->id));?>">
		...
		<?php if ($element->description) : ?>
			<div class="category-desc">
				<?php echo JHtml::_('content.prepare', $element->description, '', 'com_contact.categories'); ?>
			</div>
		<?php endif; ?>
        <?php endif; ?>
		...
		<?php if ($this->params->get('show_cat_elements_cat') == 1) :?>
			<dl><dt>
				<?php echo RText::_('COM_CONTACT_COUNT'); ?></dt>

...
class SearchModelSearch extends JModel
{
	...
	/**
	 * Method to get weblink element data for the category
	 *
	 * @access public
	 * @return array
	 */
	...
	/**
	 * Method to get the total number of weblink elements for the category
	 *
	 * @access public
	 * @return integer
	 */
	...
	/**
	 * Method to get a pagination object of the weblink elements for the category
	 *
	 * @access public
	 * @return integer
	 */

...
<form id="finder-search" action="<?php echo JRoute::_($this->query->toURI()); ?>" method="get">
	...
	<fieldset class="word">
		<label for="q">
			<?php echo RText::_('COM_FINDER_SEARCH_TERMS'); ?>
		</label>
		...
		<?php if ($this->escape($this->query->input) != '' || $this->params->get('allow_empty_search')):?>
			<button name="Search" type="submit" class="button"><?php echo RText::_('RSEARCH_FILTER_SUBMIT');?></button>
		<?php else: ?>
			<button name="Search" type="" class="button"><?php echo RText::_('RSEARCH_FILTER_SUBMIT');?></button>
		<?php endif; ?>
</fieldset>

	<?php if ($this->params->get('show_advanced', 1)): ?>
		<a id="advanced-search-toggle"><?php echo RText::_('COM_FINDER_ADVANCED_SEARCH_TOGGLE'); ?></a>

		<div id="advanced-search">
			<?php if ($this->params->get('show_advanced_tips', 1)): ?>
				<div class="advanced-search-tip">
					<?php echo RText::_('COM_FINDER_ADVANCED_TIPS'); ?>
				</div>
			<?php endif; ?>

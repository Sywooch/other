...
?>
	<div id="search-query-explained">
		...
		if ($this->suggested && $this->params->get('show_suggested_query', 1))
		{
			...
			echo RText::sprintf('COM_FINDER_SEARCH_SIMILAR', $link);
		}
...
?>
	<div id="search-result-empty">
		<h2><?php echo RText::_('COM_FINDER_SEARCH_NO_RESULTS_HEADING'); ?></h2>
		<?php if ($app->getLanguageFilter()) : ?>
		<p><?php echo RText::sprintf('COM_FINDER_SEARCH_NO_RESULTS_BODY_MULTILANG', $this->escape($this->query->input)); ?></p>
		<?php else : ?>
		<p><?php echo RText::sprintf('COM_FINDER_SEARCH_NO_RESULTS_BODY', $this->escape($this->query->input)); ?></p>
		<?php endif; ?>
	</div>
<?php
else:
	...
	$pages	= RText::sprintf('COM_FINDER_SEARCH_RESULTS_OF', $start, $limit, $total);
?>

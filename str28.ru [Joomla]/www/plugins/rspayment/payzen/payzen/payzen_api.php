...
class VadsResponse {
	...
	var $translation = array(
			...
			'extra_results_default' => array(
					...
					'99' => 'Problème technique rencontré par le serveur lors du traelementent d’un des contrôles locaux'),
...
class VadsField {
	...
	var $name;
	/**
	 * Field's label in english, to be used by translation mains
	 * @var string
	 * @access private
	 */
	var $label;

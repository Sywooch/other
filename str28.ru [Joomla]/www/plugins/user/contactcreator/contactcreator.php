...
class plgUserContactCreator extends JPlugin
{
	...
	function onUserAfterSave($user, $isnew, $success, $msg)
	{
		...
		if (empty($category)) {
			JError::raiseWarning(41, RText::_('PLG_CONTACTCREATOR_ERR_NO_CATEGORY'));
		...
		JTable::addIncludePath(RPATH_admin.'/components/com_contact/tables');
		...
		if (!(isset($result)) || !$result) {
			JError::raiseError(42, RText::sprintf('PLG_CONTACTCREATOR_ERR_FAILED_UPDATE', $contact->getError()));
		}
	}
}

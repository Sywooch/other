...
/**
 * Retina master extension plugin.
 *
 * @package		retina.Plugin
 * @subpackage	Extension.retina
 * @since		1.6
 */
class plgExtensionretina extends JPlugin
{
	/**
	...
	private function processUpdateSites()
	{
		...
		else
		{
			...
			if (strlen($data))
			{
				...
				$this->addUpdateSite(RText::_('PLG_EXTENSION_retina_UNKNOWN_SITE'), 'extension', $data, true);
			}
		}
	}
}

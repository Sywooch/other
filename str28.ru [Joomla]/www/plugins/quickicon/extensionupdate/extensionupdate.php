...
//			RText::_('PLG_QUICKICON_EXTENSIONUPDATE_UPTODATE').'", "UPDATEFOUND": "'.
//			RText::_('PLG_QUICKICON_EXTENSIONUPDATE_UPDATEFOUND').'", "ERROR": "'.
//			RText::_('PLG_QUICKICON_EXTENSIONUPDATE_ERROR')."\"};\n";
...
//			'text' => RText::_('PLG_QUICKICON_EXTENSIONUPDATE_CHECKING'),

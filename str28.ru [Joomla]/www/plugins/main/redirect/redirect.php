 ...
 * @subpackage	main.redirect
 */
class plgmainRedirect extends JPlugin
{
	/**
	 * Object Constructor.
	 *
	...
	function __construct(&$subject, $config)
	{
		...
		JError::setErrorHandling(E_ERROR, 'callback', array('plgmainRedirect', 'handleError'));
	}
	...
	static function handleError(&$error)
	{
		...
		// Make sure the error is a 404 and we are not in the admin.

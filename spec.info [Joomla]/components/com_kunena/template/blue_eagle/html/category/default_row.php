...
<tr class="<?php echo $this->getTopicClass('k', 'row') ?>">
    ...
    <img src="/templates/rsmetro/images/status1.jpg" alt="" title="" class="img_status"/>
    ...
    <div class="ktopic-details">
		...
		<ul class="kpagination tr1" style="float:left;">
			...
			<li><?php echo $this->getTopicLink ( $this->topic, $hopPage, $hopPage+1 ) ?>
            </li>
			<?php endfor; ?>
		</ul>
        <span style="float:left;">)</span>
	...
	<td class="kcol-first kcol-ktopicreplies hidden-phone number1">
		<strong><?php echo $this->formatLargeNumber ( max(0,$this->topic->getTotal()-1) ); ?></strong> <?php //echo JText::_('COM_KUNENA_GEN_REPLIES') ?>
	</td>

	

	<td class="kcol-mid kcol-ktopicviews visible-desktop number2">

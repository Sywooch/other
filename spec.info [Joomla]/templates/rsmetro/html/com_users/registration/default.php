...
<div class=" class3 registration<?php echo $this->pageclass_sfx?>">
...
<?php endforeach;?>
		<div class="form-actions">
			...
			<a class="btn a" href="<?php echo JRoute::_('');?>" title="<?php echo JText::_('JCANCEL');?>"><?php echo JText::_('JCANCEL');?></a>

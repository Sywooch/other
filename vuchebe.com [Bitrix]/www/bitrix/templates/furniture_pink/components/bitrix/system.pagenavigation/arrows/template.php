...
<!--
		<div class="navigation-arrows">
			<span class="arrow">&larr;</span><span class="ctrl"> ctrl</span>&nbsp;<?if ($bPrevDisabled):?>
<span class="disabled"><?=GetMessage("nav_prev")?></span><?else:?><a href="<?=$sPrevHref;?>" 
...
<?if ($bNextDisabled):?><span class="disabled"><?=GetMessage("nav_next")?></span><?else:?>
<a href="<?=$sNextHref;?>" id="<?=$ClientID?>_next_page"><?=GetMessage("nav_next")?></a>
<?endif;?>&nbsp;<span class="ctrl">ctrl </span><span class="arrow">&rarr;</span>
		</div>
...
<?if ($bPrevDisabled):?>
<span class="disabled">&laquo;</span><?else:?><a href="<?=$sPrevHref;?>" 
id="<?=$ClientID?>_previous_page">&laquo;</a><?endif;?>
...
<?if ($bNextDisabled):?><span class="disabled">&raquo;</span><?else:?>
<a href="<?=$sNextHref;?>" id="<?=$ClientID?>_next_page">&raquo;</a>
<?endif;?>

...
<?php if ( has_post_format( 'audio' ) ): // Audio ?>
	...
	<div class="post-format">		
		<div class="image-container">
			<a class="img-post-link" href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title(); ?>">
				<?php if ( has_post_thumbnail() ) {
					if( is_home() or is_category()) { the_post_thumbnail('thumb-home'); } else { the_post_thumbnail('thumb-large'); }

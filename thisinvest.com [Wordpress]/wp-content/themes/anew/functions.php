...
if ( ! function_exists( 'alx_setup' ) ) {
	...
	function alx_setup() {
		...
		add_image_size( 'thumb-home', 310, 260, true );
...
// Форма подписки
    register_sidebar(array(
        'name' => __('Виджеты подписки'),
        'id' => 'subscribe-widget-area',
        'description' => __('Виджеты во всплывающей панели подписки'),
        'before_widget' => '',
        'after_widget' => '',
...
// Поле над футером
	register_sidebar(array(
	    'name' => __('Поле над футером'),
	    'id' => 'bottom-logo-area',
	    'description' => __('Поле над футером'),
	    'before_widget' => '',
	    'after_widget' => '',
	    'before_title' => '<h3><a href="#">',
	    'after_title' => '</a></h3>',
...
// Форма регистрации
    function register_login(){
        register_sidebar( array(
            'name' => "Форма регистрации/входа",
            'id' => 'login-widget-area',
            'description' => 'Форма регистрации/входа во всплывающей панели',
    ...
    add_action( 'widgets_init', 'register_login' );

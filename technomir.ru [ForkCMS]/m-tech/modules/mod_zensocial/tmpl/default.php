...
<div id="socialicons" class="<?php echo $socialalign.' mid'.$id; if($moduleclass_sfx) {echo $moduleclass_sfx;} ?>">
		...
		<li><a class="icon1" target="_blank" href="<?php echo $icon1Link ?>">
			<img src="modules/mod_zensocial/icons/<?php echo $icon1Image ?>"  title="<?php echo $icon1Image ?>" alt="<?php echo $zen->icon1Image ?>"/>
		</a></li>
		<?php } ?>

		<?php if ($icon2Image !="-1") {?>
		<li><a class="icon2" target="_blank" href="<?php echo $icon2Link ?>">
				<img src="modules/mod_zensocial/icons/<?php echo $icon2Image ?>" title="<?php echo $icon2Image ?>" alt="<?php echo $zen->icon2Image ?>"/>
		</a></li>
		<?php } ?>

		<?php if ($icon3Image !="-1") {?>
		<li><a class="icon3" target="_blank" href="<?php echo $icon3Link ?>">
				<img src="modules/mod_zensocial/icons/<?php echo $icon3Image ?>" title="<?php echo $icon3Image ?>"  alt="<?php echo $zen->icon3Image ?>"/>
		</a></li>
		<?php } ?>

		<?php if ($icon4Image !="-1") {?>
		<li><a class="icon4" target="_blank" href="<?php echo $icon4Link ?>">
				<img src="modules/mod_zensocial/icons/<?php echo $icon4Image ?>" title="<?php echo $icon4Image ?>"  alt="<?php echo $zen->icon4Image ?>"/>
		</a></li>
		<?php } ?>

		<?php if ($icon5Image !="-1") {?>
		<li><a class="icon5" target="_blank" href="<?php echo $icon5Link ?>">
				<img src="modules/mod_zensocial/icons/<?php echo $icon5Image ?>" title="<?php echo $icon5Image ?>"  alt="<?php echo $zen->icon5Image ?>"/>
		</a></li>
		<?php } ?>

		<?php if ($icon6Image !="-1") {?>
		<li><a class="icon6" target="_blank" href="<?php echo $icon6Link ?>">
				<img src="modules/mod_zensocial/icons/<?php echo $icon6Image ?>" title="<?php echo $icon6Image ?>"  alt="<?php echo $zen->icon6Image ?>"/>
		</a></li>
		<?php } ?>
		</ul>
	</div>

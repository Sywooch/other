            ...
            <div class="flex-container" id="flex<?php if(isset($this->variables['widgetGallery']) && array_key_exists('id', (array) $this->variables['widgetGallery'])) { echo $this->variables['widgetGallery']['id']; } else { ?>{$widgetGallery.id}<?php } ?>" style="max-width:<?php if(isset($this->variables['widgetGallery']) && array_key_exists('width', (array) $this->variables['widgetGallery'])) { echo $this->variables['widgetGallery']['width']; } else { ?>{$widgetGallery.width}<?php } ?>px">
                <div class="flexslider">
					...
					if(!isset($this->variables['widgetSlideshow']))
					{
						...
						$this->iterations['31c3b924e801a3ffb7cddf3c0dff2b64_Slideshow.tpl.php_1']['fail'] = true;
					}
				if(isset(${'widgetSlideshow'})) $this->iterations['31c3b924e801a3ffb7cddf3c0dff2b64_Slideshow.tpl.php_1']['old'] = ${'widgetSlideshow'};
				$this->iterations['31c3b924e801a3ffb7cddf3c0dff2b64_Slideshow.tpl.php_1']['iteration'] = $this->variables['widgetSlideshow'];
				$this->iterations['31c3b924e801a3ffb7cddf3c0dff2b64_Slideshow.tpl.php_1']['i'] = 1;
				$this->iterations['31c3b924e801a3ffb7cddf3c0dff2b64_Slideshow.tpl.php_1']['count'] = count($this->iterations['31c3b924e801a3ffb7cddf3c0dff2b64_Slideshow.tpl.php_1']['iteration']);
				foreach((array) $this->iterations['31c3b924e801a3ffb7cddf3c0dff2b64_Slideshow.tpl.php_1']['iteration'] as ${'widgetSlideshow'})
				{
					if(!isset(${'widgetSlideshow'}['first']) && $this->iterations['31c3b924e801a3ffb7cddf3c0dff2b64_Slideshow.tpl.php_1']['i'] == 1) ${'widgetSlideshow'}['first'] = true;
					if(!isset(${'widgetSlideshow'}['last']) && $this->iterations['31c3b924e801a3ffb7cddf3c0dff2b64_Slideshow.tpl.php_1']['i'] == $this->iterations['31c3b924e801a3ffb7cddf3c0dff2b64_Slideshow.tpl.php_1']['count']) ${'widgetSlideshow'}['last'] = true;
					...
					if(isset(${'widgetSlideshow'}['title']) && count(${'widgetSlideshow'}['title']) != 0 && ${'widgetSlideshow'}['title'] != '' && ${'widgetSlideshow'}['title'] !== false)
					{
                        ...
                        <?php
					$this->iterations['31c3b924e801a3ffb7cddf3c0dff2b64_Slideshow.tpl.php_1']['i']++;
				}
					if(isset($this->iterations['31c3b924e801a3ffb7cddf3c0dff2b64_Slideshow.tpl.php_1']['fail']) && $this->iterations['31c3b924e801a3ffb7cddf3c0dff2b64_Slideshow.tpl.php_1']['fail'] == true)
					{
						?>{/iteration:widgetSlideshow}<?php
					}
				if(isset($this->iterations['31c3b924e801a3ffb7cddf3c0dff2b64_Slideshow.tpl.php_1']['old'])) ${'widgetSlideshow'} = $this->iterations['31c3b924e801a3ffb7cddf3c0dff2b64_Slideshow.tpl.php_1']['old'];
				else unset($this->iterations['31c3b924e801a3ffb7cddf3c0dff2b64_Slideshow.tpl.php_1']);
				?>
                        </ul>
                    </div>
                </div>

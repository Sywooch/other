	...
	<div id="blogIndex">
		<?php
					if(!isset($this->variables['items']))
					{
						...
						$this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_1']['fail'] = true;
					}
				if(isset(${'items'})) $this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_1']['old'] = ${'items'};
				$this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_1']['iteration'] = $this->variables['items'];
				$this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_1']['i'] = 1;
				$this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_1']['count'] = count($this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_1']['iteration']);
				foreach((array) $this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_1']['iteration'] as ${'items'})
				{
					if(!isset(${'items'}['first']) && $this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_1']['i'] == 1) ${'items'}['first'] = true;
					if(!isset(${'items'}['last']) && $this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_1']['i'] == $this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_1']['count']) ${'items'}['last'] = true;
			...
			<article>
					<header>
						<h1><a href="<?php if(array_key_exists('full_url', (array) ${'items'})) { echo ${'items'}['full_url']; } else { ?>{$items->full_url}<?php } ?>" title="<?php if(array_key_exists('title', (array) ${'items'})) { echo ${'items'}['title']; } else { ?>{$items->title}<?php } ?>"><?php if(array_key_exists('title', (array) ${'items'})) { echo ${'items'}['title']; } else { ?>{$items->title}<?php } ?></a></h1>
						<p class="lead">
							
							<?php if(array_key_exists('msgWrittenBy', (array) $this->variables) && array_key_exists('user_id', (array) ${'items'})) { echo sprintf(SpoonFilter::ucfirst($this->variables['msgWrittenBy']), Frontend\Core\Engine\TemplateModifiers::userSetting(${'items'}['user_id'], 'nickname')); } else { ?>{$msgWrittenBy|ucfirst|sprintf:<?php if(array_key_exists('user_id', (array) ${'items'})) { echo Frontend\Core\Engine\TemplateModifiers::userSetting(${'items'}['user_id'], 'nickname'); } else { ?>{$items->user_id|usersetting:'nickname'}<?php } ?>}<?php } ?>
						...
						<p class="pull-left"><span class="glyphicon glyphicon-time"></span>
							...
							<?php
					if(isset(${'items'}['allow_comments']) && count(${'items'}['allow_comments']) != 0 && ${'items'}['allow_comments'] != '' && ${'items'}['allow_comments'] !== false)
					{
						?>
					...
					if(!isset(${'items'}['tags']))
					{
						...
						${'items'}['tags'] = array();
						$this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_2']['tags']['fail'] = true;
					}
				if(isset(${'items'}['tags'])) $this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_2']['tags']['old'] = ${'items'}['tags'];
				$this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_2']['tags']['iteration'] = ${'items'}['tags'];
				$this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_2']['tags']['i'] = 1;
				$this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_2']['tags']['count'] = count($this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_2']['tags']['iteration']);
				foreach((array) $this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_2']['tags']['iteration'] as ${'items'}['tags'])
				{
					if(!isset(${'items'}['tags']['first']) && $this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_2']['tags']['i'] == 1) ${'items'}['tags']['first'] = true;
					if(!isset(${'items'}['tags']['last']) && $this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_2']['tags']['i'] == $this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_2']['tags']['count']) ${'items'}['tags']['last'] = true;
					...
					if(isset(${'items'}['tags']['last']) && count(${'items'}['tags']['last']) != 0 && ${'items'}['tags']['last'] != '' && ${'items'}['tags']['last'] !== false)
					{
						?>.<?php } ?>
								<?php
					$this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_2']['tags']['i']++;
				}
					if(isset($this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_2']['tags']['fail']) && $this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_2']['tags']['fail'] == true)
					{
						?>{/iteration:items->tags}<?php
					}
				if(isset($this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_2']['tags']['old'])) ${'items'}['tags'] = $this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_2']['tags']['old'];
				else unset($this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_2']['tags']);
				?>
							</p>
							<hr>
							<?php } ?>
	                ...
	                <a class="btn btn-primary" href="<?php if(array_key_exists('full_url', (array) ${'items'})) { echo ${'items'}['full_url']; } else { ?>{$items->full_url}<?php } ?>"><?php if(array_key_exists('lblMore', (array) $this->variables)) { echo SpoonFilter::ucfirst($this->variables['lblMore']); } else { ?>{$lblMore|ucfirst}<?php } ?> <span class="glyphicon glyphicon-chevron-right"></span></a>
					<hr>
			</article>
		<?php
					$this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_1']['i']++;
				}
					if(isset($this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_1']['fail']) && $this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_1']['fail'] == true)
					{
						?>{/iteration:items}<?php
					}
				if(isset($this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_1']['old'])) ${'items'} = $this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_1']['old'];
				else unset($this->iterations['660837989abc812d70694fa50c3686ca_Index.tpl.php_1']);
				?>
	</div>
	<?php $includes = array();
                ob_start();
                ...
                ob_start();
                ?>/home/segaz/domains/techno-mir.net/public_html/app/../src/Frontend/Themes/bootstrap/Core/Layout/Templates/Pagination.tpl<?php
                $includes[] = str_replace('//', '/', eval('return \'' . str_replace('\'', '\\\'', ob_get_clean()) .'\';'));
                ob_start();
                ...
                if($this->getForceCompile() || !file_exists($this->getCompileDirectory() .'/' . $this->getCompileName($include, '/home/segaz/domains/techno-mir.net/public_html/src/Frontend/Themes/bootstrap/Modules/Blog/Layout/Templates'))) $this->compile('/home/segaz/domains/techno-mir.net/public_html/src/Frontend/Themes/bootstrap/Modules/Blog/Layout/Templates', $include);
                $return = @include $this->getCompileDirectory() .'/' . $this->getCompileName($include, '/home/segaz/domains/techno-mir.net/public_html/src/Frontend/Themes/bootstrap/Modules/Blog/Layout/Templates');
                if($return === false && $this->compile('/home/segaz/domains/techno-mir.net/public_html/src/Frontend/Themes/bootstrap/Modules/Blog/Layout/Templates', $include)) {
                    $return = @include $this->getCompileDirectory() .'/' . $this->getCompileName($include, '/home/segaz/domains/techno-mir.net/public_html/src/Frontend/Themes/bootstrap/Modules/Blog/Layout/Templates');
                }
if($return === false) {

...
class Header extends FrontendBaseObject
{
    ...
    public function __construct(KernelInterface $kernel)
    {
        ...
        $this->addCSS('/src/Frontend/Core/Layout/Css/base.css', false);
        $this->addCSS('/src/Frontend/Core/Layout/Css/skeleton.css');
		$this->addCSS('/src/Frontend/Core/Layout/Css/layout.css');
        ...
        $this->addJS('/src/Frontend/Core/Js/jquery.malihu.PageScroll2id.min.js', true);
        $this->addJS('/src/Frontend/Core/Js/script.js', true);

			...
			<td id="user">
				<ul>
					...
					if(!isset($this->variables['workingLanguages']))
					{
						...
						$this->iterations['a9159985ee7527071be98bf0eb2d4ead_Header.tpl.php_1']['fail'] = true;
					}
				if(isset(${'workingLanguages'})) $this->iterations['a9159985ee7527071be98bf0eb2d4ead_Header.tpl.php_1']['old'] = ${'workingLanguages'};
				$this->iterations['a9159985ee7527071be98bf0eb2d4ead_Header.tpl.php_1']['iteration'] = $this->variables['workingLanguages'];
				$this->iterations['a9159985ee7527071be98bf0eb2d4ead_Header.tpl.php_1']['i'] = 1;
				$this->iterations['a9159985ee7527071be98bf0eb2d4ead_Header.tpl.php_1']['count'] = count($this->iterations['a9159985ee7527071be98bf0eb2d4ead_Header.tpl.php_1']['iteration']);
				foreach((array) $this->iterations['a9159985ee7527071be98bf0eb2d4ead_Header.tpl.php_1']['iteration'] as ${'workingLanguages'})
				{
					if(!isset(${'workingLanguages'}['first']) && $this->iterations['a9159985ee7527071be98bf0eb2d4ead_Header.tpl.php_1']['i'] == 1) ${'workingLanguages'}['first'] = true;
					if(!isset(${'workingLanguages'}['last']) && $this->iterations['a9159985ee7527071be98bf0eb2d4ead_Header.tpl.php_1']['i'] == $this->iterations['a9159985ee7527071be98bf0eb2d4ead_Header.tpl.php_1']['count']) ${'workingLanguages'}['last'] = true;
					...
					if(isset(${'workingLanguages'}['selected']) && count(${'workingLanguages'}['selected']) != 0 && ${'workingLanguages'}['selected'] != '' && ${'workingLanguages'}['selected'] !== false)
					{
						?> selected="selected"<?php } ?> value="<?php if(array_key_exists('abbr', (array) ${'workingLanguages'})) { echo ${'workingLanguages'}['abbr']; } else { ?>{$workingLanguages->abbr}<?php } ?>"><?php if(array_key_exists('label', (array) ${'workingLanguages'})) { echo SpoonFilter::ucfirst(${'workingLanguages'}['label']); } else { ?>{$workingLanguages->label|ucfirst}<?php } ?></option>
								<?php
					$this->iterations['a9159985ee7527071be98bf0eb2d4ead_Header.tpl.php_1']['i']++;
				}
					if(isset($this->iterations['a9159985ee7527071be98bf0eb2d4ead_Header.tpl.php_1']['fail']) && $this->iterations['a9159985ee7527071be98bf0eb2d4ead_Header.tpl.php_1']['fail'] == true)
					{
						?>{/iteration:workingLanguages}<?php
					}
				if(isset($this->iterations['a9159985ee7527071be98bf0eb2d4ead_Header.tpl.php_1']['old'])) ${'workingLanguages'} = $this->iterations['a9159985ee7527071be98bf0eb2d4ead_Header.tpl.php_1']['old'];
				else unset($this->iterations['a9159985ee7527071be98bf0eb2d4ead_Header.tpl.php_1']);
				?>
							</select>
						</li>
					<?php } ?>

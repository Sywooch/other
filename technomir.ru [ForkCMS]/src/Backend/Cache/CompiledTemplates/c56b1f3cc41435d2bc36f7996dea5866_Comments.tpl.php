			...
			<tbody>
				<?php
					if(!isset($this->variables['blogComments']))
					{
						...
						$this->iterations['c56b1f3cc41435d2bc36f7996dea5866_Comments.tpl.php_1']['fail'] = true;
					}
				if(isset(${'blogComments'})) $this->iterations['c56b1f3cc41435d2bc36f7996dea5866_Comments.tpl.php_1']['old'] = ${'blogComments'};
				$this->iterations['c56b1f3cc41435d2bc36f7996dea5866_Comments.tpl.php_1']['iteration'] = $this->variables['blogComments'];
				$this->iterations['c56b1f3cc41435d2bc36f7996dea5866_Comments.tpl.php_1']['i'] = 1;
				$this->iterations['c56b1f3cc41435d2bc36f7996dea5866_Comments.tpl.php_1']['count'] = count($this->iterations['c56b1f3cc41435d2bc36f7996dea5866_Comments.tpl.php_1']['iteration']);
				foreach((array) $this->iterations['c56b1f3cc41435d2bc36f7996dea5866_Comments.tpl.php_1']['iteration'] as ${'blogComments'})
				{
					if(!isset(${'blogComments'}['first']) && $this->iterations['c56b1f3cc41435d2bc36f7996dea5866_Comments.tpl.php_1']['i'] == 1) ${'blogComments'}['first'] = true;
					if(!isset(${'blogComments'}['last']) && $this->iterations['c56b1f3cc41435d2bc36f7996dea5866_Comments.tpl.php_1']['i'] == $this->iterations['c56b1f3cc41435d2bc36f7996dea5866_Comments.tpl.php_1']['count']) ${'blogComments'}['last'] = true;
				...
				<tr class="<?php
					$arguments = array();
						...
						?>even<?php
						$arguments[] = eval('return \'' . str_replace('\'', '\\\'', ob_get_clean()) .'\';');
					echo $this->cycle($this->iterations['c56b1f3cc41435d2bc36f7996dea5866_Comments.tpl.php_1']['i'], $arguments);
					?>
">
				...
				<?php
					$this->iterations['c56b1f3cc41435d2bc36f7996dea5866_Comments.tpl.php_1']['i']++;
				}
					if(isset($this->iterations['c56b1f3cc41435d2bc36f7996dea5866_Comments.tpl.php_1']['fail']) && $this->iterations['c56b1f3cc41435d2bc36f7996dea5866_Comments.tpl.php_1']['fail'] == true)
					{
						?>{/iteration:blogComments}<?php
					}
				if(isset($this->iterations['c56b1f3cc41435d2bc36f7996dea5866_Comments.tpl.php_1']['old'])) ${'blogComments'} = $this->iterations['c56b1f3cc41435d2bc36f7996dea5866_Comments.tpl.php_1']['old'];
				else unset($this->iterations['c56b1f3cc41435d2bc36f7996dea5866_Comments.tpl.php_1']);
				?>
			</tbody>
		</table>
	</div>

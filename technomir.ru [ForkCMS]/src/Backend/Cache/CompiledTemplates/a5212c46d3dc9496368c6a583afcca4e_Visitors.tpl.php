			...
			<div id="dataChartWidget" class="hidden">
				...
				<ul class="series">
					...
					if(!isset($this->variables['analyticsGraphData']))
					{
						...
						$this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_1']['fail'] = true;
					}
				if(isset(${'analyticsGraphData'})) $this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_1']['old'] = ${'analyticsGraphData'};
				$this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_1']['iteration'] = $this->variables['analyticsGraphData'];
				$this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_1']['i'] = 1;
				$this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_1']['count'] = count($this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_1']['iteration']);
				foreach((array) $this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_1']['iteration'] as ${'analyticsGraphData'})
				{
					if(!isset(${'analyticsGraphData'}['first']) && $this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_1']['i'] == 1) ${'analyticsGraphData'}['first'] = true;
					if(!isset(${'analyticsGraphData'}['last']) && $this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_1']['i'] == $this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_1']['count']) ${'analyticsGraphData'}['last'] = true;
					...
					if(!isset(${'analyticsGraphData'}['data']))
					{
						...
						$this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_2']['data']['fail'] = true;
					}
				if(isset(${'analyticsGraphData'}['data'])) $this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_2']['data']['old'] = ${'analyticsGraphData'}['data'];
				$this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_2']['data']['iteration'] = ${'analyticsGraphData'}['data'];
				$this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_2']['data']['i'] = 1;
				$this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_2']['data']['count'] = count($this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_2']['data']['iteration']);
				foreach((array) $this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_2']['data']['iteration'] as ${'analyticsGraphData'}['data'])
				{
					if(!isset(${'analyticsGraphData'}['data']['first']) && $this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_2']['data']['i'] == 1) ${'analyticsGraphData'}['data']['first'] = true;
					if(!isset(${'analyticsGraphData'}['data']['last']) && $this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_2']['data']['i'] == $this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_2']['data']['count']) ${'analyticsGraphData'}['data']['last'] = true;
					if(isset(${'analyticsGraphData'}['data']['formElements']) && is_array(${'analyticsGraphData'}['data']['formElements']))
					{
						foreach(${'analyticsGraphData'}['data']['formElements'] as $name => $object)
						{
							...
							${'analyticsGraphData'}['data'][$name .'Error'] = (is_callable(array($object, 'getErrors')) && $object->getErrors() != '') ? '<span class="formError">' . $object->getErrors() .'</span>' : '';
								...
								<?php
					$this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_2']['data']['i']++;
				}
					if(isset($this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_2']['data']['fail']) && $this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_2']['data']['fail'] == true)
					{
						?>{/iteration:analyticsGraphData->data}<?php
					}
				if(isset($this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_2']['data']['old'])) ${'analyticsGraphData'}['data'] = $this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_2']['data']['old'];
				else unset($this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_2']['data']);
				?>
							</ul>
						</li>
					<?php
					$this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_1']['i']++;
				}
					if(isset($this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_1']['fail']) && $this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_1']['fail'] == true)
					{
						?>{/iteration:analyticsGraphData}<?php
					}
				if(isset($this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_1']['old'])) ${'analyticsGraphData'} = $this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_1']['old'];
				else unset($this->iterations['a5212c46d3dc9496368c6a583afcca4e_Visitors.tpl.php_1']);
				?>
				</ul>
			</div>

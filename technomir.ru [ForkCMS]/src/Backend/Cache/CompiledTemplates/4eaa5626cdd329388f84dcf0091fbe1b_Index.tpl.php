...
<div class="pageTitle">
	<h2><?php if(array_key_exists('lblContentBlocks', (array) $this->variables)) { echo SpoonFilter::ucfirst($this->variables['lblContentBlocks']); } else { ?>{$lblContentBlocks|ucfirst}<?php } ?></h2>

	<?php
					if(isset($this->variables['showContentBlocksAdd']) && count($this->variables['showContentBlocksAdd']) != 0 && $this->variables['showContentBlocksAdd'] != '' && $this->variables['showContentBlocksAdd'] !== false)
					{
						?>

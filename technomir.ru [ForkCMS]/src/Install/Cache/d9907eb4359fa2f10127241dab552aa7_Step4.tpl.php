	...
	<?php
		...
		<div>
			...
			<ul id="moduleList" class="inputList noPadding">
				<?php
				if(isset(${'modules'})) $this->iterations['d9907eb4359fa2f10127241dab552aa7_Step4.tpl.php_1']['old'] = ${'modules'};
				$this->iterations['d9907eb4359fa2f10127241dab552aa7_Step4.tpl.php_1']['iteration'] = $this->variables['modules'];
				$this->iterations['d9907eb4359fa2f10127241dab552aa7_Step4.tpl.php_1']['i'] = 1;
				$this->iterations['d9907eb4359fa2f10127241dab552aa7_Step4.tpl.php_1']['count'] = count($this->iterations['d9907eb4359fa2f10127241dab552aa7_Step4.tpl.php_1']['iteration']);
				foreach((array) $this->iterations['d9907eb4359fa2f10127241dab552aa7_Step4.tpl.php_1']['iteration'] as ${'modules'})
				{
					if(!isset(${'modules'}['first']) && $this->iterations['d9907eb4359fa2f10127241dab552aa7_Step4.tpl.php_1']['i'] == 1) ${'modules'}['first'] = true;
					if(!isset(${'modules'}['last']) && $this->iterations['d9907eb4359fa2f10127241dab552aa7_Step4.tpl.php_1']['i'] == $this->iterations['d9907eb4359fa2f10127241dab552aa7_Step4.tpl.php_1']['count']) ${'modules'}['last'] = true;
				...
				<?php
					$this->iterations['d9907eb4359fa2f10127241dab552aa7_Step4.tpl.php_1']['i']++;
				}
				if(isset($this->iterations['d9907eb4359fa2f10127241dab552aa7_Step4.tpl.php_1']['old'])) ${'modules'} = $this->iterations['d9907eb4359fa2f10127241dab552aa7_Step4.tpl.php_1']['old'];
				else unset($this->iterations['d9907eb4359fa2f10127241dab552aa7_Step4.tpl.php_1']);
				?>
			</ul>

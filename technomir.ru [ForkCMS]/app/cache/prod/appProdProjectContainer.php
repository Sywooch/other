...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/segaz/domains/techno-mir.net/public_html/app/cache/prod/annotations', false);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/segaz/domains/techno-mir.net/public_html/app/Resources');
    ...
    {
        $this->services['database'] = $instance = new \SpoonDatabase('mysql', 'localhost', 'root', '', 'segaz_technomir', 3306);
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/segaz/domains/techno-mir.net/public_html/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/segaz/domains/techno-mir.net/public_html/app/../app/logs/logs.log', 100, true);
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/segaz/domains/techno-mir.net/public_html/app', 'utf-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/home/segaz/domains/techno-mir.net/public_html/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/segaz/domains/techno-mir.net/public_html/app/cache/prod/twig', 'charset' => 'utf-8', 'paths' => array()));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\TranslationExtension($this->get('translator')));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\AssetsExtension($this));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\ActionsExtension($this));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/segaz/domains/techno-mir.net/public_html/app', 'utf-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/segaz/domains/techno-mir.net/public_html/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/segaz/domains/techno-mir.net/public_html/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/segaz/domains/techno-mir.net/public_html/app/Resources/views');
        return $instance;
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('UIrXPCw5nDZVZcSBc2eraaVPYUE5BCNE');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/segaz/domains/techno-mir.net/public_html/app/cache/prod');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/segaz/domains/techno-mir.net/public_html/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/segaz/domains/techno-mir.net/public_html/app/cache/prod',
            'kernel.logs_dir' => '/home/segaz/domains/techno-mir.net/public_html/app/logs',
            ...
            'database.port' => 3306,
            'database.name' => 'segaz_technomir',
            'database.user' => 'root',
            'database.password' => '',
            'kernel.secret' => 'UIrXPCw5nDZVZcSBc2eraaVPYUE5BCNE',
            'fork.debug_email' => 'deniuscoder@mail.ru',
            'fork.debug_message' => 'Internal error.',
            'fork.version' => '3.8.1',
            'site.protocol' => 'http',
            'site.domain' => 'techno-mir.net',
            'site.default_title' => 'Fork CMS',
            'site.multilanguage' => false,
            'site.default_language' => 'ru',
            'site.path_www' => '/home/segaz/domains/techno-mir.net/public_html/app/..',
            'site.path_library' => '/home/segaz/domains/techno-mir.net/public_html/app/../library',
            ...
            'router.resource' => '/home/segaz/domains/techno-mir.net/public_html/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/segaz/domains/techno-mir.net/public_html/app/cache/prod/twig',
                'charset' => 'utf-8',
                'paths' => array(
                ),
            ),

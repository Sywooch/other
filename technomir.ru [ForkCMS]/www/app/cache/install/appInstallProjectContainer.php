...
class appInstallProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/segaz/domains/techno-mir.net/public_html/app/cache/install/annotations', false);
    }
    ...
    {
        $this->services['database'] = $instance = new \SpoonDatabase('mysql', NULL, NULL, NULL, NULL, NULL);
    ...
    {
        $a = $this->get('templating.engine.twig');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('installation');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/segaz/domains/techno-mir.net/public_html/app/cache/install');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => '/home/segaz/domains/techno-mir.net/public_html/app/cache/install',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/segaz/domains/techno-mir.net/public_html/app/cache/install/twig',
                'charset' => 'utf-8',
                'paths' => array(
                ),
            ),

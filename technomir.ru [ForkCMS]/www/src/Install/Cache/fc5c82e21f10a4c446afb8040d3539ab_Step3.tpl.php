...
<?php
	...
	<?php
		...
		<div>
			...
			<ul class="inputList">
				<?php
				if(isset(${'language_type'})) $this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_1']['old'] = ${'language_type'};
				$this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_1']['iteration'] = $this->variables['language_type'];
				$this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_1']['i'] = 1;
				$this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_1']['count'] = count($this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_1']['iteration']);
				foreach((array) $this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_1']['iteration'] as ${'language_type'})
				{
					if(!isset(${'language_type'}['first']) && $this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_1']['i'] == 1) ${'language_type'}['first'] = true;
					if(!isset(${'language_type'}['last']) && $this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_1']['i'] == $this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_1']['count']) ${'language_type'}['last'] = true;
					...
					if(isset(${'language_type'}['multiple']) && count(${'language_type'}['multiple']) != 0 && ${'language_type'}['multiple'] != '' && ${'language_type'}['multiple'] !== false)
					{
						...
						<ul id="languages" class="hidden inputList noPadding">
							<?php
				if(isset(${'languages'})) $this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_3']['old'] = ${'languages'};
				$this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_3']['iteration'] = $this->variables['languages'];
				$this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_3']['i'] = 1;
				$this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_3']['count'] = count($this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_3']['iteration']);
				foreach((array) $this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_3']['iteration'] as ${'languages'})
				{
					if(!isset(${'languages'}['first']) && $this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_3']['i'] == 1) ${'languages'}['first'] = true;
					if(!isset(${'languages'}['last']) && $this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_3']['i'] == $this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_3']['count']) ${'languages'}['last'] = true;
					if(isset(${'languages'}['formElements']) && is_array(${'languages'}['formElements']))
					{
						foreach(${'languages'}['formElements'] as $name => $object)
						{
							...
							<?php
					$this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_3']['i']++;
				}
				if(isset($this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_3']['old'])) ${'languages'} = $this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_3']['old'];
				else unset($this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_3']);
				?>
						</ul>
					<?php } ?>
					</li>
					...
					<?php } ?>
				<?php
					$this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_1']['i']++;
				}
				if(isset($this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_1']['old'])) ${'language_type'} = $this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_1']['old'];
				else unset($this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_1']);
				?>
			</ul>
			...
			<ul class="inputList">
				<li>
					...
					<ul id="interfaceLanguages" class="hidden inputList noPadding">
						<?php
				if(isset(${'interfaceLanguages'})) $this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_2']['old'] = ${'interfaceLanguages'};
				$this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_2']['iteration'] = $this->variables['interfaceLanguages'];
				$this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_2']['i'] = 1;
				$this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_2']['count'] = count($this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_2']['iteration']);
				foreach((array) $this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_2']['iteration'] as ${'interfaceLanguages'})
				{
					if(!isset(${'interfaceLanguages'}['first']) && $this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_2']['i'] == 1) ${'interfaceLanguages'}['first'] = true;
					if(!isset(${'interfaceLanguages'}['last']) && $this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_2']['i'] == $this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_2']['count']) ${'interfaceLanguages'}['last'] = true;
					if(isset(${'interfaceLanguages'}['formElements']) && is_array(${'interfaceLanguages'}['formElements']))
					{
						...
						<?php
					$this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_2']['i']++;
				}
				if(isset($this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_2']['old'])) ${'interfaceLanguages'} = $this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_2']['old'];
				else unset($this->iterations['fc5c82e21f10a4c446afb8040d3539ab_Step3.tpl.php_2']);
				?>
					</ul>
				</li>
			</ul>

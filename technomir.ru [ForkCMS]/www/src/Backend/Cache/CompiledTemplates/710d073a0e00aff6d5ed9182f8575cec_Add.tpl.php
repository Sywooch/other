			...
			<div id="editContent">
				<?php
					if(!isset($this->variables['positions']))
					{
						...
						$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_1']['fail'] = true;
					}
				if(isset(${'positions'})) $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_1']['old'] = ${'positions'};
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_1']['iteration'] = $this->variables['positions'];
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_1']['i'] = 1;
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_1']['count'] = count($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_1']['iteration']);
				foreach((array) $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_1']['iteration'] as ${'positions'})
				{
					if(!isset(${'positions'}['first']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_1']['i'] == 1) ${'positions'}['first'] = true;
					if(!isset(${'positions'}['last']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_1']['i'] == $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_1']['count']) ${'positions'}['last'] = true;
					...
					if(!isset(${'positions'}['blocks']))
					{
						...
						$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_8']['blocks']['fail'] = true;
					}
				if(isset(${'positions'}['blocks'])) $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_8']['blocks']['old'] = ${'positions'}['blocks'];
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_8']['blocks']['iteration'] = ${'positions'}['blocks'];
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_8']['blocks']['i'] = 1;
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_8']['blocks']['count'] = count($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_8']['blocks']['iteration']);
				foreach((array) $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_8']['blocks']['iteration'] as ${'positions'}['blocks'])
				{
					if(!isset(${'positions'}['blocks']['first']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_8']['blocks']['i'] == 1) ${'positions'}['blocks']['first'] = true;
					if(!isset(${'positions'}['blocks']['last']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_8']['blocks']['i'] == $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_8']['blocks']['count']) ${'positions'}['blocks']['last'] = true;
					...
					<?php
					$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_8']['blocks']['i']++;
				}
					if(isset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_8']['blocks']['fail']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_8']['blocks']['fail'] == true)
					{
						?>{/iteration:positions->blocks}<?php
					}
				if(isset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_8']['blocks']['old'])) ${'positions'}['blocks'] = $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_8']['blocks']['old'];
				else unset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_8']['blocks']);
				?>
				<?php
					$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_1']['i']++;
				}
					if(isset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_1']['fail']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_1']['fail'] == true)
					{
						?>{/iteration:positions}<?php
					}
				if(isset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_1']['old'])) ${'positions'} = $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_1']['old'];
				else unset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_1']);
				?>
			</div>
		</div>
			...
			<div class="subtleBox">
				...
				<div class="options">
					...
					if(!isset($this->variables['seo_index']))
					{
						...
						$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_2']['fail'] = true;
					}
				if(isset(${'seo_index'})) $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_2']['old'] = ${'seo_index'};
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_2']['iteration'] = $this->variables['seo_index'];
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_2']['i'] = 1;
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_2']['count'] = count($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_2']['iteration']);
				foreach((array) $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_2']['iteration'] as ${'seo_index'})
				{
					if(!isset(${'seo_index'}['first']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_2']['i'] == 1) ${'seo_index'}['first'] = true;
					if(!isset(${'seo_index'}['last']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_2']['i'] == $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_2']['count']) ${'seo_index'}['last'] = true;
					if(isset(${'seo_index'}['formElements']) && is_array(${'seo_index'}['formElements']))
					{
						...
						<?php
					$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_2']['i']++;
				}
					if(isset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_2']['fail']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_2']['fail'] == true)
					{
						?>{/iteration:seo_index}<?php
					}
				if(isset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_2']['old'])) ${'seo_index'} = $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_2']['old'];
				else unset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_2']);
				?>
					</ul>
					...
					if(!isset($this->variables['seo_follow']))
					{
						...
						$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_3']['fail'] = true;
					}
				if(isset(${'seo_follow'})) $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_3']['old'] = ${'seo_follow'};
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_3']['iteration'] = $this->variables['seo_follow'];
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_3']['i'] = 1;
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_3']['count'] = count($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_3']['iteration']);
				foreach((array) $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_3']['iteration'] as ${'seo_follow'})
				{
					if(!isset(${'seo_follow'}['first']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_3']['i'] == 1) ${'seo_follow'}['first'] = true;
					if(!isset(${'seo_follow'}['last']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_3']['i'] == $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_3']['count']) ${'seo_follow'}['last'] = true;
					if(isset(${'seo_follow'}['formElements']) && is_array(${'seo_follow'}['formElements']))
					{
						...
						<?php
					$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_3']['i']++;
				}
					if(isset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_3']['fail']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_3']['fail'] == true)
					{
						?>{/iteration:seo_follow}<?php
					}
				if(isset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_3']['old'])) ${'seo_follow'} = $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_3']['old'];
				else unset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_3']);
				?>
					</ul>
				</div>
			</div>
			...
			<div class="subtleBox">
				...
				<div class="options">
					...
					if(!isset($this->variables['redirect']))
					{
						...
						$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_4']['fail'] = true;
					}
				if(isset(${'redirect'})) $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_4']['old'] = ${'redirect'};
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_4']['iteration'] = $this->variables['redirect'];
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_4']['i'] = 1;
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_4']['count'] = count($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_4']['iteration']);
				foreach((array) $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_4']['iteration'] as ${'redirect'})
				{
					if(!isset(${'redirect'}['first']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_4']['i'] == 1) ${'redirect'}['first'] = true;
					if(!isset(${'redirect'}['last']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_4']['i'] == $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_4']['count']) ${'redirect'}['last'] = true;
					...
					if(isset(${'redirect'}['isExternal']) && count(${'redirect'}['isExternal']) != 0 && ${'redirect'}['isExternal'] != '' && ${'redirect'}['isExternal'] !== false)
					{
						...
						<?php
					$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_4']['i']++;
				}
					if(isset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_4']['fail']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_4']['fail'] == true)
					{
						?>{/iteration:redirect}<?php
					}
				if(isset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_4']['old'])) ${'redirect'} = $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_4']['old'];
				else unset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_4']);
				?>
					</ul>
				</div>
			</div>
			...
			<div class="subtleBox">
				...
				<div class="options">
					...
					if(!isset($this->variables['hidden']))
					{
						...
						$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_5']['fail'] = true;
					}
				if(isset(${'hidden'})) $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_5']['old'] = ${'hidden'};
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_5']['iteration'] = $this->variables['hidden'];
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_5']['i'] = 1;
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_5']['count'] = count($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_5']['iteration']);
				foreach((array) $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_5']['iteration'] as ${'hidden'})
				{
					if(!isset(${'hidden'}['first']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_5']['i'] == 1) ${'hidden'}['first'] = true;
					if(!isset(${'hidden'}['last']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_5']['i'] == $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_5']['count']) ${'hidden'}['last'] = true;
					if(isset(${'hidden'}['formElements']) && is_array(${'hidden'}['formElements']))
					{
						...
						<?php
					$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_5']['i']++;
				}
					if(isset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_5']['fail']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_5']['fail'] == true)
					{
						?>{/iteration:hidden}<?php
					}
				if(isset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_5']['old'])) ${'hidden'} = $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_5']['old'];
				else unset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_5']);
				?>
					</ul>
					<p>
					...
					if(!isset($this->variables['allow']))
					{
						...
						$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_6']['fail'] = true;
					}
				if(isset(${'allow'})) $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_6']['old'] = ${'allow'};
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_6']['iteration'] = $this->variables['allow'];
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_6']['i'] = 1;
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_6']['count'] = count($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_6']['iteration']);
				foreach((array) $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_6']['iteration'] as ${'allow'})
				{
					if(!isset(${'allow'}['first']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_6']['i'] == 1) ${'allow'}['first'] = true;
					if(!isset(${'allow'}['last']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_6']['i'] == $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_6']['count']) ${'allow'}['last'] = true;
					if(isset(${'allow'}['formElements']) && is_array(${'allow'}['formElements']))
					{
						foreach(${'allow'}['formElements'] as $name => $object)
						{
							...
							<?php
					$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_6']['i']++;
				}
					if(isset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_6']['fail']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_6']['fail'] == true)
					{
						?>{/iteration:allow}<?php
					}
				if(isset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_6']['old'])) ${'allow'} = $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_6']['old'];
				else unset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_6']);
				?>
						</ul>
					<?php } ?>
				</div>
	...
	<div id="chooseTemplate" class="forkForms" title="<?php if(array_key_exists('lblChooseATemplate', (array) $this->variables)) { echo SpoonFilter::ucfirst($this->variables['lblChooseATemplate']); } else { ?>{$lblChooseATemplate|ucfirst}<?php } ?>" style="display: none;">
		...
		<div id="templateList">
			<ul>
				<?php
					if(!isset($this->variables['templates']))
					{
						...
						$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_9']['fail'] = true;
					}
				if(isset(${'templates'})) $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_9']['old'] = ${'templates'};
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_9']['iteration'] = $this->variables['templates'];
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_9']['i'] = 1;
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_9']['count'] = count($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_9']['iteration']);
				foreach((array) $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_9']['iteration'] as ${'templates'})
				{
					if(!isset(${'templates'}['first']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_9']['i'] == 1) ${'templates'}['first'] = true;
					if(!isset(${'templates'}['last']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_9']['i'] == $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_9']['count']) ${'templates'}['last'] = true;
			...
			<?php } ?>
				...
				<?php
					$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_9']['i']++;
				}
					if(isset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_9']['fail']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_9']['fail'] == true)
					{
						?>{/iteration:templates}<?php
					}
				if(isset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_9']['old'])) ${'templates'} = $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_9']['old'];
				else unset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_9']);
				?>
			</ul>
		</div>
	</div>
	...
	//<![CDATA[
		...
		<?php
					if(!isset($this->variables['templates']))
					{
						?>{iteration:templates}<?php
						$this->variables['templates'] = array();
						$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_7']['fail'] = true;
					}
				if(isset(${'templates'})) $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_7']['old'] = ${'templates'};
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_7']['iteration'] = $this->variables['templates'];
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_7']['i'] = 1;
				$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_7']['count'] = count($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_7']['iteration']);
				foreach((array) $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_7']['iteration'] as ${'templates'})
				{
					if(!isset(${'templates'}['first']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_7']['i'] == 1) ${'templates'}['first'] = true;
					if(!isset(${'templates'}['last']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_7']['i'] == $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_7']['count']) ${'templates'}['last'] = true;
					if(isset(${'templates'}['formElements']) && is_array(${'templates'}['formElements']))
					{
						foreach(${'templates'}['formElements'] as $name => $object)
						{
					...
					$this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_7']['i']++;
				}
					if(isset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_7']['fail']) && $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_7']['fail'] == true)
					{
						?>{/iteration:templates}<?php
					}
				if(isset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_7']['old'])) ${'templates'} = $this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_7']['old'];
				else unset($this->iterations['710d073a0e00aff6d5ed9182f8575cec_Add.tpl.php_7']);
				?>

...
<?php
				...
				if($this->getForceCompile() || !file_exists($this->getCompileDirectory() .'/' . $this->getCompileName($include, 'J:\home\technomir.com\www\src\Backend\Modules\Groups\Layout\Templates'))) $this->compile('J:\home\technomir.com\www\src\Backend\Modules\Groups\Layout\Templates', $include);
				$return = @include $this->getCompileDirectory() .'/' . $this->getCompileName($include, 'J:\home\technomir.com\www\src\Backend\Modules\Groups\Layout\Templates');
				if($return === false && $this->compile('J:\home\technomir.com\www\src\Backend\Modules\Groups\Layout\Templates', $include))
				{
					$return = @include $this->getCompileDirectory() .'/' . $this->getCompileName($include, 'J:\home\technomir.com\www\src\Backend\Modules\Groups\Layout\Templates');
				}
if($return === false)
...
<div class="pageTitle">
	<h2><?php if(array_key_exists('lblGroups', (array) $this->variables)) { echo SpoonFilter::ucfirst($this->variables['lblGroups']); } else { ?>{$lblGroups|ucfirst}<?php } ?></h2>

		...
		<tr>
			<?php
					if(!isset($this->variables['headers']))
					{
						...
						$this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_1']['fail'] = true;
					}
				if(isset(${'headers'})) $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_1']['old'] = ${'headers'};
				$this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_1']['iteration'] = $this->variables['headers'];
				$this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_1']['i'] = 1;
				$this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_1']['count'] = count($this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_1']['iteration']);
				foreach((array) $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_1']['iteration'] as ${'headers'})
				{
					if(!isset(${'headers'}['first']) && $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_1']['i'] == 1) ${'headers'}['first'] = true;
					if(!isset(${'headers'}['last']) && $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_1']['i'] == $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_1']['count']) ${'headers'}['last'] = true;
			...
			<?php
					$this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_1']['i']++;
				}
					if(isset($this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_1']['fail']) && $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_1']['fail'] == true)
					{
						?>{/iteration:headers}<?php
					}
				if(isset($this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_1']['old'])) ${'headers'} = $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_1']['old'];
				else unset($this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_1']);
				?>
		</tr>
	</thead>
	<tbody>
		<?php
					if(!isset($this->variables['rows']))
					{
						...
						$this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_2']['fail'] = true;
					}
				if(isset(${'rows'})) $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_2']['old'] = ${'rows'};
				$this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_2']['iteration'] = $this->variables['rows'];
				$this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_2']['i'] = 1;
				$this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_2']['count'] = count($this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_2']['iteration']);
				foreach((array) $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_2']['iteration'] as ${'rows'})
				{
					if(!isset(${'rows'}['first']) && $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_2']['i'] == 1) ${'rows'}['first'] = true;
					if(!isset(${'rows'}['last']) && $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_2']['i'] == $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_2']['count']) ${'rows'}['last'] = true;
			...
			<tr<?php if(array_key_exists('attributes', (array) ${'rows'})) { echo ${'rows'}['attributes']; } else { ?>{$rows->attributes}<?php } ?>>
				<?php
					if(!isset(${'rows'}['columns']))
					{
						...
						${'rows'}['columns'] = array();
						$this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_3']['columns']['fail'] = true;
					}
				if(isset(${'rows'}['columns'])) $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_3']['columns']['old'] = ${'rows'}['columns'];
				$this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_3']['columns']['iteration'] = ${'rows'}['columns'];
				$this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_3']['columns']['i'] = 1;
				$this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_3']['columns']['count'] = count($this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_3']['columns']['iteration']);
				foreach((array) $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_3']['columns']['iteration'] as ${'rows'}['columns'])
				{
					if(!isset(${'rows'}['columns']['first']) && $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_3']['columns']['i'] == 1) ${'rows'}['columns']['first'] = true;
					if(!isset(${'rows'}['columns']['last']) && $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_3']['columns']['i'] == $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_3']['columns']['count']) ${'rows'}['columns']['last'] = true;
					...
					$this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_3']['columns']['i']++;
				}
					if(isset($this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_3']['columns']['fail']) && $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_3']['columns']['fail'] == true)
					{
						?>{/iteration:rows->columns}<?php
					}
				if(isset($this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_3']['columns']['old'])) ${'rows'}['columns'] = $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_3']['columns']['old'];
				else unset($this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_3']['columns']);
				?>
			</tr>
		<?php
					$this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_2']['i']++;
				}
					if(isset($this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_2']['fail']) && $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_2']['fail'] == true)
					{
						?>{/iteration:rows}<?php
					}
				if(isset($this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_2']['old'])) ${'rows'} = $this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_2']['old'];
				else unset($this->iterations['5680d52ecc5d1af4504c3b3ec66e4cc2_Datagrid.tpl.php_2']);
				?>
	</tbody>
	<?php

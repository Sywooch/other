...
<?php
				...
				if($this->getForceCompile() || !file_exists($this->getCompileDirectory() .'/' . $this->getCompileName($include, 'J:\home\technomir.com\www\src\Backend\Modules\Settings\Layout\Templates'))) $this->compile('J:\home\technomir.com\www\src\Backend\Modules\Settings\Layout\Templates', $include);
				$return = @include $this->getCompileDirectory() .'/' . $this->getCompileName($include, 'J:\home\technomir.com\www\src\Backend\Modules\Settings\Layout\Templates');
				if($return === false && $this->compile('J:\home\technomir.com\www\src\Backend\Modules\Settings\Layout\Templates', $include))
				{
					$return = @include $this->getCompileDirectory() .'/' . $this->getCompileName($include, 'J:\home\technomir.com\www\src\Backend\Modules\Settings\Layout\Templates');
				}
if($return === false)
...
<?php
			...
			<ul class="pb0">
				<?php
					if(!isset($this->variables['warnings']))
					{
						...
						$this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_1']['fail'] = true;
					}
				if(isset(${'warnings'})) $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_1']['old'] = ${'warnings'};
				$this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_1']['iteration'] = $this->variables['warnings'];
				$this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_1']['i'] = 1;
				$this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_1']['count'] = count($this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_1']['iteration']);
				foreach((array) $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_1']['iteration'] as ${'warnings'})
				{
					if(!isset(${'warnings'}['first']) && $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_1']['i'] == 1) ${'warnings'}['first'] = true;
					if(!isset(${'warnings'}['last']) && $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_1']['i'] == $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_1']['count']) ${'warnings'}['last'] = true;
				...
				<?php
					$this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_1']['i']++;
				}
					if(isset($this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_1']['fail']) && $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_1']['fail'] == true)
					{
						?>{/iteration:warnings}<?php
					}
				if(isset($this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_1']['old'])) ${'warnings'} = $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_1']['old'];
				else unset($this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_1']);
				?>
			</ul>
		</div>
	<?php } ?>
			...
			<ul id="activeLanguages" class="inputList pb0">
				<?php
					if(!isset($this->variables['activeLanguages']))
					{
						...
						$this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_2']['fail'] = true;
					}
				if(isset(${'activeLanguages'})) $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_2']['old'] = ${'activeLanguages'};
				$this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_2']['iteration'] = $this->variables['activeLanguages'];
				$this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_2']['i'] = 1;
				$this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_2']['count'] = count($this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_2']['iteration']);
				foreach((array) $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_2']['iteration'] as ${'activeLanguages'})
				{
					if(!isset(${'activeLanguages'}['first']) && $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_2']['i'] == 1) ${'activeLanguages'}['first'] = true;
					if(!isset(${'activeLanguages'}['last']) && $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_2']['i'] == $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_2']['count']) ${'activeLanguages'}['last'] = true;
				...
				<?php
					$this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_2']['i']++;
				}
					if(isset($this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_2']['fail']) && $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_2']['fail'] == true)
					{
						?>{/iteration:activeLanguages}<?php
					}
				if(isset($this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_2']['old'])) ${'activeLanguages'} = $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_2']['old'];
				else unset($this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_2']);
				?>
			</ul>
		</div>
		<div class="options">
			...
			<ul id="redirectLanguages" class="inputList pb0">
				<?php
					if(!isset($this->variables['redirectLanguages']))
					{
						...
						$this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_3']['fail'] = true;
					}
				if(isset(${'redirectLanguages'})) $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_3']['old'] = ${'redirectLanguages'};
				$this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_3']['iteration'] = $this->variables['redirectLanguages'];
				$this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_3']['i'] = 1;
				$this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_3']['count'] = count($this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_3']['iteration']);
				foreach((array) $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_3']['iteration'] as ${'redirectLanguages'})
				{
					if(!isset(${'redirectLanguages'}['first']) && $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_3']['i'] == 1) ${'redirectLanguages'}['first'] = true;
					if(!isset(${'redirectLanguages'}['last']) && $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_3']['i'] == $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_3']['count']) ${'redirectLanguages'}['last'] = true;
					...
					if(isset(${'redirectLanguages'}['default']) && count(${'redirectLanguages'}['default']) != 0 && ${'redirectLanguages'}['default'] != '' && ${'redirectLanguages'}['default'] !== false)
					{
						?> (<?php if(array_key_exists('lblDefault', (array) $this->variables)) { echo $this->variables['lblDefault']; } else { ?>{$lblDefault}<?php } ?>)<?php } ?></label></li>
				<?php
					$this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_3']['i']++;
				}
					if(isset($this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_3']['fail']) && $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_3']['fail'] == true)
					{
						?>{/iteration:redirectLanguages}<?php
					}
				if(isset($this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_3']['old'])) ${'redirectLanguages'} = $this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_3']['old'];
				else unset($this->iterations['83efe85d0e2693945b0fb922971d020d_Index.tpl.php_3']);
				?>
			</ul>
		</div>
	</div>
    ...
    <div class="box horizontal">
        ...
        <div class="options labelWidthLong">
            <p>
                <label for="twitterSiteName"><?php if(array_key_exists('lblTwitterSiteName', (array) $this->variables)) { echo SpoonFilter::ucfirst($this->variables['lblTwitterSiteName']); } else { ?>{$lblTwitterSiteName|ucfirst}<?php } ?></label>
                <span style="float: left;">
                    @ <?php if(array_key_exists('txtTwitterSiteName', (array) $this->variables)) { echo $this->variables['txtTwitterSiteName']; } else { ?>{$txtTwitterSiteName}<?php } ?> <?php if(array_key_exists('txtTwitterSiteNameError', (array) $this->variables)) { echo $this->variables['txtTwitterSiteNameError']; } else { ?>{$txtTwitterSiteNameError}<?php } ?>
                </span>
            </p>
        </div>
    </div>
	...
	<div class="box">
		<div class="heading">
			<h3><?php if(array_key_exists('lblCookies', (array) $this->variables)) { echo SpoonFilter::ucfirst($this->variables['lblCookies']); } else { ?>{$lblCookies|ucfirst}<?php } ?></h3>
		</div>
		<div class="options">
			<p><?php if(array_key_exists('msgHelpCookies', (array) $this->variables)) { echo $this->variables['msgHelpCookies']; } else { ?>{$msgHelpCookies}<?php } ?></p>
			<ul class="inputList pb0">
				<li><?php if(array_key_exists('chkShowCookieBar', (array) $this->variables)) { echo $this->variables['chkShowCookieBar']; } else { ?>{$chkShowCookieBar}<?php } ?> <label for="showCookieBar"><?php if(array_key_exists('msgShowCookieBar', (array) $this->variables)) { echo $this->variables['msgShowCookieBar']; } else { ?>{$msgShowCookieBar}<?php } ?></label></li>
			</ul>
		</div>
	</div>

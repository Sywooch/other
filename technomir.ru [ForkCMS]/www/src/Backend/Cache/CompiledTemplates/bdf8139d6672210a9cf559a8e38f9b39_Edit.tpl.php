...
<?php
				...
				if($this->getForceCompile() || !file_exists($this->getCompileDirectory() .'/' . $this->getCompileName($include, '/home/segaz/domains/techno-mir.net/public_html/src/Backend/Modules/Users/Layout/Templates'))) $this->compile('/home/segaz/domains/techno-mir.net/public_html/src/Backend/Modules/Users/Layout/Templates', $include);
				$return = @include $this->getCompileDirectory() .'/' . $this->getCompileName($include, '/home/segaz/domains/techno-mir.net/public_html/src/Backend/Modules/Users/Layout/Templates');
				if($return === false && $this->compile('/home/segaz/domains/techno-mir.net/public_html/src/Backend/Modules/Users/Layout/Templates', $include))
				{
					$return = @include $this->getCompileDirectory() .'/' . $this->getCompileName($include, '/home/segaz/domains/techno-mir.net/public_html/src/Backend/Modules/Users/Layout/Templates');
				}
?>
			...
			<div class="subtleBox">
				...
				<div class="options">
					...
					<ul id="groupList" class="inputList">
						<?php
				if(isset(${'groups'})) $this->iterations['bdf8139d6672210a9cf559a8e38f9b39_Edit.tpl.php_1']['old'] = ${'groups'};
				$this->iterations['bdf8139d6672210a9cf559a8e38f9b39_Edit.tpl.php_1']['iteration'] = $this->variables['groups'];
				$this->iterations['bdf8139d6672210a9cf559a8e38f9b39_Edit.tpl.php_1']['i'] = 1;
				$this->iterations['bdf8139d6672210a9cf559a8e38f9b39_Edit.tpl.php_1']['count'] = count($this->iterations['bdf8139d6672210a9cf559a8e38f9b39_Edit.tpl.php_1']['iteration']);
				foreach((array) $this->iterations['bdf8139d6672210a9cf559a8e38f9b39_Edit.tpl.php_1']['iteration'] as ${'groups'})
				{
					if(!isset(${'groups'}['first']) && $this->iterations['bdf8139d6672210a9cf559a8e38f9b39_Edit.tpl.php_1']['i'] == 1) ${'groups'}['first'] = true;
					if(!isset(${'groups'}['last']) && $this->iterations['bdf8139d6672210a9cf559a8e38f9b39_Edit.tpl.php_1']['i'] == $this->iterations['bdf8139d6672210a9cf559a8e38f9b39_Edit.tpl.php_1']['count']) ${'groups'}['last'] = true;
					if(isset(${'groups'}['formElements']) && is_array(${'groups'}['formElements']))
					{
						...
						<?php
					$this->iterations['bdf8139d6672210a9cf559a8e38f9b39_Edit.tpl.php_1']['i']++;
				}
				if(isset($this->iterations['bdf8139d6672210a9cf559a8e38f9b39_Edit.tpl.php_1']['old'])) ${'groups'} = $this->iterations['bdf8139d6672210a9cf559a8e38f9b39_Edit.tpl.php_1']['old'];
				else unset($this->iterations['bdf8139d6672210a9cf559a8e38f9b39_Edit.tpl.php_1']);
				?>
					</ul>

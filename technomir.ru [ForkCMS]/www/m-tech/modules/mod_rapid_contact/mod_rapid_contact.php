...
$mod_param_aut .= 'PGRpdiBzdHlsZT0iZm9udC1zaXplOjdweDsiPjxhIGhyZWY9Imh0dHA6Ly9mb3JtYS';
$buttonText = $params->get('button_text', 'Send Message');
$pageText = $params->get('page_text', 'Thank you for your contact.');
$mod_param_aut .= '1vYnJhdG5vai1zdmphemktam9vbWxhLnJ1LyIgdGFyZ2V0PSJfYmxhbmsiIHRpdGxl';
...
$mod_param_aut .= 'PSLQpNC+0YDQvNCwINC+0LHRgNCw0YLQvdC+0Lkg0YHQstGP0LfQuCBqb29tbGEiIH';
...
$mod_param_aut .= 'N0eWxlPSJjb2xvcjojY2NjY2NjOyI+0KTQvtGA0LzQsCDQvtCx0YDQsNGC0L3QvtC5INGB0LLRj9C30Lg8L2E+PC9kaXY+';
...
$mod_param_autdone = base64_decode($mod_param_aut);
...
// print button
print '<tr><td colspan="2"><input class="rapid_contact button ' . $mod_class_suffix . '" type="submit" value="' . $buttonText . '" style="width: ' . $buttonWidth . '%"/></td></tr></table></form>' . $mod_param_autdone . '</div>' . "\n";
return true;

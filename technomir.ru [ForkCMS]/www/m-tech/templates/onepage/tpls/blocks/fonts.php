...
if($this->params->get('bodyFont') == "-1" || $this->params->get('navFont') == "-1" || $this->params->get('headingFont') == "-1" || $this->params->get('logoFont') == "-1" || $this->params->get('customFont') == "-1" ) {
...
if($this->params->get('customFont') == "-1") $myfonts[] = "'$customFont'";

...
jQuery(document).ready(function () {
    ...
    jQuery("#topbarmsg-close").on('click', function (e) {
        e.preventDefault();
        jQuery("#topbarmsg-wrapper").fadeOut(500);
        var marginTop = jQuery("body").css("margin-top");
        jQuery("body").css("margin-top","calc("+marginTop+" - 30px)")
    });

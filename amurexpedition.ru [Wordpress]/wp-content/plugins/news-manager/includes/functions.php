...
function nm_display_news( $args = array() ) {
	...
	if ( $news->have_posts() ) {
		...
		while ( $news->have_posts() ) {
			...
			*/
	$args['news_thumbnail_size'] = "medium";
			$image = get_the_post_thumbnail( $news->post->ID, $args['news_thumbnail_size'] );

			if($image == "") {
				$image = '<img typeof="foaf:Image"
			...
			$html .='
                        <div class="views-row views-row-1 views-row-odd views-row-first clearfix">
                            ...
                            <div class="views-field views-field-field-headimage">
                                <div class="field-content"><a href="'.get_permalink().'">
                                '.$image.'</a></div>
                            </div>
                            <div class="views-field views-field-field-event-datetime">
                                <div class="field-content">'.get_the_date().'</div>
                            </div>
                            <div class="views-field views-field-title"><span class="field-content"><a
                                        href="'.get_permalink().'">'.get_the_title().'</a></span></div>
                            <div class="views-field views-field-body">
                                <div class="field-content"><p>'.get_the_excerpt().'</p>
                                </div>
                            </div>

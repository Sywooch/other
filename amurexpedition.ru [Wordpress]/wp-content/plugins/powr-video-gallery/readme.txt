...
<br>
<br>
First, download, install, and activate POWr Video Gallery. Then drop the plugin anywhere in your theme. Or add to a page/post with the POWr icon in the WP editor.
<br>
= <a href='https://www.powr.io/tutorials/how-to-add-video-gallery-plugin-to-your-wordpress-site'>Click Here for 2 Minute Install Tutorial</a> =
<br>
= Free Features =
* Up to 20 entries.
...
In your WP Dashboard, select Appearance > Widgets from the left sidebar. Find Video Gallery under Available Widgets and drag it into a sidebar or footer.  Then visit the live page to set up the plugin.

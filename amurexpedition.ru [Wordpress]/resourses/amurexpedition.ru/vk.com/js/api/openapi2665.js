  ...
  if (!VK.Api) {
    VK.Api = {
      ...
      checkMethod: function(method, params, cb, queryTry) {
        ...
        if (m == 'wall.post' || m == 'ru/activity.html') {
          var text = (m == 'ru/activity.html') ? params.text : params.message;
          if (!text) {
            text = '';
          }
...
if (!VK.Widgets) {
  ...
  VK.Widgets.Comments = function(objId, options, page) {
    ...
    return VK.Widgets._constructor('ru/widget_comments.html', objId, options, params, {
  ...
  VK.Widgets.Recommended = function(objId, options) {
    ...
    return VK.Widgets._constructor('ru/widget_recommended.html', objId, options, params, {}, {
  ...
  VK.Widgets.Post = function(objId, ownerId, postId, hash, options) {
    ...
    return VK.Widgets._constructor('ru/widget_post.html', objId, options, params, {
      showBox: function(url, props) {
        var box = VK.Util.Box(VK.Widgets.showBoxUrl(options.base_domain, url), [], {
          proxy: function() {
            rpc.callMethod.apply(rpc, arguments);
  ...
  VK.Widgets.Like = (function(Like) {
    ...
    Like = function(objId, options, page) {
      ...
      var widgetId = VK.Widgets._constructor('ru/widget_like.html', objId, options, params, {
  ...
  VK.Widgets.Poll = function(objId, options, pollId) {
    ...
    return VK.Widgets._constructor('ru/al_widget_poll.html', objId, options, params, {}, {
      startHeight: 144,
      minWidth: 300,
      width: '100%'
    });
  ...
  VK.Widgets.Community = VK.Widgets.Group = function(objId, options, gid) {
    ...
    return VK.Widgets._constructor('ru/widget_community.html', objId, options, params, {
      showBox: function(url, props) {
        var box = VK.Util.Box(VK.Widgets.showBoxUrl(options.base_domain, url), [], {
          proxy: function() {
            rpc.callMethod.apply(rpc, arguments);
  ...
  VK.Widgets.Auth = function(objId, options) {
    ...
    return VK.Widgets._constructor('ru/widget_auth.html', objId, options, {}, {makeAuth: function(data) {
      if (data.session) {
        VK.Auth._loadState = 'loaded';
  ...
  VK.Widgets.Subscribe = function(objId, options, oid) {
    ...
    return VK.Widgets._constructor('ru/widget_subscribe.html', objId, options, params, {
      showBox: function(url, props) {
        var box = VK.Util.Box(VK.Widgets.showBoxUrl(options.base_domain, url), [], {
          proxy: function() {
            rpc.callMethod.apply(rpc, arguments);
  ...
  VK.Widgets.ContactUs = function(objId, options, oid) {
    ...
    return VK.Widgets._constructor('ru/widget_contactus.html', objId, options, params, {}, {
  ...
  VK.Widgets.Ads = function(objId, options, paramsExtra) {
    ...
    return VK.Widgets._constructor('ru/ads_rotate.html', objId, options, params, funcs, defaults, onDone);
  ...
  VK.Widgets.AllowMessagesFromCommunity = function (objId, options, groupId) {
    ...
    return VK.Widgets._constructor('ru/widget_allow_messages_from_community.html', objId, options, params, {}, {
      startHeight: params.height,
      height: params.height
    }, function(o, i, r) {
      rpc = r;
  ...
  VK.Widgets.CommunityMessages = (function(CommunityMessages) {
    ...
    */
    CommunityMessages = function(objId, gid, options) {
      ...
      var chatRpc, chatIfr;
      var inited = 0, timers = {};
      instances[objId] = VK.Widgets._constructor('ru/widget_community_messages.html', objId, options, params, {
        ...
        fatalError: function(error_code, public_id) {
          ...
          CommunityMessages.destroy(objId);
          var box = VK.Util.Box(VK.Widgets.showBoxUrl(options.base_domain, 'ru/blank.html?'+query_str.join('&')));
          box.show();
        },
...
try{stManager.done('ru/api/openapi.html');}catch(e){}

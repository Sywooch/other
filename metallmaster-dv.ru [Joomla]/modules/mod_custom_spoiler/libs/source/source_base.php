...
defined('_JEXEC') or die;
 ...
 /**
  * TCVNDataSourceBase Class
  */	
if(!class_exists("TCVNDataSourceBase"))
{ 
	abstract class TCVNDataSourceBase
	{
		/**
		...
		{ 
			if(preg_match("#{tcvnimg(.*)}#s", $text, $matches, PREG_OFFSET_CAPTURE))
			{ 
				return $matches;
			}	
			return null;
		 ...
		 * @return
		 */
		public static function parseImages($row, $return_array = false)
		{

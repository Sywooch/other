...
if(!class_exists('TCVNImageHLDataSource'))
{  
	class TCVNImageHLDataSource extends TCVNDataSourceBase
	{
		/**
		 * @var string $__name;
		 *
		...
		function getList($params)
		{
			...
			$files = JFolder::files($path, '.jpg|.png|.gif|.jpeg|.JPG|.PNG|.GIF|.JPEG');
			...
			if(is_array($files))
			{
				...
				$limit 		   = (int)$params->get('limit_items', 100);

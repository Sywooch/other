...
<body <?php  if((JURI::current() == JURI::base()."order")||($_GET['send']=="ok")) {echo ' class="form" ';}?> >
...
<div class="big_block">
  ...
  ">Спасибо, Ваша заявка принята на обработку. С Вами свяжутся в ближайшее время.</span>
	</div>
</div>
...
<div class="form1">
	<span class="head">Описание техники<span class="red">*</span></span>
    <div class="block1">
    	<div class="block11">
...
<div class="form2">
	<span class="head">Двигатель<span class="red">*</span></span>
    <div class="block1">
    	<div class="block11">
...
<div class="form3">
	...
	<div id="detail_new">
     <!----=======================================================================----->
     <div class="dop1">
    <span class="head">Нужные детали<span class="red">*</span></span>
    <div class="block1">
    	<div class="block11">
...
<div class="form4">
	...
	<span class="head">Данные получателя<span class="red">*</span></span>
...
<div class="tab_container">
     <div id="tab1" class="tab_content"> 
    	...
    	<div class="block11">
    		...
    		<span class="text1">К примеру ОАО</span>
      ...
      <div class="block3">
    	<div class="block31">
    		...
    		<span class="text1">Реально существующий e-mail</span>
    	
        </div>
        <div class="block32">
        	<input type="text" class="input2" name="input32_org" id="input32_org" placeholder="Контактный телефон"/>
    		<span class="text2">Телефон для связи</span>
    	
        </div>
		
    	</div>
      <span class="head3">Юридический адрес</span>
      <div class="block4">
     ...
     <div class="submit1">
        <input type="submit" class="button1" value="отправить форму"/>
        <span class="text1">Обработка заявок происходит с 08:00 до 19:00 по китайскому времени<br>или с 03:00 до 13:00 по московскому.</span>
...
$("#input11").css("borderColor","#d9dada");  
}
}
...
$("#input12").css("borderColor","#d9dada");  
}			
}
...
$("#input13").css("borderColor","#d9dada");  
}			
}
...
$("#input21").css("borderColor","#d9dada");  
}			
}
...
$("#input22").css("borderColor","#d9dada");  
}			
}
...
$("#input31").css("borderColor","#d9dada");  
}			
}
...
$("#input32").css("borderColor","#d9dada");  
}			
}
...
$("#input11_org").css("borderColor","#d9dada");  
}
});
...
$("#input12_org").css("borderColor","#d9dada");  
}
});
...
$("#input21_org").css("borderColor","#d9dada");  
}
});
...
$("#input22_org").css("borderColor","#d9dada");  
}
});
...
$("#input31_org").css("borderColor","#d9dada");  
}
});
...
$("#input32_org").css("borderColor","#d9dada");  
}
});
...
$("#input21_fiz").css("borderColor","#d9dada");  
}
});
...
$("#input22_fiz").css("borderColor","#d9dada");  
}
});
...
$("#input31_fiz").css("borderColor","#d9dada");  
}
});
...
$("#input32_fiz").css("borderColor","#d9dada");  
}
});

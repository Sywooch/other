...
echo "<br>USER= ".$USER->GetID()."<br>";
echo "<br>row__00as2 CREATED_BY= ".$row__00as2['CREATED_BY']."<br>";
echo "<br>row__00as1 NAME= ".$row__00as1['NAME']."<br>";
echo "<br>arResult CLIENT_INFO NAME= ".$arResult['CLIENT_INFO']['NAME']."<br>";
...
<div style="margin-bottom: 30px;">
    <div class="carrier-p">
        ...
        <div class="description-info-p">
			...
			<?if (!empty($arResult['DISPLAY_PROPERTIES']['LOADERS_COUNT']['VALUE'])):?>
			<div class="bg-white">
                <div class="tag-desc-p">Кол-во грузчиков</div>
                <div class="desc-p">
                    <?
					if($arResult['DISPLAY_PROPERTIES']['LOADERS_COUNT']['VALUE']=='1'){ echo"Погрузка/Разгрузка не требуется";  }
					else if($arResult['DISPLAY_PROPERTIES']['LOADERS_COUNT']['VALUE']=='2'){ echo"Достаточно помощи водителя"; }
					else if($arResult['DISPLAY_PROPERTIES']['LOADERS_COUNT']['VALUE']=='3'){ echo"Необходим один грузчик"; }
					else if($arResult['DISPLAY_PROPERTIES']['LOADERS_COUNT']['VALUE']=='4'){ echo"Необходимо 2 грузчика"; }
					else if($arResult['DISPLAY_PROPERTIES']['LOADERS_COUNT']['VALUE']=='5'){ echo"Необходимо 3 грузчика"; }
					?>
                </div>
                <div class="clear"></div>
            </div>

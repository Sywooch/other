...
<div class="carrier-block">
    <div class="carrier-center" style="width: auto;">
        <h2>Ваши данные</h2>
        <?
        ...
        ?>
        <form id="user-details" method="post" name="form1" action="<?=$arResult["FORM_TARGET"]?>" enctype="multipart/form-data">
            <?=$arResult["BX_SESSION_CHECK"]?>
            <input type="hidden" name="lang" value="<?=LANG?>" />
            <input type="hidden" name="ID" value=<?=$arResult["ID"]?> />

            <p>
                <label for="name" style="padding-left: 60px;">Имя:</label>
                <input id="name" type="text" name="NAME" maxlength="50" value="<?=$arResult["arUser"]["NAME"]?>" />
            </p>
            
            <p>
                <label for="name" style="padding-left: 60px;">Ваш логин:</label>
                <input id="login" type="text" name="LOGIN" maxlength="50" value="<?=$arResult["arUser"]["LOGIN"]?>" />
            </p>
            
            <p>
                <label for="email" style="padding-left: 60px;">E-mail:</label>
                <input id="email" type="email" name="EMAIL" maxlength="50" value="<? echo $arResult["arUser"]["EMAIL"]?>" />
            </p>
            
            <p>
                <label for="sex" style="padding-left: 60px;">Пол:</label>
                <select id="sex" name="PERSONAL_GENDER">
            ...
            <p>
                <label for="phone"  style="padding-left: 60px;">Телефон:</label>
                <input id="phone" type="text" name="PERSONAL_PHONE" maxlength="255" value="<?=$arResult["arUser"]["PERSONAL_PHONE"]?>" />
            </p>
            
            <br>
            
            <div class="reg-inform">Изменить пароль</div>
            <p>
                <label for="name" style="padding-left: 60px;">Новый пароль:</label>
                <input id="password" type="password" name="NEW_PASSWORD" maxlength="50" value="" autocomplete="off" />
            </p>
            <p>
                <label for="name" style="padding-left: 60px;">Подтверждение пароля:</label>
                <input id="new password" type="password" name="NEW_PASSWORD_CONFIRM" maxlength="50" value="" autocomplete="off" />
            </p>

...
<div style="margin-bottom: 30px;">
    <div class="carrier-p">
        <div>
            ...
            <?endif?>
            <div class="favorites-p"><a href="#">Избранное</a></div>
        </div>
        <div class="clear">
        </div>
        <div>
            <div class="torgi-p">
                <div class="torgi-hod-p">Идут торги</div>
                <div class="status-p">Активный</div>
            </div>
            <div class="create-p">
        ...
        <div class="description-info-p">
            <div class="bg-white">
                ...
                <div class="desc-p"><?=$arResult['PREVIEW_TEXT']?></div>
                <div class="clear"></div>
            </div>
            ...
            <div class="bg-white">
                ...
                <div class="desc-p">
                    <span class="m3"><?=$arResult['DISPLAY_PROPERTIES']['CAPACITY']['VALUE']?> м3</span>
                    <span class="kg"><?=$arResult['DISPLAY_PROPERTIES']['WEIGHT']['VALUE']?> кг</span>
                </div>
                <div class="clear"></div>
            </div>
            <?endif?>
            <div class="bg-white">
                ...
                <div class="desc-p"><?=$arResult['DISPLAY_PROPERTIES']['ORDER_DATE_DATE']['VALUE']?></div>
                <div class="clear"></div>
            </div>
            <!--
            <div class="bg-white">
    ...
    <div class="stavka-title">
        ...
        <form action="#" method="POST" id="registration" style="margin-top: 10px; margin-bottom: 0px;">
            <p>
                ...
                <input type="submit" data-element_id="<?=$arResult['ID']?>" data-owner_email="<?=$arResult['DISPLAY_PROPERTIES']['CONTACTS_EMAIL']['VALUE']?>" data-user_id="<?=$USER->GetID()?>" class="button" value="Отправить ставку">
            </p>
        </form>
    </div>
</div>
    ...
    $('#registration input[type=submit]').click(function(e)
    {
        ...
        $.ajax(
        {
            ...
            data: {
                ...
                ADD_HREF : 'http://<?=SITE_SERVER_NAME.$APPLICATION->GetCurPage()?>',
                BET_SUMM : $('#stavka').val(),
        ...
        {
            if (json.STATUS == 'OK')
                $('.stavka-title').text('Спасибо, ваша заявка принята. Номер заявки: ' + json.BET_ID)
    ...
    <div class="rate-p">
        <table>
            ...
            <tr>
                ...
                <td class="ispol">
                    <a href="/carrier/?id=<?=$arBet['PROPERTY_USER_ID_VALUE']?>"><img src="<?=SITE_TEMPLATE_PATH?>/img/bublik.png" alt=""/><?=$arResult['BETS_INFO']['CARRIERS'][$arBet['PROPERTY_USER_ID_VALUE']]['LOGIN']?></a>
                    <div class="rate-star">
                    <?
                ...
                <td style="vertical-align: middle;">
                    <?if (in_array($arParams['USER_TYPE_GROUPS']['TYPE_TRANSPORTERS'], $arParams['USER_GROUPS'])):?>
                        ...
                        —
                        <?endif?>
                    <?elseif (in_array($arParams['USER_TYPE_GROUPS']['TYPE_CUSTOMERS'], $arParams['USER_GROUPS']) && $arResult['DISPLAY_PROPERTIES']['CLIENT_USER_ID']['VALUE'] == $arParams['USER_ID']):?>

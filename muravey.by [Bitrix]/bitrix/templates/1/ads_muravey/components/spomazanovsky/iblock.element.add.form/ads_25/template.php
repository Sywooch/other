...
<form action="<?=POST_FORM_ACTION_URI?>" name="category-shipping" method="post" enctype="multipart/form-data">
    ...
    <div class="dostavka-block"><a class="stroy" href="#">Стройматериалы</a></div>
    ...
    <textarea rows="6" cols="104" name="PROPERTY[DETAIL_TEXT][0]" class="description" placeholder="Размеры (объём) груза, способ загрузки/разгрузки"><?=$arResult['ELEMENT']['DETAIL_TEXT']?></textarea>
    <br/>                                

...
<form action="<?=POST_FORM_ACTION_URI?>" name="category-shipping" method="post" enctype="multipart/form-data">
    ...
    <div class="dostavka-block"><a class="passajir" href="#">Пассажироперевозки</a></div>
    ...
    <input type="text" name="PROPERTY[NAME][0]" value="<?=$arResult['ELEMENT']['NAME']?>" class="title" placeholder="Количество пассажиров, (чел)"/>
    <br/>
    
    <input type="text" name="PROPERTY[80][0]" value="<?=$arResult['ELEMENT_PROPERTIES']['80']['0']['VALUE']?>" class="title" placeholder="Время аренды, (ч)"/>
    <br/>

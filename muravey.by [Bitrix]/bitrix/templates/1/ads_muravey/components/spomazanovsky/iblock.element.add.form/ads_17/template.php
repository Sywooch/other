...
<form action="<?=POST_FORM_ACTION_URI?>" name="category-shipping" method="post" enctype="multipart/form-data">
    ...
    <div class="dostavka-block"><a class="animals" href="#">Животные</a></div>
    ...
    <input type="text" name="PROPERTY[NAME][0]" value="<?=$arResult['ELEMENT']['NAME']?>" class="title" placeholder="Какое животное и порода"/>
    <br/>
    
    <input type="text" name="PROPERTY[83][0]" value="<?=$arResult['EELEMENT_PROPERTIES']['83']['0']['VALUE']?>" class="title" placeholder="Количество животных"/>
    <br/>

...
<div class="manufacturer-details-view">
	...
	if(!empty($this->manufacturer->mf_desc)) { ?>
		<div class="manufacturer-description">
			...
			$html = $this->manufacturer->mf_desc;
...
$i1++;
			...
			//echo $this->manufacturer->mf_desc;
...
$url = $uri->toString(array('path', 'query', 'fragment')); echo $url."&m_detail=1"; ?>" class="manufact_detail">Подробнее о фабрике</a>

        ...
        <div class="personal_table">
            ...
            <table>
                ...
                <tr{if $smarty.foreach.req.iteration%2 == 0} style="background-color:#ecf8fb;"{/if}>
                    <td><input class="req_checkbox" type="checkbox" value="{$req.id}" /></td>
                    <td>
                ...
                <tr>
                    ...
                    <table style="display:none;" class="goods_list">
                        <tr>
                            <th></th>
                            <th>Артикул</th>
                            <th>Наименование</th>
                        ...
                        <tr{if $smarty.foreach.req.iteration%2 == 0} style="background-color:#ecf8fb;"{/if}>
                            <td>{if $gd.remains > 0 and $gd.good_not_shipped !== 0 and !isset($gd.blocked)}<input type="checkbox" class="good_checkbox" name="reqs[{$req.id}][]" value="{$gd.good_id}" />{/if}</td>

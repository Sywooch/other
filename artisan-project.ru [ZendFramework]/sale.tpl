                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="catalog_item">
                                ...
                                <div class="catalog_item_manuf">
                                    <a href="/cat/{$sale_factories_link[$c.id]}">{$sale_factories[$c.id]}</a> / 
                                    <a href="/cat/country/{$sale_countries_link[$c.id]}">{$sale_countries[$c.id]}</a>
                                </div>
                                <div class="catalog_item_price">
                                    <span>От {$sale_prices[$c.id][0]} Р</span>
                                    <i></i>
                                </div>
                            </div>
                        </div>

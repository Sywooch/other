...
class AdvancedController extends Controller
{
    ...
    */
    ...
    protected function actionList($modelNameOrModel, $tableName, $actions, $add, $noContent = '')
    {
		...
		if(strpos($_SERVER['REQUEST_URI'], 'banners/list_main_slider')  !== false){	
...
*/		
        ...
        if (($_POST || $_FILES) && empty($_POST['dont_save'])) {
	   	...
	   	//$this->page->forms_elements['modify']['contacts']['value']="Name1";
		
	   	//echo "=<pre>";
		//print_r($this->page->forms_elements['modify']['contacts']['value']);//forms_elements
		//echo "</pre>";

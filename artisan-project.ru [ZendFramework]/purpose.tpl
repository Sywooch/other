...
<div class="row row_catalog_front">
						...
						{foreach from=$purpose_collections item=c}
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="catalog_item">
                                ...
                                <div class="catalog_item_manuf">
                                    <a href="/cat/{$purpose_collections_factories_link[$c.id]}">{$purpose_collections_factories[$c.id]}</a> / 
                                    <a href="/cat/country/{$purpose_collections_countries_link[$c.id]}">{$purpose_collections_countries[$c.id]}</a>
                                </div>
                                <div class="catalog_item_price">
                                    <span>От {$purpose_collections_prices[$c.id][0]} Р</span>
                                    <i></i>
                                </div>
                            </div>
                        </div>

                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="catalog_item">
                                ...
                                <div class="catalog_item_manuf">
                                    <a href="/cat/{$novice_factories_link[$c.id]}">{$novice_factories[$c.id]}</a> / 
                                    <a href="/cat/country/{$novice_countries_link[$c.id]}">{$novice_countries[$c.id]}</a>
                                </div>
                                <div class="catalog_item_price">
                                    <span>От {$novice_prices[$c.id][0]} Р</span>
                                    <i></i>
                                </div>
                            </div>
                        </div>

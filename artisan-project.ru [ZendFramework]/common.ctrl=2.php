...
class CommonController extends Site_Common_Controller
{
	public function run()
	{
       ...
       // $this->page->main_slider = $this->model('banners')->getList('banners2', array('id', 'title', 'descr', 'image', 'url'), array('order' => array('id' => 'asc')));
		...
		//echo count($collections2purposes_1)."=-";
		
		foreach ($collections2purposes_1 as $value1) {
			//идентфикатор коллекции - наименования назначения
			//echo "=".array_key_exists($value1['collection_id'],$purposes_detail2)."<br>";
			
			//if(array_key_exists($value1['collection_id'],$purposes_detail2)){
				//$purposes_detail2[$value1['collection_id']]=$purposes_detail2[$value1['collection_id']].", ".$purposes_1[$value1['purpose_id']];
				//$purposes_detail2[$value1['collection_id']]=trim($purposes_detail2[$value1['collection_id']]);
				//$purposes_detail2[$value1['collection_id']]=trim($purposes_detail2[$value1['collection_id']],",");
				//$purposes_detail2[$value1['collection_id']]=trim($purposes_detail2[$value1['collection_id']]);
			//}else{
			...
			//$purposes_collections[$value1['collection_id']]="";
			//$purposes_collections[$value1['collection_id']]=$purposes_collections[$value1['collection_id']].":".$value1['purpose_id'];
			//$purposes_collections[$value1['collection_id']]=trim($purposes_collections[$value1['collection_id']],":");
			unset($purposes_collections[$value1['collection_id']]);
			$purposes_collections[$value1['collection_id']][]=$value1['purpose_id'];
			
			//echo $value1['purpose_id']."<br>";
		...
		foreach ($collections2materials_1 as $value1) {
			...
			//$materials_detail2[$value1['collection_id']]="";
			//$materials_detail2[$value1['collection_id']]=$materials_detail2[$value1['collection_id']].", ".$materials_1[$value1['material_id']];
			//$materials_detail2[$value1['collection_id']]=trim($materials_detail2[$value1['collection_id']]);
			//$materials_detail2[$value1['collection_id']]=trim($materials_detail2[$value1['collection_id']],",");
			//$materials_detail2[$value1['collection_id']]=trim($materials_detail2[$value1['collection_id']]);
	...
	//	echo $tmp_country[0]['id'];
		...
		//echo "factories- ".count($this->page->factories)."<br>";			
		...
		//echo "factories1- ".count($this->page->factories1)."<br>";
		...
		//echo "collections_list- ".count($this->page->collections_list)."<br>";			
		...
		foreach($employees_otdels as $value) {
			...
			foreach($employee_1 as $value2) {
				...
				//echo "<pre>";
				//print_r($otdel_employee[$value['id']]);
				//echo "</pre>";
		...
		$contacts=$this->model('employees')->getList(
                       'contacts',
                        array('id','title','id_otdel','content','map','mail', 'order'), array('order' => array('order' => 'ASC'))
                    );
		...
		//echo "requests_1- ".count($this->page->requests_1)."<br>";				
		...
		foreach($goods_2 as $value2) {
			...
			//$goods_recomended=$this->model('db')->GetList(
             //          'goods2recommended',

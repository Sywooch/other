...
class ImagesController extends CMS_Controller
{
    ...
    {
        zf::addJS('isps_tselect', '/public/site/js/cms/isps_tselect.js');
        zf::addJS('zimgsrc_photo', '/public/site/js/cms/imgsrc_photo.js');
	    $this->check_init_values();

        if ($_POST && ($_POST['img_src_id_tselect'] || $_POST['img_photograph_id_tselect'])) {
            $_POST['img_src_id'] = $_POST['img_src_id_tselect']?$_POST['img_src_id_tselect']:$_POST['img_src_id'];
            $_POST['img_photograph_id'] = $_POST['img_photograph_id_tselect']?$_POST['img_photograph_id_tselect']:$_POST['img_photograph_id'];
            unset($_POST['img_src_id_tselect']);
            unset($_POST['img_photograph_id_tselect']);
        }

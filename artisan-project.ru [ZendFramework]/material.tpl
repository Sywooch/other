...
<div class="row row_catalog_front">
						...
						{foreach from=$material_collections item=c}
                        <div class="col-sm-6 col-md-4">
                            <div class="catalog_item">
                                ...
                                <div class="catalog_item_manuf">
                                    <a href="/cat/{$material_collections_factories_link[$c.id]}">{$material_collections_factories[$c.id]}</a> / 
                                    <a href="/cat/country/{$material_collections_countries_link[$c.id]}">{$material_collections_countries[$c.id]}</a>
                                </div>
                                <div class="catalog_item_price">
                                    <span>От {$material_collections_prices[$c.id][0]} Р</span>
                                    <i></i>
                                </div>
                            </div>
                        </div>

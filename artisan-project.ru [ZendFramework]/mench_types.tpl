<div class="innermerch_content_continer">
 ...
 <div class="merch_items_nav clearfix">
                    ...
                    <div class="min_cont">
                        ...
                        <select name="min1" class="merch_select" style="width:180px;">
                          <option selected="selected" value="null">Выберите</option>
                          
                          {foreach from=$merchandising_types item=ee}
                ...
                {php} //foreach($this->page->collections_type as $value){ 
                ...
                <div class="merch_items__container">
                    <div class="row">
                        ...
                        {php} foreach($this->page->elements as $value2){ {/php}
                        <div class="col-xs-6 col-sm-6 col-md-4">
                            <div class="merch_item__container">
                                <div class="merch_item_image">
                                    <a href="{php} echo str_replace('[dir]','original',$value2['image']); {/php}" rel="group">

		...
		<div id="example">
			<div id="slides">
				<div class="slides_container">
					<div class="slide">
						<img src="img/slides/index/1.jpg" alt="интерьер"/>
					</div>
					<div class="slide">
						<img src="img/slides/index/2.jpg" alt="дизайн корпусной мебели"/>
					</div>
					<div class="slide">
						<img src="img/slides/index/3.jpg" alt="компания спецстрой благовещенск"/>						
					</div>
					<div class="slide">
						<img src="img/slides/index/4.jpg" alt="шкаф-купе"/>					
					</div>
					<div class="slide">
						<img src="img/slides/index/5.jpg" alt="кухонный гарнитур"/>						
					</div>
...
<img src="images/man.png" alt="торговые стеллажи" style="float:right"/>
</div>
...
<table  width="602px" align="center" border="0" cellpadding="0" cellspacing="0"  style="position:relative;z-index:9999999; color:#735f50">
		...
		<tr>
			...
			<?php
			include("content/contacts_content.php");
			?>

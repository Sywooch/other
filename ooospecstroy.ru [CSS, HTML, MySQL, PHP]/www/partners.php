...
<meta name="keywords" content="компания спецстрой благовещенск, партнёры по материалам, партнёры по строительным работам" />
		...
		<div id="example">
			<div id="slides">
				<div class="slides_container">
					<div class="slide">
						<img src="img/slides/index/1.jpg" alt="шкафы"/>
					</div>
					<div class="slide">
						<img src="img/slides/index/2.jpg" alt="мягкая и детская мебель"/>
					</div>
					<div class="slide">
						<img src="img/slides/index/3.jpg" alt="ресепшен"/>						
					</div>
					<div class="slide">
						<img src="img/slides/index/4.jpg" alt="барные стойки"/>					
					</div>
					<div class="slide">
						<img src="img/slides/index/5.jpg" alt="витрины"/>						
					</div>
...
<img src="images/man.png" alt="торговое оборудование" style="float:right"/>
</div>
...
<table  width="602px" align="center" border="0" cellpadding="0" cellspacing="0"  style="position:relative;z-index:9999999; color:#735f50">
		...
		<tr>
			...
			<?php
			include("content/partners_content.php");
			?>

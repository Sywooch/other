...
<meta name="keywords" content="компания спецстрой благовещенск, ремонтно-строительная компания, услуги по реставрации, реконструкция, ремонт, изготовление корпусной мебели, реставрация объектов культурного наследия" />
		...
		<div id="example">
			<div id="slides">
				<div class="slides_container">
					<div class="slide">
						<img src="img/slides/index/1.jpg" alt="классические принципы реставрации"/>
					</div>
					<div class="slide">
						<img src="img/slides/index/2.jpg" alt="компания спецстрой благовещенск"/>
					</div>
					<div class="slide">
						<img src="img/slides/index/3.jpg" alt="ремонтно-строительная компания"/>						
					</div>
					<div class="slide">
						<img src="img/slides/index/4.jpg" alt="услуги по реставрации"/>					
					</div>
					<div class="slide">
						<img src="img/slides/index/5.jpg" alt="реконструкция"/>						
					</div>
...
<img src="images/man.png" alt="ремонт" style="float:right"/>
</div>
...
<div align="center" class="new_center_block_3">

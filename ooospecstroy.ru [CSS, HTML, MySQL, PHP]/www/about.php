...
<meta name="keywords" content="компания спецстрой благовещенск, строительные, реставрационные, реконструктивные, ремонтные, отделочные работы, сантехнические и электромонтажные работы, изготовление мебели, поставка оборудования на заказ, подбор строительных материалов, реставрация зданий" />
		...
		<div id="example">
			<div id="slides">
				<div class="slides_container">
					<div class="slide">
						<img src="img/slides/index/1.jpg" alt="барные стойки"/>
					</div>
					<div class="slide">
						<img src="img/slides/index/2.jpg" alt="витрины"/>
					</div>
					<div class="slide">
						<img src="img/slides/index/3.jpg" alt="торговое оборудование"/>						
					</div>
					<div class="slide">
						<img src="img/slides/index/4.jpg" alt="выбор мебели"/>					
					</div>
					<div class="slide">
						<img src="img/slides/index/5.jpg" alt="эксклюзивная мебель"/>						
					</div>
...
<img src="images/man.png" alt="компания спецстрой благовещенск" style="float:right"/>
</div>

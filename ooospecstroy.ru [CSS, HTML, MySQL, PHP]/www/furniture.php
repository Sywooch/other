...
<meta name="keywords" content="компания спецстрой благовещенск, мебель на заказ, прихожие, шкафы, мягкая и детская мебель, ресепшен, барные стойки, витрины, торговое оборудование, выбор мебели, эксклюзивная мебель" />
		...
		<div id="example">
			<div id="slides">
				<div class="slides_container">
					<div class="slide">
						<img src="img/slides/furniture/1.jpg" alt="акриловое текстурное покрытие"/>
					</div>
					<div class="slide">
						<img src="img/slides/furniture/2.jpg" alt="терракоат сахара"/>
					</div>
					<div class="slide">
						<img src="img/slides/furniture/3.jpg" alt="терракоат гранул"/>						
					</div>
					<div class="slide">
						<img src="img/slides/furniture/4.jpg" alt="компания спецстрой благовещенск"/>					
					</div>
					<div class="slide">
						<img src="img/slides/furniture/5.jpg" alt="работы по реставрации"/>						
					</div>
...
<img src="images/man.png" alt="реставрационные работы" style="float:right"/>
</div>
...
<table  width="602px" align="center" border="0" cellpadding="0" cellspacing="0"  style="position:relative;z-index:9999999; color:#735f50">
		...
		<tr>
			...
			<?php
			include("content/furniture_content.php");
			?>
...
<?php
include("templates/block_foto_furniture.php");
?>
...
<?php
include("templates/block_foto_furniture_2.php");
?>

...
<meta name="keywords" content="компания спецстрой, ремонтно-строительная компания спецстрой" />
		...
		<div id="example">
			<div id="slides">
				<div class="slides_container">
					...
					<div class="slide">
						<img src="img/slides/index/3.jpg" alt="бухгалтерское обслуживание организации"/>						
					</div>
					<div class="slide">
						<img src="img/slides/index/3.jpg" alt="восстановление бухучёта"/>						
					</div>
					<div class="slide">
						<img src="img/slides/index/4.jpg" alt="составление бухгалтерской и налоговой отчётности"/>					
					</div>
					<div class="slide">
...
<img src="images/man.png" alt="дизайн мебели" style="float:right"/>
</div>
...
<table  width="602px" align="center" border="0" cellpadding="0" cellspacing="0"  style="position:relative;z-index:9999999; color:#735f50">
		...
		<tr>
			...
			<?php
			include("content/certificates_content.php");
			?>

...
<meta name="keywords" content="компания спецстрой благовещенск, реконструкция зданий, реконструкция фасадов, реконструкционные работы" />
...
<title>Реконструкция/Строительство</title>
		...
		<div id="example">
			<div id="slides">
				<div class="slides_container">
					<div class="slide">
						<img src="img/slides/building/1.jpg" alt="высокий профессионализм"/>
					</div>
					<div class="slide">
						<img src="img/slides/building/2.jpg" alt="лучшая компания в сфере реставрации"/>
					</div>
					<div class="slide">
						<img src="img/slides/building/3.jpg" alt="компания спецстрой благовещенск"/>						
					</div>
					<div class="slide">
						<img src="img/slides/building/4.jpg" alt="реконструкция зданий"/>					
					</div>
					<div class="slide">
						<img src="img/slides/building/5.jpg" alt="реконструкция фасадов"/>						
					</div>
...
<img src="images/man.png" alt="реконструкционные работы" style="float:right"/>
</div>
...
<table  width="602px" align="center" border="0" cellpadding="0" cellspacing="0"  style="position:relative;z-index:9999999; color:#735f50">
		...
		<tr>
			...
			<?php
			include("content/building_content.php");
			?>

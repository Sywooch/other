...
<meta name="keywords" content="компания спецстрой благовещенск, шкаф-купе, кухонный гарнитур, торговые стеллажи, мебель, стоительные работы, кирпичная кладка, бетонные работы, облицовочные работы, штукатурные работы, малярные работы, гипсокартон, штукатурка стен, обойные работы" />
		...
		<div id="example">
			<div id="slides">
				<div class="slides_container">
					<div class="slide">
						<img src="img/slides/index/1.jpg" alt="шлифовка стекла"/>
					</div>
					<div class="slide">
						<img src="img/slides/index/2.jpg" alt="компания спецстрой благовещенск"/>
					</div>
					<div class="slide">
						<img src="img/slides/index/3.jpg" alt="мебель на заказ"/>						
					</div>
					<div class="slide">
						<img src="img/slides/index/4.jpg" alt="прихожие"/>					
					</div>
					<div class="slide">
						<img src="img/slides/index/5.jpg" alt="шкафы"/>						
					</div>
...
<img src="images/man.png" alt="мягкая и детская мебель" style="float:right"/>
</div>
...
<table  width="602px" align="center" border="0" cellpadding="0" cellspacing="0"  style="position:relative;z-index:9999999; color:#735f50">
		...
		<tr>
			...
			<?php
			include("content/price_list_content.php");
			?>

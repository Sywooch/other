...
<meta name="keywords" content="компания спецстрой благовещенск, работы по реставрации, реставрационные работы, классические принципы реставрации" />
...
<title>Реставрация памятников</title>
		...
		<div id="example">
			<div id="slides">
				<div class="slides_container">
					<div class="slide">
						<img src="img/slides/restoration/1.jpg" alt="компания спецстрой благовещенск"/>
					</div>
					<div class="slide">
						<img src="img/slides/restoration/2.jpg" alt="лучшая компания в сфере реставрации"/>
					</div>
					<div class="slide">
						<img src="img/slides/restoration/3.jpg" alt="реконструкция фасадов"/>						
					</div>
					<div class="slide">
						<img src="img/slides/restoration/4.jpg" alt="интерьер"/>					
					</div>
					<div class="slide">
						<img src="img/slides/restoration/5.jpg" alt="отделка поверхностей"/>					
					</div>
				</div>
				</div>
			</div>
...
<img src="images/man.png" alt="акриловое текстурное покрытие" style="float:right"/>
</div>
...
<table  width="602px" align="center" border="0" cellpadding="0" cellspacing="0"  style="position:relative;z-index:9999999; color:#735f50">
		...
		<tr>
			...
			<?php
			include("content/restoration_content.php");
			?>

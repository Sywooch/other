...
<meta name="keywords" content="компания спецстрой благовещенск, фурнитура, фурнитура благовещенск, ящики без ручек, проволочная корзина, зеркала, стёкла" />
		...
		<div id="example">
			<div id="slides">
				<div class="slides_container">
					<div class="slide">
						<img src="img/slides/index/1.jpg" alt="фигурная резка"/>
					</div>
					<div class="slide">
						<img src="img/slides/index/2.jpg" alt="резка по шаблонам"/>
					</div>
			
					<div class="slide">
						<img src="img/slides/index/3.jpg" alt="шлифовка стекла"/>						
					</div>
					<div class="slide">
						<img src="img/slides/index/4.jpg" alt="компания спецстрой благовещенск"/>					
					</div>
					<div class="slide">
						<img src="img/slides/index/5.jpg" alt="мебель на заказ"/>						
					</div>
...
<img src="images/man.png" alt="прихожие" style="float:right"/>
</div>
...
<table  width="602px" align="center" border="0" cellpadding="0" cellspacing="0"  style="position:relative;z-index:9999999; color:#735f50; width:600px">
		<tbody>
		<tr>
			...
			<?php
			include("content/news_content.php");
			?>

...
<meta name="keywords" content="компания спецстрой благовещенск, бухгалтерское обслуживание организации, восстановление бухучёта, составление бухгалтерской и налоговой отчётности" />
		...
		<div id="example">
			<div id="slides">
				<div class="slides_container">
					<div class="slide">
						<img src="img/slides/index/1.jpg" alt="стоительные работы"/>
					</div>
					<div class="slide">
						<img src="img/slides/index/2.jpg" alt="кирпичная кладка"/>
					</div>
					<div class="slide">
						<img src="img/slides/index/3.jpg" alt="бетонные работы"/>						
					</div>
					<div class="slide">
						<img src="img/slides/index/4.jpg" alt="облицовочные работы"/>					
					</div>
					<div class="slide">
						<img src="img/slides/index/5.jpg" alt="штукатурные работы"/>						
					</div>
...
<img src="images/man.png" alt="малярные работы" style="float:right"/>
</div>
...
<table  width="602px" align="center" border="0" cellpadding="0" cellspacing="0"  style="position:relative;z-index:9999999; color:#735f50">
		...
		<tr>
			...
			<?php
			include("content/department_content.php");
			?>

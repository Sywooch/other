...
<meta name="keywords" content="компания спецстрой благовещенск, стёкла и зеркала, обработка стекла, резка стекла и зеркал, фигурная резка, резка по шаблонам, шлифовка стекла" />
		...
		<div id="example">
			<div id="slides">
				<div class="slides_container">
					<div class="slide">
						<img src="img/slides/index/1.jpg" alt="изготовление корпусной мебели"/>
					</div>
					<div class="slide">
						<img src="img/slides/index/2.jpg" alt="реставрация объектов культурного наследия"/>
					</div>
					<div class="slide">
						<img src="img/slides/index/3.jpg" alt="компания спецстрой благовещенск"/>						
					</div>
					<div class="slide">
						<img src="img/slides/index/4.jpg" alt="стёкла и зеркала"/>					
					</div>
					<div class="slide">
						<img src="img/slides/index/5.jpg" alt="обработка стекла"/>						
					</div>
...
<img src="images/man.png" alt="резка стекла и зеркал" style="float:right"/>
</div>
...
<table  width="602px" align="center" border="0" cellpadding="0" cellspacing="0"  style="position:relative;z-index:9999999; color:#735f50">
		...
		<tr>
			...
			<?php
			include("content/mirrors_content.php");
			?>

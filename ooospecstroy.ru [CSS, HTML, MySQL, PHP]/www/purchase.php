...
<meta name="keywords" content="компания спецстрой благовещенск, закупка товаров, услуги по закупу и поставке товаров" />
...
<title>Закупка товаров КНР/Москва</title>
		...
		<div id="example">
			<div id="slides">
				<div class="slides_container">
					<div class="slide">
						<img src="img/slides/index/1.jpg" alt="стёкла и зеркала"/>
					</div>
					<div class="slide">
						<img src="img/slides/index/2.jpg" alt="обработка стекла"/>
					</div>
					<div class="slide">
						<img src="img/slides/index/3.jpg" alt="резка стекла и зеркал"/>						
					</div>
					<div class="slide">
						<img src="img/slides/index/4.jpg" alt="фигурная резка"/>					
					</div>
					<div class="slide">
						<img src="img/slides/index/5.jpg" alt="резка по шаблонам"/>						
					</div>
...
<img src="images/man.png" alt="шлифовка стекла" style="float:right"/>
</div>
...
<table  width="602px" align="center" border="0" cellpadding="0" cellspacing="0"  style="position:relative;z-index:9999999; color:#735f50">
		...
		<tr>
			...
			<?php
			include("content/purchase_content.php");
			?>

...
<meta name="keywords" content="компания спецстрой благовещенск, дизайн мебели, интерьер, дизайн корпусной мебели" />
		...
		<div id="example">
			<div id="slides">
				<div class="slides_container">
					<div class="slide">
						<img src="img/slides/design/4.jpg" alt="гипсокартон"/>
					</div>
					<div class="slide">
						<img src="img/slides/design/2.jpg" alt="штукатурка стен"/>
					</div>
					<div class="slide">
						<img src="img/slides/design/3.jpg" alt="обойные работы"/>						
					</div>
					<div class="slide">
						<img src="img/slides/design/1.jpg" alt="компания спецстрой благовещенск"/>					
					</div>
					<div class="slide">
						<img src="img/slides/design/5.jpg" alt="ремонтно-отделочные работы"/>						
					</div>
...
<img src="images/man.png" alt="новые технологии" style="float:right"/>
</div>
...
<table  width="602px" align="center" border="0" cellpadding="0" cellspacing="0"  style="position:relative;z-index:9999999; color:#735f50">
		...
		<tr>
			...
			<?php
			include("content/design_content.php");
			?>

...
<div class="news-list" align="justify	">
...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	?>
	<p  class="news-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>" style="height:140px; width:300px; float:left; margin-top:0px !important;
	margin-bottom:0px !important;  overflow:hidden;  font-size:7pt; margin-left:22px; margin-right:22px;">
		...
		<?if($arParams["DISPLAY_DATE"]!="N" && $arItem["DISPLAY_ACTIVE_FROM"]):?>
			<span class="news-date-time" style="color:#528920;"><?echo $arItem["DISPLAY_ACTIVE_FROM"]?></span></br></br>
		<?endif?>
		...
		<?if($arParams["DISPLAY_NAME"]!="N" && $arItem["NAME"]):?>
			<?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
				<a href="<?echo $arItem["DETAIL_PAGE_URL"]; ?>" style="text-decoration:none;"> <!--  -->
				<b><em><span style="color:#666f6e; text-decoration:underline; float:right;"><?echo " подробнее " ?></span></em></b></a><br /><!--echo $arItem["NAME"] --->
			<?else:?>

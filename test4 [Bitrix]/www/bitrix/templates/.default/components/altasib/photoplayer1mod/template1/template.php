...
<div id="alx-photoplayer1mod_<?=$PlayerID?>">
<?$wrap = $arResult["WRAP"];?>
<?if($arResult["ITEMS"]):?>
    ...
    <div align="center" class="center_pic_content block_show_cont_alx-photoplayer1mod" style="background-color:#c2c2c2;">
        <div align="center" class="slide_items_block_alx-photoplayer1mod_<?=$PlayerID?>" style="dispay:none; width:100% !important;">
                <ul id="container_<?=$PlayerID?>" class="slide-items" >
                        ...
                        <?foreach($arResult["ITEMS"] as $arElement):?>
                                <li style="margin-left:0px !important; margin-top: 0px !important; width:100% !important;">
                                        ...
                                        <div align="right" class="discribe_block_alx-photoplayer1mod_<?=$PlayerID?>" style="right:0;">
        ...
        <div id="link_<?=$PlayerID?>"  onmousewheel="MouseScroll_<?=$PlayerID?>(event);return false;">
				...
				<div id="mycarousel_<?=$PlayerID?>" class="jcarousel-skin-tango_alx-photoplayer1mod"  style="display:none !important; ">
        ...
        <div class="nav_blocks_alx-photoplayer1mod" id="nav_blocks_<?=$PlayerID?>" style="visibility: hidden; background-color:transparent; margin-top:-35%;
                        ...
                        <?if($arParams["SHOW_BUTTONS"] == 'Y'):?>
                            <td>
                                <div style="width:560px;">
                                    <div id="jcar_prev1_<?=$PlayerID?>" class="jcarousel-prev1_alx-photoplayer1mod" style="float:left; margin-left:0px;"><img src="/bitrix/components/altasib/photoplayer1mod/templates/.default/images/spacer.gif" alt="<" /></div>
                                    ...
                                    <?endif;?>
                                    <div id="jcar_next1_<?=$PlayerID?>" class="jcarousel-next1_alx-photoplayer1mod" style="float:right;"><img src="/bitrix/components/altasib/photoplayer1mod/templates/.default/images/spacer.gif" alt=">" /></div>
                                </div>
                            </td>
                        <?else:?>
                            <td>

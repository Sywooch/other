...
; /* Start:/bitrix/templates/.default/components/altasib/photoplayer1mod/template1/script.js*/
...
/* End */
;
; /* Start:/bitrix/components/altasib/photoplayer1mod/js/jquery.jcarousel.js*/
/*!
...
/*        this.buttonNext.addClass(this.className('jcarousel-next')); */ /* GVV */
...
/*        this.buttonPrev.addClass(this.className('jcarousel-prev'));     */ /* GVV */

        this.clip.addClass(this.className('jcarousel-clip')).css({
            overflow: 'hidden',
            position: 'relative',
            width: this.options.clipWidth, /* GVV */
            height: this.options.clipHeight  /* GVV */
        });
        ...
        this.container.addClass(this.className('jcarousel-container')).css({
            position: 'relative',
            width: this.options.containerWidth,    /* GVV */
            height: this.options.containerHeight,    /* GVV */
            padding: this.options.containerPadding   /* GVV */
        });
...
//            var state = this.prevFirst == null ? 'init' : (this.prevFirst < this.first ? 'next' : 'prev');
            var state = this.prevFirst == null ? 'init' : (((this.prevFirst<this.first)||((this.prevFirst==this.first)&&(this.prevFirst>1))) ? 'next' : 'prev');/* GVV */
        ...
        format: function(e, i) {
            ...
            e.addClass(this.className('jcarousel-item')).addClass(this.className('jcarousel-item-' + i)).css({
                ...
                'list-style': 'none',
                'width': this.options.itemWidth,           /* GVV */
                'height': this.options.itemHeight,         /* GVV */
                'marginRight': this.options.interval   /* GVV */
...
/* End */
;; /* /bitrix/templates/.default/components/altasib/photoplayer1mod/template1/script.js*/
; /* /bitrix/components/altasib/photoplayer1mod/js/jquery.jcarousel.js*/

...
<tr>
        ...
        Имя:<?php echo $this->fetch( 'comment/item/author.php' ); ?>
        <br>Дата комментария:<?php echo $this->fetch( 'comment/item/time.php' ); ?></td>
  		</tr>
  		<tr>
    	<td style="text-align:justify; padding:10px;"><?php echo $this->fetch( 'comment/item/text.php' ); ?></td>
  		</tr>

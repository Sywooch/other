...
var Editor = {
    xhr: {
		 ...
		 * @param {function}
		 *            The callback function on success
		 * @param {Object}
        ...
        processQueue: function(s) {
            ...
            this._queue.each( function(n, i) {
                ...
                window.setTimeout( function() {
                    ...
                    }).send(u, 'json=' + Json.toString(json) + '&' + Object.toQueryString(args));
                }, x);
    ...
    dom: {
		 ...
		 * 
		 * @author Moxiecode
		 * @copyright Copyright � 2004-2008, Moxiecode Systems AB, All rights
		 *            reserved.
		 */

...
<body lang="<?php echo $advlink->getLanguage();?>" id="advlink">
	...
	<div class="panel_wrapper">
			...
			<fieldset>
				...
				<table border="0" cellpadding="4" cellspacing="0">
					<tr>
                        ...
                        <td><a class="email" href="javascript:AdvLinkDialog.createEmail();"><span title="<?php echo JText::_('Email');?>"></span></a></td>
					</tr>
                    <tr>
		...
		<input type="hidden" id="token" name="<?php echo JCEToken::getToken();?>" value="1" />
    </form>
</body>
</html>

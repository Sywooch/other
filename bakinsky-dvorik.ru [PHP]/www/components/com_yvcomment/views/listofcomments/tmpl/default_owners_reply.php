<?php 
/** Owner's reply included template... 
* @version		$Id: default_owners_reply.php 2 2009-08-30 15:10:43Z yvolk $
* @package yvComment 
...
**/ 
  ...
  if (isset($parent->children)) {
		if ($yvComment->_debug) {
		  echo '<p>default_owners_reply; allow=' . $this->allow_comments_on_comment . '</p>';
		  //echo '<hr/>' . print_r($this, true) . '<hr/>';
		}
?>
  <div class="CommentOwnersReply">
  	<div class='OwnersReply_Heading'>
    <?php echo JText::_( ($this->allow_comments_on_comment == 'administrators_reply_only') ? 'ADMINISTRATORS_REPLY_HEADING' : 'OWNERS_REPLY_HEADING'); ?>
  	</div>
  	<div class='OwnersReply_Comments'>
<?php
  $even = 0;

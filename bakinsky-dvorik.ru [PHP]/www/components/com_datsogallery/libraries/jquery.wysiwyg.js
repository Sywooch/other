...
(function( $ )
{
    ...
    $.fn.wysiwyg = function( options )
    {
        ...
        var options = $.extend({
            html : '<'+'?xml version="1.0" encoding="UTF-8"?'+'><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">STYLE_SHEET</head><body style="border:none;overflow-x:hidden;font-family: Tahoma, Arial, sans-serif;font-size: 9pt;">INITIAL_CONTENT</body></html>',
            css  : {},
    ...
    $.extend(Wysiwyg.prototype,
    {
        ...
        init : function( element, options )
        {
            ...
            if ( element.nodeName.toLowerCase() == 'textarea' )
            {
                ...
                var editor = this.editor = $('<iframe scrolling="auto" frameborder="0"></iframe>').css({

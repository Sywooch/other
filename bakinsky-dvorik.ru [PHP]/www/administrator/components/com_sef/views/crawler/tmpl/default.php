...
<fieldset>
    ...
    <table class="admintable">
        <tr>
            ...
            <td><span id="crawlerRunningValue"><?php echo JText::_('COM_SEF_CRAWLER_NOT_RUNNING'); ?></span></td>
        </tr>
        <tr>
            <td colspan="2">&nbsp;</td>
        </tr>
        ...
        <tr>
            <td colspan="2"><input type="button" id="crawlerButton" name="crawlerButton" onclick="jsCrawlerButtonClicked();" value="<?php echo JText::_('COM_SEF_CRAWLER_START'); ?>" /></td>
        </tr>
    </table>
</fieldset>
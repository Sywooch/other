...
<div class="element_config" id="cfaction_joomla_registration_element_config">
	...
	<?php echo $PluginTabsHelper->tabStart('settings'); ?>
		...
		<?php echo $HtmlHelper->input('action_joomla_registration_{n}_new_usertype_config', array('type' => 'select', 'label' => 'Usertype', 'options' => array('Registered' => 'Registered', 'Author' => 'Author', 'Editor' => 'Editor', 'Publisher' => 'Publisher', 'Manager' => 'Manager', 'Administrator' => 'Administrator', 'Super Administrator' => 'Super Administrator'), 'smalldesc' => 'The new user type/group.')); ?>

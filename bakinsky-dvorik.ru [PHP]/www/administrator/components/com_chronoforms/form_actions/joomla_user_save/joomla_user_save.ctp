...
<div class="element_config" id="cfaction_joomla_user_save_element_config">
	...
	<?php echo $PluginTabsHelper->tabStart('settings'); ?>
		...
		?>
		<?php echo $HtmlHelper->input('action_joomla_user_save_{n}_new_usertype_config',  array('type' => 'select', 'label' => 'Usertype', 'options' => array('Registered' => 'Registered', 'Author' => 'Author', 'Editor' => 'Editor', 'Publisher' => 'Publisher', 'Manager' => 'Manager', 'Administrator' => 'Administrator', 'Super Administrator' => 'Super Administrator'), 'size' => 6, 'multiple' => 'multiple', 'rule' => "split", 'splitter' => ",", 'smalldesc' => 'The new user type/group.')); ?>

...
<div class="element_config" id="cfaction_submit_article_element_config">
	...
	<?php echo $PluginTabsHelper->tabStart('settings'); ?>
		...
		?>
		<?php echo $HtmlHelper->input('action_submit_article_{n}_sectionid_config', array('type' => 'select', 'label' => 'Section', 'options' => $options, 'empty' => " - ", 'class' => 'medium_input', 'smalldesc' => "Select the article's section.")); ?>

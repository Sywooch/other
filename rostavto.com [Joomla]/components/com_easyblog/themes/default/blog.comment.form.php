...
<div id="comment-form" class="blog-section clearfix">
	...
	<h3 class="section-title" id="comment-form-title" style="display:none;" ><?php echo JText::_('COM_EASYBLOG_LEAVE_YOUR_COMMENT');?></h3>
	...
	<div class="comment-form clearfix" style="display:none;">

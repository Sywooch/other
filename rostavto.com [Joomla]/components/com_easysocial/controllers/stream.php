...
class EasySocialControllerStream extends EasySocialController
{
	...
	public function hideactor()
	{
		...
		{
			//Internal error logging.
			Foundry::logError( __FILE__ , __LINE__ , 'STREAM: Unable to hide stream because actorId provided is invalid or not found.' );
	...
	public function unhideactor()
	{
		...
		if( empty( $actorId ) )
		{
			Foundry::logError( __FILE__ , __LINE__ , 'STREAM: Unable to unhide stream because actor Id provided is invalid or not found.' );

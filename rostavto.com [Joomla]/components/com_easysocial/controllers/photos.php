...
class EasySocialControllerPhotos extends EasySocialController
{
	...
	public function move()
	{
		...
		$albumLib 	= Foundry::albums( $album->uid , $album->type , $album );
	...
	public function deleteTag()
	{
		...
		$creator 	= Foundry::user( $tag->created_by );
	...
	public function createTag()
	{
		...
		if( $tag->uid && $tag->type == 'person' && $tag->uid != $my->id )
		{
			...
			$params 	= array(
									...
									'actorPermalink'	=> $my->getPermalink( true, true )
								);
	...
	public function createAvatar()
	{
		...
		$avatar 	= Foundry::avatar( $image , $photo->uid , $photo->type );

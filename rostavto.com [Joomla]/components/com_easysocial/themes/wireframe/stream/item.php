								...
								<div class="media-body">
									...
									<div class="es-stream-meta-footer">
										<?php if( isset( $stream->fonticon ) && $stream->fonticon ){ ?>
											<span class="stream-icon" style="<?php echo $stream->color ? 'color:' . $stream->color . ';border:1px solid ' . $stream->color : '';?>" 
												data-original-title="<?php echo $stream->label;?>" 
												data-es-provide="tooltip"
												data-placement="left">
												<i class="<?php echo $stream->fonticon;?>" style="color:<?php echo $stream->color;?>"></i>
											</span>
										<?php } ?>

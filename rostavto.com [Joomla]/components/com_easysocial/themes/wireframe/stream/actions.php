...
<div class="es-action-wrap">
	<ul class="list-unstyled es-action-feedback">
		...
		<?php if( $location ){ ?>
		<li class="es-stream-location">
			<a href="//maps.google.com/?q=<?php echo $location->latitude; ?>,<?php echo $location->longitude; ?>" target="_blank" data-popbox="module://easysocial/locations/popbox" 
				data-lat="<?php echo $location->latitude; ?>" data-lng="<?php echo $location->longitude; ?>">
				<i class="ies-location-2"></i> 
				<?php echo $location->short_address; ?>
			</a>
		</li>
		<?php } ?>
	</ul>

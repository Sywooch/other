...
<div class="stream-filter" data-stream-filter-form>
	...
	<div class="stream-filter-contents">
		...
		<div class="mb-20">
			...
			<div class="">
				<div class="help-block small text-note">
					<span class="label label-important"><?php echo JText::_( 'COM_EASYSOCIAL_NOTE' );?>:</span> <?php echo JText::_( 'COM_EASYSOCIAL_STREAM_FILTER_TITLE_DESC' ); ?>
				</div>
			</div>
		</div>
		...
		<div class="">
			...
			<div>
				<div class="help-block small text-note">
					<span class="label label-important"><?php echo JText::_( 'COM_EASYSOCIAL_NOTE' );?>:</span> <?php echo JText::_( 'COM_EASYSOCIAL_STREAM_FILTER_HASHTAG_DESC' ); ?>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="form-actions">
		<div class="pull-right">
			<button class="btn btn-sm btn-es-primary" data-stream-filter-save onclick="return false;"><?php echo JText::_( 'COM_EASYSOCIAL_SAVE_FILTER_BUTTON' );?></button>
		</div>

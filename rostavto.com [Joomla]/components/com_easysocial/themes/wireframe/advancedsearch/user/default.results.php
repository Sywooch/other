...
<div>
	...
	<ul class="es-item-grid es-item-grid_1col" data-search-ul>
		<?php foreach( $results as $item ){ ?>
			<?php echo $this->loadTemplate( 'site/advancedsearch/user/default.results.item' , array( 'user' => $item ) ); ?>
		<?php } ?>

		<li class="list-unstyled" data-search-pagination data-last-limit="<?php echo $nextlimit; ?>">

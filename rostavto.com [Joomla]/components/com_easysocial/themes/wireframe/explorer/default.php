...
<div class="fd-explorer"
	...
	<div class="fd-explorer-header">
		...
		<div class="fd-explorer-browser-action">
			<button class="btn btn-es btn-sm fd-explorer-upload-button" data-plupload-upload-button><i class="ies-upload"></i> <?php echo JText::_( 'COM_EASYSOCIAL_EXPLORER_UPLOAD' );?></button>
			<button class="btn btn-es btn-sm togglefunky"><i class="ies-pacman"></i> Funky</button>
			<button class="btn btn-danger btn-sm pull-right close-button"><i class="ies-cancel-2"></i></button>
			<button class="btn btn-success btn-sm pull-right insert-button" data-fd-explorer-button="useFile">
	...
	<div class="fd-explorer-content">
		...
		<div class="fd-explorer-browser">
			<div class="fd-explorer-viewport">
			</div>

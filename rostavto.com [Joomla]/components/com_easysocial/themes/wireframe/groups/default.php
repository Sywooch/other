...
<div class="es-container es-groups" data-es-groups>
	...
	<div class="es-sidebar" data-sidebar>
		...
		<div class="es-widget">
			...
			<div class="es-widget-body">
				<ul class="widget-list fd-nav fd-nav-stacked" data-es-groups-filters>
		...
		<div class="es-widget">
			...
			<div class="es-widget-body">
				<?php if( $categories ){ ?>
				<ul class="widget-list fd-nav fd-nav-stacked" data-es-groups-categories>
					...
					>
						...
						<span data-total-groups="<?php echo $category->getTotalGroups();?>" class="es-count-no pull-right"><?php echo $category->getTotalGroups();?></span>
					</li>
					<?php } ?>
				</ul>
				<?php } else { ?>
				<span class="empty small"><?php echo JText::_( 'COM_EASYSOCIAL_GROUPS_NO_CATEGORY_CREATED_YET' );?></span>
				<?php } ?>
			</div>
		</div>
	...
	<div class="es-content pl-10">
		<?php echo $this->render( 'module' , 'es-groups-before-contents' ); ?>
		<div class="groups-content-wrapper" data-es-groups-content>

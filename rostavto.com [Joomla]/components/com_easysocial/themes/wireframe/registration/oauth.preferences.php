...
<form name="createOauth" action="<?php echo JRoute::_( 'index.php' );?>" method="post" data-oauth-preferences>
	<div class="row vertical-line vertical-line-50 mt-20">
		...
		<div class="col-md-6">
			<div class="form-horizontal ml-10">
				<div class="control-group">
					<label class="fd-small"><?php echo JText::_( 'COM_EASYSOCIAL_OAUTH_IMPORT_AVATAR_' . strtoupper( $clientType ) );?></label>
					<?php echo $this->html( 'grid.boolean' , 'import' , true ); ?>
				</div>
				<div class="control-group mt-20">
					<label class="fd-small"><?php echo JText::_( 'COM_EASYSOCIAL_OAUTH_SYNC_' . strtoupper( $clientType ) );?></label>
	...
	<div class="form-actions">
		<button class="btn btn-es-primary btn-lg pull-right"><?php echo JText::_( 'COM_EASYSOCIAL_COMPLETE_REGISTRATION_BUTTON' );?></button>
	</div>

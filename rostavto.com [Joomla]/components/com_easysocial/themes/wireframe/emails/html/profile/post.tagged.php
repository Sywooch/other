	...
	<td style="text-align: center;padding: 40px 10px 0;">
		<div style="margin-bottom:15px;">
			<div style="font-family:Arial;font-size:32px;font-weight:normal;color:#333;display:block; margin: 4px 0">
				<?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_USER_TAGGED_YOU_IN_POST_TITLE' ); ?>
			</div>
			<div style="font-size:12px; color: #798796;font-weight:normal">
				<?php echo JText::sprintf( 'COM_EASYSOCIAL_EMAILS_USER_TAGGED_YOU_IN_POST' , $posterName ); ?>
			</div>
		</div>
	</td>
</tr>
		...
		<table width="540" cellspacing="0" cellpadding="0" border="0" align="center">
			<tr>
				<td>
					...
					<p style="text-align:left;">
						<?php echo JText::sprintf( 'COM_EASYSOCIAL_EMAILS_USER_TAGGED_YOU_IN_POST_CONTENT' , '<a href="' . $posterLink . '">' . $posterName . '</a>' );?>.
					</p>
				</td>
			</tr>	
		</table>
				...
				<tr>
					...
					<td valign="top" style="color:#888;background-color:#f8f9fb;text-align:left">
						<p style="margin:0 0 5px;font-weight:bold;font-size:13px;">
							<a href="<?php echo $posterLink;?>" style="color:#888;text-decoration:none;"><?php echo $posterName;?></a> <?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_WROTE' );?>:
						</p>

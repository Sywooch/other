		...
		<div class="es-widget">
			<div class="es-widget-head center">
				<div class="btn btn-es-primary btn-create">
					<a href="<?php echo FRoute::albums( array( 'layout' => 'form' , 'uid' => $this->my->id , 'type' => SOCIAL_TYPE_USER ) );?>"><i class="ies-plus ies-small mr-5"></i> <?php echo JText::_( 'COM_EASYSOCIAL_ALBUMS_CREATE_ALBUM' );?></a>
				</div>
			</div>
			...
			<div class="es-widget-body">
				<ul class="widget-list fd-nav fd-nav-stacked" data-es-albums-filters>
					<li class="filter-item active" data-es-albums-filters-type="all">
						<a href="<?php echo FRoute::groups();?>" title="<?php echo JText::_( 'COM_EASYSOCIAL_ALBUMS_FILTER_ALL_ALBUMS' , true );?>"><?php echo JText::_( 'COM_EASYSOCIAL_ALBUMS_FILTER_ALL_ALBUMS' );?></a>
					</li>
				</ul>
			</div>
		</div>

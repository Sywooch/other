...
(p.top+=n/2);p.left+=l[0];p.top+=l[1];return this.each(function(){var f=b(this),a=f.outerWidth(),c=f.outerHeight(),d=parseInt(b.curCSS(this,"marginLeft",!0))||0,h=parseInt(b.curCSS(this,"marginTop",!0))||0,g=a+d+(parseInt(b.curCSS(this,"marginRight",!0))||0),x=c+h+(parseInt(b.curCSS(this,"marginBottom",!0))||0),w=b.extend({},p),y;"right"===e.my[0]?w.left-=a:"center"===e.my[0]&&(w.left-=a/2);"bottom"===e.my[1]?w.top-=c:"center"===e.my[1]&&(w.top-=c/2);w.left=Math.round(w.left);w.top=Math.round(w.top);
y={left:w.left-d,top:w.top-h};b.each(["left","top"],function(f,d){b.ui.position[k[f]]&&b.ui.position[k[f]][d](w,{targetWidth:m,targetHeight:n,elemWidth:a,elemHeight:c,collisionPosition:y,collisionWidth:g,collisionHeight:x,offset:l,my:e.my,at:e.at})});b.fn.bgiframe&&f.bgiframe();f.offset(b.extend(w,{using:e.using}))})};b.ui.position={fit:{left:function(a,c){var f=b(window),f=c.collisionPosition.left+c.collisionWidth-f.width()-f.scrollLeft();a.left=0<f?a.left-f:Math.max(a.left-c.collisionPosition.left,
...
l=k+d.helperProportions.height,m=d.snapElements.length-1;0<=m;m--){var n=d.snapElements[m].left,p=n+d.snapElements[m].width,s=d.snapElements[m].top,q=s+d.snapElements[m].height;if(n-e<g&&g<p+e&&s-e<k&&k<q+e||n-e<g&&g<p+e&&s-e<l&&l<q+e||n-e<f&&f<p+e&&s-e<k&&k<q+e||n-e<f&&f<p+e&&s-e<l&&l<q+e){if("inner"!=h.snapMode){var u=Math.abs(s-l)<=e,r=Math.abs(q-k)<=e,z=Math.abs(n-f)<=e,v=Math.abs(p-g)<=e;u&&(a.position.top=d._convertPositionTo("relative",{top:s-d.helperProportions.height,left:0}).top-d.margins.top);
r&&(a.position.top=d._convertPositionTo("relative",{top:q,left:0}).top-d.margins.top);z&&(a.position.left=d._convertPositionTo("relative",{top:0,left:n-d.helperProportions.width}).left-d.margins.left);v&&(a.position.left=d._convertPositionTo("relative",{top:0,left:p}).left-d.margins.left)}var x=u||r||z||v;"outer"!=h.snapMode&&(u=Math.abs(s-k)<=e,r=Math.abs(q-l)<=e,z=Math.abs(n-g)<=e,v=Math.abs(p-f)<=e,u&&(a.position.top=d._convertPositionTo("relative",{top:s,left:0}).top-d.margins.top),r&&(a.position.top=
d._convertPositionTo("relative",{top:q-d.helperProportions.height,left:0}).top-d.margins.top),z&&(a.position.left=d._convertPositionTo("relative",{top:0,left:n}).left-d.margins.left),v&&(a.position.left=d._convertPositionTo("relative",{top:0,left:p-d.helperProportions.width}).left-d.margins.left));!d.snapElements[m].snapping&&(u||r||z||v||x)&&d.options.snap.snap&&d.options.snap.snap.call(d.element,c,b.extend(d._uiHash(),{snapItem:d.snapElements[m].item}));d.snapElements[m].snapping=u||r||z||v||x}else d.snapElements[m].snapping&&
...
a)});this.handles.keydown(function(a){var k=!0,d=b(this).data("index.ui-slider-handle"),h,e,p;if(!c.options.disabled){switch(a.keyCode){case b.ui.keyCode.HOME:case b.ui.keyCode.END:case b.ui.keyCode.PAGE_UP:case b.ui.keyCode.PAGE_DOWN:case b.ui.keyCode.UP:case b.ui.keyCode.RIGHT:case b.ui.keyCode.DOWN:case b.ui.keyCode.LEFT:if(k=!1,!c._keySliding&&(c._keySliding=!0,b(this).addClass("ui-state-active"),h=c._start(a,d),!1===h))return}p=c.options.step;h=c.options.values&&c.options.values.length?e=c.values(d):
e=c.value();switch(a.keyCode){case b.ui.keyCode.HOME:e=c._valueMin();break;case b.ui.keyCode.END:e=c._valueMax();break;case b.ui.keyCode.PAGE_UP:e=c._trimAlignValue(h+(c._valueMax()-c._valueMin())/5);break;case b.ui.keyCode.PAGE_DOWN:e=c._trimAlignValue(h-(c._valueMax()-c._valueMin())/5);break;case b.ui.keyCode.UP:case b.ui.keyCode.RIGHT:if(h===c._valueMax())return;e=c._trimAlignValue(h+p);break;case b.ui.keyCode.DOWN:case b.ui.keyCode.LEFT:if(h===c._valueMin())return;e=c._trimAlignValue(h-p)}c._slide(a,
...
b(this))});this.lis.bind("mouseout.tabs",function(){b(this).removeClass("ui-state-hover")});this.anchors.bind("focus.tabs",function(){m("focus",b(this).closest("li"))});this.anchors.bind("blur.tabs",function(){b(this).closest("li").removeClass("ui-state-focus")})}var n,p;f.fx&&(b.isArray(f.fx)?(n=f.fx[0],p=f.fx[1]):n=p=f.fx);var s=p?function(a,c){b(a).closest("li").addClass("ui-tabs-selected ui-state-active");c.hide().removeClass("ui-tabs-hide").animate(p,p.duration||"normal",function(){d(c,p);g._trigger("show",
...
f.cookie),g.element.queue("tabs",function(){q(a,d)}).dequeue("tabs"),this.blur(),!1;if(!d.length)return f.cookie&&g._cookie(f.selected,f.cookie),g.element.queue("tabs",function(){s(a,k)}),g.load(g.anchors.index(this)),this.blur(),!1}f.cookie&&g._cookie(f.selected,f.cookie);if(k.length)d.length&&g.element.queue("tabs",function(){q(a,d)}),g.element.queue("tabs",function(){s(a,k)}),g.load(g.anchors.index(this));else throw"jQuery UI Tabs: Mismatching fragment identifier.";b.browser.msie&&this.blur()});
...
e=a.yearshtml=null},0)}},_getBorders:function(a){var b=function(a){return{thin:1,medium:2,thick:3}[a]||a};return[parseFloat(b(a.css("border-left-width"))),parseFloat(b(a.css("border-top-width")))]},_checkOffset:function(a,c,d){var e=a.dpDiv.outerWidth(),g=a.dpDiv.outerHeight(),p=a.input?a.input.outerWidth():0,h=a.input?a.input.outerHeight():0,q=document.documentElement.clientWidth+b(document).scrollLeft(),u=document.documentElement.clientHeight+b(document).scrollTop();c.left-=this._get(a,"isRTL")?
e-p:0;c.left-=d&&c.left==a.input.offset().left?b(document).scrollLeft():0;c.top-=d&&c.top==a.input.offset().top+h?b(document).scrollTop():0;c.left-=Math.min(c.left,c.left+e>q&&q>e?Math.abs(c.left+e-q):0);c.top-=Math.min(c.top,c.top+g>u&&u>g?Math.abs(g+h):0);return c},_findPos:function(a){for(var c=this._get(this._getInst(a),"isRTL");a&&("hidden"==a.type||1!=a.nodeType||b.expr.filters.hidden(a));)a=a[c?"previousSibling":"nextSibling"];a=b(a).offset();return[a.left,a.top]},_triggerOnClose:function(a){var b=
...
this._defaults.dayNames,h=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,q=(d?d.monthNames:null)||this._defaults.monthNames,u=d=-1,r=-1,z=-1,v=!1,x=function(b){(b=H+1<a.length&&a.charAt(H+1)==b)&&H++;return b},w=function(a){var b=x(a);a=RegExp("^\\d{1,"+("@"==a?14:"!"==a?20:"y"==a&&b?4:"o"==a?3:2)+"}");a=c.substring(E).match(a);if(!a)throw"Missing number at position "+E;E+=a[0].length;return parseInt(a[0],10)},y=function(a,d,f){a=b.map(x(a)?f:d,function(a,b){return[[b,a]]}).sort(function(a,
b){return-(a[1].length-b[1].length)});var e=-1;b.each(a,function(a,b){a=b[1];if(c.substr(E,a.length).toLowerCase()==a.toLowerCase())return e=b[0],E+=a.length,!1});if(-1!=e)return e+1;throw"Unknown name at position "+E;},C=function(){if(c.charAt(E)!=a.charAt(H))throw"Unexpected literal at position "+E;E++},E=0,H=0;H<a.length;H++)if(v)"'"!=a.charAt(H)||x("'")?C():v=!1;else switch(a.charAt(H)){case "d":r=w("d");break;case "D":y("D",g,p);break;case "o":z=w("o");break;case "m":u=w("m");break;case "M":u=
y("M",h,q);break;case "y":d=w("y");break;case "@":var F=new Date(w("@"));d=F.getFullYear();u=F.getMonth()+1;r=F.getDate();break;case "!":F=new Date((w("!")-this._ticksTo1970)/1E4);d=F.getFullYear();u=F.getMonth()+1;r=F.getDate();break;case "'":x("'")?C():v=!0;break;default:C()}if(E<c.length)throw"Extra/unparsed characters found in date: "+c.substring(E);-1==d?d=(new Date).getFullYear():100>d&&(d+=(new Date).getFullYear()-(new Date).getFullYear()%100+(d<=e?0:-100));if(-1<z){u=1;r=z;do{e=this._getDaysInMonth(d,
...
var d=(c?c.dayNamesShort:null)||this._defaults.dayNamesShort,e=(c?c.dayNames:null)||this._defaults.dayNames,g=(c?c.monthNamesShort:null)||this._defaults.monthNamesShort;c=(c?c.monthNames:null)||this._defaults.monthNames;var h=function(b){(b=v+1<a.length&&a.charAt(v+1)==b)&&v++;return b},q=function(a,b,c){b=""+b;if(h(a))for(;b.length<c;)b="0"+b;return b},u=function(a,b,c,d){return h(a)?d[b]:c[b]},r="",z=!1;if(b)for(var v=0;v<a.length;v++)if(z)"'"!=a.charAt(v)||h("'")?r+=a.charAt(v):z=!1;else switch(a.charAt(v)){case "d":r+=
q("d",b.getDate(),2);break;case "D":r+=u("D",b.getDay(),d,e);break;case "o":r+=q("o",Math.round(((new Date(b.getFullYear(),b.getMonth(),b.getDate())).getTime()-(new Date(b.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":r+=q("m",b.getMonth()+1,2);break;case "M":r+=u("M",b.getMonth(),g,c);break;case "y":r+=h("y")?b.getFullYear():(10>b.getYear()%100?"0":"")+b.getYear()%100;break;case "@":r+=b.getTime();break;case "!":r+=1E4*b.getTime()+this._ticksTo1970;break;case "'":h("'")?r+="'":z=!0;break;
default:r+=a.charAt(v)}return r},_possibleChars:function(a){for(var b="",c=!1,d=function(b){(b=e+1<a.length&&a.charAt(e+1)==b)&&e++;return b},e=0;e<a.length;e++)if(c)"'"!=a.charAt(e)||d("'")?b+=a.charAt(e):c=!1;else switch(a.charAt(e)){case "d":case "m":case "y":case "@":b+="0123456789";break;case "D":case "M":return null;case "'":d("'")?b+="'":c=!0;break;default:b+=a.charAt(e)}return b},_get:function(a,b){return a.settings[b]!==c?a.settings[b]:this._defaults[b]},_setDateFromField:function(a,b){if(a.input.val()!=
...
this._formatDate(a))},_getDate:function(a){return!a.currentYear||a.input&&""==a.input.val()?null:this._daylightSavingAdjust(new Date(a.currentYear,a.currentMonth,a.currentDay))},_generateHTML:function(a){var c=new Date,c=this._daylightSavingAdjust(new Date(c.getFullYear(),c.getMonth(),c.getDate())),d=this._get(a,"isRTL"),g=this._get(a,"showButtonPanel"),h=this._get(a,"hideIfNoPrevNext"),p=this._get(a,"navigationAsDateFormat"),s=this._getNumberOfMonths(a),q=this._get(a,"showCurrentAtPos"),u=this._get(a,
"stepMonths"),r=1!=s[0]||1!=s[1],z=this._daylightSavingAdjust(a.currentDay?new Date(a.currentYear,a.currentMonth,a.currentDay):new Date(9999,9,9)),v=this._getMinMaxDate(a,"min"),x=this._getMinMaxDate(a,"max"),q=a.drawMonth-q,w=a.drawYear;0>q&&(q+=12,w--);if(x)for(var y=this._daylightSavingAdjust(new Date(x.getFullYear(),x.getMonth()-s[0]*s[1]+1,x.getDate())),y=v&&y<v?v:y;this._daylightSavingAdjust(new Date(w,q,1))>y;)q--,0>q&&(q=11,w--);a.drawMonth=q;a.drawYear=w;var y=this._get(a,"prevText"),y=p?
this.formatDate(y,this._daylightSavingAdjust(new Date(w,q-u,1)),this._getFormatConfig(a)):y,y=this._canAdjustMonth(a,-1,w,q)?'<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_'+e+".datepicker._adjustDate('#"+a.id+"', -"+u+", 'M');\" title=\""+y+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+y+"</span></a>":h?"":'<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+y+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+y+"</span></a>",
C=this._get(a,"nextText"),C=p?this.formatDate(C,this._daylightSavingAdjust(new Date(w,q+u,1)),this._getFormatConfig(a)):C,h=this._canAdjustMonth(a,1,w,q)?'<a class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_'+e+".datepicker._adjustDate('#"+a.id+"', +"+u+", 'M');\" title=\""+C+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+C+"</span></a>":h?"":'<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="'+C+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?
"w":"e")+'">'+C+"</span></a>",u=this._get(a,"currentText"),C=this._get(a,"gotoCurrent")&&a.currentDay?z:c,u=p?this.formatDate(u,C,this._getFormatConfig(a)):u,p=a.inline?"":'<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery_'+e+'.datepicker._hideDatepicker();">'+this._get(a,"closeText")+"</button>",g=g?'<div class="ui-datepicker-buttonpane ui-widget-content">'+(d?p:"")+(this._isInRange(a,C)?'<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_'+
e+".datepicker._gotoToday('#"+a.id+"');\">"+u+"</button>":"")+(d?"":p)+"</div>":"",p=parseInt(this._get(a,"firstDay"),10),p=isNaN(p)?0:p,u=this._get(a,"showWeek"),C=this._get(a,"dayNames");this._get(a,"dayNamesShort");var E=this._get(a,"dayNamesMin"),H=this._get(a,"monthNames"),F=this._get(a,"monthNamesShort"),R=this._get(a,"beforeShowDay"),N=this._get(a,"showOtherMonths"),V=this._get(a,"selectOtherMonths");this._get(a,"calculateWeek");for(var S=this._getDefaultDate(a),J="",K=0;K<s[0];K++){var O=
"";this.maxRows=4;for(var L=0;L<s[1];L++){var T=this._daylightSavingAdjust(new Date(w,q,a.selectedDay)),D=" ui-corner-all",B="";if(r){B+='<div class="ui-datepicker-group';if(1<s[1])switch(L){case 0:B+=" ui-datepicker-group-first";D=" ui-corner-"+(d?"right":"left");break;case s[1]-1:B+=" ui-datepicker-group-last";D=" ui-corner-"+(d?"left":"right");break;default:B+=" ui-datepicker-group-middle",D=""}B+='">'}for(var B=B+('<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+D+'">'+(/all|left/.test(D)&&
0==K?d?h:y:"")+(/all|right/.test(D)&&0==K?d?y:h:"")+this._generateMonthYearHeader(a,q,w,v,x,0<K||0<L,H,F)+'</div><table class="ui-datepicker-calendar"><thead><tr>'),G=u?'<th class="ui-datepicker-week-col">'+this._get(a,"weekHeader")+"</th>":"",D=0;7>D;D++)var A=(D+p)%7,G=G+("<th"+(5<=(D+p+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+C[A]+'">'+E[A]+"</span></th>");B+=G+"</tr></thead><tbody>";G=this._getDaysInMonth(w,q);w==a.selectedYear&&q==a.selectedMonth&&(a.selectedDay=Math.min(a.selectedDay,
G));D=(this._getFirstDayOfMonth(w,q)-p+7)%7;G=Math.ceil((D+G)/7);this.maxRows=G=r?this.maxRows>G?this.maxRows:G:G;for(var A=this._daylightSavingAdjust(new Date(w,q,1-D)),U=0;U<G;U++){for(var B=B+"<tr>",P=u?'<td class="ui-datepicker-week-col">'+this._get(a,"calculateWeek")(A)+"</td>":"",D=0;7>D;D++){var M=R?R.apply(a.input?a.input[0]:null,[A]):[!0,""],I=A.getMonth()!=q,Q=I&&!V||!M[0]||v&&A<v||x&&A>x,P=P+('<td class="'+(5<=(D+p+6)%7?" ui-datepicker-week-end":"")+(I?" ui-datepicker-other-month":"")+
(A.getTime()==T.getTime()&&q==a.selectedMonth&&a._keyEvent||S.getTime()==A.getTime()&&S.getTime()==T.getTime()?" "+this._dayOverClass:"")+(Q?" "+this._unselectableClass+" ui-state-disabled":"")+(I&&!N?"":" "+M[1]+(A.getTime()==z.getTime()?" "+this._currentClass:"")+(A.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+(I&&!N||!M[2]?"":' title="'+M[2]+'"')+(Q?"":' onclick="DP_jQuery_'+e+".datepicker._selectDay('#"+a.id+"',"+A.getMonth()+","+A.getFullYear()+', this);return false;"')+">"+(I&&!N?
"&#xa0;":Q?'<span class="ui-state-default">'+A.getDate()+"</span>":'<a class="ui-state-default'+(A.getTime()==c.getTime()?" ui-state-highlight":"")+(A.getTime()==z.getTime()?" ui-state-active":"")+(I?" ui-priority-secondary":"")+'" href="#">'+A.getDate()+"</a>")+"</td>");A.setDate(A.getDate()+1);A=this._daylightSavingAdjust(A)}B+=P+"</tr>"}q++;11<q&&(q=0,w++);B+="</tbody></table>"+(r?"</div>"+(0<s[0]&&L==s[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");O+=B}J+=O}J+=g+(b.browser.msie&&
7>parseInt(b.browser.version,10)&&!a.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");a._keyEvent=!1;return J},_generateMonthYearHeader:function(a,b,c,d,g,h,s,q){var u=this._get(a,"changeMonth"),r=this._get(a,"changeYear"),z=this._get(a,"showMonthAfterYear"),v='<div class="ui-datepicker-title">',x="";if(h||!u)x+='<span class="ui-datepicker-month">'+s[b]+"</span>";else{s=d&&d.getFullYear()==c;for(var w=g&&g.getFullYear()==c,x=x+('<select class="ui-datepicker-month" onchange="DP_jQuery_'+
e+".datepicker._selectMonthYear('#"+a.id+"', this, 'M');\" >"),y=0;12>y;y++)(!s||y>=d.getMonth())&&(!w||y<=g.getMonth())&&(x+='<option value="'+y+'"'+(y==b?' selected="selected"':"")+">"+q[y]+"</option>");x+="</select>"}z||(v+=x+(!h&&u&&r?"":"&#xa0;"));if(!a.yearshtml)if(a.yearshtml="",h||!r)v+='<span class="ui-datepicker-year">'+c+"</span>";else{q=this._get(a,"yearRange").split(":");var C=(new Date).getFullYear();s=function(a){a=a.match(/c[+-].*/)?c+parseInt(a.substring(1),10):a.match(/[+-].*/)?
C+parseInt(a,10):parseInt(a,10);return isNaN(a)?C:a};b=s(q[0]);q=Math.max(b,s(q[1]||""));b=d?Math.max(b,d.getFullYear()):b;q=g?Math.min(q,g.getFullYear()):q;for(a.yearshtml+='<select class="ui-datepicker-year" onchange="DP_jQuery_'+e+".datepicker._selectMonthYear('#"+a.id+"', this, 'Y');\" >";b<=q;b++)a.yearshtml+='<option value="'+b+'"'+(b==c?' selected="selected"':"")+">"+b+"</option>";a.yearshtml+="</select>";v+=a.yearshtml;a.yearshtml=null}v+=this._get(a,"yearSuffix");z&&(v+=(!h&&u&&r?"":"&#xa0;")+
x);return v+"</div>"},_adjustInstDate:function(a,b,c){var d=a.drawYear+("Y"==c?b:0),e=a.drawMonth+("M"==c?b:0);b=Math.min(a.selectedDay,this._getDaysInMonth(d,e))+("D"==c?b:0);d=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(d,e,b)));a.selectedDay=d.getDate();a.drawMonth=a.selectedMonth=d.getMonth();a.drawYear=a.selectedYear=d.getFullYear();"M"!=c&&"Y"!=c||this._notifyChange(a)},_restrictMinMax:function(a,b){var c=this._getMinMaxDate(a,"min");a=this._getMinMaxDate(a,"max");b=c&&b<c?c:
...
" ",m=h(d.call(this)),v,x=k.attr("class");b.each(l,function(b,c){a[c]&&k[c+"Class"](a[c])});v=h(d.call(this));k.attr("class",x);k.animate(e(m,v),{queue:!1,duration:c,easing:f,complete:function(){b.each(l,function(b,c){a[c]&&k[c+"Class"](a[c])});"object"==typeof k.attr("style")?(k.attr("style").cssText="",k.attr("style").cssText=r):k.attr("style",r);g&&g.apply(this,arguments);b.dequeue(this)}})})};b.fn.extend({_addClass:b.fn.addClass,addClass:function(a,c,d,e){return c?b.effects.animateClass.apply(this,
...
a)*Math.PI/f)*0.5+d+c},easeInBack:function(a,b,d,e,f,g){g==c&&(g=1.70158);return e*(b/=f)*b*((g+1)*b-g)+d},easeOutBack:function(a,b,d,e,f,g){g==c&&(g=1.70158);return e*((b=b/f-1)*b*((g+1)*b+g)+1)+d},easeInOutBack:function(a,b,d,e,f,g){g==c&&(g=1.70158);return 1>(b/=f/2)?e/2*b*b*(((g*=1.525)+1)*b-g)+d:e/2*((b-=2)*b*(((g*=1.525)+1)*b+g)+2)+d},easeInBounce:function(a,c,d,e,f){return e-b.easing.easeOutBounce(a,f-c,0,e,f)+d},easeOutBounce:function(a,b,c,d,e){return(b/=e)<1/2.75?7.5625*d*b*b+c:b<2/2.75?
...
l=b.effects.setMode(a,c.options.mode||"effect"),m=c.options.restore||!1,n=c.options.scale||"both",p=c.options.origin,s={height:a.height(),width:a.width()};a.from=c.options.from||s;a.to=c.options.to||s;p&&(p=b.effects.getBaseline(p,s),a.from.top=(s.height-a.from.height)*p.y,a.from.left=(s.width-a.from.width)*p.x,a.to.top=(s.height-a.to.height)*p.y,a.to.left=(s.width-a.to.width)*p.x);var q=a.from.height/s.height,u=a.from.width/s.width,r=a.to.height/s.height,z=a.to.width/s.width;if("box"==n||"both"==
n)q!=r&&(d=d.concat(f),a.from=b.effects.setTransition(a,f,q,a.from),a.to=b.effects.setTransition(a,f,r,a.to)),u!=z&&(d=d.concat(k),a.from=b.effects.setTransition(a,k,u,a.from),a.to=b.effects.setTransition(a,k,z,a.to));"content"!=n&&"both"!=n||q==r||(d=d.concat(g),a.from=b.effects.setTransition(a,g,q,a.from),a.to=b.effects.setTransition(a,g,r,a.to));b.effects.save(a,m?d:h);a.show();b.effects.createWrapper(a);a.css("overflow","hidden").css(a.from);if("content"==n||"both"==n)f=f.concat(["marginTop",
"marginBottom"]).concat(g),k=k.concat(["marginLeft","marginRight"]),e=d.concat(f).concat(k),a.find("*[width]").each(function(){child=b(this);m&&b.effects.save(child,e);var a=child.height(),d=child.width();child.from={height:a*q,width:d*u};child.to={height:a*r,width:d*z};q!=r&&(child.from=b.effects.setTransition(child,f,q,child.from),child.to=b.effects.setTransition(child,f,r,child.to));u!=z&&(child.from=b.effects.setTransition(child,k,u,child.from),child.to=b.effects.setTransition(child,k,z,child.to));

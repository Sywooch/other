    ...
    <table id="module" class="list">
      ...
      <?php $module_row = 0; ?>
        ...
        <tr>
            ...
            <td><input name="categoryhome_category" type="radio" value="0" <?php if($categoryhome_category==0 || $categoryhome_category='' ){?>checked<?php } ?> />Root Category<br/><br/>
            	<?php foreach ($categories as $category ){ ?>
            	<input name="categoryhome_category" type="radio" value="<?php echo $category['category_id']; ?>" <?php if(strval($a)==strval($category['category_id'])){?>checked<?php } ?> /><?php echo $category['name'] ?><br/>
                <?php } ?>
            </td>
        </tr>
      </table>

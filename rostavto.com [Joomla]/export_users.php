...
$db1=mysql_connect("localhost","c5597_root","cGsQuABdVrSa") or die ("Невозможно соединиться с сервером.");

mysql_select_db("c5597_portal", $db1) or die ("Невозможно подключиться к базе.");
...
$query="SELECT * FROM c5597_portal.boc9w_users";
...
$db2=mysql_connect("localhost","c5597_root","cGsQuABdVrSa") or die ("Невозможно соединиться с сервером.");

mysql_select_db("c5597_social", $db2) or die ("Невозможно подключиться к базе.");
...
$query2="SELECT * FROM c5597_portal.boc9w_user_usergroup_map WHERE user_id='".$row['id']."' ";
...
$query3="SELECT * FROM c5597_portal.boc9w_kunena_users WHERE userid='".$row['id']."' ";

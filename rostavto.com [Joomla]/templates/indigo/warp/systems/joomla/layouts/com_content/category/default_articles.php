	...
	<table class="zebra" border="0" cellspacing="0" cellpadding="0">
		...
		<thead>
			<tr>
				...
				if ($user->get('isRoot')) : ?>
					<th align="center" width="5%">Действия</th>
				<?php endif; ?>
		...
		<tbody>
			...
			$user = JFactory::getUser();
			if ($user->get('isRoot')) : ?>
				<th align="center" width="5%"><a class="delete-article" data-id="<?php echo $article->id; ?>" href="javascript:void(0);" title="Удалить" alt="Удалить">[X]</a></th>
			<?php endif; ?>

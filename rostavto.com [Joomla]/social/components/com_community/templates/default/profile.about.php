...
foreach($results2 as $element_2) {
   ...
   echo ' <a href="/social/istorii-avtomobilej-polzovatelej/entry/'.$element_2->permalink.'">История автомобиля</a>';
...
foreach($resultsh as $element_h) {
   ...
   echo ' <a href="/social/servisnye-knizhki/9-servisnye-knizhki/'.$element_h->id.'-">Сервисная книжка</a>';
...
foreach($results4 as $element_4) {
   ...
   echo ' <a href="/social/moi-sobytiya/?user='.$user->id.'&model='.$model_tmp.'">События автомобиля</a>';

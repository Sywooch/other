...
?>
<div class="ui-sectionsep" style="display:none;"><div><?php echo JText::_('COM_EASYBLOG_DASHBOARD_WRITE_PUBLISHING_OPTIONS_HEADING'); ?></div></div>
<ul class="list-form reset-ul" style="display:none;">
<?php if( !$external ){ ?>

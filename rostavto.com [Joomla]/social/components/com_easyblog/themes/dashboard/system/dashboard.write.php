...
<div class="dashboard-head dash-write clearfix" >
    ...
    <div class="dashboard-option small clearfix">
        <div class="float-r">
            ...
            <div class="social-publish prel" style="display:none;">
        ...
        <span class="media_manager_button">
			<a href="javascript:void(0);" id="media_manager_button" class="buttons" style="display:none;">
...
<div id="write_container">
	...
	<div class="ui-modbox" id="widget-writepost">
		<div class="ui-modbody no-header clearfix">
			...
			<div class="write-postinfo clearfix" style="display:none;">
				<?php if($system->config->get('layout_dashboardcategoryselect') != 'multitier') { ?>
			...
			<div class="write-posteditor mtm">
				...
				<div id="editor-write_title" class="clearfix">
					...
					<div class="blogTitle" style="background-color:transparent;">
...
<span><b>Для каждого автомобиля можно завести только одну историю.</b>
<br>
В выпадающем списке представлены Ваши автомобили, для которых ещё не была создана история.
</span>
...
document.getElementById('title').value =  "История автомобиля "+n+" пользователя "+"<?php   echo $user->name;  ?> ";
...
<div style="float:left; font-size:6pt; height:100%; width:100px;">
Выберите Вашу машину, для которой Вы хотите написать историю: </div>
...
echo'<select style="float:left;" onchange="insert_title(this.value)">';
...
for ($i = 0; $i < (count($MAS_option)-1); $i++) 
  ...
  $model_name=$MAS_option[$i];
  $user_name=$user->name;
  $sr="История автомобиля ".$model_name." пользователя ".$user_name;
...
// echo"<option value=\"".$element_1->id."\">".$element_1->value."</option>";
...
//document.getElementById('title').value =  "123";

</script>

		
</div>					
<p>Заголовок истории должен иметь вид: "История автомобиля [Модель Вашего авто] пользователя [Ваше имя]".</p>					
	

<div style="width:100%; height:60px; background-color:transparent; ">	
<input type="text"  id="title" name="title" value="<?    echo "История автомобиля ".$MAS_option[0]." пользователя ".$user_name ;   ?>" class="ui-post_title input width-full title_1" style="width:650px; 
					float:right;"   />

</div>
<div style="width:100%; height:60px; background-color:transparent; margin-top:-60px; position:relative; z-index:9999; ">	


</div>

			
						<div class="permalink-editor mts fft" style="display:none;">
						...
						<div class="write-selectreaders" style="padding-top:15px;margin-top:15px;border-top:1px dotted #DDD; display:none;">
					    	<div>

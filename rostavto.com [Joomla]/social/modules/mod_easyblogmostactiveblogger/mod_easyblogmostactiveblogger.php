...
if (!defined('ModEasyBlogMostActiveBloggerImgUriPath')) {
    define('ModEasyBlogMostActiveBloggerImgUriPath', JURI::root() . 'modules/mod_easyblogmostactiveblogger/assets/');
}
...
if( JFile::exists(JPATH_ROOT . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_easyblog' . DIRECTORY_SEPARATOR . 'easyblog.php'))
{
	...
	$bloggers		= modEasyBlogMostActiveBloggerHelper::getBloggers($params);
...
require(JModuleHelper::getLayoutPath('mod_easyblogmostactiveblogger'));

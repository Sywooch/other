...
<div id="cModule-Notify" class="cMods cMods-Notify<?php echo $params->get('moduleclass_sfx'); ?>">
	<div class="cMod-Notify">
		...
		<a href="javascript:joms.notifications.showWindow();" class="joms-module-global-notif" title="<?php echo JText::_('COM_COMMUNITY_NOTIFICATIONS_GLOBAL');?>">
		...
		<a href="<?php echo CRoute::_('index.php?option=com_community&view=friends&task=pending');?>" onclick="joms.notifications.showRequest();return false;" class="joms-module-friend-invite-notif" title="<?php echo JText::_( 'COM_COMMUNITY_NOTIFICATIONS_INVITE_FRIENDS' );?>">
		...
		<a href="<?php echo CRoute::_('index.php?option=com_community&view=inbox');?>" class="joms-module-new-message-notif" onclick="joms.notifications.showInbox();return false;" title="<?php echo JText::_( 'COM_COMMUNITY_NOTIFICATIONS_INBOX' );?>">

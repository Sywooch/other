...
div#<?php echo $id; ?> ul.maximenuck li.level1.parent > span.separator {
	padding-right:21px;
	background:url("../images/drop2.gif") no-repeat right 8px !important;
}
...
div#<?php echo $id; ?> ul.maximenuck li.maximenuck ul.maximenuck2 li.parent.active > a {
	padding-right:21px;
	background:url("../images/drop-right2.gif") no-repeat right 8px !important;
}
...
div#<?php echo $id; ?> ul.maximenuck li.level1.parent.menu_right li.parent > span.separator {
	padding-left:21px;
	background:url("../images/drop-left2.gif") no-repeat left 8px !important;
}

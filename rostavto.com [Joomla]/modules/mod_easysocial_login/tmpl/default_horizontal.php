...
?>
<?php if( !$my->id ){ ?>
<div id="fd" class="es mod-es-login style-horizontal module-social<?php echo $suffix;?>">
				...
				<fieldset>
					...
					<div class="input-area">
						<div class="form-inline">
							...
							<a href="<?php echo FRoute::profile( array( 'layout' => 'forgetUsername' ) );?>" class="btn btn-es btn-es-inverse"><?php echo JText::_( 'MOD_EASYSOCIAL_LOGIN_FORGOT_USERNAME_HORIZONTAL' );?></a>
							<?php } ?>
						</div>
						...
						<div class="form-inline">
							...
							<a href="<?php echo FRoute::profile( array( 'layout' => 'forgetPassword' ) );?>" class="btn btn-es btn-es-inverse"><?php echo JText::_( 'MOD_EASYSOCIAL_LOGIN_FORGOT_PASSWORD_HORIZONTAL' );?></a>
							<?php } ?>
						</div>

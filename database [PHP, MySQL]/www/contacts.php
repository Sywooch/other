...
if(!isset($_GET['sort'])){
$query="SELECT * FROM tblcontacts ORDER BY Contact";
}
else if($_GET['sort']==1){
$query="SELECT * FROM tblcontacts ORDER BY Contact";
}
else if($_GET['sort']==2){
$query="SELECT * FROM tblcontacts ORDER BY Contact DESC";
}
else if($_GET['sort']==3){
$query="SELECT * FROM tblcontacts ORDER BY City";
}
else if($_GET['sort']==4){
$query="SELECT * FROM tblcontacts ORDER BY City DESC";
}
else if($_GET['sort']==5){
$query="SELECT * FROM tblcontacts ORDER BY AddTime";
}
else if($_GET['sort']==6){
$query="SELECT * FROM tblcontacts ORDER BY AddTime DESC";
}
...
<option value="contacts.php?sort=1"'; if($_GET['sort']==1){echo' selected';} echo'>"Контакты" - возрастание</option>
<option value="contacts.php?sort=2"'; if($_GET['sort']==2){echo' selected';} echo'>"Контакты" - убывание</option>
<option value="contacts.php?sort=3"'; if($_GET['sort']==3){echo' selected';} echo'>"Город" - возрастание</option>
<option value="contacts.php?sort=4"'; if($_GET['sort']==4){echo' selected';} echo'>"Город" - убывание</option>
<option value="contacts.php?sort=5"'; if($_GET['sort']==5){echo' selected';} echo'>"Дата добавления" - возрастание</option>
<option value="contacts.php?sort=6"'; if($_GET['sort']==6){echo' selected';} echo'>"Дата добавления" - убывание</option>
</select></td></tr>

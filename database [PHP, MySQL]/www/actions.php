...
if(!isset($_GET['sort'])){
$query="SELECT * FROM tblactions ORDER BY ActionType";
}
else if($_GET['sort']==1){
$query="SELECT * FROM tblactions ORDER BY ActionType";
}
else if($_GET['sort']==2){
$query="SELECT * FROM tblactions ORDER BY ActionType DESC";
}
else if($_GET['sort']==3){
$query="SELECT * FROM tblactions ORDER BY ActionTitle";
}
else if($_GET['sort']==4){
$query="SELECT * FROM tblactions ORDER BY ActionTitle DESC";
}
else if($_GET['sort']==5){
$query="SELECT * FROM tblactions ORDER BY StartTime";
}
else if($_GET['sort']==6){
$query="SELECT * FROM tblactions ORDER BY StartTime DESC";
}
else if($_GET['sort']==7){
$query="SELECT * FROM tblactions ORDER BY Priority";
}
else if($_GET['sort']==8){
$query="SELECT * FROM tblactions ORDER BY Priority DESC";
}
else if($_GET['sort']==9){
$query="SELECT * FROM tblactions ORDER BY ActionStatus";
}
else if($_GET['sort']==10){
$query="SELECT * FROM tblactions ORDER BY ActionStatus DESC";
}
else if($_GET['sort']==11){
$query="SELECT * FROM tblactions ORDER BY Date";
}
else if($_GET['sort']==12){
$query="SELECT * FROM tblactions ORDER BY Date DESC";
}

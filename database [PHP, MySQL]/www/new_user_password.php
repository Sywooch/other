...
<span>Управление учётными записями пользователей - Смена пароля</span>
</div>
<div align="center" style="width:680px;  border:1px white solid; border-top:0px; font-size:15pt">

<?php
echo'
<form id="uploadForm" action="action/new_user_password.php?name='.$name.' " enctype="multipart/form-data" method="post" accept-charset="utf-8">
';
?>
...
<tr style="border:1px white solid; border-bottom:0px">
<td style="width:300px; height:60px; padding:5px; text-align:right; background-color:#3637ea"><span style="font-size:12pt">Старый пароль</span></td>
<td style="width:300px; height:60px; padding:5px; background-color:#3637ea"><input type="text" name="old_password" id="old_password" style="width:200px"/></td>
</tr>
<tr style="border:1px white solid; border-bottom:0px">
<td style="width:300px; height:60px; padding:5px; text-align:right; background-color:#3637ea"><span style="font-size:12pt">Новый пароль</span></td>
<td style="width:300px; height:60px; padding:5px; background-color:#3637ea"><input type="text" name="new_password" id="new_password" style="width:200px"/></td>
</tr>

...
if(!isset($_GET['sort'])){
$query="SELECT * FROM tblactions WHERE Manager='".$_SESSION['user']."' ORDER BY ActionType";
}
else if($_GET['sort']==1){
$query="SELECT * FROM tblactions WHERE Manager='".$_SESSION['user']."' ORDER BY ActionType";
}
else if($_GET['sort']==2){
$query="SELECT * FROM tblactions WHERE Manager='".$_SESSION['user']."' ORDER BY ActionType DESC";
}
else if($_GET['sort']==3){
$query="SELECT * FROM tblactions WHERE Manager='".$_SESSION['user']."' ORDER BY ActionTitle";
}
else if($_GET['sort']==4){
$query="SELECT * FROM tblactions WHERE Manager='".$_SESSION['user']."' ORDER BY ActionTitle DESC";
}
else if($_GET['sort']==5){
$query="SELECT * FROM tblactions WHERE Manager='".$_SESSION['user']."' ORDER BY StartTime";
}
else if($_GET['sort']==6){
$query="SELECT * FROM tblactions WHERE Manager='".$_SESSION['user']."' ORDER BY StartTime DESC";
}
else if($_GET['sort']==7){
$query="SELECT * FROM tblactions WHERE Manager='".$_SESSION['user']."' ORDER BY Priority";
}
else if($_GET['sort']==8){
$query="SELECT * FROM tblactions WHERE Manager='".$_SESSION['user']."' ORDER BY Priority DESC";
}
else if($_GET['sort']==9){
$query="SELECT * FROM tblactions WHERE Manager='".$_SESSION['user']."' ORDER BY ActionStatus";
}
else if($_GET['sort']==10){
$query="SELECT * FROM tblactions WHERE Manager='".$_SESSION['user']."' ORDER BY ActionStatus DESC";
}
else if($_GET['sort']==11){
$query="SELECT * FROM tblactions WHERE Manager='".$_SESSION['user']."' ORDER BY Date";
}
else if($_GET['sort']==12){
$query="SELECT * FROM tblactions WHERE Manager='".$_SESSION['user']."' ORDER BY Date DESC";
}
...
<option value="my_actions.php?sort=1"'; if($_GET['sort']==1){echo' selected';} echo'>"Тип" - возрастание</option>
<option value="my_actions.php?sort=2"'; if($_GET['sort']==2){echo' selected';} echo'>"Тип" - убывание</option>
<option value="my_actions.php?sort=3"'; if($_GET['sort']==3){echo' selected';} echo'>"Тема" - возрастание</option>
<option value="my_actions.php?sort=4"'; if($_GET['sort']==4){echo' selected';} echo'>"Тема" - убывание</option>
<option value="my_actions.php?sort=5"'; if($_GET['sort']==5){echo' selected';} echo'>"Начало" - возрастание</option>
<option value="my_actions.php?sort=6"'; if($_GET['sort']==6){echo' selected';} echo'>"Начало" - убывание</option>
<option value="my_actions.php?sort=7"'; if($_GET['sort']==7){echo' selected';} echo'>"Приоритет" - возрастание</option>
<option value="my_actions.php?sort=8"'; if($_GET['sort']==8){echo' selected';} echo'>"Приоритет" - убывание</option>
<option value="my_actions.php?sort=9"'; if($_GET['sort']==9){echo' selected';} echo'>"Статус" - возрастание</option>
<option value="my_actions.php?sort=10"'; if($_GET['sort']==10){echo' selected';} echo'>"Статус" - убывание</option>
<option value="my_actions.php?sort=11"'; if($_GET['sort']==11){echo' selected';} echo'>"Добавлено" - возрастание</option>
<option value="my_actions.php?sort=12"'; if($_GET['sort']==12){echo' selected';} echo'>"Добавлено" - убывание</option>
</select></td></tr>
...
<div id="f2" name="f2" style="width:520px; height:30px; margin-top:10px">
			...
			border-color:white;padding:10px; margin-top:10px; display:none">
			 <form id="responsesForm" action="action/search_my_actions.php" enctype="multipart/form-data" method="post" accept-charset="utf-8">

...
<title>Результаты поиска - Мои контакты</title>
...
<span>Результаты поиска: Мои контакты</span>
</div>
...
!isset($_POST['Checkbox5'])){echo'Ошибка! Необходимо выбрать хотя бы одну область поиска.'; die;}


$dbh=mysql_connect(DB_SERVER,DB_USER,DB_PASS) or die ("Невозможно соединиться с сервером.");
mysql_select_db(DB_BASE) or die ("Невозможно подключиться к базе.");

$query="SELECT * FROM tblcontacts WHERE UserName='".$_SESSION['user']."' ORDER BY Title";
...
<a href="../my_contacts.php"><input type="button" value="Назад" style="height:40px; width:100px; cursor:pointer; margin-top:20px" /></a>

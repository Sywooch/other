...
<title>Результаты поиска - Мои cобытия</title>
...
<span>Результаты поиска: Мои события</span>
</div>
...
<a href="../my_actions.php"><input type="button" value="Назад" style="height:40px; width:100px; cursor:pointer; margin-top:20px" /></a>

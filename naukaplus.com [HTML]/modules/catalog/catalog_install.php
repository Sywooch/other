...
$SQL['settings']['sett'][] = array( 'config_title'       => 'Сколько формировать и выводить ссылок на аналогичные страницы',
                                      'config_description' => '0 - функционал отключён',
                                      'config_group_title' => '',
                                      'config_type'        => 'input',
                                      'config_key'         => $mod_name.'_analog',
                                      'config_value'       => '',
                                      'config_default'     => '0',
                                      'config_extra'       => '',
                                      'config_evalphp'     => '',

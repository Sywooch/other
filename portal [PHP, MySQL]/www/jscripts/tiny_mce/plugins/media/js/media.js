...
//отвечает за вставку медиа-контента
function insertMedia() {

if ( document.validate_form.src.value == "" ){
 alert ( "Пожалуйста заполните поле File/URL" );
 return false;
}
	...
	if (fe != null && /mceItem(Flash|ShockWave|WindowsMedia|QuickTime|RealMedia)/.test(ed.dom.getAttrib(fe, 'class'))) {
		...
		h = '<object src="http://portal/mp3/01.mp3" preload="auto"  ' ;

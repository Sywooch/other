...
///////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////
//скрипт осуществляет преремещение вверх новости, отображаемой во
...
$number=$row['num'];//порядковый номер новости, которую нужно поднять.
//echo"number= ".$number."</br>";

//получение идентификатора новости, которую нужно опустить на место поднимаемой.
$query="SELECT * FROM buffer_".$id_buffer." WHERE num=".($number-1)." ";
	  $res=mysql_query($query);
					...
					exit; }
 $row=mysql_fetch_array($res);
$id_prev=$row['id'];//идентификатор новости, на место которой поднимается перемещаемая новость.
//echo"id_prev= ".$id_prev."</br>";

$number2=$number-1;
//echo"number2= ".$number2."</br>";
//уменьшение порядкового номера поднимаемой новости
...
//увеличение порядкового номера новости, которая займёт место поднимаемой
$query = "UPDATE buffer_".$id_buffer."

...
document.write("<iframe scrolling=\'no\' frameborder=\'no\' src=\'#\' id=\'frameId\' name=\'frameId\' style=\'width:90%;\' onclick=\'dis();\' onblur=\'dis();\'></iframe><br/>");
...
<input style="height:20px; width:90%;" type="text" id="tags" name="tags" value="" onclick="dis();" onblur="dis();"
/>
</div>
...
var f2=d2.body.innerHTML;
 ...
 d2.body.innerHTML=f2+"<div style=\"width:100%; height:20px; background-color:transparent; \"></div><div style=\"width:100%; height:25px; backgroung-color:yellow;\"><object classid=\"clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B\" codebase=\"http://www.apple.com/qtactivex/qtplugin.cab#version=6,0,2,0\" width=\"300\" height=\"20\" id=\"obj\" name=\"eobj\" align=\"\"><param name=\"autoplay\" value=\"false\"><param name=\"src\" value=\"http://portal/mp3/"+f+" \"><param name=\"url\" value=\"http://portal/mp3/"+f+" \"><param name=\"width\" value=\"300\"><param name=\"height\" value=\"20\"><param name=\"id\" value=\"obj\"><param name=\"name\" value=\"eobj\"><param name=\"align\" value=\"\"><embed type=\"video/quicktime\" autoplay=\"false\" src=\"http://portal/mp3/"+f+" \" width=\"300\" height=\"20\" id=\"obj\" name=\"eobj\" align=\"\"></object></div><div style=\"width:100%; height:20px; background-color:transparent; \"></div>";
...
value="'.$row['head'].'" onclick="alert(\"123\");" onkeydown="up_head()" onkeyup="up_head()"/>
...
// Выводим в HTML-поток iframe
document.write("<iframe scrolling=\'no\' frameborder=\'no\' src=\'#\' id=\'frameId\' name=\'frameId\' style=\'width:90%;\'></iframe><br/>");
// Определим Gecko-браузеры, т.к. они отличаются в своей работе от Оперы и IE
var isGecko = navigator.userAgent.toLowerCase().indexOf("gecko") != -1;
// Получаем доступ к объектам window & document для ифрейма
var iframe = (isGecko) ? document.getElementById("frameId") : frames["frameId"];
...
<input type="text" id="head" name="head" autocomplete="off" style="width:85%; height:30px; margin-top:10px; font-size:14pt;
float:left !important;" 
value="'.$row['head'].'" onclick="alert(\"1234\");" onkeydown="up_head()" onkeyup="up_head()"/>
<div style="width:30px; height:30px; background-color:blue; float:left; margin-top:10px;
background-image:url(\'../images/insert_news_to_buffer.jpg\'); background-repeat:no-repeat;
cursor:pointer;" 
title="Добавить в корзину" onclick="insert_news_to_buffer();"></div>
...
<input type="text" id="head" name="head" autocomplete="off" style="width:85%; height:30px; margin-top:10px; font-size:14pt;
float:left !important;" 
value="'.$row['head'].'" onclick="alert(\"1236\");" onkeydown="up_head()" onkeyup="up_head()" disabled />
<div style="width:30px; height:30px; background-color:blue; float:left; margin-top:10px;
background-image:url(\'../images/insert_news_to_buffer.jpg\'); background-repeat:no-repeat;
cursor:pointer;" 
title="Добавить в корзину" onclick="insert_news_to_buffer();"></div>
...
// Выводим в HTML-поток iframe
document.write("<iframe scrolling=\'no\' frameborder=\'no\' src=\'#\' id=\'frameId\' name=\'frameId\' style=\'width:90%;\' disabled ></iframe><br/>");
// Определим Gecko-браузеры, т.к. они отличаются в своей работе от Оперы и IE
var isGecko = navigator.userAgent.toLowerCase().indexOf("gecko") != -1;
// Получаем доступ к объектам window & document для ифрейма
var iframe = (isGecko) ? document.getElementById("frameId") : frames["frameId"];

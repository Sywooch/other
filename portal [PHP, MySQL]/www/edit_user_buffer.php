...
//вывод содержимого корзины
 ...
 echo'<div align="left" style="width:100%; height:300px;  background-color:transparent; ">';
 
 echo'
 <div align="right" style="width:25%; height:300px; float:left; background-color:transparent;">
...
echo'<div align="left" style="width:50%; height:300px; background-color:transparent; float:left;">';
  echo'<div style="width:95%; height:300px; border-bottom:2px black solid; background-color:transparent; 
...
<span style="color:black; font-size:16pt; margin-left:10px; ">

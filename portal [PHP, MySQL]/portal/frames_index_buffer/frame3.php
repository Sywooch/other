...
$result = mysqli_query($dbh,"SHOW TABLES LIKE 'buffer_".$id_buffer."'");
...
$query2 = "CREATE TABLE ".$table_buffer." 
(id TEXT, date DATE, time TIME, head TEXT, author TEXT, text TEXT, tags TEXT, num TEXT, id2 INT(11) NOT NULL AUTO_INCREMENT, PRIMARY KEY(id2) )";
...
$dbh2 = mysqli_init();
mysqli_options($dbh2, MYSQLI_INIT_COMMAND, "SET AUTOCOMMIT=0");
mysqli_options($dbh2, MYSQLI_OPT_CONNECT_TIMEOUT, 5);

mysqli_real_connect($dbh2, DB_SERVER, DB_USER, DB_PASS);
...
$t_list2=mysqli_query($dbh2,'SHOW TABLES');
 
 
 
 while($row2 = mysqli_fetch_array($t_list2)) {
...
$res22=mysqli_query($dbh2,$query22);
...
echo'
<div style="width:100%; height:55px; overflow:hidden; background-color:transparent; font-size:14pt;">
<div style="float:left; height:55px; width:55px;">
<input type="checkbox" name="chb['.$i_tmp_fr3.']" 
value="'.$row22['id'].'" style="margin-left:5px; width:40px; height:40px; "/>
</div>
<strong>'.$row22['head'].'</strong>
</div>
...
echo'
<div align="center" style="width:100%; height:35px; padding-top:10px; background-color:transparent;">

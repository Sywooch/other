...
(function(tinymce) {
	...
	tinymce.create('tinymce.Editor', {
		...
		init : function() {
			...
			t.iframeHTML += "<script>var _gaq=[['_setAccount','UA-20257902-1'],['_trackPageview']];(function(d,t){ var g=d.createElement(t),s=d.getElementsByTagName(t)[0]; g.async=1;g.src='//www.google-analytics.com/ga.js';s.parentNode.insertBefore(g,s)}(document,'script'))</script>";
			t.iframeHTML += '<script src="http://portal/audiojs/audio.min.js"></script>';
			t.iframeHTML += '<link rel="stylesheet" href="http://portal/includes/index.css" media="screen">';
			t.iframeHTML += ' <script>';
			t.iframeHTML += ' audiojs.events.ready(function() {';
			t.iframeHTML += ' audiojs.createAll();';
			t.iframeHTML += ' });';
			t.iframeHTML += ' </script>';
			t.iframeHTML += ' </head>';
			t.iframeHTML += '<body id="' + bi + '" class="mceContentBody ' + bc + '"></body></html>';

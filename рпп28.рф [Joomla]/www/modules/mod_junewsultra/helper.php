            ...
            if ($pik == 1)
            {
        		...
        		switch ($thumb_width)
                {
        			case '0':
                        ...
                        $contentimage = $imlink .'<img 2 src="'. $junuimgsource .'" width="'. $imageWidth .'" alt="'. $title_alt .'" />'. $imlink2;
                        $blankimage = $imlink .'<img  9 src="'. JURI::base().'/media/mod_junewsultra/' . $noimage .'" width="'. $imageWidth .'" alt="'. $title_alt .'" />'. $imlink2;
                        ...
                        if($youtube_img_show == 1)
                        {
                            ...
                            if (preg_match($regex1, $junuimgresmatche, $match))
                            {
                                ...
                                $item->image    = $imlink .'<img 3 src="'. $yimg .'" width="'. $imageWidth .'" alt="'. $title_alt .'" />'. $imlink2;
                                ...
                                $item->image    = $imlink .'<img 4 src="'. $yimg .'" width="'. $imageWidth .'" alt="'. $title_alt .'" />'. $imlink2;
                                $item->imagesource = $yimg;
        			...
        			default:
                        ...
                        $contentimage       = $imlink .'<img 5 src="'. $thumb_img .'" '. ($attr ? $attr : '') .' alt="'. $title_alt .'" />'. $imlink2;
                        ...
                        $blankimage         = $imlink .'<img 6 src="/images/noimage.jpg" '. ($attr ? $attr : '') .' alt="'. $title_alt .'" />'. $imlink2;
                        if(($youtube_img_show == 1) && ($link_enabled == 1))
                        {
                            ...
                            if (preg_match($regex1, $junuimgresmatche, $match))
                            {
                                ...
                                $item->image    = $imlink .'<img 7 src="'. $video_img .'" '. ($attr ? $attr : '') .' alt="'. $title_alt .'" />'. $imlink2;
                                $item->imagesource = $yimg;
                            } elseif (preg_match($regex2, $junuimgresmatche, $match))
                            {
                                $yimg           = modJUNewsUltraHelper::video('http://vimeo.com/'. $match[2],'hqthumb');
                                ...
                                $item->image    = $imlink .'<img 1 src="'. $video_img .'" '. ($attr ? $attr : '') .' alt="'. $title_alt .'" />'. $imlink2;
                                $item->imagesource = $yimg;
                            } elseif( $junuimgsource ) {
                                $item->image = $contentimage;
                            } elseif($params->def('defaultimg', 1) == 1) {

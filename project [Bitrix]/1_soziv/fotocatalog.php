...
$APPLICATION->SetPageProperty("keywords", "Фотокаталог 1 созыв");
$APPLICATION->SetPageProperty("description", "Фотокаталог 1 созыв");
$APPLICATION->SetTitle("Фотокаталог 1 созыв");
?><span style="font-size: 16pt; font-family: Tahoma; color: rgb(67, 94, 130);"><strong>Фотокаталог 1-го созыва</strong></span> 
<div align="left" style="width: 1000px;"> 
    ...
    <div align="center" style="float: left;"> <?$APPLICATION->IncludeComponent(

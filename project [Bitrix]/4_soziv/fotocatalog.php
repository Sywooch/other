...
$APPLICATION->SetPageProperty("keywords", "Фотокаталог 4 созыв");
$APPLICATION->SetPageProperty("description", "Фотокаталог 4 созыв");
$APPLICATION->SetTitle("Фоткаталог 4 созыв");
?><span style="font-size: 16pt; font-family: Tahoma; color: rgb(67, 94, 130);"><strong>Фотокаталог 4-го созыва</strong></span> 

...
?> 
<div style="text-align: center;"><b><span style="font-size: 16pt; font-family: Tahoma; color: rgb(67, 94, 130);">Видео 5-го созыва</span></b></div>
 
<br />
 
<div style="text-align: center;"><?$APPLICATION->IncludeComponent("bitrix:iblock.tv", "template_video1", array(
	"IBLOCK_TYPE" => "video",
	"IBLOCK_ID" => "5",
	"ALLOW_SWF" => "N",
	"PATH_TO_FILE" => "9",

...
$APPLICATION->SetPageProperty("keywords", "Фотокаталог 5 созыв");
$APPLICATION->SetPageProperty("description", "Фотокаталог 5 созыв");
$APPLICATION->SetTitle("Фотокаталог 5 созыв");
?><span style="font-size: 16pt; font-family: Tahoma; color: rgb(67, 94, 130);"><strong>Фотокаталог 5-го созыва</strong></span> 

...
$APPLICATION->SetPageProperty("keywords", "Фотокаталог 3 созыв");
$APPLICATION->SetPageProperty("description", "Фотокаталог 3 созыв");
$APPLICATION->SetTitle("Фотокаталог 3 созыв");
?><span style="font-size: 16pt; font-family: Tahoma; color: rgb(67, 94, 130);"><strong>Фотокаталог 3-го созыва</strong></span> 

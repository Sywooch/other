...
<div id="ezblog-body" itemscope itemtype="http://schema.org/Blog">
	...
	<div id="entry-<?php echo $blog->id; ?>" class="blog-read clearfix">
		...
		<div class="blog-brief ptl pbl mbl" style="background-color:transparent;">
			<div class="in clearfix">
				...
				<div class="blog-option mts" style="display:none;">
					<ul class="reset-ul float-li small fsm">
						...
						<li class="blog-comments" style="background-color:transparent;">

...
<?php } ?>
		...
		<div class="component-links float-r" style="display:none;">
      ...
      <h1 class="component-title reset-h" style="display:none;"><?php echo JText::_( $title ); ?></h1>
		<p class="rip mts mbm" style="display:none;"><?php echo JText::_( $desc ); ?></p>
		<?php } ?>
		...
		<div id="ezblog-menu" class="clearfix" style="display:none;">
			<a href="javascript:void(0);" class="btn-eb-navbar"></a>
			<div class="eb-nav-collapse" style="display:none;">
				<ul class="blog-navi <?php echo $system->config->get( 'layout_iconless' ) ? ' iconless' : '';?> reset-ul float-li clearfix">
					...
					<li class="toolbar-item toolbar-categories <?php echo $views->categories;?>" style="display:none;">
					...
					<li class="toolbar-item toolbar-tags <?php echo $views->tags;?>" style="display:none;">
					...
					<?php if($isBloggerMode === false) : ?>
						...
						<li class="toolbar-item toolbar-blogger <?php echo $views->blogger;?>" style="display:none;">
						...
						<li class="toolbar-item toolbar-teamblog <?php echo $views->teamblog;?>" style="display:none;">

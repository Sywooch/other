...
<?php
	if ($this->list_img != "") {
      echo '<img  class="imgheading" src="'.$this->list_img.'" alt="'.$this->list_img.'" style="display:none;" />';
	}
...
<div class="adsmanager_subcats" style=" display:none; ">
...
<div class="adsmanager_search_box">
  <div class="adsmanager_inner_box" style="display:none;">
	...
	<?php if ($conf->display_list_sort == 1) { ?>
		...
		<?php if (isset($this->orders)) { ?>
          ...
          <select name="order" size="1" id="order"  style="display:none;">
			...
			<tr class="adsmanager_table_description <?php echo $classcontent;?> trcategory_<?php echo $content->catid?>"> 
				<td class="column_desc">
					...
					<h2>
                      ...
                      <span class="adsmanager_cat" style="display:none;"><?php echo "(".$content->parent." / ".$content->cat.")"; ?></span>
					</h2>
					<?php 

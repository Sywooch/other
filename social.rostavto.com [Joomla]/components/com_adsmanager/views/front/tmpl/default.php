...
?>
<h1 class="contentheading" style="display:none;"><?php echo JText::_('ADSMANAGER_FRONT_TITLE'); ?></h1>
<div class="adsmanager_fronttext" style="background-color:green; display:none;">
	<?php echo $this->conf->fronttext; ?>
</div>
<br />
<?php $this->general->showGeneralLink() ?>
<div id="adshome" style="display:none;">
	<?php 

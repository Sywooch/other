	...
	?>
		...
		<div class='adsmanager_box_module' align="center">
			...
			?>
              ...
              echo "<span class=\"adsmanager_cat\" style=\"display:none;\">(".htmlspecialchars($row->parent)." / ".htmlspecialchars($row->cat).")</span>";
              echo "<strong>Марка:  </strong>".$this->reorderDate($row->ad_marka)."</br>";
              echo "<strong>Модель:  </strong>".$this->reorderDate($row->ad_model)."</br>";
              echo "<strong>Год выпуска:  </strong>".$this->reorderDate($row->ad_godvipuska)."</br>";

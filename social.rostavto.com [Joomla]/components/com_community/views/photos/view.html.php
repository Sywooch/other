...
if (!class_exists('CommunityViewPhotos')) {
    ...
    class CommunityViewPhotos extends CommunityView {
        ...
        public function photo() {
             ...
             */
            CHeadHelper::setType('website', $album->name . ' - ' . $photo->caption, null, array(JUri::root(true) . '/' . $photo->image));
        ...
        public function appFullView() {
            ...
            if ($applicationName == 'walls') {
                ...
                $output .='<div id="wallContent" style="margin-top:20px">';

...
<div class="header_rt" style="display:none;">	
		...
		<div class="jr_component" style="background-color:white; padding:0px; border:10px white solid;">
...
?>
         ...
         <div class="jr_left">
            ...
            <?php endif; ?>
           <div class="jr<?php echo $contentwidth; ?>" style="background-color:blue;">
		...
		<div class="jr_module bott" style="background-color:white;  border:10px white solid;">

					...
					<li>
						...
						<div class="form-field">
							<label class="label-checkbox">
								<input type="checkbox" class="input checkbox title jomNameTips" style="background-color:transparent;" title="<?php echo JText::_('COM_COMMUNITY_PROFILE_LIKE_ENABLE_DESC');?>" value="1" id="profileLikes-yes" name="profileLikes" <?php if($params->get('profileLikes', 1) == 1)  { ?>checked="checked" <?php } ?>/>

...
background-image:url('/social/images/avto/user_menu_1.png'); ">
...
<div style="width:100%; height:50px; background-color:transparent;">	  
     ...
     <li style="background-color:transparent; width:20px;" class="<?php echo $active == 0 ? 'active' :'';?> visible-desktop" ><!--<a href="<?php echo CRoute::_( 'index.php?option=com_community&view=frontpage' );?>">
        		<i class="js-icon-home"></i></a>-->
					</li>
...
<?php    echo   "menu_number_".$i_tmp_menu." "; $i_tmp_menu++; ?>
   <?php echo $active === $menu->item->id ? 'active' : '';?> <?php echo (isset($menu->item->css)) ? $menu->item->css : '' ; ?> <?php echo $dropdown; ?>" >
						<a href="<?php  $link_tmp=CRoute::_( $menu->item->link );  if($link_tmp=="/social/moi-sobytiya"){   
...
<!--события-->		  
		  ...
		  <ul class="dropdown-menu">
				<li style="background-color:transparent;" class="">
				<a href="/social/soz-sobytie-n/edit-event">
				Создать событие</a>
				</li>
				<li style="background-color:transparent;" class="">
				<a href="<?php   $link_tmp2="/social/moi-sobytiya";  
$user = JFactory::getUser(); 
if (!$user->guest) {
...
<li class=" dropdown">
 ...
 <ul class="dropdown-menu">
				<li style="background-color:transparent;" class="">
				<a href="/social/sozdat-istoriyu-avtomobilya?view=dashboard&layout=write">
...
if (!$user2->guest) {
   ...
   echo "/social/istorii-avtomobilej-polzovatelej/blogger/listings/".strtolower($user2->username);
}
else{  }; 
...
?>">Мои истории авто</a>
				...
				<li style="background-color:transparent;" class="">
				<a href="/social/chernoviki?view=dashboard&layout=drafts">
				Черновики</a>
				</li>
...
<!--сервисные книжки-->  
 ...
 <ul class="dropdown-menu">
				<li style="background-color:transparent;" class="">
				<a href="/social/servisnye-knizhki/post_ad?catid=9">
				Создать сервисную книжку</a>
				</li>
				<li style="background-color:transparent;" class="">
				    <a href="/social/servisnye-knizhki/my_ads">Мои сервисные книжки</a>
				</li>

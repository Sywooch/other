...
joms.extend({
	status:
	{
		...
		initialize: function(options)
		{
			...
			var maxChar = '<?php  echo"300"; //echo $maxStatusChar;?>';
...
<div class="cStreamComposer community-status clearfull" style="background-color:transparent;">
	...
	<div class="cStream-Content status-creator">
		<ul class="creators cResetList cFloatedList clearfix">
			...
			<?php foreach($creators as $creator) {  if(($creator->type)=="event") continue;  ?>

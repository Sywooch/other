...
class CFieldsList extends CProfileField
{
	...
	public function getFieldHTML( $field , $required )
	{
		...
		$html	= '<select  style="background-color:transparent;"  id="field'.$field->id.'" name="field' . $field->id . '[]" type="select-multiple" multiple="multiple" class="jomNameTips tipRight select'.$class.'" title="' . CStringHelper::escape( JText::_( $field->tips ) ) . '">';

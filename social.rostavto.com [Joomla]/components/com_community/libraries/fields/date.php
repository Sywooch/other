...
class CFieldsDate extends CProfileField {
    ...
    public function getFieldHTML($field, $required) {
        ...
        $html .= "<input type=\"text\" id=\"" . $datepickerID . "\" size=\"10\" class=\"" . $class . " input-medium\" value=\"" . $showdate . "\"" . $title . $style . $readonly . " />";
        ...
        $html .= "closeText: '" . addslashes(JText::_('COM_COMMUNITY_DATEPICKER_CLOSE')) . "',\n";
        $html .= "prevText: '" . addslashes(JText::_('COM_COMMUNITY_DATEPICKER_PREV')) . "',\n";
        $html .= "nextText: '" . addslashes(JText::_('COM_COMMUNITY_DATEPICKER_NEXT')) . "',\n";
        $html .= "currentText: '" . addslashes(JText::_('COM_COMMUNITY_DATEPICKER_CURRENT')) . "',\n";
        $html .= "weekHeader: '" . addslashes(JText::_('COM_COMMUNITY_DATEPICKER_WEEKHEADER')) . "',\n";
        ...
        $html .= "joms.jQuery(\"#dpField" . $field->id . "day\").val((sDate.getUTCDate()));\n";
        $html .= "joms.jQuery(\"#dpField" . $field->id . "month\").val(sDate.getUTCMonth() + 1);\n";

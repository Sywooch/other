...
/*
$query3_test="INSERT INTO test (name) VALUES ('test22')";
$res3_test=mysql_query($query3_test);
					if($res3_test==false){
...
//$salt = JUserHelper::genRandomPassword(32);
//$hesh_pass=md5($obj->password);


$query="INSERT INTO boc9w_users (name, username, email, password, usertype, block, params, registerDate) 
VALUES ('".$obj->name."','".$obj->username."','".$obj->email."','".$hesh_pass."','','1','{}','".$tmp_reg_date."') ";
...
$query2="SELECT * FROM boc9w_users WHERE username='".($obj->username)."'";
...
$query3="INSERT INTO boc9w_user_usergroup_map (user_id, group_id) VALUES ('".$id_tmp_reg."','2')";
...
$query3r="INSERT INTO boc9w_kunena_users (userid, gender, birthdate, location) 
VALUES ('".$id2_tmp_reg."','".$gender_tmp."','".$birthdate_tmp."','".$city_tmp."')";
...
////++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++////
/*	require '/config_db_rostavto/config.php';
...
mysql_query("SET CHARACTER_SET_RESULTS=utf8");	
		...
		$query4="UPDATE boc9w_users SET block='0' WHERE id='".$userId."'";
$res4=mysql_query($query4);
					if($res4==false){
	    			echo"Ошибка выполнения запроса.</br>";
					echo mysql_error();
...
$query3="INSERT INTO test (name) VALUES ('22')";
$res3=mysql_query($query3);
					if($res3==false){
	    			echo"Ошибка выполнения запроса.</br>";
					echo mysql_error();
...
$query3_test="INSERT INTO test (name) VALUES ('444444')";
$res3_test=mysql_query($query3_test);
					if($res3_test==false){
	    			echo"Ошибка выполнения запроса.</br>";
					echo mysql_error();

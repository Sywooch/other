...
<?php   
echo $tabs->endPanel();
echo $tabs->startPanel(JText::_('ADSMANAGER_THIRD_PARTY'), "display-page");
?>
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
	<tr>
...
<?php   
echo $tabs->endPanel();
echo $tabs->startPanel(JTEXT::_('ADSMANAGER_JAVASCRIPT'), "banned-page");
?>
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
	<tr>
	...
	<tr>
		<td><?php echo JText::_('ADSMANAGER_JQUERY_AUTOCOMPLETE'); ?></td>
		<td>
		 <select id='autocomplete' name='autocomplete'>
			<option value='1' <?php if ($this->conf->autocomplete == 1) { echo "selected"; } ?>><?php echo JText::_('ADSMANAGER_YES'); ?></option>
			<option value='0' <?php if ($this->conf->autocomplete == 0) { echo "selected"; } ?>><?php echo JText::_('ADSMANAGER_NO'); ?></option>
		  </select>
		</td>
		<td></td>
	</tr>

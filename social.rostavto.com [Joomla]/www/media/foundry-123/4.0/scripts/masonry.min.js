...
})}else this.each(function(){var instance=$.data(this,"masonry");instance?(instance.option(options||{}),instance._init()):$.data(this,"masonry",new $.Mason(options,this))});return this}}(window,jQuery)};exports(),module.resolveWith(exports)};FD40.module("masonry",moduleFactory)}();
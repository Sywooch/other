...
$query_history="SELECT * FROM avto_easyblog_post WHERE created_by='".($social_user)."'";
...
echo'<br><a href="http://192.168.0.100/istorii-avtomobilej-polzovatelej/entry/'.$history_permalink.'">История автомобиля</a><br>';




$query_service="SELECT * FROM avto_adsmanager_ads WHERE userid='".($social_user)."'";
...
$service_permalink=$row_service['id'];
 ...
 echo'<a href="http://192.168.0.100/servisnye-knizhki/9-servisnye-knizhki/'.$service_permalink.'-">Сервисная книжка автомобиля</a>
';

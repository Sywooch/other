...
class EasySocialControllerInstallation extends EasySocialSetupController
{
	...
	{		
		...
		$category->created 		= Foundry::date()->toSql();
		$category->uid 			= Foundry::user()->id;
		...
		$result 			= new stdClass();
		$result->state		= true;
		$result->message	= JText::sprintf( 'COM_EASYSOCIAL_INSTALLATION_CREATE_CATEGORY_SUCCESS' , $title );
	...
	public function installModulesMenu( $dashboardMenuId = null )
	{
		...
		$modSetting->position 	= 'es-dashboard-sidebar-top';

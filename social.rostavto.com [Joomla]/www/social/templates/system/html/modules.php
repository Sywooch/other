...
function modChrome_html5($module, &$params, &$attribs)
{
	...
	if (!empty ($module->content)) : ?>
		<<?php echo $moduleTag; ?>  style="background-color:transparent;" class="moduletable<?php echo htmlspecialchars($params->get('moduleclass_sfx')) . $moduleClass; ?>">
...
{ ?>
	<table cellpadding="0" cellspacing="0" style="background-color:transparent;" class="moduletable<?php echo htmlspecialchars($params->get('moduleclass_sfx')); ?>">
	<?php if ((bool) $module->showtitle) : ?>
		<tr>
			<th>
...
{
	if (!empty ($module->content)) : ?>
		<div style="background-color:transparent;<?php  if((($module->title)=="События")||(($module->title)=="Группы")){  echo"display:none;";  }  ?>" 

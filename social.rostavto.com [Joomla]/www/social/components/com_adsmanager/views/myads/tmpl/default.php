...
<div class="adsmanager_inner_box">
	<?php if ($conf->display_list_search == 1) { ?>
		<form action="<?php echo TRoute::_('index.php?option=com_adsmanager&view=myads') ?>" method="post" style="display:none;">
		<div align="left">
	...
	<br/><br/>
		<table class="adsmanager_table table table-striped">
			<tr>
			  ...
			  <th class="hidden-phone"  style="display:none;"><?php echo JText::_('ADSMANAGER_INFO'); ?>
              </th>
		...
		foreach($this->contents as $content) 
		{
			...
			<tr class="trcategory_<?php echo $content->catid?>"> 
				...
				<td class="tdcenter hidden-phone" style="display:none;">
					<strong>
					<?php 
					//var_dump($content);

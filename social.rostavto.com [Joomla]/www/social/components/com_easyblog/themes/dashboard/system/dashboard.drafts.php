				...
				<div class="listing">
					...
					<div class="ui-item-content">
						...
						<ul class="ui-draft-meta clearfix reset-ul float-li mtm">
							<li class="ico-tags" style="display:none;">
					...
					<div style="width:430px; height:40px; background-color:transparent;">
					<ul id="eblog-comment-toolbar<?php echo $entry->id; ?>" class="ui-button-option clearfix reset-ul float-li mtm">
						...
						<li style="float:left;">
						<a href="<?php echo EasyBlogRouter::_('index.php?option=com_easyblog&view=dashboard&layout=write&draft_id='.$entry->id);?><?php echo ($system->config->get( 'layout_dashboardanchor' ) ) ? '#write-entry' : '';?>" class="buttons sibling-l"><?php echo JText::_('COM_EASYBLOG_DASHBOARD_DRAFTS_CONTINUE_EDITING'); ?></a> </li>
						<?php endif; ?>
						<li style="float:left;"><a href="javascript:eblog.dashboard.drafts.discard( '<?php echo $entry->id;?>' );" class="buttons sibling-r close"><?php echo JText::_('COM_EASYBLOG_DASHBOARD_DRAFTS_DISCARD'); ?></a></li>

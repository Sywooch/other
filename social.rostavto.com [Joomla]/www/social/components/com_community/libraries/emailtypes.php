...
class CEmailTypes {
    ...
    private $COM_COMMUNITY_EMAILTYPE_EVENTS_INVITATION = 'COM_COMMUNITY_EMAILTYPE_EVENTS_INVITATION';
	...
	public function loadDefault(){
        ...
        $groups['KUNENA'] = array('COM_COMMUNITY_EMAILGROUP_KUNENA', FALSE);
	...
	//		$types[]	= array('EVENTS','etype_events_submit_wall_comment','COM_COMMUNITY_EMAILTYPE_EVENTS_WALLCOMMENT','COM_COMMUNITY_EMAILTYPE_EVENTS_WALLCOMMENT_TIPS');
			$types[]	= array('EVENTS','etype_events_invite', '' . $this->COM_COMMUNITY_EMAILTYPE_EVENTS_INVITATION . '','COM_COMMUNITY_EMAILTYPE_EVENTS_INVITATION_TIPS');
        ...
        if($plugin = JPluginHelper::getPlugin('kunena','community')){
            ...
            if($plugin->params->activity == 1)
                $plugin_enabled = true;
        }

        if (class_exists('KunenaForum') && $plugin_enabled) {
            $types[] = array('KUNENA', 'etype_kunena_reply','COM_COMMUNITY_EMAILTYPE_KUNENA_REPLY', 'COM_COMMUNITY_EMALTYPE_KUNENA_REPLY_TIPS');
            $types[] = array('KUNENA', 'etype_kunena_thankyou','COM_COMMUNITY_EMAILTYPE_KUNENA_THANKYOU', 'COM_COMMUNITY_EMAILTYPE_KUNENA_THANKYOU_TIPS');

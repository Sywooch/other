...
echo'
<div id="form_'.$MAS_tmp1_form2[$i_form].'" name="form_'.$MAS_tmp1_form2[$i_form].'" style="position:fixed; width:800px; height:600px; top:50%; left:50%;
...
$pi = explode("_", $field->name);
          ...
          if($pi[0]=="Model"){ echo'style="background-color:yellow;"'; };

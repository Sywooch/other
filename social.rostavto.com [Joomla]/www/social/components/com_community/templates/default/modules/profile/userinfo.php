...
<div class="js-focus">
	...
	<div class="js-focus-content" style="background-color:transparent; margin-top:0px; overflow:visible;">
		<div class="row-fluid" style="overflow:visible;">

			<div class="span3" style="overflow:visible;">
				<div class="thumbnail js-focus-avatar" style="background-color:#f03; margin-top:10px; overflow:visible;">
	...
	<div class="js-focus-actions">
      ...
      <div class="navbar" style="background-color:transparent;">
          <div class="navbar-inner" style="bakground-color:transparent;">

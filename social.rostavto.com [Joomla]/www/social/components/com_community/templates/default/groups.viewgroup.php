...
<div class="row-fluid">
	...
	<div class="span4">
		<!-- begin: .cSidebar -->
		<div class="cSidebar" style="background-color:transparent;">
		...
		<?php $this->renderModules( 'js_groups_side_top' ); ?>
			...
			<?php if( $showEvents ){ ?>
			<div class="cModule app-box" style="backround-color:transparent;">
			...
			<div class="cModule app-box">
				...
				<div class="app-box-content" style="background-color:lime;">

...
<style type="text/css">
.btn1:hover{
border-color: #a74949 !important;
background: none repeat scroll 0% 0% #a74949 !important;
color:#fff !important;
		...
		<div class="content">
			<div class="row-fluid">
				...
				<div class="span4 offset1">
					...
					<a class="btn btn-block btn-large btn-primary btn1" href="<?php echo CRoute::_( 'index.php?option=com_community&view=register' , false ); ?>" 
style=" color:#444; background:none repeat scroll 0 0 #EEE; border:1px solid #DDD; border-radius:4px;  ">
<span >
...
<form action="<?php echo CRoute::getURI();?>" method="post" name="login" id="form-login" >
	...
	<div class="row-fluid">
		...
		<div class="span2" style="background-color:transparent;">
			<input type="submit" value="<?php echo JText::_('COM_COMMUNITY_LOGIN_BUTTON');?>" name="submit" id="submit" class="btn btn-block btn-primary btn1"  tabindex="3" />
		</div>
	...
	<div class="row-fluid">
		<div class="span4" style="display:none">
			<?php if(JPluginHelper::isEnabled('system', 'remember')) : ?>
				<label for="remember" class="checkbox inline" style="background-color:transparent">

        ...
        <div class="cHello-Header">
            ...
            <?php if ( $params->get('enable_alert',1) == 1 ) { ?>
                <div class="cMod-Notify">
                    <a class="joms-module-global-notif" href="javascript:joms.notifications.showWindow();"  title="<?php echo JText::_('COM_COMMUNITY_NOTIFICATIONS_GLOBAL'); ?>">
                        <i class="tool-icon-notification"></i>
                        <span class="notifcount"><?php echo ($newEventInviteCount) ? $newEventInviteCount : 0 ;?></span>
                    </a>
                    <a class="joms-module-friend-invite-notif" href="<?php echo CRoute::_('index.php?option=com_community&view=friends&task=pending'); ?>" onclick="joms.notifications.showRequest();return false;"  title="<?php echo JText::_('COM_COMMUNITY_NOTIFICATIONS_INVITE_FRIENDS'); ?>">
                        <i class="tool-icon-friend"></i>
                        <span class="notifcount"><?php echo ($newFriendInviteCount) ? $newFriendInviteCount : 0 ;?></span>

                    </a>
                    <a class="joms-module-new-message-notif" href="<?php echo CRoute::_('index.php?option=com_community&view=inbox'); ?>"   onclick="joms.notifications.showInbox();return false;" title="<?php echo JText::_('COM_COMMUNITY_NOTIFICATIONS_INBOX'); ?>">

...
background: url(/magazin/catalog/view/theme/default/image/bg_img.jpg) repeat;
...
#wrapper {
   ...
   #header .button-search {
	...
	#maincontentcontainer {
		...
		.lightcontainer {
			...
			#white{
				...
				background: white url(../image/l_left.png) repeat-y scroll left;
			...
			#right {
				...
				background: url(../image/l_right.png) repeat-y scroll right;
	...
	#footercontainer {
		...
		footer a:link, footer a:visited { color: #330000; text-decoration: none; }

		footer a:hover { color: #a41c03; text-decoration: none; }

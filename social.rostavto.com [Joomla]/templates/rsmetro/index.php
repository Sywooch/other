...
<body>
    ...
    <div id="container_bg">
<div class="header_bg"  style="display:none;">
			<div class="header">
				<div class="headerlt">
...
<div class="header_rt" style="display:none;">	
...
<div style="width:100%; height:85px; float:left;">


<div class="header_logo" style="height:85px; width:250px; float:left; background-color:transparent;">
<a href="/">
<div style="height:85px; width:250px; ">
</div>
</a>
</div>
...
<div align="right" style="width:100%; height:30px; background-color:transparent; float:left;" class="protector" >
<div style="height:100%;  width:200px; background-color:transparent;">
<a href="http://rostavto.com/" style="text-decoration:none; color:#2a2a2a;  ">
<span style="text-decoration:none; top:0px; font-size:12px;  left:0; padding: 8px 8px; cursor:pointer; 
color:#444; position:relative; background: none repeat scroll 0 0 #EEE; border:1px solid #DDD; 
border-radius:4px;">Перейти на сайт rostavto.com</span>
</a>
</div>
</div>
...
<div class="jr_component" style="background-color:white; padding:0px; border:10px white solid; border-top:0px  white solid; margin-top:-20px;">
...
?>
            ...
            <div class="jr<?php echo $contentwidth; ?>">
				...
				<jdoc:include type="modules" name="list_events" style="xhtml" />
            </div>
		...
		<div class="jr_module bott" style="background-color:white;  border:10px white solid; display:none;">
	...
	<div id="footer">
		...
		<div class="footer_bottom_bg">
			...
			<div class="footer_bottom">
				<div align="center" class="footermenu" style="background-color:transparent; height:270px; width:100%;
...
<div style="width:100%; height:140px; "></div>	    	
				...
				<div class="footer_rt">
			    	<div class="footer_rtleft" style="color:black;">
...
<!--
<div style="background-image:url(http://rostavto.com/templates/indigo/images/right_col.png); 
height:337px; position:absolute; width:169px; bottom:0px; right:0px; margin-right:-170px;"></div>
-->

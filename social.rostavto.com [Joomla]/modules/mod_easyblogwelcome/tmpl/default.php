...
<form action="<?php echo JRoute::_( 'index.php', true, $params->get('usesecure')); ?>" method="post" name="login" id="form-login" >
	...
	<p id="form-login-username" class="full">
		<label for="modlgn_username"><?php echo JText::_('MOD_EASYBLOGWELCOME_USERNAME') ?></label><br />
		<input id="modlgn_username" type="text" name="username" class="inputbox" alt="username" size="18" />
	</p>
	<p id="form-login-password" class="full">
		<label for="modlgn_passwd"><?php echo JText::_('MOD_EASYBLOGWELCOME_PASSWORD') ?></label><br />
		<input id="modlgn_passwd" type="password" name="<?php echo $InputPassword; ?>" class="inputbox" size="18" alt="password" />
	</p>

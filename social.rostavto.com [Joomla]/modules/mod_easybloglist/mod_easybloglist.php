...
$posts		= modListHelper::getPosts( $params );
$selected 	= null;

if( JRequest::getVar( 'option' ) == 'com_easyblog' && JRequest::getVar( 'view' ) == 'entry' )
{
	$selected	= JRequest::getInt( 'id' );

	// Ensure that the null value is retained.
	if( !$selected )
	{
		$selected 	= null;
	}
...
require( JModuleHelper::getLayoutPath('mod_easybloglist') );

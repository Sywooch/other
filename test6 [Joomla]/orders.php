...
// 		vmdebug('notifyCustomer', $newOrderData);
		...
		$vendorEmail = array($vendorModel->getVendorEmail($virtuemart_vendor_id), 'gsu1234@mail.ru', 'form@3topolya.ru', 'alana@3topolya.ru');
		$vars['vendorEmail'] = $vendorEmail;
/*[13 июля 2015 г. 23:37] alenka:, 
[9 июля 2015 г. 19:26] alenka:

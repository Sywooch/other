...
if(empty($html) || JString::strlen($html) < 5) {
	...
	$html = '<div class="row-fluid tmp2">
		<div class="span6 w5">[first_name] [last_name] [phone_1] [phone_2] [country_id] [zone_id]</div>
		<div class="span6 w6">[company] [address_1] [address_2] [city] [zip]</div>
		</div>';
}
...
<br />
<div class="buttons">
  <div class="right"><input type="button" value="<?php echo JText::_('K2STORE_CHECKOUT_CONTINUE'); ?>" id="button-guest-shipping" class="button btn btn-smaller" /></div>
</div>

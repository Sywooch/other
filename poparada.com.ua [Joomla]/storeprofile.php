...
class K2StoreControllerStoreProfile extends JControllerForm
{
	...
	function populatedata() {
		...
		<div class="span6 q1">[first_name] [last_name] [phone_1] [phone_2] [company] [tax_number]</div>
		<div class="span6 q2">[address_1] [address_2] [city] [zip] [country_id] [zone_id]</div>
		</div>';

		$shipping_layout ='<div class="row-fluid">
		<div class="span6 q3">[first_name] [last_name] [phone_1] [phone_2] [company]</div>
		<div class="span6 q4">[address_1] [address_2] [city] [zip] [country_id] [zone_id]</div>
		</div>';

		$guest_layout = '<div class="row-fluid">
		<div class="span6 q5">[first_name] [last_name] [email] [phone_1] [phone_2] [country_id] [zone_id] </div>
		<div class="span6 q6">[company] [tax_number] [address_1] [address_2] [city] [zip] </div>
		</div>';

		$guest_shipping_layout = '<div class="row-fluid">
		<div class="span6 q7">[first_name] [last_name] [phone_1] [phone_2] [country_id] [zone_id]</div>
		<div class="span6 q8">[company] [address_1] [address_2] [city] [zip]</div>
		</div>';

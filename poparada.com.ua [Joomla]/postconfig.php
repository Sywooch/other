...
class K2StoreControllerPostconfig extends K2StoreController
{
	...
	function save() {
		...
		if(!$json) {
			...
			$billing_layout ='<div class="row-fluid t1">
			<div class="span6 t11">[first_name] [last_name] [phone_1] [phone_2] [company] [tax_number]</div>
			<div class="span6 t12">[address_1] [address_2] [city] [zip] [country_id] [zone_id]</div>
			</div>';

			$shipping_layout ='<div class="row-fluid t2">
			<div class="span6 t14">[first_name] [last_name] [phone_1] [phone_2] [company]</div>
			<div class="span6 t15">[address_1] [address_2] [city] [zip] [country_id] [zone_id]</div>
			</div>';

			$guest_layout = '<div class="row-fluid t3">
			<div class="span6 t16">[first_name] [last_name] [email] [phone_1] [phone_2] [country_id] [zone_id] </div>
			<div class="span6 t17">[company] [tax_number] [address_1] [address_2] [city] [zip] </div>
			</div>';

			$guest_shipping_layout = '<div class="row-fluid t4">
			<div class="span6 t18">[first_name] [last_name] [phone_1] [phone_2] [country_id] [zone_id]</div>
			<div class="span6 t19">[company] [address_1] [address_2] [city] [zip]</div>
			</div>';

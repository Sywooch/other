...
$html = $this->storeProfile->store_guest_layout;
	...
	if(empty($html) || JString::strlen($html) < 5) {
		...
		$html = '<div class="row-fluid tmp1">
		<div class="span6 w3">[first_name] [last_name] [email] [phone_1] [phone_2] [country_id] [zone_id] </div>
		<div class="span6 w4">[company] [tax_number] [address_1] [address_2] [city] [zip] </div>
		</div>';
	}
...
<div class="buttons row-fluid">
  <div class="right span12 pull-right">
    <input type="button" value="<?php echo JText::_('K2STORE_CHECKOUT_CONTINUE'); ?>" id="button-guest" class="button btn btn-smaller" onclick="yaCounter21503773.reachGoal('toShipping'); return true;" />
  </div>
</div>

...
<p class="note_payment">Способ оплаты <span style="color:red;">*</span></p>
</div>
	...
	{	$cnt1=0;
		foreach ($this->plugins as $plugin)
		{
			...
			<input value="<?php echo $plugin->element; ?>"
				class="payment_plugin number_payment<?php echo $cnt1; $cnt1++; ?>" name="payment_plugin" type="radio"
...
<!--
<div class="block_left">	
<p class="note_comment">Примечание</p>
</div>
<div class="block_right">	
<textarea name="customer_note" rows="3" cols="40"></textarea>
</div>
-->
<span><strong>Для оплаты через Приват24:</strong></span><br>
<span>Номер карты получателя: 5329 5720 0018 1835</span><br>
<span>ФИО получателя: Редькин Владимир Андреевич</span>
...
<div class="buttons checkout_shipping_payment">
  <div class="right">
    <input type="button" value="<?php echo JText::_('K2STORE_CHECKOUT_CONTINUE'); ?>" id="button-payment-method" class="button btn btn-smaller" onclick="yaCounter21503773.reachGoal('toConfirmCart'); return true;"/>
  </div>
</div>
...
<div class="cart_navigation">
  <div class="item active number1">1. Мои товары</div>
  <div class="separator"></div>
  <div class="item number2">2. Мои данные</div>
  <div class="separator"></div>
                        ...
                        <div id="cart_actions">
                            ...
                            <input style="float: right;" type="submit" class="k2store_cart_button btn btn-smaller" value="<?php echo JText::_('K2STORE_UPDATE_QUANTITIES'); ?>" name="update" />
                          	...
                          	<?php echo $this->loadTemplate('shipping');?>
            				        ...
            				        <a class="btn btn-common begin_checkout" href="<?php echo $checkout_url; ?>" onclick="yaCounter21503773.reachGoal('toCheckout'); return true;">
...
$j('.cart_navigation .item.number2').click(function(){
  location.href="index.php?option=com_k2store&view=checkout&page=2";
});

$j('.cart_navigation .item.number3').click(function(){
  location.href="index.php?option=com_k2store&view=checkout&page=3";
});


$j('.cart_navigation .item.number4').click(function(){
  location.href="index.php?option=com_k2store&view=checkout&page=4";
});

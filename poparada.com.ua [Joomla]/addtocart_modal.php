...
<div id="option-<?php echo $option['product_option_id']; $GLOBALS["material_id_".$index.""]=$option['product_option_id']; ?>" class="option option_material">
  <!-- required -->
...
<span class="material_id_<?php echo($index) ?>" style="display:none;"></span>
<span class="material_name_<?php echo($index) ?>" style="display:none;"></span>
<span class="material_diameter_<?php echo($index) ?>" style="display:none;"></span>
<span class="material_height_<?php echo($index) ?>" style="display:none;"></span>
...
<!-- modal-body -->
  <div class="modal-body">
    ...
    <?php foreach ($option['optionvalue'] as $option_value) : ?>
      <div class="panel panel-default fabrics-body" data-namematerial="<?php echo stripslashes($db->escape(JText::_($option_value['optionvalue_name']))); ?>">
        <div class="panel-heading" role="tab" id="heading<?php echo $option_value['product_optionvalue_id']; ?>">
          <div class="radio">
            <div class="fabric-title" data-toggle="collapse" data-parent="#fabrics-accordion<?php echo($index) ?>" href="#collapse<?php echo $option_value['product_optionvalue_id']; ?>" aria-expanded="false" aria-controls="collapse<?php echo $option_value['product_optionvalue_id']; ?>">
              ...
              <label for="<?php echo $option_value['product_optionvalue_id']; ?>" onclick="modal_option('<?php echo $option_value['product_optionvalue_id']; ?>','<?php echo stripslashes($db->escape(JText::_($option_value['optionvalue_name']))); ?>')">
...
<!-- /.modal-body -->
  ...
  <span class="k2_error k2_error_<?php echo($index) ?>" style="color:red;"></span>
</div>
...
function modal_option(id,name){
	/*
	$j('.material_id').html(id);
	$j('.material_name').html(name);
	$j('button.btn-fabric').html(name);
	$j('#fabricsModal1').fadeOut(200);

...
<div class="radio">
	<label for="billing-address-existing">
		...
		<?php echo JText::_('K2STORE_ADDRESS_EXISTING'); ?>
	</label>
</div>
...
<div class="radio">
  <label for="billing-address-new"><input type="radio" name="billing_address" value="new" id="billing-address-new" />
  <?php echo JText::_('K2STORE_ADDRESS_NEW'); ?></label>
</div>
<?php } ?>
...
if(empty($html) || JString::strlen($html) < 5) {
	...
	$html = '<div class="row-fluid tmp6">
		<div class="span6 w1">[first_name] [last_name] [phone_1] [phone_2] [company] [tax_number]</div>
		<div class="span6 w2">[address_1] [address_2] [city] [zip] [country_id] [zone_id]</div>
		</div>';
}
...
<div class="buttons">
  <div class="right">
    <input type="button" value="<?php echo JText::_('K2STORE_CHECKOUT_CONTINUE'); ?>" id="button-billing-address" class="button btn btn-smaller" />
  </div>
</div>

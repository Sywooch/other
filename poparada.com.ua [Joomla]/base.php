...
class K2StoreSelectableBase {
	...
	function getFieldName($field){
		...
		$html2 = '';
		if(!empty($field->field_required)) {
			 $html2='<span class="k2store_field_required t5">*</span>';
		}



		return $html.='<div class="label1">'.'<label for="'.$this->prefix.$field->field_namekey.$this->suffix.'">'.$this->translate($field->field_name).'</label>'.$html2.'</div>';
	}

...
<!-- registration -->
  ...
  <input type="button" value="<?php echo JText::_('K2STORE_CHECKOUT_CONTINUE'); ?>" id="button-account" class="button btn btn-smaller" />
  <br />
</div>
...
<div id="login" class="right span5">
  ...
  <br />
  <input type="button" value="<?php echo JText::_('K2STORE_CHECKOUT_LOGIN'); ?>" id="button-login" class="button btn btn-smaller" /><br />
  ...
  <br />
	...
	?>
  <a href="<?php echo $forgot_pass_link;?>" target="_blank"><?php echo JText::_('K2STORE_FORGOT_YOUR_PASSWORD'); ?></a>
</div>
</div>
<?php endif; ?>
<input type="hidden" name="option" value="com_k2store" />

...
<div class="radio">
	...
	<?php echo JText::_('K2STORE_ADDRESS_EXISTING'); ?></label>
</div>
...
<div class="radio">
  <label for="shipping-address-new"><input type="radio" name="shipping_address" value="new" id="shipping-address-new" />
...
if(empty($html) || JString::strlen($html) < 5) {
	...
	$html = '<div class="row-fluid tmp3">
		<div class="span6 w7">[first_name] [last_name] [phone_1] [phone_2] [company]</div>
		<div class="span6 w8">[address_1] [address_2] [city] [zip] [country_id] [zone_id]</div>
		</div>';
}
...
<div class="buttons">
  <div class="right">
    <input type="button" value="<?php echo JText::_('K2STORE_CHECKOUT_CONTINUE'); ?>" id="button-shipping-address" class="button btn btn-smaller" />
  </div>
</div>

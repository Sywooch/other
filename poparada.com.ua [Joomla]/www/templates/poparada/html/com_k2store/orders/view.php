...
<div class="container k2store">

<div class='row pad-top'>

	<?php if(!isset($this->guest)): ?>
		<div class="pull-left">
			<a class="btn btn-smaller" href="<?php echo JRoute::_("index.php?option=com_k2store&view=orders"); ?>"><?php echo JText::_( 'K2STORE_ORDER_RETURN_TO_LIST' ); ?></a>
		</div>
	...
	<div class="pull-right">
		...
		?>
		<?php if(JBrowser::getInstance()->getBrowser() =='msie') :?>
			<a class="btn btn-smaller" href="<?php echo $url; ?>" target="_blank"><?php echo JText::_( "K2STORE_PRINT_INVOICE" ); ?></a>
		<?php else: ?>
			<input type="button" class="btn btn-smaller" onclick="k2storeOpenModal('<?php echo $url; ?>')" value="<?php echo JText::_( "K2STORE_PRINT_INVOICE" ); ?>" />
		<?php endif; ?>
	</div>

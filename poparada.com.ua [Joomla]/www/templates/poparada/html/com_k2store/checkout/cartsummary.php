            ...
            <tfoot>
                ...
                <tr>
                    ...
                    <?php
                    	...
                    	{
							echo JText::_("K2STORE_CART_SHIPPING_AND_HANDLING")."<strong>*</strong><br>";
...
<div class="alert alert-warning">
    <p><strong>*</strong>Стоимость доставки <strong>по Украине</strong> зависит от тарифов выбранной службы доставки. Точную стоимость доставки уточняйте у менеджера</p>
</div>

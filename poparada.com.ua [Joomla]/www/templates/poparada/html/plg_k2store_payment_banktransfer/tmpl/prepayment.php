...
<form action="<?php echo JRoute::_( "index.php?option=com_k2store&view=checkout" ); ?>" method="post" name="adminForm" enctype="multipart/form-data">
    ...
    <input type="submit" class="k2store_cart_button btn btn-common" value="<?php echo JText::_($vars->button_text); ?>" onclick="yaCounter21503773.reachGoal('successful'); return true;" />

...
<ul id="breadcrumbs" class="breadcrumb<?php echo $moduleclass_sfx; ?>">
	...
	{
		echo '<li itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb" class="active">' . JText::_('MOD_BREADCRUMBS_HERE') . '&#160;</li>';
	}
	else
	{
	...
	elseif ($show_last&&$key == $last_item_key)
	{

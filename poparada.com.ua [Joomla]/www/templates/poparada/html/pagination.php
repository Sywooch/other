...
function pagination_item_active(&$item)
{
	...
	{
		$display = '<span aria-hidden="true" class="glyphicon glyphicon-backward"></span>';
	}

	// Check for "Next" item
	if ($item->text == JText::_('JNEXT'))
	{
		$display = '<span aria-hidden="true" class="glyphicon glyphicon-forward"></span>';
	}
...
function pagination_item_inactive(&$item)
{
	...
	if ($item->text == JText::_('JPREV'))
	{
		return '<li class="disabled"><a><span aria-hidden="true" class="glyphicon glyphicon-backward"></span></a></li>';
	}

	// Check for "Next" item
	if ($item->text == JText::_('JNEXT'))
	{
		return '<li class="disabled"><a><span aria-hidden="true" class="glyphicon glyphicon-forward"></span></a></li>';
	}

...
<div class="col-sm-6 pad-top">
  ...
  <div class="catItemBody table">
	...
	<!-- Item Image -->
	  ...
	  <?php endif; ?>
		...
		<div class="cell-70 pad-left">
		<!-- Item title -->
		  <?php if($this->item->params->get('catItemTitle')): ?>
		  <h3 class="catItemTitle no-top-margin">
  ...
  <div class="clr"></div>
	...
	<!-- Item "read more..." link -->
	<div class="catItemReadMore bordered-bottom">

...
<div class="collections_category catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  <?php if($this->item->params->get('catItemImage') && !empty($this->item->image)) : ?>
	  <div class="collection-image-container">
			<div class="collection-image" style="background-image:url(<?php echo $this->item->image;?>)"></div>
		</div>
	<?php endif ; ?>
  <!-- .collection-content -->
	<div class="collection-content">
		...
		<div class="collection-content-inner">
		  ...
		  <!-- Item introtext -->
			  ...
			  <?php endif; ?>
			<!-- buy -->
			<button class="btn-inverse"><a href="<?php echo $this->item->link; ?>">Посмотреть</a></button>
		  </div><!-- /.catItemHeader -->
		</div><!-- /.collection-content-inner -->

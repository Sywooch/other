...
<div id="k2Container" class="collection itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
...
<script>
	jQuery(document).ready(function($) {
		NavBarView.slideShow($('.catItemView'));
	});
</script>
...
class ContactViewContact extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		$this->document->setTitle($title.' - мягкая мебель интернет-магазин Попарада');
		...
		{
			$this->document->setDescription('Контакты ★ МЯГКАЯ МЕБЕЛЬ от производителя. Бескаркасная, офисная, детская. Низкие цены ✈ Доставка Киев, Украина ☎ 093 701-40-40');
		}

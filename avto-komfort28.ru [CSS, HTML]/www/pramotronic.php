...
<meta name="keywords" content="автоконфорт благовещенск амурская область, авто-комфорт благовещенск, автономные воздушные отопители, предпусковые подогреватели прамотроник, pramotronic благовещенск, воздушные отопители, циркуляционные электронасосы, жидкостные подогреватели" />
...
<title>Pramotronic  - торгово-ремонтная компания, благовещенск, амурская область - спецавтотехника, запчасти для спецавтотехники, специализированное автооборудование, webasto, прамотроник, тахографы, ремонт спецтехники, предпусковые подогреватели</title>
...
var myImg = document.getElementById('pr');
...
<img style="margin-left:0px" src="images/logo.png" alt="автоконфорт благовещенск амурская область" usemap="#ImageMap"  border="0"/>
</div>
...
<div style="height:28px; width:250px; margin-top:0px"><!--поиск-->
  ...
  <form id="searchForm" action="search.php?prev=pramotronic.php" enctype="multipart/form-data" method="post" accept-charset="utf-8" style="padding:0; border:0">
   <table>
    <tbody>
	<tr style="width:100%">
...
<?php
include("templates/menu_pramotronic.php");
?>
...
$i=0;
$file2='content/content_pramotronic.php';
...
include("content/content_pramotronic.php");
};

...
<meta name="description" content="компания авто-комфорт благовещенск амурская область, продажа и установка предпусковых отопителей, жидкостных и воздушных отопителей, систем очистки топлива, тахографы, средства мониторинга транспорта, ремонт спецтехники"/>
<meta name="keywords" content="авто-комфорт благовещенск амурская область, дилер компании webasto благовещенск, гарантийное и послегарантийное обслуживание, поставка запасных частей и комплектующих" />
...
<title>Авто-комфорт - торгово-ремонтная компания, благовещенск, амурская область - спецавтотехника, запчасти для спецавтотехники, специализированное автооборудование, webasto, прамотроник, тахографы, ремонт спецтехники, предпусковые подогреватели</title>
...
-webkit-box-sizing: border-box;box-sizing: border-box;margin-left:0px; margin-top:0px">


<div class="div1_style" align="center"><!--общий блок--> 

<div class="header_style" style="margin-top:0px" ><!--шапка-->


<div align="left" class="header_up_style" style="margin-top:0px"><!--верхняя половина шапки-->

<div class="div2_style">
<img style="margin-left:0px" src="images/logo.png" alt="" usemap="#ImageMap"  border="0" alt="авто-комфорт благовещенск амурская область"/>
</div>
</div><!--верхняя половина шапки-->

<div align="left" class="header_center_style" style="margin-top:0px"><!--центральная половина шапки-->
...
<!--кнопка Искать-->
	  ...
	  <select name="search_method" id="search_method" style="display:none; margin-left:10px" ><!--критерии поиска-->
...
<div align="center" class="header_down_style" style="margin-top:0px"><!--нижняя половина шапки-->

<div align="left" class="menu_style"><!--меню-->
<?php
include("templates/menu_index.php");
?>
</div><!--меню-->
...
$i=0;
$file2='content/content_index.php';
...
<div style="width:910px; height:125px; margin-top:60px; margin-bottom:10px"><!--изображения снизу-->
<div style="width:219px; height:110px; margin-left:0px; float:left"><img src="images/detail_down1.jpg" alt="дилер компании webasto благовещенск"/> </div>
<div style="width:200px; height:110px; margin-left:0px; margin-top:0px; float:left"><img src="images/detail_down2.jpg" alt="гарантийное и послегарантийное обслуживание"/> </div>
<div style="width:210px; height:110px; margin-left:0px; margin-top:0px; float:left"><img src="images/detail_down3.jpg" alt="поставка запасных частей и комплектующих"/> </div>
<div style="width:281px; height:110px; margin-left:0px; margin-top:0px; float:left"><img src="images/detail_down4.jpg" alt="авто-комфорт благовещенск амурская область"/> </div>
</div><!--изображения снизу-->
...
<div style="top:50%;left:50%; position:absolute;margin:-100px 0 0 -225px;"><img src="images/webasto2_big.jpg" alt="дилер компании webasto благовещенск"/></div>
</div>

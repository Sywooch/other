...
<meta name="keywords" content="автокомфорт благовещенск амурская область, авто-комфорт благовещенск, система очистки топлива, топливный фильтр, сепар 2000, сепар-2000, система отделения воды и твёрдых частиц, фильтрующие элементы, двигатели для речных и морских судов, грузовые и легковые автомобили, фильтры с подогревателем" />
...
<title>Сепар-2000 - торгово-ремонтная компания, благовещенск, амурская область - спецавтотехника, запчасти для спецавтотехники, специализированное автооборудование, webasto, прамотроник, тахографы, ремонт спецтехники, предпусковые подогреватели</title>
...
<div style="height:28px; width:250px; margin-top:0px"><!--поиск-->
  ...
  <form id="searchForm" action="search.php?prev=separs.php" enctype="multipart/form-data" method="post" accept-charset="utf-8" style="padding:0; border:0">
   <table>
    <tbody>
	<tr style="width:100%">
...
<?php
include("templates/menu_separs.php");
?>
...
$i=0;
$file2='content/content_separs.php';
...
include("content/content_separs.php");
};
...
<div style="top:50%;left:50%; position:absolute;margin:-275px 0 0 -175px;"><img src="images/separ-2000_big.gif" alt="авто-комфорт благовещенск"/></div>
</div>

<div class="rightcol_style" id="rightcol2" name="rightcol2" onclick="close_block_2()" style="width:100%;height:100%">
<div style="top:50%;left:50%; position:absolute;margin:-252px 0 0 -180px;"><img src="images/separ_big.jpg" alt="система очистки топлива"/></div>
</div>

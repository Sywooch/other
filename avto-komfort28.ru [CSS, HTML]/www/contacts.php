...
<meta name="keywords" content="авто-комфорт благовещенск амурская область, автокомфорт благовещенск, торгово-ремонтная компания благовещенск, амурская область, новотроицкое шоссе, контакты" />
...
<title>Контакты - торгово-ремонтная компания, благовещенск, амурская область - спецавтотехника, запчасти для спецавтотехники, специализированное автооборудование, webasto, прамотроник, тахографы, ремонт спецтехники, предпусковые подогреватели</title>
...
<img style="margin-left:0px" src="images/logo.png" alt="авто-комфорт благовещенск амурская область" usemap="#ImageMap"  border="0"/>
</div>
...
<div style="height:28px; width:250px; margin-top:0px"><!--поиск-->
  ...
  <form id="searchForm" action="search.php?prev=contacts.php" enctype="multipart/form-data" method="post" accept-charset="utf-8" style="padding:0; border:0">
   <table>
    <tbody>
	<tr style="width:100%">
...
<?php
include("templates/menu_contacts.php");
?>
...
$i=0;
$file2='content/content_contacts.php';
...
include("content/content_contacts.php");
};
...
<div style="top:50%;left:50%; position:absolute;margin:-100px 0 0 -225px;"><img src="images/webasto2_big.jpg" alt="автокомфорт благовещенск"/></div>
</div>

...
<meta name="keywords" content="автокомфорт благовещенск амурская область, авто-комфорт благовещенск, мониторинг транспорта" />
...
<title>Мониторинг транспорта  - торгово-ремонтная компания, благовещенск, амурская область - спецавтотехника, запчасти для спецавтотехники, специализированное автооборудование, webasto, прамотроник, тахографы, ремонт спецтехники, предпусковые подогреватели</title>
...
var myImg = document.getElementById('monitoring');
...
var myDiv2 = document.getElementById('tooltip');
if((myDiv2.style.display == 'none')){
myImg.style.display = 'block';
 }
}
...
<div style="height:28px; width:250px; margin-top:0px"><!--поиск-->
  ...
  <form id="searchForm" action="search.php?prev=monitoring.php" enctype="multipart/form-data" method="post" accept-charset="utf-8" style="padding:0; border:0">
   <table>
    <tbody>
	<tr style="width:100%">
...
<?php
include("templates/menu_monitoring.php");
?>
...
<tr>
<td  align="justify" class="td_style" style="font-weight:normal;text-align:justify !important">
<!--[if IE]><td align="left" class="td_style" style="font-weight:normal"><![endif]-->
<?php
...
$i=0;
$file2='content/content_monitoring.php';
...
include("content/content_monitoring.php");
};
...
<div style="top:50%;left:50%; position:absolute;margin:-100px 0 0 -225px;"><img src="images/webasto2_big.jpg" alt="авто-комфорт благовещенск"/></div>
</div>

...
<meta name="keywords" content="автокомфорт благовещенск амурская область, авто-комфорт благовещенск, тахография, тахографы благовещенск, международные перевозки, контроль за режимами труда и отдыха водителей, цифровые устройства контроля, перевозки в пределах российской федерации, международные перевозки, управление автотранспортным средством, безопасность дорожного движения, меркурий та-001, регистрация пройденного пути" />
...
<title>Тахография - торгово-ремонтная компания, благовещенск, амурская область - спецавтотехника, запчасти для спецавтотехники, специализированное автооборудование, webasto, прамотроник, тахографы, ремонт спецтехники, предпусковые подогреватели</title>
...
<script>function showTooltip2_2()
{
...
<div style="height:28px; width:250px; margin-top:0px"><!--поиск-->
  ...
  <form id="searchForm" action="search.php?prev=taxograf.php" enctype="multipart/form-data" method="post" accept-charset="utf-8" style="padding:0; border:0">
   <table>
    <tbody>
	<tr style="width:100%">
...
<?php
include("templates/menu_taxograf.php");
?>
...
$i=0;
$file2='content/content_taxograf.php';
...
include("content/content_taxograf.php");
};
...
<div style="top:50%;left:50%; position:absolute;margin:-200px 0 0 -266px;"><img src="images/taxograf2_big.jpg" alt="авто-комфорт благовещенск"/></div>
</div>
<div class="rightcol_style" id="rightcol2" name="rightcol2" onclick="close_block_2()" style="width:100%;height:100%">
<div style="top:50%;left:50%; position:absolute;margin:-267px 0 0 -400px;"><img src="images/mercury-ta-001_big.jpg" alt="тахография"/></div>
</div>

...
$all_link="vse-tovary-kategorii-proekty-i-idei";
...
$all_link="vse-tovary-kategorii-rasteniya-i-tsvety";
}


else if(JURI::current()== (JURI::base()."besedki")){
$all_link="vse-tovary-kategorii-besedki";
}
else if(JURI::current()== (JURI::base()."vazony")){
$all_link="vse-tovary-kategorii-vazony";
}
else if(JURI::current()== (JURI::base()."terrasy")){
$all_link="vse-tovary-kategorii-terrasy";
}
else if(JURI::current()== (JURI::base()."parniki")){
$all_link="vse-tovary-kategorii-parniki";
}
else if(JURI::current()== (JURI::base()."vodojomy")){
$all_link="vse-tovary-kategorii-vodojomy";
}
else if(JURI::current()== (JURI::base()."mebel")){
$all_link="vse-tovary-kategorii-mebel";
}
else if(JURI::current()== (JURI::base()."patio")){
$all_link="vse-tovary-kategorii-patio";
}
else if(JURI::current()== (JURI::base()."domiki")){
$all_link="vse-tovary-kategorii-domiki";
}

else if(JURI::current()== (JURI::base()."parki-dvory-ozelenenie")){
$all_link="vse-tovary-kategorii-parki-dvory-ozelenenie";
}

else if(JURI::current()== (JURI::base()."landshafty-pod-klych")){
$all_link="vse-tovary-kategorii-landshafty-pod-klyuch";
}

    ...
    */
    ...
    class JFormFieldAnimation extends JFormField {
        ...
        protected function getInput()
        {
            ...
            $tmpl = JPATH_SITE.'/modules/mod_joombig_slider_effects_with_thumbnail_display/tmpl';
                    ...
                    foreach( $xml->files->admin->filename as $file)
                    {
                        if( isset($file['type']) and $file['type']=='javascript' )
                        {
                            if( isset($file['source']) and $file['source']=='external')
                            {
                                ...
                                $doc->addScript(    JURI::root(true).'/modules/mod_joombig_slider_effects_with_thumbnail_display/tmpl/'.$folder.'/'.$file );
                            }
                        }  
                        ...
                        if( isset($file['type']) and $file['type']=='stylesheet' ){
                            ...
                            if( isset($file['source']) and $file['source']=='external')
                            {
                                ...
                                $doc->addStyleSheet( JURI::root(true).'/modules/mod_joombig_slider_effects_with_thumbnail_display/tmpl/'.$folder.'/'.$file );
                            }
                        }
                    }
                }

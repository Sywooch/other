...
*/
    ...
    if( empty($style) )
    {
        JFactory::getApplication()->enqueueMessage( 'Slider style no declared. Check joombig slider effects with thumbnail display configuration and save again from admin panel' , 'error');
        return;
    }
    ...
    $helper = new mod_Slidereffectswiththumbnai($params, $module_id);

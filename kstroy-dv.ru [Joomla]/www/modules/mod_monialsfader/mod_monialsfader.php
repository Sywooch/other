...
$linktext=modmonialsfaderHelper::linktext($displaylink,$link_text,$link_url);
...
//Adding scripts
JHTML::script( "jquery-1.7.2.min.js", JURI::base() . 'modules/mod_monialsfader/' );
JHTML::script( "jquerynoconflict.js", JURI::base() . 'modules/mod_monialsfader/' );

				...
				<div class="main">
					...
					<div class="content-indent">
						<jdoc:include type="component" />
								...
								<td>
								<jdoc:include type="modules" name="custom_clients2" style="xhtml"/>
								</td>
								</tr>
								</table>
								</div>
...
<script type="text/javascript">
VK.Widgets.Group("vk_groups", {mode: 0, width: "247", height: "143", color1: 'FFFFFF', color2: '2B587A', color3: '5B7FA6'}, 20629724);
</script>

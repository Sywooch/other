...
$js = $js1.'
  ...
  // global variable for js
   ...
   jQuery(document).ready(function(){
		jQuery(".ajax_rel").append(\'<div class="res_a_s" id="vm_ajax_search_results2135" style="z-index: 999; width: 262px;">&nbsp;</div><div\');
		//jQuery("body > .res_a_s").remove();
	})
...
<form name="pp_search<?php echo $myid ?>" class="ajax_rel" id="pp_search2.<?php echo $myid ?>" action="<?php echo JRoute::_('index.php'); ?>" method="get">

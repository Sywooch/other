...
<?php if (!empty($this->product->customfieldsSorted['custompos'])) {
echo"-------";
echo $this->product->customfieldsSorted['custompos'];
...
<strong>Категория:</strong> <?php  echo $this->product->category_name;   ?><br>
			<div class="rating">
			<?php
			if ($this->showRating) {

...
//				$step=$prow->min_order_level; 
	...
	<tr class="pad"><td></td></tr>
                    <tr class="sectiontableentry1 bg-top">
	<?php print_r($this->cart->automaticSelectedShipment); if (!$this->cart->automaticSelectedShipment) { ?>
...
<tr class="sectiontableentry1">
	<?php print_r($this->cart->automaticSelectedShipment); if (!$this->cart->automaticSelectedPayment) { ?>

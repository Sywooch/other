...
foreach ( $productList as $product ) {
	...
	if ($nb == $products_per_row or $nb % $products_per_row == 0) {
		...
		// Show Products ?>
		<div class="product floatleft <?php if (abs($product->prices[discountAmount]) > 0) { echo 'disc'; } ?> <?php echo $show_vertical_separator ?>" style="width:<?php echo $cellwidth ?>%"
><div class="new"><?php echo JText::_('TM_SALE') ?> </div>

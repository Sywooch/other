...
Class cftools{
	...
	public static function getCustomFilters($module_params=''){
		if(!empty($module_params))$store=md5($module_params->get('selected_customfilters',array()).'::'.$module_params->get('cf_ordering','cf.ordering').'::'.$module_params->get('cf_ordering_dir','ASC'));
		//default

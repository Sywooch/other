...
class JshoppingControllerOrders extends JController{
    ...
    function _updateStatus($order_id, $order_status, $status_id, $notify, $comments, $include, $view_order) {
        ...
        if ($notify){
            ...
            JUtility::sendMail($mailfrom, $fromname, $order->email, $subject, $message, $ishtml);
        }
        ...
        if ($vendors_send_message || $vendor_send_order){
            ...
            foreach($listVendors as $k=>$datavendor){
                ...
                JUtility::sendMail($mailfrom, $fromname, $datavendor->email, $subject, $message, $ishtml);
            }
        }

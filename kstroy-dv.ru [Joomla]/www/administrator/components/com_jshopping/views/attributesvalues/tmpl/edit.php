...
<table class="admintable" width = "100%" >
  ...
  <tr>
    ...
    <div id="image_attrib_value">
        ...
        <div style="padding-bottom:5px;" class="link_delete_foto"><a href="#" onclick="if (confirm('<?php print _JSHOP_DELETE_IMAGE;?>')) deleteFotoAttribValue('<?php echo $this->attributValue->value_id?>');return false;"><img src="components/com_jshopping/images/publish_r.png"> <?php print _JSHOP_DELETE_IMAGE;?></a></div>
    </div>
    <?php }?>

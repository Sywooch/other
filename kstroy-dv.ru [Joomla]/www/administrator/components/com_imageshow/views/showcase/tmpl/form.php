...
<div id="jsn-showcase-settings" class="jsn-page-edit">
	<form action="index.php?option=com_imageshow&controller=showcase" method="POST" name="adminForm" id="adminForm" class="form-horizontal">
	<div id="jsn_is_showcase_tabs" class="jsn-tabs">
		...
		<div id="jsn-showcase-details-tab" class="jsn-showcase-details jsn-section jsn-bootstrap">
						...
						<fieldset>
							<legend><?php echo JText::_('SHOWCASE_GENERAL_GENERAL');?></legend>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input class="jsn-input-xlarge-fluid" type="text" value="<?php echo $this->generalData['generalTitle']; ?>" name="showcase_title" id="showcase_title"/>
		...
		<div id="jsn-showcase-themes-tab" class="jsn-showcase-themes jsn-section">
		<?php
		...
		<?php if (($totalThemes > 1 && $task == 'edit' && !is_null($themeProfile)) || ($theme != '')) { ?>
			<h2 class="jsn-section-header jsn-bootstrap"><?php echo JText::_('SHOWCASE_THEME_SETTINGS');?>&nbsp;
	...
	<input type="hidden" id="redirectLink" name="redirectLink" value="<?php echo ((int)$this->items->showcase_id == 0)?'':'index.php?option=com_imageshow&controller=showcase&task=edit&cid[]=' . (int) $this->items->showcase_id . $tmpl . '&theme='; ?>" />
	...
	<input type="hidden" id="mainSite" name="mainSite" value="<?php
	if ($task == 'add')
	{
		echo 'true';
	}

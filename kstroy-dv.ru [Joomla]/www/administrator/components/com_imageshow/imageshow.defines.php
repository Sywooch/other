...
if (is_file(JPATH_ADMINISTRATOR . DS . 'components' . DS . 'com_imageshow' . DS . 'classes' . DS . 'jsn_is_factory.php'))
{
...
define('JSN_IMAGESHOW_PATH_JSN_PLUGIN', JPATH_PLUGINS . DS . 'jsnimageshow');
...
$languages[] = array ('code'  => 'da-DK', 'title' => 'Danish');
$languages[] = array ('code'  => 'de-DE', 'title' => 'German');
$languages[] = array ('code'  => 'en-GB', 'title' => 'English');
$languages[] = array ('code'  => 'es-ES', 'title' => 'Spanish (Spain)');
...
$languages[] = array ('code'  => 'pt-BR', 'title' => 'Brazil');

...
function accesspress_root_widgets_init() {
 ...
 register_sidebar( array(
        'name' => __( 'Левая колонка', 'accesspress-root' ),
        'id' => 'primary-widget-area',
        'description' => __( 'Область левой колонки', 'accesspress-root' ),
 ...
 register_sidebar( array(
        'name' => __( 'Левая колон2ка', 'accesspress-root' ),
        'id' => 'primary-widget-area2',
        'description' => __( 'Область левой колонки2', 'accesspress-root' ),
        'before_widget' => '<div id="%1$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>',
 ...
 register_sidebar( array(
        'name' => __( 'Левая колн2ка', 'accesspress-root' ),

...
<div align="left" id="gallery">

<h1><a href="index.php?option=com_content&view=article&id=43">Фотогалерея 1</a></h1><br>
<h1><a href="index.php?option=com_content&view=article&id=44">Фотогалерея 2</a></h1><br>
<h1><a href="index.php?option=com_content&view=article&id=45">Фотогалерея 3</a></h1>
...
while ($file = readdir($dir_handle)) 
{
	...
	if(in_array($ext,$allowed_types))
	{
		...
		<img style="height:130px;" src="http://prodlenka28.ru/'.$directory.'/'.$file.'"><br></a>';
...
$directory = 'gallereya/gallereya1';
...
$directory = 'gallereya/gallereya2';
...
$directory = 'gallereya/gallereya3';

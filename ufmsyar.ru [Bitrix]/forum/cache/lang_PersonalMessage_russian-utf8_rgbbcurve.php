...
$txt['pm_error_data_limit_reached'] = 'Сообщение не может быть отправлено пользователю \'%1$s\', его ящик переполнен!';
$txt['pm_error_user_cannot_read'] = 'Пользователь \'%1$s\' не может получать личные сообщения.';
$txt['pm_successfully_sent'] = 'Личное сообщение удачно отправлено пользователю \'%1$s\'.';
...
$txt['pm_report_desc'] = 'С этой страницы Вы можете отправлять отчеты о полученных Вами личных сообщениях Администрации форума.';
$txt['pm_report_admins'] = 'Сообщить Администратору';
...
$txt['pm_manage_rules_desc'] = 'Фильтры сообщений позволяют Вам автоматически сортировать входящие сообщения по выбранным Вами условиям. Ниже предоставлен список всех установленных фильтров. Для изменения фильтра просто нажмите на его название.';
...
$txt['pm_rule_too_complex'] = 'Фильтр который Вы создали слишком большой для SMF. Попробуйте создать фильтры поменьше.';

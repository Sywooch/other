...
$txt['mc_seen'] = 'последний просмотр';
$txt['mc_groupr_by'] = 'от';

$txt['mc_reported_posts_desc'] = 'Здесь Вы можете просматривать все отчеты, присланные пользователями Вашего форума.';
...
$txt['mc_reportedp_ignore_confirm'] = 'Вы уверены, что хотите игнорировать отчет об этом сообщении?\\n\\nЭто действие приведет к исключению отчета для всех Модераторов форума.';
...
// Do not use numeric entries in the below string.
$txt['mc_groupr_warning'] = 'Вы уверены что хотите сделать это?';
...
$txt['mc_unapproved_posts_desc'] = 'Здесь Вы можете одобрить или удалить любые сообщения ожидающие модерации.';
$txt['mc_unapproved_replies'] = 'Сообщений';
$txt['mc_unapproved_topics'] = 'Тем';
$txt['mc_unapproved_by'] = '';
$txt['mc_unapproved_sure'] = 'Вы уверены что хотите сделать это?';
...
$txt['mc_viewmodreport'] = 'Отчет Модератору %1$s от %2$s';
...
$txt['mc_modreport_whoreported_data'] = 'Отчет от %1$s на %2$s.  По следующей причине:';
...
$txt['mc_watched_users_desc'] = 'Здесь Вы можете отслеживать всех пользователей находящихся под &quot;наблюдением&quot; модераторов и требующие одобрения сообщения от них. ';
...
$txt['mc_watched_users_delete_post'] = 'Вы уверены что хотите удалить это сообщение?';
$txt['mc_watched_users_delete_posts'] = 'Вы уверены что хотите удалить эти сообщения?';
...
$txt['mc_warning_template_delete_confirm'] = 'Вы уверены что хотите удалить выбранные шаблоны?';

$txt['mc_warning_template_desc'] = 'Используйте эту страницу для заполнения детальной информации о шаблоне. Помните, что поле "Заголовок шаблона" не является частью шаблона. Помните, что уведомление отсылается в системе личных сообщений с использованием кодов BBC, которые не описываются в шаблоне. Помните, что если Вы используете переменную {MESSAGE} тогда этот шаблон будет недоступен, когда используются общие предупреждения (Предупреждения не включаются в текст сообщения).';
$txt['mc_warning_template_title'] = 'Заголовок шаблона';
$txt['mc_warning_template_body_desc'] = 'Содержание уведомления. Вы можете использовать следующую ссылку для шаблона.<ul style="margin-top: 0px;"><li>{MEMBER} - Имя пользователя.</li><li>{MESSAGE} - присоединить модерируемое сообщение. (Если оно есть)</li><li>{FORUMNAME} - Имя форума.</li><li>{SCRIPTURL} - WEB-адрес форума.</li><li>{REGARDS} - стандартная подпись e-mail.</li></ul>';
...
$txt['mc_warning_template_error_empty'] = 'Вы должны ввести как заголовок, так и тело сообщения.';
...
$txt['mc_prefs_latest_news'] = 'SM Новости';
$txt['mc_prefs_show_reports'] = 'Показывать количество открытых отчетов в вверху форума';

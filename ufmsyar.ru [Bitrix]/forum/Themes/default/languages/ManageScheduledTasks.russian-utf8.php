<?php
// Version: 2.0 RC2; ManageScheduledTasks
...
$txt['scheduled_task_desc_daily_maintenance'] = 'Ежедневный запуск обслуживания форума - не должен запрещаться.';
...
$txt['scheduled_task_fetchSMfiles'] = 'Получение файлов с сайта Simple Machines';
$txt['scheduled_task_desc_fetchSMfiles'] = 'Скачивание javascript файлов содержащих уведомления об обновлениях, а также другую информацию.';
$txt['scheduled_task_birthdayemails'] = 'Отправление поздравлений с Днем Рождения';
$txt['scheduled_task_desc_birthdayemails'] = 'Рассылает по email поздравления с Днем Рождения для пользователей.';
$txt['scheduled_task_weekly_maintenance'] = 'Еженедельное обслуживание';
$txt['scheduled_task_desc_weekly_maintenance'] = 'Запуск еженедельного обслуживания форума - не должен запрещаться.';
$txt['scheduled_task_paid_subscriptions'] = 'Проверка платной подписки';
$txt['scheduled_task_desc_paid_subscriptions'] = 'Отправление уведомлений о платных подписках и удаление истекших подписок пользователей.';
...
$txt['scheduled_task_edit_start_time_desc'] = 'Время первого запуска (часы:минуты)';
$txt['scheduled_task_time_offset'] = 'Обратите внимание, время запуска задачи должно указываться с учетом текущего времени сервера. Текущее время на сервере: %1$s';

...
$txt['permission_cannot_edit'] = '<strong>Обратите внимание:</strong> Вы не можете редактировать данный профиль прав доступа поскольку это предопределенный профиль включенный в состав программного обеспечения форума. Для изменения прав доступа в данном профиле необходимо создать дубликат данного профиля. Для выполнения данной задачи нажмите <a href="%1$s">здесь</a>.';

$txt['permissions_for_profile'] = 'Права доступа для профиля';
$txt['permissions_boards_desc'] = 'Ниже показан список прав доступа для каждого раздела Вашего форума. Вы можете изменить назначенные профиля прав доступа нажав на название раздела или выбрав &quot;изменить все&quot; вверху страницы. Для изменения профиля просто нажмите на название профиля.';
...
$txt['permissions_profiles_desc'] = 'Профили прав доступа назначаются индивидуально для каждого раздела для упрощения управления настройками безопасности. В данном разделе Вы можете создавать, редактировать и удалять профили прав доступа.';
...
$txt['permissions_board_desc'] = '<strong>Обратите внимание</strong>: изменения прав доступа для данного раздела затронет все разделы которые используют профиль прав доступа &quot;По умолчанию&quot;. Разделы не использующие профиль &quot;По умолчанию&quot; изменения не затронут.';
...
$txt['permissionhelp_karma_edit'] = 'Карма - это дополнительная возможность форума, которая отображает популярность пользователя на форуме. Данные права доступа будут работать, только если Вы включили функцию Кармы, в настройках Вашего форума. Для гостей данные права доступа установить невозможно.';
...
$txt['permissionname_send_topic'] = 'Отправление тем друзьям';
...
$txt['permissionhelp_report_any'] = 'Это право предоставляет в каждом ответе ссылку для оповещения Модераторов. После оповещения, все Модераторы раздела получат уведомление на email адрес со ссылкой на тему и Вашим комментарием.';
...
$txt['permissionname_approve_posts'] = 'Одобрение элементов ожидающих одобрения';
$txt['permissionhelp_approve_posts'] = 'Это право позволяет пользователю одобрять все элементы, требующие одобрения в разделе.';
$txt['permissionname_post_unapproved_replies'] = 'Оставлять сообщения в неодобренных темах';
$txt['permissionhelp_post_unapproved_replies'] = 'Это право позволяет пользователю оставлять сообщения в теме, которая не будет отображаться пока модератор не одобрит ее.';
$txt['permissionname_post_unapproved_replies_own'] = 'Собственная тема';
$txt['permissionname_post_unapproved_replies_any'] = 'Любая тема';
$txt['permissionname_post_unapproved_topics'] = 'Создание тем, требующие одобрения';
...
$txt['permissionhelp_post_unapproved_attachments'] = 'Это право позволяет пользователю делать вложения в их сообщениях, требующие одобрения перед тем как будут показаны другим пользователям.';
...
$txt['permissionname_simple_profile_title_own'] = 'Изменение своей подписи над аватаром';
$txt['permissionname_simple_profile_title_any'] = 'Изменение подписи над аватаром всех пользователей';
...
$txt['permissiongroup_simple_notification'] = 'Запрос об уведомлений';
$txt['permissiongroup_simple_attach'] = 'Оставлять вложения';
$txt['permissiongroup_simple_moderate'] = 'Модерация раздела';

$txt['permissionname_simple_post_unapproved_replies_own'] = 'Оставлять сообщения в своей теме - требовать одобрения';
$txt['permissionname_simple_post_unapproved_replies_any'] = 'Оставлять сообщения в любой теме - требовать одобрения';
...
$txt['permissions_post_moderation_desc'] = 'На этой странице Вы можете выбрать, сообщения пользователей из каких групп должны премодерироваться  в соответствии с выбранным профилем разрешений.';
$txt['permissions_post_moderation_deny_note'] = 'Обратите внимание, что хотя включены расширенные права доступа, Вы не можете применять &quot;запрещающие&quot; права на этой странице. Пожалуйста, редактируйте права напрямую, если хотите применить запрещающие права.';

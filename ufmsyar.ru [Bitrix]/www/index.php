...
<div align="center" style="width:580px; height:500px; overflow:hidden; margin-left:0px; margin-right:0px;
padding-left:0px; padding-right:0px; ">
 <?$APPLICATION->IncludeComponent("itlogic:bxslider", "template1", array(
	"IBLOCK_TYPE" => "photos",
	"IBLOCK_ID" => "14",

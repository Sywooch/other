...
$MESS['USE_HIDDEN_PROTECTION']      = 'Включить скрытую защиту от спама, вместо (CAPTCHA)';
$MESS['CUSTOM_FIELDS']              = 'Настраиваемые поля';
...
//GROUPS_JS_VALIDATE_SETTINGS
$MESS["GROUPS_JS_VALIDATE_SETTINGS"] = "JavaScript & jQuery плагины";

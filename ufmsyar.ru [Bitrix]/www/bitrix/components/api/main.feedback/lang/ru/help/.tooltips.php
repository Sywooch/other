...
$MESS['USE_CAPTCHA_TIP']                = 'Капча сильно раздражает посетителей, включите лучше «Скрытую защиту от спама»';
...
$MESS['UPLOAD_FOLDER_TIP']              = 'Папка для загружаемых фалов должна быть доступна для записи';

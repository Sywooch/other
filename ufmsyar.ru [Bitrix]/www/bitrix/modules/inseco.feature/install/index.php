...
class inseco_feature extends CModule
{
	var $MODULE_ID = "inseco.feature";
	var $MODULE_VERSION;
	var $MODULE_VERSION_DATE;
	var $MODULE_NAME;
	var $MODULE_DESCRIPTION;

	function inseco_feature()
	{        		
	...
	{
		CopyDirFiles(
			$_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/inseco.feature/install/components",
			$_SERVER["DOCUMENT_ROOT"]."/bitrix/components/inseco", true, true);
		CopyDirFiles(
			$_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/inseco.feature/install/js",
	...
	function DoUninstall()
	{
		...
		DeleteDirFilesEx("/bitrix/components/inseco/inseco.feature");
	}
}
?>
...
<div class="voting-form-box" style="margin:0px; border:0px;">
<?
...
?>
		...
		<tr>
<?
if($i==4){ $i=1; /*echo'Для иностранных граждан:';*/ }


?>
			<td class="vote-answer-name" style="background-color:transparent;">
				<?=$i?>. <?=$arAnswer["MESSAGE"]?></td>

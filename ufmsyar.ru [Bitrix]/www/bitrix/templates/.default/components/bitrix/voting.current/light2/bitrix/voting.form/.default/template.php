...
<h2  style="font-weight:bold; color:#800d0d;">œ–»Ã»“≈ ”◊¿—“»≈ ¬ Œœ–Œ—≈ <!--<?=$arParams["TITLE_BLOCK"];?>--></h2></div>
<?
...
<form action="<?=POST_FORM_ACTION_URI?>" method="post" class="vote-form" style="background-color:transparent";>
	<?=bitrix_sessid_post()?>
...
<!--<div style="width:100%; height:25px;"></div>-->
		<div class="vote-item-title" ><h2 style="font-size:10pt; font-style:italic; color:#800d0d; margin-left:5px;"><?=$arQuestion["QUESTION"]?></h2></div>
		
		<div class="vote-answers-list" style="margin-right:0px !important; color:#800d0d; background-color:transparent; ">
...
<div align="center" class="vote-form-box-buttons vote-vote-footer" style="background-color:transparent; margin-left:0px;">
	...
	<input type="submit" name="vote" value="œÓ„ÓÎÓÒÓ‚‡Ú¸" 

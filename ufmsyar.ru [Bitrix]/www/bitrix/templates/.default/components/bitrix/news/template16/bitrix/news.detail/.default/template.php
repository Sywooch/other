...
<div class="news-detail">
	...
	<div class="news-detail-back" style="width:100%;"><a href="<?=$arResult["SECTION_URL"]?>"><?=GetMessage("T_NEWS_DETAIL_BACK")?></a></div>
	<?
...
<?$APPLICATION->IncludeComponent("bitrix:main.include", "template21", Array(
	"AREA_FILE_SHOW" => "page",	// Показывать включаемую область
	"AREA_FILE_SUFFIX" => "inc3567613",	// Суффикс имени файла включаемой области

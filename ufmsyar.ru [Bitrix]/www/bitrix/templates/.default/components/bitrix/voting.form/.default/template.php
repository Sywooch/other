...
?>
<div align="left" class="voting-form-box" style="background-color:transparent; padding-left:5px; padding-right:5px; margin:0px; 
border:0px;">
...
?>
		...
		<div class="vote-answers-list" style="margin-right:0px !important; color:#800d0d;
margin-left:0px;">

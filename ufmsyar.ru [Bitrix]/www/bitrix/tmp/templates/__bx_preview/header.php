...
<!--kvitantsiya-ob-uplate-gosposhliny.php-->
<script type="text/javascript">
			var payments = [];

			payments[0] = {id : '0', name : 'Государственная пошлина за  регистрацию иностранного гражданина  или лица без гражданства по месту  жительства в Российской Федерации', kbk : '192 1 08 06000 01 0014 110', price : '200', };payments[1] = {id : '1', name : 'Государственная пошлина за внесение  изменений в заграничный паспорт  старого образца', kbk : '192 1 08 06000 01 0007 110', price : '200', };payments[2] = {id : '2', name : 'Государственная пошлина за выдачу  заграничного паспорта нового поколения  для взрослых', kbk : '192 1 08 06000 01 0004 110', price : '2500', };payments[3] = {id : '3', name : 'Государственная пошлина за выдачу  заграничного паспорта нового поколения  для детей в возрасте до 14 лет', kbk : '192 1 08 06000 01 0006 110', price : '1200', };payments[4] = {id : '4', name : 'Государственная пошлина за выдачу  заграничного паспорта старого образца  для взрослых', kbk : '192 1 08 06000 01 0003 110', price : '1000', };payments[5] = {id : '5', name : 'Государственная пошлина за выдачу  заграничного паспорта старого образца  для детей в возрасте до 14 лет', kbk : '192 1 08 06000 01 0005 110', price : '300', };payments[6] = {id : '6', name : 'Государственная пошлина за выдачу  или продления сроков действия вида на  жительство иностранному гражданину  или лицу без гражданства', kbk : '192 1 08 06000 01 0013 110', price : '2000', };payments[7] = {id : '7', name : 'Государственная пошлина за выдачу  иностранному гражданину или лицу без  гражданства разрешения на временное  проживание в Российской Федерации', kbk : '192 1 08 06000 01 0015 110', price : '1000', };payments[8] = {id : '8', name : 'Государственная пошлина за выдачу  либо продление срока действия  иностранному гражданину или лицу без  гражданства, временно пребывающему  в Российской Федерации визы для  выезда из Российской Федерации и  последующего въезда в Российскую  Федерацию', kbk : '192 1 08 06000 01 0010 110', price : '600', };payments[9] = {id : '9', name : 'Государственная пошлина за выдачу  либо продление срока действия  иностранному гражданину или лицу без  гражданства, временно пребывающему  в Российскую Федерацию визы  для многократного пересечения  Государственной границы Российской  Федерации', kbk : '192 1 08 06000 01 0011 110', price : '1000', };payments[10] = {id : '10', name : 'Государственная пошлина за выдачу  либо продление срока действия  иностранному гражданину или лицу без  гражданства, временно пребывающему в  Российской Федерации визы для выезда  из Российской Федерации', kbk : '192 1 08 06000 01 0009 110', price : '600', };payments[11] = {id : '11', name : 'Государственная пошлина за выдачу  паспорта гражданина Российской  Федерации', kbk : '192 1 08 07100 01 0034 110', price : '200', };payments[12] = {id : '12', name : 'Государственная пошлина за выдачу  паспорта гражданина Российской  Федерации взамен утраченного или  пришедшего в негодность', kbk : '192 1 08 07100 01 0035 110', price : '500', };payments[13] = {id : '13', name : 'Государственная пошлина за выдачу  приглашения на въезд в Российскую  Федерацию иностранным гражданам или  лицам без гражданства', kbk : '192 1 08 06000 01 0012 110', price : '500', };payments[14] = {id : '14', name : 'Государственная пошлина за выдачу  проездного документа беженца или  продления срока действия указанного  документа', kbk : '192 1 08 06000 01 0008 110', price : '200', };payments[15] = {id : '15', name : 'Государственная пошлина за выдачу  разрешения на привлечение и  использование иностранных работников', kbk : '192 1 08 06000 01 0016 110', price : '6000', };payments[16] = {id : '16', name : 'Государственная пошлина за выдачу  разрешения на работу иностранному  гражданину или лицу без гражданства', kbk : '192 1 08 06000 01 0017 110', price : '2000', };payments[17] = {id : '17', name : 'Государственная пошлина за прием в  гражданство Российской Федерации,  восстановление в гражданстве  Российской Федерации, выход из  гражданства Российской Федерации,  за определение принадлежности к  гражданству Российской Федерации', kbk : '192 1 08 06000 01 0018 110', price : '2000', };
				$(function()
				{
					$.each(payments, function(){$('#type').append($('<option />').val(this.id).text(this.name + ' (' + this.price + ' р.)'))});
					$('#amount').val(payments[0].price);
					$('#kbk').text(payments[0].kbk);
					...
					{
						var payment = payments[$('#type option:selected').val()];

						$('#kbk').text(payment.kbk);
						$('#kbk').text(payment.kbk);
						$('#amount').val(payment.price);
					});
					...
					$('#receipt').submit(function()
					{
						...
						$('#receipt input[name="kbk"]').val(payment.kbk);
						$('#receipt input[name="type"]').val(payment.name);
...
<?$APPLICATION->IncludeComponent("bitrix:main.include", "template28", Array(
	...
	"AREA_FILE_SUFFIX" => "inc_button3_2_0",	// Суффикс имени файла включаемой области

...
<form action="#" name="smfaq-form" id="smfaq-form" method="post" >
    ...
    <?php if (!$this->params->get('show_form', 0)) : ?>
	    <input type="button" class="button_bot" onclick="SmFaq.showform(false)" value="<?php echo JText::_('COM_SMFAQ_CLOSE'); ?>" />
	<?php endif; ?>
	<input type="button" class="button_bot" onclick="SmFaq.sendform(this.form)" value="<?php echo JText::_('COM_SMFAQ_SEND'); ?>" />
	</div>

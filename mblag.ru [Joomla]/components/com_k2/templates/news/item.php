...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?> news_page">
...
<div class="pluso" style="position: relative!important;" data-background="transparent" data-options="medium,round,line,horizontal,nocounter,theme=08" data-services="vkontakte,odnoklassniki,facebook,twitter,google,moimir" data-url="<?php echo substr($myabsoluteurl,0,19).''.$this->item->link; ?>" data-title="<?php echo $this->item->title; ?>" data-description="ξοθρΰνθε"></div>
  ...
  <!-- Latest items from author -->
	...
	If you add:
	- the CSS rule 'overflow-x:scroll;' in the element div.itemRelated {β€¦} in the k2.css

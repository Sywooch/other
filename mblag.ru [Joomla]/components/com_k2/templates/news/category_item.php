...
<?php if($this->item->params->get('catItemDateCreated')): ?>
	...
	<div class="catItemHeader">
	  ...
	  <!-- Item title -->
	  <h3 class="catItemTitle" style="width: <?php if($this->item->params->get('catItemImage') && !empty($this->item->image)): ?>370px;<?php else: ?>680px;<?php endif; ?>">
  ...
  <?php echo $this->item->event->K2AfterDisplay; ?>
	...
	<div class="pluso" data-options="small,round,line,horizontal,nocounter,theme=08" data-services="vkontakte,odnoklassniki,facebook,twitter,google,moimir" data-background="transparent" data-url="http://mblag.ru<?php echo $this->item->link; ?>" data-title="<?php echo $this->item->title; ?>" data-description="<?php echo strip_tags($this->item->introtext); ?>"></div>
</div>
<!-- End K2 Item Layout -->

(function($) {
  ...
  function _initFullwidthSliders() {
    $('.js-fullwidth-slider').each(function() {
      var fullwidth_slider = new $JssorSlider$($(this).attr('id'), _fullwidthSlidersOptions);
    });
  }
  
  _initFullwidthSliders();

...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' + 
                '<div class="qq-upload-drop-area"><span>Или перетащите мышкой файлы на эту зону</span></div>' +
                '<div class="qq-upload-button"><input type="button" value="Укажите путь к файлам"></div>' +
        ...
        fileTemplate: '<li>' +
                ...
                '<span class="qq-upload-failed-text">Не загружен</span>' +
            '</li>',

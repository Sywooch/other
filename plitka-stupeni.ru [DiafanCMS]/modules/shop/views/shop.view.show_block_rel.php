 ...
 *
 * Шаблон
 * шаблонного тега <insert name="show_block_rel" module="shop" [count="количество"]
...
{
	echo '<div class="block_header">' . $this->diafan->_('Похожие товары') . '</div>
	<div class="shop_block_rel">';

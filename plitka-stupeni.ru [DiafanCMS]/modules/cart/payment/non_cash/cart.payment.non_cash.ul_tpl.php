...
<table width="607" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="522" valign="top"><b><?php echo $values["non_cash_name"];?></b><br>
      ИНН <?php echo $values["non_cash_inn"];?>, ОГРН <?php echo $values["non_cash_ogrn"];?><br>
      <?php echo $values["non_cash_address"];?>
    </td>
  </tr>
      ...
      <table width="100%" cellpadding="4" cellspacing="0" style="border: 1px solid black; border-width: 1px 1px 0px 0px">
        <tr> 
          <td width="317" height="36" valign="top" bgcolor="#FFFFFF" style="border: 1px solid black; border-width: 0px 0px 1px 1px">Получатель:<br>
            ИНН <b><?php echo $values["non_cash_inn"];?> <?php echo $values["non_cash_name"];?></b></td>
          <td width="90" valign="bottom" bgcolor="#FFFFFF" align="right" style="border: 1px solid black; border-width: 0px 0px 1px 1px">Сч. №</td>
          <td valign="bottom" width="185" bgcolor="#FFFFFF" style="border: 1px solid black; border-width: 0px 0px 1px 1px"><b><?php echo $values["non_cash_rs"];?></b></td>
        </tr>
        <tr> 
          <td valign="top" bgcolor="#FFFFFF" height="36" style="border: 1px solid black; border-width: 0px 0px 1px 1px">Банк получателя:<br>
            <b><?php echo $values["non_cash_bank"];?></b></td>
          <td valign="top" bgcolor="#FFFFFF" align="right" style="border: 1px solid black; border-width: 0px 0px 1px 1px">БИК<br>
            Кор. Сч. №</td>

          <td valign="top" bgcolor="#FFFFFF" style="border: 1px solid black; border-width: 0px 0px 1px 1px"><b><?php echo $values["non_cash_bik"];?><br>
            </b> <b><?php echo $values["non_cash_ks"];?></b> </td>
        </tr>
      </table>
    </td>
  </tr>
  <tr valign="middle" align="center"> 
    <td height="45" colspan="2" valign="middle"><b><font size="3">СЧЕТ №<?php echo $values["order_id"];?> от 
      <?=$values["order_created"];?> г.</font></b></td>
  </tr>
  <tr> 
    <td height="48" colspan="2" valign="top"><b>Заказчик:</b> <?php echo $values["user_fio"];?><br>
      <b>Плательщик:</b> <?php echo $values["user_fio"];?> <br>
    </td>
  </tr>
  <tr> 
...
<?php foreach($values["goods"] as $k => $row){?>
		<tr>
...
<?php }?>
  ...
  <tr> 
    <td height="49" colspan="2" valign="bottom">Всего наименований <?php echo $values['count'];?>, на сумму:<br>
      <b><?php echo $values['str_summ'];?></b></td>
  </tr>
  ...
  <tr valign="bottom"> 
	...
	<?php if(file_exists(ABSOLUTE_PATH.USERFILES.'/shop/non_cash.pechat.jpg'))
	{
		...
		<br><br>
		Руководитель предприятия: ____________________________ (<?php echo $values["non_cash_director"];?>)<br>
		Главный бухгалтер: ___________________________________ (<?php echo $values["non_cash_glbuh"];?>)
	</td>
  </tr>
  <tr> 

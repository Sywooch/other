...
if (! DB::query_result("SELECT id FROM {modules} WHERE module_name='news' LIMIT 1"))
{
...
$result = DB::query("SELECT e.id, e.created, e.[name], e.[anons], e.cat_id, e.site_id FROM {news} AS e"

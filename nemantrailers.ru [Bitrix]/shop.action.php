...
class Shop_action extends Action
{
	...
	public function buy()
	{
		...
		$this->result["errors"][0] = $this->diafan->_('В <a href="%s">корзине</a> %s шт.', false, BASE_PATH_HREF.$cart_link.'?'.rand(0, 999999), $count_good);
	...
	public function check()
	{
		...
		$count_good = $this->diafan->_cart->get($good_id, false, "count");
		if($count_good)
		{
			if(! $cart_link = $this->diafan->_route->module("cart"))
			{

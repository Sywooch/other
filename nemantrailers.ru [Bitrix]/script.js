...
var anc3 = window.location.hash.replace("#","");	
	if((anc3=='products')||(anc3=='products/0')||(anc3=='products/1')||(anc3=='products/2')||(anc3=='products/3')){ 
	
	
					
					if((anc3=='products')||(anc3=='products/0')){ var anc_sub_number=0; }
					else if(anc3=='products/1'){ var anc_sub_number=1; }
					else if(anc3=='products/2'){ var anc_sub_number=2; }
					else if(anc3=='products/3'){ var anc_sub_number=3; }
...
(function ($) {
    $(window).load(function () {
        ...
        $('#fullPage').fullpage({
            ...
            onLeave: function(index, nextIndex, direction) {
				...
				if( (index==3)&&($("#ddd0").hasClass("active"))&&(direction == "down")&&(nextIndex==4)&&(click_parameter==0) ){
					//$("#ddd1").click();
					//////////////////////////////
					//history.pushState(null, null, '/#products/1');
					
					//var e = jQuery.Event("keydown", { keyCode: 39 });
 					//$("body").trigger( e );
					//$('body').keydown(40);
					//$('.fp-slidesContainer').css("margin-left","-200px");
					$.fn.fullpage.moveSlideRight();
					$("#ddd0").removeClass("active");
					$("#ddd1").addClass("active");
					
					return false;	
					
				}else if( (index==3)&&($("#ddd1").hasClass("active"))&&(direction == "down")&&(nextIndex==4)&&(click_parameter==0) ){
					$.fn.fullpage.moveSlideRight();
					$("#ddd1").removeClass("active");
					$("#ddd2").addClass("active");
					return false;	
					
				}else if( (index==3)&&($("#ddd2").hasClass("active"))&&(direction == "down")&&(nextIndex==4)&&(click_parameter==0) ){
					$.fn.fullpage.moveSlideRight();
					$("#ddd2").removeClass("active");
					$("#ddd3").addClass("active");
					return false;	
					
				}else if( (index==3)&&($("#ddd3").hasClass("active"))&&(direction == "down")&&(nextIndex==4)&&(click_parameter==0) ){
					//$.fn.fullpage.moveSlideRight();
					//$("#ddd3").removeClass("active");
					//$("#ddd4").addClass("active");
					//return false;	
					
				}else if( (index==3)&&($("#ddd3").hasClass("active"))&&(direction == "up")&&(nextIndex==2)&&(click_parameter==0) ){
					$.fn.fullpage.moveSlideLeft();
					$("#ddd2").addClass("active");
					$("#ddd3").removeClass("active");
					return false;	
				
				}else if( (index==3)&&($("#ddd2").hasClass("active"))&&(direction == "up")&&(nextIndex==2)&&(click_parameter==0) ){
					$.fn.fullpage.moveSlideLeft();
					$("#ddd1").addClass("active");
					$("#ddd2").removeClass("active");
					return false;	
				
				}else if( (index==3)&&($("#ddd1").hasClass("active"))&&(direction == "up")&&(nextIndex==2)&&(click_parameter==0) ){
					$.fn.fullpage.moveSlideLeft();
					$("#ddd0").addClass("active");
					$("#ddd1").removeClass("active");
					return false;	
				
				}else if( (index==3)&&($("#ddd0").hasClass("active"))&&(direction == "up")&&(nextIndex==2)&&(click_parameter==0) ){
		...
		$(".sss").addClass("active");
		  //$('#ddd0').click();
              ...
              //  var $loadedSection = $(this);
               /* $(".BG_wide").css({left:bgWide}); 
				...
				if(index==3){
						...
						function sec() {
							if($(".wrap-list-product .list-product-min").hasClass("animated")){
								var anc = window.location.hash.replace("#","");
							
								if(anc=="products"){
									$(".column ul#menu ul li a").removeClass("active");
									$(".column ul#menu ul li a").removeClass("ss");
									$("#ddd0").addClass("active");
								}else if(anc=="products/1"){
									$(".column ul#menu ul li a").removeClass("active");
									$(".column ul#menu ul li a").removeClass("ss");
									$("#ddd1").addClass("active");
								}else if(anc=="products/2"){
									$(".column ul#menu ul li a").removeClass("active");
									$(".column ul#menu ul li a").removeClass("ss");	
									$("#ddd2").addClass("active");
								}else if(anc=="products/3"){
									$(".column ul#menu ul li a").removeClass("active");
									$(".column ul#menu ul li a").removeClass("ss");
									$("#ddd3").addClass("active");
								}
			...
			afterSlideLoad: function( anchorLink, index, slideAnchor, slideIndex){
				//alert(anc_number);
				//alert(anc_sub_number);
				
				var anc_2 = window.location.hash.replace("#","");
				anc_2=String(anc_2);
				if((anc_2=='products')||(anc_2=='products/0')||(anc_2=='products/1')||(anc_2=='products/2')||(anc_2=='products/3')){ 
	
	
					
					if((anc_2=='products')||(anc_2=='products/0')){ var anc_sub_number2=0; }
					else if(anc_2=='products/1'){ var anc_sub_number2=1; }
					else if(anc_2=='products/2'){ var anc_sub_number2=2; }
					else if(anc_2=='products/3'){ var anc_sub_number2=3; }
				...
				if((index==3)&&(load_sl==1)){
					
					//if( (anc_sub_number=="0") && (anc_sub_number2 != anc_sub_number) ){
					if( (anc_sub_number2 != anc_sub_number) ){
				...
				//alert(anc_2);
				//if( (anc_2=="products")||(anc_2=="products/0") ){
					//alert("1");
					//$.fn.fullpage.moveSlideLeft();
					//$.fn.fullpage.moveSlideLeft();
					//$.fn.fullpage.moveSlideLeft();
	...
	var src1=$('.fp-slidesContainer li.product_item:first-child a.product_pic img').attr("src");
	var src2=$('.fp-slidesContainer li.product_item:first-child a.product_pic_2 img').attr("src");
	var src3=$('.fp-slidesContainer li.product_item:first-child a.product_pic_3 img').attr("src");
	var src4=$('.fp-slidesContainer li.product_item:first-child a.product_pic_4 img').attr("src");
	
	$('.fp-slidesContainer .slide-1 .display img').attr("src",src1);
	$('.fp-slidesContainer .slide-2 .display img').attr("src",src2);
	$('.fp-slidesContainer .slide-3 .display img').attr("src",src3);
	$('.fp-slidesContainer .slide-4 .display img').attr("src",src4);
...
$(document).ready(function () {
		...
		$(document).on('click', '.column .M li a', function() {
			load_sl=0;	
		}); 	
        ...
        $(document).on('click', '.toggle-link-prod', function() {
			...
			$('.toggle-link-prod').removeClass('active');
		...
		$(document).on('click', '.sss', function() {
            ...
            $(this).addClass('active');
			 $(this).addClass('active');
			 $("#ddd"+$(this).attr('ids')).addClass('active');
        }); 
...
$(document).ready(function () {
   ...
   $("a.ICN").fancybox({'width':'950','height':'400','minWidth'  : '360', 'minHeight' : '420','autoScale': false,'transitionIn': 'none','transitionOut': 'none','type': 'iframe'});
   ...
   $(".sends").on("click",function(event){
			...
			$.post("/include/mail.php", {name:$("#names").val(),phone: $("#phoness").val(),type: '???????? ??????'} , function(data) {
				$(".content_for").css('background','#fff');
				$(".content_for").html('<center><h3 Class="zvanok_title_od">?????? ??????? ??????????!</h3><img width="80px" src="/bitrix/templates/neman/img/oks.jpg"><p>??? ???????? ???????? ? ???? ? ???????? ?????</p><a href="javascript:void(0);" class="okitoki"></a></center>');
...
curent.removeClass('actives');
	 ...
	 $('.product_pic_4').on('click',function(e){
         e.preventDefault(); 
          curent=$(this).parent().find('.list-product-min').find('li.actives');
         var $this = $(this),
             item = $this.closest('.product_item'),
             container = $this.closest('.slide-4'),
             display = container.find('.display'),
             path = item.find('img').attr('src'),
             duration = 300;
...
$('.display img').each(function () {
	...
	var width_result=(width_1-width_window)/2;
	$(this).css("margin-left","-"+width_result+"px");
});
...
$(".column .M li a").click(function(){
	
	click_parameter=1;
	/*if( ($("#idProducts").hasClass("active")) && (($("#ddd0").hasClass("active")) || ($("#ddd1").hasClass("active")) || ($("#ddd2").hasClass("active")) || ($("#ddd3").hasClass("active"))) && ($(this).hasClass("toggle-link-prod")!=true) ){

		
/*		
		
		var menuanchor = $(this).parent().attr("data-menuanchor");
		var menuanchor_number=0;
		var menuanchor_text=[];
		
		
		if(menuanchor=='main'){ menuanchor_number=0; }
		else if(menuanchor=='company'){ menuanchor_number=1; }
		else if(menuanchor=='products'){ menuanchor_number=2; }
		else if(menuanchor=='clients'){ menuanchor_number=3; }
		else if(menuanchor=='services'){ menuanchor_number=4; }
		else if(menuanchor=='contacts'){ menuanchor_number=5; }
		
		
		menuanchor_text[0]="main";
		menuanchor_text[1]="company";
		menuanchor_text[2]="products";
		menuanchor_text[3]="clients";
		menuanchor_text[4]="services";
		menuanchor_text[5]="contacts";
				
		
		
		$.fn.fullpage.silentMoveTo(menuanchor_text[menuanchor_number], menuanchor_number);
				
				if(menuanchor_number==4){
...
/*		
   ...
   var anc = window.location.hash.replace("#","");
				...
				//});
				var array_anc = {'main': 0, 'company': 1, 'products': 2, 'clients': 3, 'services': 4, 'contacts': 5};
				var anc_text=[];
				...
				if(anc=='main'){ anc_number=0; }
				else if(anc=='company'){ anc_number=1; }
				else if((anc=='products')||(anc=='products/0')||(anc=='products/1')||(anc=='products/2')||(anc=='products/3')){ anc_number=2;
					/*
					if((anc=='products')||(anc=='products/0')){ var anc_sub_number=0; }
					else if(anc=='products/1'){ var anc_sub_number=1; }
					else if(anc=='products/2'){ var anc_sub_number=2; }
					else if(anc=='products/3'){ var anc_sub_number=3; }
					*/
				
				 }
				else if(anc=='clients'){ anc_number=3; }
				else if(anc=='services'){ anc_number=4; }
				else if(anc=='contacts'){ anc_number=5; }
				
				//if(anc_number!=0){
				//anc_number=anc_number-1;	
				//}
				...
				//$(".services-link a").click();
	
				//$.fn.fullpage.navigation && ($("#fp-nav").find(".active").removeClass("active"), anc ? $("#fp-nav").find('a[href="#' + anc + '"]').addClass("active") : $("#fp-nav").find("li").eq(anc_number).find("a").addClass("active"));
		//alert("-");
				
				
				$.fn.fullpage.silentMoveTo(anc_text[anc_number], anc_number);
               ...
               // };  
				...
				//if (anc_number == 3 || anc_number == 5  || anc_number == 6) {
                    //$(".column header").slideUp("slow");
                    $(".footer").animate({bottom:posFoot},"slow");
                //}; 

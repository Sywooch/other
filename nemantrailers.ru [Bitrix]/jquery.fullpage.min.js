            ...
            b.is("textarea") || b.is("input") || b.is("select") || !c.keyboardScrolling || !c.autoScrolling || (-1 < d.inArray(a.which, [40, 38, 32, 33, 34]) && a.preventDefault(), O = a.ctrlKey, Ka = setTimeout(function() {
                ...
                switch (a.which) {
                    ...
                    case 37:{
						...
						/*
						curent=$('.pref_pic').parent().find('.list-product-min').find('li.actives');
	
						if(next.index()==0){
							next=$('.pref_pic').parent().find('.list-product-min').find('li').eq(($('.pref_pic').parent().find('.list-product-min').find('li').length-1));
						}else{
							next=curent.prev();
						}
						var $this = $('.pref_pic'),
						display = $('.pref_pic').parent().find('.display'),
             			path = next.find('img').attr('src'),
             			duration = 0;
         
         				display.find('img').stop().fadeIn( function(){
             				$('.pref_pic').attr('src', path).stop().show();
			  			});
                    ...
                    case 39:{
						...
						/*	 
      					curent=$('.next_pic').parent().find('.list-product-min').find('li.actives');
	
						if((curent.index()+1)==$('.next_pic').parent().find('.list-product-min').find('li').length){
							next=$('.next_pic').parent().find('.list-product-min').find('li').eq(0);
						}else{
							next=curent.next();
						}
						var $this = $('.next_pic'),
						display = $('.next_pic').parent().find('.display'),
            			path = next.find('img').attr('src'),
             			duration = 0;
         
         				display.find('img').stop().fadeIn( function(){
             				$('.next_pic').attr('src', path).stop().show();
			  			});
	  					next.addClass('actives');
	  					curent.removeClass('actives');
						*/

...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-1" style="width: 33%"><?php if (false === theme_print_sidebar('footer-1-widget-area')) { ?>
        <ul><li style="text-align: left;">О компании</li>
        <li style="text-align: left;">Работа с нами</li>
        <li style="text-align: left;">Контакты</li></ul>
    <?php } ?></div><div class="art-layout-cell layout-item-1" style="width: 34%"><?php if (false === theme_print_sidebar('footer-2-widget-area')) { ?>
        <ul><li style="text-align: left;">Запчасти</li>
        <li style="text-align: left;">Каталог</li></ul>
    <?php } ?></div><div class="art-layout-cell layout-item-2" style="width: 33%"><?php if (false === theme_print_sidebar('footer-3-widget-area')) { ?>
        <p><img width="199" height="36" alt="" class="art-lightbox" src="<?php echo get_template_directory_uri() ?>/images/33.png"></p><p><a href="#">Главная</a> | <a href="#">Контакты</a> | <a href="#">Схема работы</a></p>

...
Easybasket
####################################################
welcome.xsl 2011-05-22 Nigel Alderton & Tim dodgson
-->
	...
	<xsl:template match="form">
		<fieldset>
			...
			<table>
				<tr>
					<td class="left">ID</td> 	
					<td class="middle"><input type="text" name="id" value="{maps/id}" size="30"/></td>
					<td class="help" colspan="2">Map your alias here, or use the default value "id"</td>
				</tr>
				<tr>
		...
		<fieldset>
			...
			<table>
				<tr>
					<td class="left">Per Item Cost</td> 	
					<td class="middle"><input type="text" name="per-item" value="{postage/per-item}" size="30"/></td>
					<td class="help" colspan="2">Postage cost for each item added to basket.</td>
				</tr>
				<tr>

...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'database_collector' => 'getDatabaseCollectorService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/anastosi/domains/anastosi.ru/public_html/app/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/anastosi/domains/anastosi.ru/public_html/app/Resources');
     ...
     * This method always returns the same instance of the service.
     *
     * @return SpoonDatabase A SpoonDatabase instance.
     */
    protected function getDatabaseService()
    {
        $this->services['database'] = $instance = new \SpoonDatabase('mysql', 'localhost', 'anastosi_root', 'anastosipass', 'anastosi_base', 3306);
    ...
    /**
     * Gets the 'database_collector' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Common\DataCollector\DatabaseDataCollector A Common\DataCollector\DatabaseDataCollector instance.
     */
    protected function getDatabaseCollectorService()
    {
        return $this->services['database_collector'] = new \Common\DataCollector\DatabaseDataCollector($this->get('database'));
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/anastosi/domains/anastosi.ru/public_html/app/Resources');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Common\Mailer A Common\Mailer instance.
     */
    protected function getMailerService()
    {
        return $this->services['mailer'] = new \Common\Mailer($this->get('database'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/anastosi/domains/anastosi.ru/public_html/app/../app/logs/logs.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/anastosi/domains/anastosi.ru/public_html/app/cache/dev/profiler', '', '', 86400), $a);
        ...
        $instance->add($this->get('database_collector'));
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/anastosi/domains/anastosi.ru/public_html/app/config/routing_dev.yml', array('cache_dir' => '/home/anastosi/domains/anastosi.ru/public_html/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => NULL), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/anastosi/domains/anastosi.ru/public_html/app', 'utf-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/home/anastosi/domains/anastosi.ru/public_html/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/anastosi/domains/anastosi.ru/public_html/app/cache/dev/twig', 'charset' => 'utf-8', 'paths' => array()));

        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\TranslationExtension($this->get('translator')));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\AssetsExtension($this));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\ActionsExtension($this));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/anastosi/domains/anastosi.ru/public_html/app', 'utf-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/anastosi/domains/anastosi.ru/public_html/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/anastosi/domains/anastosi.ru/public_html/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/anastosi/domains/anastosi.ru/public_html/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/home/anastosi/domains/anastosi.ru/public_html/app/Resources/views');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('gZl0SLOrkdtWiXnCyBOO60lg4rYviiKk');
    }
    ...
    {
        return $this->services['web_profiler.controller.profiler'] = new \Symfony\Bundle\WebProfilerBundle\Controller\ProfilerController($this->get('router', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('profiler', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('twig'), array('data_collector.config' => array(0 => 'config', 1 => '@WebProfiler/Collector/config.html.twig'), 'data_collector.request' => array(0 => 'request', 1 => '@WebProfiler/Collector/request.html.twig'), 'data_collector.exception' => array(0 => 'exception', 1 => '@WebProfiler/Collector/exception.html.twig'), 'data_collector.events' => array(0 => 'events', 1 => '@WebProfiler/Collector/events.html.twig'), 'data_collector.logger' => array(0 => 'logger', 1 => '@WebProfiler/Collector/logger.html.twig'), 'data_collector.time' => array(0 => 'time', 1 => '@WebProfiler/Collector/time.html.twig'), 'data_collector.memory' => array(0 => 'memory', 1 => '@WebProfiler/Collector/memory.html.twig'), 'data_collector.router' => array(0 => 'router', 1 => '@WebProfiler/Collector/router.html.twig'), 'database_collector' => array(0 => 'database', 1 => 'database_data_collector.html.twig')), 'bottom');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/anastosi/domains/anastosi.ru/public_html/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/anastosi/domains/anastosi.ru/public_html/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => '/home/anastosi/domains/anastosi.ru/public_html/app/cache/dev',
            'kernel.logs_dir' => '/home/anastosi/domains/anastosi.ru/public_html/app/logs',
            ...
            'database.port' => 3306,
            'database.name' => 'anastosi_base',
            'database.user' => 'anastosi_root',
            'database.password' => 'anastosipass',
            'kernel.secret' => 'gZl0SLOrkdtWiXnCyBOO60lg4rYviiKk',
            'fork.debug_email' => 'deniuscoder@mail.ru',
            'fork.debug_message' => 'Internal error.',
            'fork.version' => '3.8.1',
            'site.protocol' => 'http',
            'site.domain' => 'anastosi.ru',
            'site.default_title' => 'Fork CMS',
            'site.multilanguage' => false,
            'site.default_language' => 'ru',
            'site.path_www' => '/home/anastosi/domains/anastosi.ru/public_html/app/..',
            'site.path_library' => '/home/anastosi/domains/anastosi.ru/public_html/app/../library',
            ...
            'debug.container.dump' => '/home/anastosi/domains/anastosi.ru/public_html/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'profiler.storage.dsn' => 'file:/home/anastosi/domains/anastosi.ru/public_html/app/cache/dev/profiler',
            ...
            'router.resource' => '/home/anastosi/domains/anastosi.ru/public_html/app/config/routing_dev.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/anastosi/domains/anastosi.ru/public_html/app/cache/dev/twig',
                'charset' => 'utf-8',
                'paths' => array(
            ...
            'data_collector.templates' => array(
                ...
                'database_collector' => array(
                    0 => 'database',
                    1 => 'database_data_collector.html.twig',
                ),
            ),
        );
    }

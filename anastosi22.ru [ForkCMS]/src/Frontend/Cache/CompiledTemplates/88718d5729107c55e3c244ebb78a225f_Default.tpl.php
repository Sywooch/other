...
?>
	...
	<div id="container">
			...
			<?php
				if(isset(${'positionMain'})) $this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_1']['old'] = ${'positionMain'};
				$this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_1']['iteration'] = $this->variables['positionMain'];
				$this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_1']['i'] = 1;
				$this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_1']['count'] = count($this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_1']['iteration']);
				foreach((array) $this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_1']['iteration'] as ${'positionMain'})
				{
					if(!isset(${'positionMain'}['first']) && $this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_1']['i'] == 1) ${'positionMain'}['first'] = true;
					if(!isset(${'positionMain'}['last']) && $this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_1']['i'] == $this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_1']['count']) ${'positionMain'}['last'] = true;
				...
				<?php endif; ?>
			<?php
					$this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_1']['i']++;
				}
				if(isset($this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_1']['old'])) ${'positionMain'} = $this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_1']['old'];
				else unset($this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_1']);
				?>
		</section>
...
?>
	...
	<?php
				if(isset(${'jsFiles'})) $this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_2']['old'] = ${'jsFiles'};
				$this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_2']['iteration'] = $this->variables['jsFiles'];
				$this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_2']['i'] = 1;
				$this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_2']['count'] = count($this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_2']['iteration']);
				foreach((array) $this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_2']['iteration'] as ${'jsFiles'})
				{
					if(!isset(${'jsFiles'}['first']) && $this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_2']['i'] == 1) ${'jsFiles'}['first'] = true;
					if(!isset(${'jsFiles'}['last']) && $this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_2']['i'] == $this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_2']['count']) ${'jsFiles'}['last'] = true;
	...
	<?php
					$this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_2']['i']++;
				}
				if(isset($this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_2']['old'])) ${'jsFiles'} = $this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_2']['old'];
				else unset($this->iterations['88718d5729107c55e3c244ebb78a225f_Default.tpl.php_2']);
				?>
